...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t32346 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t32346 = (function (val,box,meta32347){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t32346.cljs$lang$type = true;
cljs.core.async.impl.channels.t32346.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t32346";
cljs.core.async.impl.channels.t32346.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write(writer__3836__auto__,"cljs.core.async.impl.channels/t32346");
});
cljs.core.async.impl.channels.t32346.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t32346.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32348){var self__ = this;
var _32348__$1 = this;return self__.meta32347;
});
cljs.core.async.impl.channels.t32346.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32348,meta32347__$1){var self__ = this;
var _32348__$1 = this;return (new cljs.core.async.impl.channels.t32346(self__.val,self__.box,meta32347__$1));
});
cljs.core.async.impl.channels.__GT_t32346 = (function __GT_t32346(val__$1,box__$1,meta32347){return (new cljs.core.async.impl.channels.t32346(val__$1,box__$1,meta32347));
});
}
return (new cljs.core.async.impl.channels.t32346(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_32349 = self__.takes.pop();if((taker_32349 == null))
{} else
{if(taker_32349.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_32350 = taker_32349.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_32350,taker_32349){
return (function (){return (take_cb_32350.cljs$core$IFn$_invoke$arity$1 ? take_cb_32350.cljs$core$IFn$_invoke$arity$1(null) : take_cb_32350.call(null,null));
});})(take_cb_32350,taker_32349))
);
} else
{}
{
