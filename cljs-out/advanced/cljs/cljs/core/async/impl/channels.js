...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t43637 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t43637 = (function (val,box,meta43638){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t43637.cljs$lang$type = true;
cljs.core.async.impl.channels.t43637.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t43637";
cljs.core.async.impl.channels.t43637.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write(writer__4111__auto__,"cljs.core.async.impl.channels/t43637");
});
cljs.core.async.impl.channels.t43637.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t43637.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43639){var self__ = this;
var _43639__$1 = this;return self__.meta43638;
});
cljs.core.async.impl.channels.t43637.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43639,meta43638__$1){var self__ = this;
var _43639__$1 = this;return (new cljs.core.async.impl.channels.t43637(self__.val,self__.box,meta43638__$1));
});
cljs.core.async.impl.channels.__GT_t43637 = (function __GT_t43637(val__$1,box__$1,meta43638){return (new cljs.core.async.impl.channels.t43637(val__$1,box__$1,meta43638));
});
}
return (new cljs.core.async.impl.channels.t43637(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_43640 = self__.takes.pop();if((taker_43640 == null))
{} else
{if(taker_43640.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_43641 = taker_43640.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_43641,taker_43640,this$__$1){
return (function (){return (take_cb_43641.cljs$core$IFn$_invoke$arity$1 ? take_cb_43641.cljs$core$IFn$_invoke$arity$1(null) : take_cb_43641.call(null,null));
});})(take_cb_43641,taker_43640,this$__$1))
);
} else
{}
{
