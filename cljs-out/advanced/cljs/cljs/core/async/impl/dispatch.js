...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_25502 = 0;while(true){
var m_25503 = cljs.core.async.impl.dispatch.tasks.pop();if((m_25503 == null))
{} else
{(m_25503.cljs$core$IFn$_invoke$arity$0 ? m_25503.cljs$core$IFn$_invoke$arity$0() : m_25503.call(null));
if((count_25502 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__25504 = (count_25502 + 1);
count_25502 = G__25504;
continue;
}
} else
{}
