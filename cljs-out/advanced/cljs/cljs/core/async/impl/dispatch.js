...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_38662 = 0;while(true){
var m_38663 = cljs.core.async.impl.dispatch.tasks.pop();if((m_38663 == null))
{} else
{(m_38663.cljs$core$IFn$_invoke$arity$0 ? m_38663.cljs$core$IFn$_invoke$arity$0() : m_38663.call(null));
if((count_38662 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__38664 = (count_38662 + 1);
count_38662 = G__38664;
continue;
}
} else
{}
