...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_26852 = 0;while(true){
var m_26853 = cljs.core.async.impl.dispatch.tasks.pop();if((m_26853 == null))
{} else
{(m_26853.cljs$core$IFn$_invoke$arity$0 ? m_26853.cljs$core$IFn$_invoke$arity$0() : m_26853.call(null));
if((count_26852 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__26854 = (count_26852 + 1);
count_26852 = G__26854;
continue;
}
} else
{}
