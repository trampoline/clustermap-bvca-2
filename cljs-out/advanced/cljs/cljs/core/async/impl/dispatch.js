...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_32340 = 0;while(true){
var m_32341 = cljs.core.async.impl.dispatch.tasks.pop();if((m_32341 == null))
{} else
{(m_32341.cljs$core$IFn$_invoke$arity$0 ? m_32341.cljs$core$IFn$_invoke$arity$0() : m_32341.call(null));
if((count_32340 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__32342 = (count_32340 + 1);
count_32340 = G__32342;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3279__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3279__auto__)
