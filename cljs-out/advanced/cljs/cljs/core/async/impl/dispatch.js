...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_51822 = (0);while(true){
var m_51823 = cljs.core.async.impl.dispatch.tasks.pop();if((m_51823 == null))
{} else
{(m_51823.cljs$core$IFn$_invoke$arity$0 ? m_51823.cljs$core$IFn$_invoke$arity$0() : m_51823.call(null));
if((count_51822 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__51824 = (count_51822 + (1));
count_51822 = G__51824;
continue;
}
} else
{}
