...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4213__auto__,writer__4214__auto__,opt__4215__auto__){return cljs.core._write(writer__4214__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_67818 = (0);while(true){
if((i_67818 < arr.length))
{(arr[i_67818] = null);
{
var G__67819 = (i_67818 + (1));
i_67818 = G__67819;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4213__auto__,writer__4214__auto__,opt__4215__auto__){return cljs.core._write(writer__4214__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_67831 = (self__.level + (1));while(true){
if((i_67831 <= (new_level + (1))))
{(update[i_67831] = self__.header);
{
var G__67832 = (i_67831 + (1));
i_67831 = G__67832;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_67833 = (0);while(true){
if((i_67833 <= self__.level))
{var links_67834 = (update[i_67833]).forward;if(((links_67834[i_67833]) === x__$1))
{(links_67834[i_67833] = (x__$1.forward[i_67833]));
{
var G__67835 = (i_67833 + (1));
i_67833 = G__67835;
continue;
}
} else
{{
var G__67836 = (i_67833 + (1));
i_67833 = G__67836;
continue;
}
}
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3637__auto__,timeout__$1,me){
