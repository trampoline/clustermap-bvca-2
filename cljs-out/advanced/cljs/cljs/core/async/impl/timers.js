...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_25619 = 0;while(true){
if((i_25619 < arr.length))
{(arr[i_25619] = null);
{
var G__25620 = (i_25619 + 1);
i_25619 = G__25620;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_25626 = (self__.level + 1);while(true){
if((i_25626 <= (new_level + 1)))
{(update[i_25626] = self__.header);
{
var G__25627 = (i_25626 + 1);
i_25626 = G__25627;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_25628 = 0;while(true){
if((i_25628 <= self__.level))
{var links_25629 = (update[i_25628]).forward;if(((links_25629[i_25628]) === x__$1))
{(links_25629[i_25628] = (x__$1.forward[i_25628]));
{
var G__25630 = (i_25628 + 1);
i_25628 = G__25630;
continue;
}
} else
{{
var G__25631 = (i_25628 + 1);
i_25628 = G__25631;
continue;
}
}
