...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_32305 = 0;while(true){
if((i_32305 < arr.length))
{(arr[i_32305] = null);
{
...
{var i_32312 = (self__.level + 1);while(true){
if((i_32312 <= (new_level + 1)))
{(update[i_32312] = self__.header);
{
var G__32313 = (i_32312 + 1);
i_32312 = G__32313;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_32314 = 0;while(true){
if((i_32314 <= self__.level))
{var links_32315 = (update[i_32314]).forward;if(((links_32315[i_32314]) === x__$1))
{(links_32315[i_32314] = (x__$1.forward[i_32314]));
{
