...
var _EQ___delegate = function (args){if(cljs.core.every_QMARK_((function (p1__53990_SHARP_){return (p1__53990_SHARP_ instanceof goog.date.Date);
}),args))
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53991_SHARP_){return p1__53991_SHARP_.getTime();
}),args));
} else
...
_EQ_.cljs$lang$applyTo = (function (arglist__53992){
var args = cljs.core.seq(arglist__53992);
...
cljs_time.internal.core.year_corrected_dim = (function year_corrected_dim(year,month){var G__53994 = (cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1 ? cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([month,(1)], 0)))?(11):(month - (1)))) : cljs_time.internal.core.days_in_month.call(null,(cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([month,(1)], 0)))?(11):(month - (1)))));var G__53994__$1 = (cljs.core.truth_((function (){var and__3546__auto__ = cljs_time.internal.core.leap_year_QMARK_(year);if(and__3546__auto__)
{return cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([month,(2)], 0));
} else
{return and__3546__auto__;
}
})())?(G__53994 + (1)):G__53994);return G__53994__$1;
});
cljs_time.internal.core.valid_date_QMARK_ = (function valid_date_QMARK_(p__53995){var map__53997 = p__53995;var map__53997__$1 = ((cljs.core.seq_QMARK_(map__53997))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53997):map__53997);var d = map__53997__$1;var millis = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53997__$1,cljs.core.constant$keyword$1293);var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53997__$1,cljs.core.constant$keyword$1294);var minutes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53997__$1,cljs.core.constant$keyword$1295);var hours = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53997__$1,cljs.core.constant$keyword$1296);var days = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53997__$1,cljs.core.constant$keyword$1297);var months = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53997__$1,cljs.core.constant$keyword$1298);var years = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53997__$1,cljs.core.constant$keyword$1299);var months__$1 = (months + (1));var _GT__LT_ = ((function (months__$1,map__53997,map__53997__$1,d,millis,seconds,minutes,hours,days,months,years){
return (function _GT__LT_(a,b,x){return ((x >= a)) && ((x <= b));
});})(months__$1,map__53997,map__53997__$1,d,millis,seconds,minutes,hours,days,months,years))
;
...
cljs_time.internal.core.index_of = (function index_of(coll,x){return cljs.core.first(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__53999_SHARP_,p2__53998_SHARP_){if(cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([p2__53998_SHARP_,x], 0))))
{return p1__53999_SHARP_;
} else
{return null;
}
}),coll));
...
var G__54000__delegate = function (p1,v1,kvs){return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc,period.cljs$core$IFn$_invoke$arity$2(p1,v1),kvs);
};
var G__54000 = function (p1,v1,var_args){
var kvs = null;if (arguments.length > 2) {
  kvs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__54000__delegate.call(this,p1,v1,kvs);};
G__54000.cljs$lang$maxFixedArity = 2;
G__54000.cljs$lang$applyTo = (function (arglist__54001){
var p1 = cljs.core.first(arglist__54001);
arglist__54001 = cljs.core.next(arglist__54001);
var v1 = cljs.core.first(arglist__54001);
var kvs = cljs.core.rest(arglist__54001);
return G__54000__delegate(p1,v1,kvs);
});
G__54000.cljs$core$IFn$_invoke$arity$variadic = G__54000__delegate;
return G__54000;
})()
;
...
format.cljs$lang$applyTo = (function (arglist__54002){
var fmt = cljs.core.first(arglist__54002);
var args = cljs.core.rest(arglist__54002);
