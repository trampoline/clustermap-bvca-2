...
{{
var G__24248 = cljs.core.pop(v__$1);
v__$1 = G__24248;
continue;
}
} else
...
{var pred__24252 = cljs.core._EQ_;var expr__24253 = limit;if(cljs.core.truth_((pred__24252.cljs$core$IFn$_invoke$arity$2 ? pred__24252.cljs$core$IFn$_invoke$arity$2(1,expr__24253) : pred__24252.call(null,1,expr__24253))))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((pred__24252.cljs$core$IFn$_invoke$arity$2 ? pred__24252.cljs$core$IFn$_invoke$arity$2(2,expr__24253) : pred__24252.call(null,2,expr__24253))))
...
var G__24255 = s__$1.substring((index + cljs.core.count(m)));
var G__24256 = (limit__$1 - 1);
var G__24257 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring(0,index));
s__$1 = G__24255;
limit__$1 = G__24256;
parts = G__24257;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24259 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4090__auto___24259))
{var replacement_24260 = temp__4090__auto___24259;buffer.append([cljs.core.str(replacement_24260)].join(''));
} else
{buffer.append(ch);
}
{
var G__24261 = (index + 1);
index = G__24261;
continue;
}
}
