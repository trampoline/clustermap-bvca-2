...
{{
var G__24048 = cljs.core.pop(v__$1);
v__$1 = G__24048;
continue;
}
} else
...
{var pred__24052 = cljs.core._EQ_;var expr__24053 = limit;if(cljs.core.truth_((pred__24052.cljs$core$IFn$_invoke$arity$2 ? pred__24052.cljs$core$IFn$_invoke$arity$2(1,expr__24053) : pred__24052.call(null,1,expr__24053))))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((pred__24052.cljs$core$IFn$_invoke$arity$2 ? pred__24052.cljs$core$IFn$_invoke$arity$2(2,expr__24053) : pred__24052.call(null,2,expr__24053))))
...
var G__24055 = s__$1.substring((index + cljs.core.count(m)));
var G__24056 = (limit__$1 - 1);
var G__24057 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring(0,index));
s__$1 = G__24055;
limit__$1 = G__24056;
parts = G__24057;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24059 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4090__auto___24059))
{var replacement_24060 = temp__4090__auto___24059;buffer.append([cljs.core.str(replacement_24060)].join(''));
} else
{buffer.append(ch);
}
{
var G__24061 = (index + 1);
index = G__24061;
continue;
}
}
