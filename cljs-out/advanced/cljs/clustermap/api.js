...
{var inst_14037 = (state_14039[2]);var state_14039__$1 = state_14039;return cljs.core.async.impl.ioc_helpers.return_chan(state_14039__$1,inst_14037);
} else
{if((state_val_14040 === 1))
{var inst_14035 = clustermap.api.GET("/api/bvca/portfolio-company-sites");var state_14039__$1 = state_14039;return cljs.core.async.impl.ioc_helpers.take_BANG_(state_14039__$1,2,inst_14035);
} else
{return null;
}
}
...
var result__5794__auto__ = switch__5791__auto__(state_14039);if(cljs.core.keyword_identical_QMARK_(result__5794__auto__,cljs.core.constant$keyword$17))
{{
continue;
}
} else
...
cljs.core.async.impl.ioc_helpers.process_exception(state_14039);
...
})();var state__5863__auto__ = (function (){var statearr_14047 = (f__5862__auto__.cljs$core$IFn$_invoke$arity$0 ? f__5862__auto__.cljs$core$IFn$_invoke$arity$0() : f__5862__auto__.call(null));(statearr_14047[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5861__auto__);
...
{var inst_14066 = (state_14069[2]);var inst_14067 = console.log(inst_14066);var state_14069__$1 = state_14069;return cljs.core.async.impl.ioc_helpers.return_chan(state_14069__$1,inst_14067);
} else
{if((state_val_14070 === 1))
{var inst_14064 = clustermap.api.portfolio_company_sites();var state_14069__$1 = state_14069;return cljs.core.async.impl.ioc_helpers.take_BANG_(state_14069__$1,2,inst_14064);
} else
{return null;
}
}
...
var ret_value__5793__auto__ = (function (){try{while(true){
var result__5794__auto__ = switch__5791__auto__(state_14069);if(cljs.core.keyword_identical_QMARK_(result__5794__auto__,cljs.core.constant$keyword$17))
{{
continue;
}
} else
...
cljs.core.async.impl.ioc_helpers.process_exception(state_14069);
return cljs.core.constant$keyword$17;
} else
{if(cljs.core.constant$keyword$6)
{throw e14075;
...
;})(switch__5791__auto__))
})();var state__5863__auto__ = (function (){var statearr_14077 = (f__5862__auto__.cljs$core$IFn$_invoke$arity$0 ? f__5862__auto__.cljs$core$IFn$_invoke$arity$0() : f__5862__auto__.call(null));(statearr_14077[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5861__auto__);
