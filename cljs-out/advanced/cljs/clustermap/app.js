...
goog.require('goog.events');
goog.require('secretary.core');
clustermap.app.state = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentHashMap.fromArrays([cljs.core.constant$keyword$268,cljs.core.constant$keyword$316,cljs.core.constant$keyword$346,cljs.core.constant$keyword$350,cljs.core.constant$keyword$265,cljs.core.constant$keyword$326,cljs.core.constant$keyword$349,cljs.core.constant$keyword$331,cljs.core.constant$keyword$269],[null,null,null,null,null,cljs.core.PersistentVector.EMPTY,null,cljs.core.PersistentArrayMap.EMPTY,null]));
/**
...
{var inst_21131 = (state_21134[2]);var inst_21132 = clustermap.app.set_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.constant$keyword$346,inst_21131], 0));var state_21134__$1 = state_21134;return cljs.core.async.impl.ioc_helpers.return_chan(state_21134__$1,inst_21132);
} else
{if((state_val_21135 === 1))
{var inst_21129 = clustermap.api.boundaryline_collection_index.cljs$core$IFn$_invoke$arity$variadic("uk_constituencies",cljs.core.array_seq([cljs.core.constant$keyword$215,true], 0));var state_21134__$1 = state_21134;return cljs.core.async.impl.ioc_helpers.take_BANG_(state_21134__$1,2,inst_21129);
} else
{return null;
}
}
...
var result__5509__auto__ = switch__5506__auto__(state_21134);if(cljs.core.keyword_identical_QMARK_(result__5509__auto__,cljs.core.constant$keyword$201))
{{
continue;
}
} else
...
* process a search
*/
clustermap.app.process_search_results = (function process_search_results(results){return clustermap.app.set_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.constant$keyword$331,cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(results)], 0));
});
clustermap.app.process_selection = (function process_selection(p__21145,type){var vec__21147 = p__21145;var selection = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21147,0,null);var selection_portfolio_company_stats = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21147,1,null);var selection_portfolio_company_site_stats = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21147,2,null);var selection_portfolio_company_sites = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21147,3,null);var selection_portfolio_company_site_account_timelines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21147,4,null);var selection_portfolio_company_locations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21147,5,null);return clustermap.app.set_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.constant$keyword$265,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$225,type,cljs.core.constant$keyword$195,selection], null),cljs.core.constant$keyword$269,selection_portfolio_company_stats,cljs.core.constant$keyword$268,selection_portfolio_company_site_stats,cljs.core.constant$keyword$326,selection_portfolio_company_sites,cljs.core.constant$keyword$316,selection_portfolio_company_site_account_timelines,cljs.core.constant$keyword$349,selection_portfolio_company_locations], 0));
});
clustermap.app.extract_id = (function extract_id(type,obj){var pred__21151 = cljs.core._EQ_;var expr__21152 = type;if(cljs.core.truth_((pred__21151.cljs$core$IFn$_invoke$arity$2 ? pred__21151.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$260,expr__21152) : pred__21151.call(null,cljs.core.constant$keyword$260,expr__21152))))
{return cljs.core.constant$keyword$351.cljs$core$IFn$_invoke$arity$1(obj);
} else
{if(cljs.core.truth_((pred__21151.cljs$core$IFn$_invoke$arity$2 ? pred__21151.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$261,expr__21152) : pred__21151.call(null,cljs.core.constant$keyword$261,expr__21152))))
{return cljs.core.constant$keyword$352.cljs$core$IFn$_invoke$arity$1(obj);
} else
{if(cljs.core.truth_((pred__21151.cljs$core$IFn$_invoke$arity$2 ? pred__21151.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$262,expr__21152) : pred__21151.call(null,cljs.core.constant$keyword$262,expr__21152))))
...
*/
clustermap.app.make_selection = (function make_selection(p__21154){var vec__21159 = p__21154;var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21159,0,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21159,1,null);var selector = (cljs.core.truth_(type)?new cljs.core.PersistentArrayMap.fromArray([type,id], true, false):cljs.core.PersistentArrayMap.EMPTY);clustermap.app.set_state.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.constant$keyword$350,selector], 0));
var pred__21160 = cljs.core._EQ_;var expr__21161 = type;if(cljs.core.truth_((pred__21160.cljs$core$IFn$_invoke$arity$2 ? pred__21160.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$260,expr__21161) : pred__21160.call(null,cljs.core.constant$keyword$260,expr__21161))))
...
{if(cljs.core.truth_((pred__21160.cljs$core$IFn$_invoke$arity$2 ? pred__21160.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$261,expr__21161) : pred__21160.call(null,cljs.core.constant$keyword$261,expr__21161))))
...
{if(cljs.core.truth_((pred__21160.cljs$core$IFn$_invoke$arity$2 ? pred__21160.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$262,expr__21161) : pred__21160.call(null,cljs.core.constant$keyword$262,expr__21161))))
...
clustermap.app.init_routes = (function init_routes(comm){cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(secretary.core._STAR_routes_STAR_,cljs.core.assoc,"/",(function (params__9258__auto__){var map__21175 = params__9258__auto__;var map__21175__$1 = ((cljs.core.seq_QMARK_(map__21175))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21175):map__21175);return cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$355,null], null));
}));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(secretary.core._STAR_routes_STAR_,cljs.core.assoc,"/:view",(function (params__9258__auto__){var map__21176 = params__9258__auto__;var map__21176__$1 = ((cljs.core.seq_QMARK_(map__21176))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21176):map__21176);var view = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21176__$1,cljs.core.constant$keyword$354);cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$356,view], null));
return cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$355,null], null));
}));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(secretary.core._STAR_routes_STAR_,cljs.core.assoc,"/:view/:type/:id",(function (params__9258__auto__){var map__21177 = params__9258__auto__;var map__21177__$1 = ((cljs.core.seq_QMARK_(map__21177))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21177):map__21177);var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21177__$1,cljs.core.constant$keyword$222);var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21177__$1,cljs.core.constant$keyword$225);var view = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21177__$1,cljs.core.constant$keyword$354);cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$356,view], null));
return cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$355,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type),id], null)], null));
}));
...
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__(state_21224);if(cljs.core.keyword_identical_QMARK_(result__5509__auto__,cljs.core.constant$keyword$201))
{{
continue;
}
} else
