...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some((function (p__22745){var vec__22746 = p__22745;var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22746,0,null);var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22746,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.cljs$core$IFn$_invoke$arity$variadic(boundaryline_id,tolerance,cljs.core.array_seq([cljs.core.constant$keyword$286,true], 0));var use_korks = ((cljs.core.sequential_QMARK_(korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1(1);cljs.core.async.impl.dispatch.run((function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_22766){var state_val_22767 = (state_22766[1]);if((state_val_22767 === 2))
{var inst_22762 = (state_22766[2]);var inst_22763 = (function (){var bl = inst_22762;return ((function (bl,inst_22762,state_val_22767){
return (function (old){return bl;
});
;})(bl,inst_22762,state_val_22767))
})();var inst_22764 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app_state,cljs.core.update_in,path,inst_22763);var state_22766__$1 = state_22766;return cljs.core.async.impl.ioc_helpers.return_chan(state_22766__$1,inst_22764);
} else
{if((state_val_22767 === 1))
{var state_22766__$1 = state_22766;return cljs.core.async.impl.ioc_helpers.take_BANG_(state_22766__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_22771 = [null,null,null,null,null,null,null];(statearr_22771[0] = state_machine__5507__auto__);
(statearr_22771[1] = 1);
return statearr_22771;
});
var state_machine__5507__auto____1 = (function (state_22766){while(true){
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__(state_22766);if(cljs.core.keyword_identical_QMARK_(result__5509__auto__,cljs.core.constant$keyword$272))
{{
continue;
}
} else
...
{var ex__5510__auto__ = e22772;var statearr_22773_22775 = state_22766;(statearr_22773_22775[5] = ex__5510__auto__);
...
{{
var G__22776 = state_22766;
state_22766 = G__22776;
continue;
}
} else
...
state_machine__5507__auto__ = function(state_22766){
switch(arguments.length){
case 0:
return state_machine__5507__auto____0.call(this);
case 1:
return state_machine__5507__auto____1.call(this,state_22766);
}
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__22777){var map__22779 = p__22777;var map__22779__$1 = ((cljs.core.seq_QMARK_(map__22779))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22779):map__22779);var min_zoom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22779__$1,cljs.core.constant$keyword$294);if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
...
var p__22777 = null;if (arguments.length > 4) {
  p__22777 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__22777);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__22780){
var app_state = cljs.core.first(arglist__22780);
arglist__22780 = cljs.core.next(arglist__22780);
var korks = cljs.core.first(arglist__22780);
arglist__22780 = cljs.core.next(arglist__22780);
var boundaryline_id = cljs.core.first(arglist__22780);
arglist__22780 = cljs.core.next(arglist__22780);
var zoom = cljs.core.first(arglist__22780);
var p__22777 = cljs.core.rest(arglist__22780);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__22777);
});
