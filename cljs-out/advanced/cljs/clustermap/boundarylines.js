...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3539__auto__ = cljs.core.some((function (p__34465){var vec__34466 = p__34465;var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34466,0,null);var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34466,1,null);if(cljs.core.truth_((function (){var and__3527__auto__ = z;if(cljs.core.truth_(and__3527__auto__))
{return (zoom <= z);
} else
...
return (function (state_34486){var state_val_34487 = (state_34486[1]);if((state_val_34487 === 2))
{var inst_34482 = (state_34486[2]);var inst_34483 = (function (){var bl = inst_34482;return ((function (bl,inst_34482,state_val_34487,c__5689__auto__,comm,use_korks,path){
return (function (old){return bl;
});
;})(bl,inst_34482,state_val_34487,c__5689__auto__,comm,use_korks,path))
})();var inst_34484 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app_state,cljs.core.update_in,path,inst_34483);var state_34486__$1 = state_34486;return cljs.core.async.impl.ioc_helpers.return_chan(state_34486__$1,inst_34484);
} else
{if((state_val_34487 === 1))
{var state_34486__$1 = state_34486;return cljs.core.async.impl.ioc_helpers.take_BANG_(state_34486__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5675__auto____0 = (function (){var statearr_34491 = [null,null,null,null,null,null,null];(statearr_34491[0] = state_machine__5675__auto__);
(statearr_34491[1] = 1);
return statearr_34491;
});
var state_machine__5675__auto____1 = (function (state_34486){while(true){
var ret_value__5676__auto__ = (function (){try{while(true){
var result__5677__auto__ = switch__5674__auto__(state_34486);if(cljs.core.keyword_identical_QMARK_(result__5677__auto__,cljs.core.constant$keyword$591))
{{
continue;
}
} else
...
{var ex__5678__auto__ = e34492;var statearr_34493_34495 = state_34486;(statearr_34493_34495[5] = ex__5678__auto__);
...
{{
var G__34496 = state_34486;
state_34486 = G__34496;
continue;
}
} else
...
state_machine__5675__auto__ = function(state_34486){
switch(arguments.length){
case 0:
return state_machine__5675__auto____0.call(this);
case 1:
return state_machine__5675__auto____1.call(this,state_34486);
}
...
})();var state__5691__auto__ = (function (){var statearr_34494 = (f__5690__auto__.cljs$core$IFn$_invoke$arity$0 ? f__5690__auto__.cljs$core$IFn$_invoke$arity$0() : f__5690__auto__.call(null));(statearr_34494[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5689__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__34497){var map__34499 = p__34497;var map__34499__$1 = ((cljs.core.seq_QMARK_(map__34499))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34499):map__34499);var min_zoom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34499__$1,cljs.core.constant$keyword$613);if(cljs.core.truth_((function (){var and__3527__auto__ = min_zoom;if(cljs.core.truth_(and__3527__auto__))
...
var p__34497 = null;if (arguments.length > 4) {
  p__34497 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__34497);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__34500){
var app_state = cljs.core.first(arglist__34500);
arglist__34500 = cljs.core.next(arglist__34500);
var korks = cljs.core.first(arglist__34500);
arglist__34500 = cljs.core.next(arglist__34500);
var boundaryline_id = cljs.core.first(arglist__34500);
arglist__34500 = cljs.core.next(arglist__34500);
var zoom = cljs.core.first(arglist__34500);
var p__34497 = cljs.core.rest(arglist__34500);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__34497);
});
