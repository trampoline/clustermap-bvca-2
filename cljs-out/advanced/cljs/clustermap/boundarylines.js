...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3441__auto__ = cljs.core.some((function (p__33896){var vec__33897 = p__33896;var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33897,0,null);var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33897,1,null);if(cljs.core.truth_((function (){var and__3429__auto__ = z;if(cljs.core.truth_(and__3429__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.cljs$core$IFn$_invoke$arity$variadic(boundaryline_id,tolerance,cljs.core.array_seq([cljs.core.constant$keyword$565,true], 0));var use_korks = ((cljs.core.sequential_QMARK_(korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5562__auto__ = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1(1);cljs.core.async.impl.dispatch.run((function (){var f__5563__auto__ = (function (){var switch__5547__auto__ = (function (state_33917){var state_val_33918 = (state_33917[1]);if((state_val_33918 === 2))
{var inst_33913 = (state_33917[2]);var inst_33914 = (function (){var bl = inst_33913;return ((function (bl,inst_33913,state_val_33918){
return (function (old){return bl;
});
;})(bl,inst_33913,state_val_33918))
})();var inst_33915 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app_state,cljs.core.update_in,path,inst_33914);var state_33917__$1 = state_33917;return cljs.core.async.impl.ioc_helpers.return_chan(state_33917__$1,inst_33915);
} else
{if((state_val_33918 === 1))
{var state_33917__$1 = state_33917;return cljs.core.async.impl.ioc_helpers.take_BANG_(state_33917__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5548__auto____0 = (function (){var statearr_33922 = [null,null,null,null,null,null,null];(statearr_33922[0] = state_machine__5548__auto__);
(statearr_33922[1] = 1);
return statearr_33922;
});
var state_machine__5548__auto____1 = (function (state_33917){while(true){
var ret_value__5549__auto__ = (function (){try{while(true){
var result__5550__auto__ = switch__5547__auto__(state_33917);if(cljs.core.keyword_identical_QMARK_(result__5550__auto__,cljs.core.constant$keyword$551))
{{
continue;
}
} else
...
{var ex__5551__auto__ = e33923;var statearr_33924_33926 = state_33917;(statearr_33924_33926[5] = ex__5551__auto__);
cljs.core.async.impl.ioc_helpers.process_exception(state_33917);
...
{{
var G__33927 = state_33917;
state_33917 = G__33927;
continue;
}
} else
...
state_machine__5548__auto__ = function(state_33917){
switch(arguments.length){
case 0:
return state_machine__5548__auto____0.call(this);
case 1:
return state_machine__5548__auto____1.call(this,state_33917);
}
...
})();var state__5564__auto__ = (function (){var statearr_33925 = (f__5563__auto__.cljs$core$IFn$_invoke$arity$0 ? f__5563__auto__.cljs$core$IFn$_invoke$arity$0() : f__5563__auto__.call(null));(statearr_33925[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5562__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__33928){var map__33930 = p__33928;var map__33930__$1 = ((cljs.core.seq_QMARK_(map__33930))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33930):map__33930);var min_zoom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33930__$1,cljs.core.constant$keyword$573);if(cljs.core.truth_((function (){var and__3429__auto__ = min_zoom;if(cljs.core.truth_(and__3429__auto__))
...
var p__33928 = null;if (arguments.length > 4) {
  p__33928 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__33928);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__33931){
var app_state = cljs.core.first(arglist__33931);
arglist__33931 = cljs.core.next(arglist__33931);
var korks = cljs.core.first(arglist__33931);
arglist__33931 = cljs.core.next(arglist__33931);
var boundaryline_id = cljs.core.first(arglist__33931);
arglist__33931 = cljs.core.next(arglist__33931);
var zoom = cljs.core.first(arglist__33931);
var p__33928 = cljs.core.rest(arglist__33931);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__33928);
});
