...
goog.require('clustermap.components.full_report.portfolio_company_sites');
goog.require('jayq.core');
clustermap.components.full_report.full_report_component = (function full_report_component(p__21506,owner){var map__21512 = p__21506;var map__21512__$1 = ((cljs.core.seq_QMARK_(map__21512))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21512):map__21512);var data = map__21512__$1;var all_portfolio_companies_summary = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21512__$1,cljs.core.constant$keyword$330);var selection = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21512__$1,cljs.core.constant$keyword$268);var comm = om.core.get_shared.cljs$core$IFn$_invoke$arity$2(owner,cljs.core.constant$keyword$266);if(typeof clustermap.components.full_report.t21513 !== 'undefined')
{} else
{
/**
* @constructor
...
var this$__$1 = this;var attrs21516 = om.core.build.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.overview.overview,self__.data,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$257,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$266,self__.comm], null)], null));if(cljs.core.map_QMARK_(attrs21516))
{return React.DOM.div(sablono.interpreter.attributes(attrs21516),sablono.interpreter.interpret(om.core.build.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.details.details,self__.data,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$257,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$266,self__.comm], null)], null))),sablono.interpreter.interpret((cljs.core.truth_(cljs.core.constant$keyword$331.cljs$core$IFn$_invoke$arity$1(self__.data))?om.core.build.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.portfolio_company_sites.portfolio_company_sites,cljs.core.constant$keyword$331.cljs$core$IFn$_invoke$arity$1(self__.data),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$257,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$266,self__.comm], null)], null)):null)));
} else
{return React.DOM.div(null,sablono.interpreter.interpret(attrs21516),sablono.interpreter.interpret(om.core.build.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.details.details,self__.data,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$257,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$266,self__.comm], null)], null))),sablono.interpreter.interpret((cljs.core.truth_(cljs.core.constant$keyword$331.cljs$core$IFn$_invoke$arity$1(self__.data))?om.core.build.cljs$core$IFn$_invoke$arity$3(clustermap.components.full_report.portfolio_company_sites.portfolio_company_sites,cljs.core.constant$keyword$331.cljs$core$IFn$_invoke$arity$1(self__.data),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$257,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$266,self__.comm], null)], null)):null)));
}
});
...
clustermap.components.full_report.mount = (function mount(app_state,elem_id,comm){return om.core.root.cljs$core$IFn$_invoke$arity$4(app_state,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$266,comm], null),clustermap.components.full_report.full_report_component,document.getElementById(elem_id));
});
