...
clustermap.components.full_report.company_list.portfolio_company = (function portfolio_company(company,owner,p__33790){var map__33803 = p__33790;var map__33803__$1 = ((cljs.core.seq_QMARK_(map__33803))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33803):map__33803);var opts = map__33803__$1;var path_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33803__$1,cljs.core.constant$keyword$636);var link_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33803__$1,cljs.core.constant$keyword$654);var company_path = (path_fn.cljs$core$IFn$_invoke$arity$2 ? path_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$633,company) : path_fn.call(null,cljs.core.constant$keyword$633,company));if(typeof clustermap.components.full_report.company_list.t33804 !== 'undefined')
{} else
{
/**
* @constructor
...
var this__9251__auto____$1 = this;return React.DOM.tr(null,(function (){var attrs33807 = (self__.link_fn.cljs$core$IFn$_invoke$arity$2 ? self__.link_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$633,self__.company) : self__.link_fn.call(null,cljs.core.constant$keyword$633,self__.company));if(cljs.core.map_QMARK_(attrs33807))
...
})(),(function (){var attrs33808 = clustermap.components.full_report.company_list.render_many_links(self__.link_fn,self__.company_path,cljs.core.constant$keyword$634,cljs.core.constant$keyword$689.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.map_QMARK_(attrs33808))
...
})(),(function (){var attrs33809 = clustermap.components.full_report.company_list.render_many_links(self__.link_fn,self__.company_path,cljs.core.constant$keyword$635,(function (){var G__33814 = self__.company;var G__33814__$1 = (((G__33814 == null))?null:cljs.core.constant$keyword$690.cljs$core$IFn$_invoke$arity$1(G__33814));var G__33814__$2 = (((G__33814__$1 == null))?null:cljs.core.filter(((function (G__33814,G__33814__$1){
...
})(),(function (){var attrs33810 = (clustermap.formats.money.fmoney.cljs$core$IFn$_invoke$arity$5 ? clustermap.formats.money.fmoney.cljs$core$IFn$_invoke$arity$5(cljs.core.constant$keyword$574.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$629,2,cljs.core.constant$keyword$545,"-") : clustermap.formats.money.fmoney.call(null,cljs.core.constant$keyword$574.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$629,2,cljs.core.constant$keyword$545,"-"));if(cljs.core.map_QMARK_(attrs33810))
{return React.DOM.td(sablono.interpreter.attributes(attrs33810),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$692.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
...
{return React.DOM.td(null,sablono.interpreter.interpret(attrs33810),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$692.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
{return or__3441__auto__;
} else
{return "no info";
}
...
})(),(function (){var attrs33811 = clustermap.components.full_report.company_list.pos_neg(cljs.core.constant$keyword$693.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.map_QMARK_(attrs33811))
...
})(),(function (){var attrs33813 = (clustermap.formats.number.fnum.cljs$core$IFn$_invoke$arity$5 ? clustermap.formats.number.fnum.cljs$core$IFn$_invoke$arity$5(cljs.core.constant$keyword$694.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$631,0,cljs.core.constant$keyword$545,"-") : clustermap.formats.number.fnum.call(null,cljs.core.constant$keyword$694.cljs$core$IFn$_invoke$arity$1(self__.company),cljs.core.constant$keyword$631,0,cljs.core.constant$keyword$545,"-"));if(cljs.core.map_QMARK_(attrs33813))
{return React.DOM.td(sablono.interpreter.attributes(attrs33813),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$692.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
{return or__3441__auto__;
} else
{return "no info";
}
...
{return React.DOM.td(null,sablono.interpreter.interpret(attrs33813),React.DOM.small(null,"\u00A0(",sablono.interpreter.interpret((function (){var or__3441__auto__ = clustermap.formats.time.get_year(cljs.core.constant$keyword$692.cljs$core$IFn$_invoke$arity$1(self__.company));if(cljs.core.truth_(or__3441__auto__))
{return or__3441__auto__;
} else
{return "no info";
}
...
clustermap.components.full_report.company_list.company_list = (function company_list(companies,owner,opts){var comm = om.core.get_shared.cljs$core$IFn$_invoke$arity$2(owner,cljs.core.constant$keyword$637);if(typeof clustermap.components.full_report.company_list.t33835 !== 'undefined')
{} else
{
/**
* @constructor
...
var this__9251__auto____$1 = this;var attrs33838 = clustermap.components.table.paginate(self__.comm,self__.companies,cljs.core.constant$keyword$695);if(cljs.core.map_QMARK_(attrs33838))
{return React.DOM.div(sablono.interpreter.attributes(sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$578,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["full-report-list"], null)], null),attrs33838], 0))),React.DOM.div({"className": "table-responsive"},React.DOM.table({"className": "table"},React.DOM.thead(null,React.DOM.tr(null,(function (){var attrs33839 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$695,"Investor-backed company",cljs.core.constant$keyword$598);if(cljs.core.map_QMARK_(attrs33839))
...
})(),React.DOM.th(null,"Investor"),React.DOM.th(null,"Constituency"),(function (){var attrs33844 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$695,"Revenue",cljs.core.constant$keyword$574);if(cljs.core.map_QMARK_(attrs33844))
...
})(),React.DOM.th({"colSpan": "2"},sablono.interpreter.interpret(clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$695,"Rev. change",cljs.core.constant$keyword$693))),(function (){var attrs33845 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$695,"Employees",cljs.core.constant$keyword$694);if(cljs.core.map_QMARK_(attrs33845))
...
})(),React.DOM.th(null,"Investor"),React.DOM.th(null,"Constituency"),(function (){var attrs33852 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$695,"Revenue",cljs.core.constant$keyword$574);if(cljs.core.map_QMARK_(attrs33852))
...
})(),React.DOM.th({"colSpan": "2"},sablono.interpreter.interpret(clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$695,"Rev. change",cljs.core.constant$keyword$693))),(function (){var attrs33853 = clustermap.components.table.order_col(self__.comm,self__.companies,cljs.core.constant$keyword$695,"Employees",cljs.core.constant$keyword$694);if(cljs.core.map_QMARK_(attrs33853))
