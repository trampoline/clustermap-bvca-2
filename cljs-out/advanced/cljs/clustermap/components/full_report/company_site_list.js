...
goog.require('clustermap.formats.time');
goog.require('clustermap.formats.number');
clustermap.components.full_report.company_site_list.investment = (function investment(investment__$1,owner,p__33855){var map__33864 = p__33855;var map__33864__$1 = ((cljs.core.seq_QMARK_(map__33864))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33864):map__33864);var opts = map__33864__$1;var path_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33864__$1,cljs.core.constant$keyword$636);var link_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33864__$1,cljs.core.constant$keyword$654);var company_path = (path_fn.cljs$core$IFn$_invoke$arity$2 ? path_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$633,investment__$1) : path_fn.call(null,cljs.core.constant$keyword$633,investment__$1));if(typeof clustermap.components.full_report.company_site_list.t33865 !== 'undefined')
{} else
{
/**
* @constructor
...
var this__9251__auto____$1 = this;return React.DOM.tr(null,(function (){var attrs33868 = cljs.core.constant$keyword$655.cljs$core$IFn$_invoke$arity$1(self__.investment);if(cljs.core.map_QMARK_(attrs33868))
...
})(),(function (){var attrs33869 = cljs.core.constant$keyword$656.cljs$core$IFn$_invoke$arity$1(self__.investment);if(cljs.core.map_QMARK_(attrs33869))
...
})(),(function (){var attrs33870 = (self__.link_fn.cljs$core$IFn$_invoke$arity$2 ? self__.link_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$634,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$657,cljs.core.constant$keyword$657.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$598,cljs.core.constant$keyword$658.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)) : self__.link_fn.call(null,cljs.core.constant$keyword$634,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$657,cljs.core.constant$keyword$657.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$598,cljs.core.constant$keyword$658.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)));if(cljs.core.map_QMARK_(attrs33870))
...
})(),(function (){var attrs33871 = (self__.link_fn.cljs$core$IFn$_invoke$arity$2 ? self__.link_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$635,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$659,cljs.core.constant$keyword$659.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$660,cljs.core.constant$keyword$661.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)) : self__.link_fn.call(null,cljs.core.constant$keyword$635,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$659,cljs.core.constant$keyword$659.cljs$core$IFn$_invoke$arity$1(self__.investment),cljs.core.constant$keyword$660,cljs.core.constant$keyword$661.cljs$core$IFn$_invoke$arity$1(self__.investment)], null)));if(cljs.core.map_QMARK_(attrs33871))
...
clustermap.components.full_report.company_site_list.company_site_list = (function company_site_list(investments,owner,opts){var comm = om.core.get_shared.cljs$core$IFn$_invoke$arity$2(owner,cljs.core.constant$keyword$637);if(typeof clustermap.components.full_report.company_site_list.t33886 !== 'undefined')
{} else
{
/**
* @constructor
...
var this__9251__auto____$1 = this;var attrs33889 = clustermap.components.table.paginate(self__.comm,self__.investments,cljs.core.constant$keyword$662);if(cljs.core.map_QMARK_(attrs33889))
{return React.DOM.div(sablono.interpreter.attributes(sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$578,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["full-report-list"], null)], null),attrs33889], 0))),React.DOM.div({"className": "table-responsive"},React.DOM.table({"className": "table"},React.DOM.thead(null,React.DOM.tr(null,(function (){var attrs33890 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Investor-backed Company",cljs.core.constant$keyword$663);if(cljs.core.map_QMARK_(attrs33890))
...
})(),(function (){var attrs33891 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Postcode",cljs.core.constant$keyword$664);if(cljs.core.map_QMARK_(attrs33891))
...
})(),(function (){var attrs33892 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Investor",cljs.core.constant$keyword$576);if(cljs.core.map_QMARK_(attrs33892))
...
})(),(function (){var attrs33893 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Constituency",cljs.core.constant$keyword$575);if(cljs.core.map_QMARK_(attrs33893))
...
{return React.DOM.div({"className": "full-report-list"},sablono.interpreter.interpret(attrs33889),React.DOM.div({"className": "table-responsive"},React.DOM.table({"className": "table"},React.DOM.thead(null,React.DOM.tr(null,(function (){var attrs33895 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Investor-backed Company",cljs.core.constant$keyword$663);if(cljs.core.map_QMARK_(attrs33895))
...
})(),(function (){var attrs33896 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Postcode",cljs.core.constant$keyword$664);if(cljs.core.map_QMARK_(attrs33896))
...
})(),(function (){var attrs33897 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Investor",cljs.core.constant$keyword$576);if(cljs.core.map_QMARK_(attrs33897))
...
})(),(function (){var attrs33898 = clustermap.components.table.order_col(self__.comm,self__.investments,cljs.core.constant$keyword$662,"Constituency",cljs.core.constant$keyword$575);if(cljs.core.map_QMARK_(attrs33898))
