...
return new cljs.core.PersistentArrayMap(null, 4, [cljs.core.constant$keyword$410,m,cljs.core.constant$keyword$411,cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY),cljs.core.constant$keyword$412,cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY),cljs.core.constant$keyword$413,cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentHashSet.EMPTY)], null);
});
/**
...
;
clustermap.components.map.display_site = (function display_site(m,site){var location = cljs.core.clj__GT_js(cljs.core.reverse((site["location"])));var options = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$365,[cljs.core.str((site["name"])),cljs.core.str(", "),cljs.core.str((site["postcode"])),cljs.core.str(", "),cljs.core.str((site["company_no"]))].join('')], null));var marker = L.marker(location,options);return marker.addTo(m);
});
clustermap.components.map.display_sites = (function display_sites(m,sites){return (function (c){return (casync.dorun_async.cljs$core$IFn$_invoke$arity$3 ? casync.dorun_async.cljs$core$IFn$_invoke$arity$3(c,cljs.core.constant$keyword$414,null) : casync.dorun_async.call(null,c,cljs.core.constant$keyword$414,null));
...
clustermap.components.map.marker_popup_content = (function marker_popup_content(path_fn,location_sites){return [cljs.core.str((function (){var attrs22573 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (site){return [cljs.core.str("<div"),cljs.core.str(" class=\"map-marker-popup-location-list\""),cljs.core.str(">"),cljs.core.str("<li"),cljs.core.str(""),cljs.core.str(">"),cljs.core.str("<a"),cljs.core.str(hiccups.runtime.render_attr_map(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$273,(path_fn.cljs$core$IFn$_invoke$arity$2 ? path_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$305,site) : path_fn.call(null,cljs.core.constant$keyword$305,site)),cljs.core.constant$keyword$268,null,cljs.core.constant$keyword$262,null], null))),cljs.core.str(">"),cljs.core.str(hiccups.runtime.render_html(cljs.core.constant$keyword$282.cljs$core$IFn$_invoke$arity$1(site))),cljs.core.str("</a>"),cljs.core.str("</li>"),cljs.core.str("</div>")].join('');
}),location_sites);if(cljs.core.map_QMARK_(attrs22573))
{return [cljs.core.str("<ul"),cljs.core.str(hiccups.runtime.render_attr_map(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$268,null,cljs.core.constant$keyword$262,null], null),attrs22573], 0)))),cljs.core.str(">"),cljs.core.str("</ul>")].join('');
} else
{return [cljs.core.str("<ul>"),cljs.core.str(hiccups.runtime.render_html(attrs22573)),cljs.core.str("</ul>")].join('');
}
})())].join('');
});
clustermap.components.map.create_marker = (function create_marker(path_fn,leaflet_map,location_sites){var temp__4090__auto__ = (function (){var G__22576 = location_sites;var G__22576__$1 = (((G__22576 == null))?null:cljs.core.first(G__22576));var G__22576__$2 = (((G__22576__$1 == null))?null:cljs.core.constant$keyword$415.cljs$core$IFn$_invoke$arity$1(G__22576__$1));var G__22576__$3 = (((G__22576__$2 == null))?null:cljs.core.reverse(G__22576__$2));var G__22576__$4 = (((G__22576__$3 == null))?null:cljs.core.clj__GT_js(G__22576__$3));return G__22576__$4;
...
*/
clustermap.components.map.tolerance_boundaryline = (function tolerance_boundaryline(fetch_boundaryline_fn,index,boundaryline_id,zoom){var default_bl = (cljs.core.truth_(index)?(index[boundaryline_id]):null);var default_tolerance = (cljs.core.truth_(default_bl)?(default_bl["tolerance"]):null);var default$ = (cljs.core.truth_(default_bl)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [default_tolerance,default_bl], null):null);var or__3406__auto__ = (fetch_boundaryline_fn.cljs$core$IFn$_invoke$arity$4 ? fetch_boundaryline_fn.cljs$core$IFn$_invoke$arity$4(boundaryline_id,zoom,cljs.core.constant$keyword$261,7) : fetch_boundaryline_fn.call(null,boundaryline_id,zoom,cljs.core.constant$keyword$261,7));if(cljs.core.truth_(or__3406__auto__))
{return or__3406__auto__;
} else
{return default$;
}
});
clustermap.components.map.style_leaflet_path = (function style_leaflet_path(leaflet_path,p__22615){var map__22617 = p__22615;var map__22617__$1 = ((cljs.core.seq_QMARK_(map__22617))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22617):map__22617);var highlighted = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22617__$1,cljs.core.constant$keyword$416);var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22617__$1,cljs.core.constant$keyword$287);if(cljs.core.truth_((function (){var and__3394__auto__ = selected;if(cljs.core.truth_(and__3394__auto__))
{return highlighted;
} else
{return and__3394__auto__;
}
})()))
{return leaflet_path.setStyle(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$417,"#0000ff",cljs.core.constant$keyword$418,3,cljs.core.constant$keyword$419,1,cljs.core.constant$keyword$420,true,cljs.core.constant$keyword$421,0.3], null)));
} else
{if(cljs.core.truth_(selected))
{return leaflet_path.setStyle(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$417,"#0000ff",cljs.core.constant$keyword$418,3,cljs.core.constant$keyword$419,1,cljs.core.constant$keyword$420,true,cljs.core.constant$keyword$421,0.3], null)));
} else
{if(cljs.core.truth_(highlighted))
{return leaflet_path.setStyle(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.constant$keyword$417,"#000000",cljs.core.constant$keyword$418,3,cljs.core.constant$keyword$419,1,cljs.core.constant$keyword$420,false], null)));
} else
{if(true)
{return leaflet_path.setStyle(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$417,"#ff0000",cljs.core.constant$keyword$418,3,cljs.core.constant$keyword$419,0,cljs.core.constant$keyword$420,false,cljs.core.constant$keyword$421,0], null)));
} else
{return null;
}
}
...
clustermap.components.map.create_path = (function create_path(comm,leaflet_map,boundaryline_id,js_boundaryline,p__22618){var map__22620 = p__22618;var map__22620__$1 = ((cljs.core.seq_QMARK_(map__22620))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22620):map__22620);var path_attrs = map__22620__$1;var selected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22620__$1,cljs.core.constant$keyword$287);var tolerance = (js_boundaryline["tolerance"]);var bounds = clustermap.components.map.postgis_envelope__GT_latlngbounds((js_boundaryline["envelope"]));var leaflet_path = L.geoJson((js_boundaryline["geojson"]));clustermap.components.map.style_leaflet_path(leaflet_path,path_attrs);
leaflet_path.addTo(leaflet_map);
leaflet_path.on("click",(function (e){return cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$288,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$307,boundaryline_id], null)], null));
}));
return new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$268,boundaryline_id,cljs.core.constant$keyword$422,tolerance,cljs.core.constant$keyword$287,selected,cljs.core.constant$keyword$423,leaflet_path,cljs.core.constant$keyword$424,bounds], null);
});
/**
...
clustermap.components.map.replace_path = (function replace_path(comm,leaflet_map,boundaryline_id,old_path,js_boundaryline,path_attrs){leaflet_map.removeLayer(cljs.core.constant$keyword$423.cljs$core$IFn$_invoke$arity$1(old_path));
return clustermap.components.map.create_path(comm,leaflet_map,cljs.core.constant$keyword$268.cljs$core$IFn$_invoke$arity$1(old_path),js_boundaryline,path_attrs);
});
/**
* update a Leaflet path for a boundaryline
*/
clustermap.components.map.update_path = (function update_path(comm,fetch_boundaryline_fn,js_boundaryline_index,leaflet_map,p__22623,path_attrs){var map__22626 = p__22623;var map__22626__$1 = ((cljs.core.seq_QMARK_(map__22626))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22626):map__22626);var path = map__22626__$1;var boundaryline_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22626__$1,cljs.core.constant$keyword$268);var temp__4090__auto__ = clustermap.components.map.tolerance_boundaryline(fetch_boundaryline_fn,js_boundaryline_index,boundaryline_id,leaflet_map.getZoom());if(cljs.core.truth_(temp__4090__auto__))
{var vec__22627 = temp__4090__auto__;var tolerance = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22627,0,null);var js_boundaryline = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22627,1,null);if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(tolerance,cljs.core.constant$keyword$422.cljs$core$IFn$_invoke$arity$1(path)))
{return clustermap.components.map.replace_path(comm,leaflet_map,boundaryline_id,path,js_boundaryline,path_attrs);
} else
{clustermap.components.map.style_leaflet_path(cljs.core.constant$keyword$423.cljs$core$IFn$_invoke$arity$1(path),path_attrs);
return path;
}
} else
{return path;
...
clustermap.components.map.delete_path = (function delete_path(leaflet_map,path){return leaflet_map.removeLayer(cljs.core.constant$keyword$423.cljs$core$IFn$_invoke$arity$1(path));
});
...
{var paths = cljs.core.deref(paths_atom);var path_keys = cljs.core.set(cljs.core.keys(paths));var old_selection_path_keys = cljs.core.deref(path_selections_atom);var new_selection_path_keys = cljs.core.set(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$425,cljs.core.constant$keyword$426),cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,cljs.core.vals(new_selection_locations)))));var live_path_keys = clojure.set.union.cljs$core$IFn$_invoke$arity$2(new_selection_path_keys,new_path_highlights);var create_path_keys = clojure.set.difference.cljs$core$IFn$_invoke$arity$2(live_path_keys,path_keys);var delete_path_keys = clojure.set.difference.cljs$core$IFn$_invoke$arity$2(path_keys,live_path_keys);var update_path_keys = clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(path_keys,live_path_keys);var created_paths = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (paths,path_keys,old_selection_path_keys,new_selection_path_keys,live_path_keys,create_path_keys,delete_path_keys,update_path_keys){
return (function (k){return clustermap.components.map.fetch_create_path(comm,fetch_boundaryline_fn,js_boundaryline_index,leaflet_map,k,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$287,cljs.core.contains_QMARK_(new_selection_path_keys,k),cljs.core.constant$keyword$416,cljs.core.contains_QMARK_(new_path_highlights,k)], null));
...
return (function (k){return clustermap.components.map.update_path(comm,fetch_boundaryline_fn,js_boundaryline_index,leaflet_map,cljs.core.get.cljs$core$IFn$_invoke$arity$2(paths,k),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$287,cljs.core.contains_QMARK_(new_selection_path_keys,k),cljs.core.constant$keyword$416,cljs.core.contains_QMARK_(new_path_highlights,k)], null));
...
return (function (m,p__22638){var map__22639 = p__22638;var map__22639__$1 = ((cljs.core.seq_QMARK_(map__22639))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22639):map__22639);var path = map__22639__$1;var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22639__$1,cljs.core.constant$keyword$268);return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,id,path);
...
{return om.core.set_state_BANG_(owner,cljs.core.constant$keyword$427,true);
} else
{om.core.set_state_BANG_(owner,cljs.core.constant$keyword$427,false);
var temp__4092__auto__ = (function (){var G__22657 = cljs.core.select_keys(paths,path_selections);var G__22657__$1 = (((G__22657 == null))?null:cljs.core.vals(G__22657));var G__22657__$2 = (((G__22657__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$424,G__22657__$1));return G__22657__$2;
...
*/
clustermap.components.map.map_component = (function map_component(p__22658,owner){var map__22678 = p__22658;var map__22678__$1 = ((cljs.core.seq_QMARK_(map__22678))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22678):map__22678);var app_state = map__22678__$1;var selection = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22678__$1,cljs.core.constant$keyword$311);if(typeof clustermap.components.map.t22679 !== 'undefined')
{} else
{
/**
* @constructor
...
var map__22684 = p__22682;var map__22684__$1 = ((cljs.core.seq_QMARK_(map__22684))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22684):map__22684);var next_selection = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22684__$1,cljs.core.constant$keyword$311);var next_locations = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22684__$1,cljs.core.constant$keyword$428);var next_uk_constituencies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22684__$1,cljs.core.constant$keyword$429);var next_uk_constituencies_rtree = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22684__$1,cljs.core.constant$keyword$430);var next_boundarylines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22684__$1,cljs.core.constant$keyword$316);var next_zoom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22684__$1,cljs.core.constant$keyword$431);var map__22685 = p__22683;var map__22685__$1 = ((cljs.core.seq_QMARK_(map__22685))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22685):map__22685);var next_path_highlights = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22685__$1,cljs.core.constant$keyword$432);var this$__$1 = this;var map__22686 = om.core.get_props(self__.owner);var map__22686__$1 = ((cljs.core.seq_QMARK_(map__22686))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22686):map__22686);var uk_constituencies_rtree = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22686__$1,cljs.core.constant$keyword$430);var map__22687 = om.core.get_shared.cljs$core$IFn$_invoke$arity$1(self__.owner);var map__22687__$1 = ((cljs.core.seq_QMARK_(map__22687))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22687):map__22687);var path_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22687__$1,cljs.core.constant$keyword$312);var link_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22687__$1,cljs.core.constant$keyword$313);var fetch_boundaryline_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22687__$1,cljs.core.constant$keyword$433);var comm = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22687__$1,cljs.core.constant$keyword$308);var map__22688 = om.core.get_state.cljs$core$IFn$_invoke$arity$1(self__.owner);var map__22688__$1 = ((cljs.core.seq_QMARK_(map__22688))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22688):map__22688);var map__22689 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22688__$1,cljs.core.constant$keyword$434);var map__22689__$1 = ((cljs.core.seq_QMARK_(map__22689))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22689):map__22689);var path_selections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22689__$1,cljs.core.constant$keyword$413);var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22689__$1,cljs.core.constant$keyword$412);var markers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22689__$1,cljs.core.constant$keyword$411);var leaflet_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22689__$1,cljs.core.constant$keyword$410);var pan_pending = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22688__$1,cljs.core.constant$keyword$427);var path_highlights = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22688__$1,cljs.core.constant$keyword$432);clustermap.components.map.update_markers(path_fn,leaflet_map,markers,next_locations);
...
,hits);var highlight_hit = cljs.core.first(hits);var highlight_path_ids = cljs.core.set(cljs.core.take(1,hit_path_ids));var old_path_highlights = om.core.get_state.cljs$core$IFn$_invoke$arity$2(self__.owner,cljs.core.constant$keyword$432);if(cljs.core.truth_((function (){var and__3394__auto__ = highlight_hit;if(cljs.core.truth_(and__3394__auto__))
...
{}
return om.core.set_state_BANG_(self__.owner,cljs.core.constant$keyword$432,highlight_path_ids);
}));
...
,hits);return cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(comm,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$288,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$307,cljs.core.first(hit_path_ids)], null)], null));
}));
} else
{}
...
var this$__$1 = this;var map__22692 = clustermap.components.map.create_map(node);var map__22692__$1 = ((cljs.core.seq_QMARK_(map__22692))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22692):map__22692);var map = map__22692__$1;var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22692__$1,cljs.core.constant$keyword$435);var markers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22692__$1,cljs.core.constant$keyword$411);var leaflet_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22692__$1,cljs.core.constant$keyword$410);om.core.set_state_BANG_(self__.owner,cljs.core.constant$keyword$434,map);
om.core.set_state_BANG_(self__.owner,cljs.core.constant$keyword$432,cljs.core.PersistentHashSet.EMPTY);
leaflet_map.on("zoomend",(function (e){return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(om.core.get_shared.cljs$core$IFn$_invoke$arity$2(self__.owner,cljs.core.constant$keyword$436),cljs.core.assoc,cljs.core.constant$keyword$431,leaflet_map.getZoom());
}));
jayq.core.$.cljs$core$IFn$_invoke$arity$1(document).on("clustermap-change-view",(function (e){console.log("change-view");
var map__22693 = om.core.get_state.cljs$core$IFn$_invoke$arity$1(self__.owner);var map__22693__$1 = ((cljs.core.seq_QMARK_(map__22693))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22693):map__22693);var map__22694 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22693__$1,cljs.core.constant$keyword$434);var map__22694__$1 = ((cljs.core.seq_QMARK_(map__22694))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22694):map__22694);var path_selections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22694__$1,cljs.core.constant$keyword$413);var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22694__$1,cljs.core.constant$keyword$412);leaflet_map.invalidateSize();
return clustermap.components.map.pan_to_selection(self__.owner,leaflet_map,paths,path_selections);
}));
return om.core.update_BANG_.cljs$core$IFn$_invoke$arity$4(self__.app_state,cljs.core.assoc,cljs.core.constant$keyword$431,leaflet_map.getZoom());
});
...
clustermap.components.map.mount = (function mount(app_state,elem_id,shared){return om.core.root.cljs$core$IFn$_invoke$arity$4(app_state,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([shared,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$436,app_state,cljs.core.constant$keyword$433,cljs.core.partial.cljs$core$IFn$_invoke$arity$3(clustermap.boundarylines.get_or_fetch_best_boundaryline,app_state,cljs.core.constant$keyword$316)], null)], 0)),clustermap.components.map.map_component,document.getElementById(elem_id));
});
