...
goog.require('clustermap.formats.number');
goog.require('jayq.core');
clustermap.components.timeline_chart.create_chart = (function create_chart(data,node,p__34560){var map__34562 = p__34560;var map__34562__$1 = ((cljs.core.seq_QMARK_(map__34562))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34562):map__34562);var opts = map__34562__$1;var y1_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34562__$1,cljs.core.constant$keyword$707);var y0_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34562__$1,cljs.core.constant$keyword$708);var x_labels = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$709,data);var stats = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$710,data);var y_median = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(((function (x_labels,stats){
...
return (function (p1__34555_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__34555_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$710,cljs.core.constant$keyword$711], null));
});})(x_labels,stats))
...
return (function (p1__34557_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__34557_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$710,cljs.core.constant$keyword$686], null));
});})(x_labels,stats,y_median))
...
return (function (p1__34559_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__34559_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$710,cljs.core.constant$keyword$681], null));
});})(x_labels,stats,y_median,y_mean))
),data);return jayq.core.$.cljs$core$IFn$_invoke$arity$1(node).highcharts(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$712,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$717,null,cljs.core.constant$keyword$718,300], null),cljs.core.constant$keyword$713,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$719,null], null),cljs.core.constant$keyword$714,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$720,x_labels,cljs.core.constant$keyword$721,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$722,270], null)], null),cljs.core.constant$keyword$715,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$713,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$719,y0_title], null),cljs.core.constant$keyword$723,0,cljs.core.constant$keyword$721,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$724,(function (){var this$ = this;return clustermap.formats.money.readable.cljs$core$IFn$_invoke$arity$variadic(this$.value,cljs.core.array_seq([cljs.core.constant$keyword$630,""], 0));
})], null)], null)], null),cljs.core.constant$keyword$716,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [cljs.core.constant$keyword$596,[cljs.core.str("Total "),cljs.core.str(y0_title)].join(''),cljs.core.constant$keyword$586,"line",cljs.core.constant$keyword$715,0,cljs.core.constant$keyword$702,y_total], null)], null)], null)));
});
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,p__34563){var map__34568 = p__34563;var map__34568__$1 = ((cljs.core.seq_QMARK_(map__34568))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34568):map__34568);var opts = map__34568__$1;var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34568__$1,cljs.core.constant$keyword$582);if(typeof clustermap.components.timeline_chart.t34569 !== 'undefined')
{} else
{
/**
* @constructor
