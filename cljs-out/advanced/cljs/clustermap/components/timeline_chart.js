...
goog.require('clustermap.formats.money');
goog.require('hiccups.runtime');
clustermap.components.timeline_chart.create_chart = (function create_chart(data,node,p__38387){var map__38389 = p__38387;var map__38389__$1 = ((cljs.core.seq_QMARK_(map__38389))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38389):map__38389);var opts = map__38389__$1;var y1_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38389__$1,cljs.core.constant$keyword$934);var y0_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38389__$1,cljs.core.constant$keyword$935);var x_labels = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$936,data);var stats = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$937,data);var y_median = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(((function (x_labels,stats,map__38389,map__38389__$1,opts,y1_title,y0_title){
...
return (function (p1__38382_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__38382_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$937,cljs.core.constant$keyword$938], null));
});})(x_labels,stats,map__38389,map__38389__$1,opts,y1_title,y0_title))
...
return (function (p1__38384_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__38384_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$937,cljs.core.constant$keyword$939], null));
});})(x_labels,stats,y_median,map__38389,map__38389__$1,opts,y1_title,y0_title))
...
return (function (p1__38386_SHARP_){return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__38386_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$937,cljs.core.constant$keyword$940], null));
});})(x_labels,stats,y_median,y_mean,map__38389,map__38389__$1,opts,y1_title,y0_title))
),data);return jayq.core.$.cljs$core$IFn$_invoke$arity$1(node).highcharts(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$941,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$946,null,cljs.core.constant$keyword$947,(300)], null),cljs.core.constant$keyword$942,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$948,null], null),cljs.core.constant$keyword$943,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$949,x_labels,cljs.core.constant$keyword$950,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$951,(270)], null)], null),cljs.core.constant$keyword$944,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$942,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$948,y0_title], null),cljs.core.constant$keyword$952,(0),cljs.core.constant$keyword$950,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$953,((function (x_labels,stats,y_median,y_mean,y_total,map__38389,map__38389__$1,opts,y1_title,y0_title){
return (function (){var this$ = this;return clustermap.formats.money.readable.cljs$core$IFn$_invoke$arity$variadic(this$.value,cljs.core.array_seq([cljs.core.constant$keyword$898,""], 0));
});})(x_labels,stats,y_median,y_mean,y_total,map__38389,map__38389__$1,opts,y1_title,y0_title))
], null)], null)], null),cljs.core.constant$keyword$945,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [cljs.core.constant$keyword$846,("Total "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(y0_title)),cljs.core.constant$keyword$816,"line",cljs.core.constant$keyword$944,(0),cljs.core.constant$keyword$929,y_total], null)], null)], null)));
});
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,p__38390){var map__38395 = p__38390;var map__38395__$1 = ((cljs.core.seq_QMARK_(map__38395))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38395):map__38395);var opts = map__38395__$1;var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38395__$1,cljs.core.constant$keyword$818);if(typeof clustermap.components.timeline_chart.t38396 !== 'undefined')
{} else
{
/**
* @constructor
