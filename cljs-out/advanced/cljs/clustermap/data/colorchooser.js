...
clustermap.data.colorchooser.log_scale = (function log_scale(min,max,steps){var translation = ((1) - min);var log_min = (function (){var G__68196 = min;return (Math.log.cljs$core$IFn$_invoke$arity$1 ? Math.log.cljs$core$IFn$_invoke$arity$1(G__68196) : Math.log.call(null,G__68196));
})();var log_max = (function (){var G__68197 = (max + translation);return (Math.log.cljs$core$IFn$_invoke$arity$1 ? Math.log.cljs$core$IFn$_invoke$arity$1(G__68197) : Math.log.call(null,G__68197));
...
return (function (n){return ((function (){var G__68198 = Math.E;var G__68199 = n;return (Math.pow.cljs$core$IFn$_invoke$arity$2 ? Math.pow.cljs$core$IFn$_invoke$arity$2(G__68198,G__68199) : Math.pow.call(null,G__68198,G__68199));
})() - translation);
...
return (function (p__68202){var vec__68203 = p__68202;var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68203,(0),null);var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68203,(1),null);return (value <= t);
});})(scheme_thresholds))
...
return (function (r){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get.cljs$core$IFn$_invoke$arity$2(r,key),(function (){var G__68205 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(r,variable);return (chooser.cljs$core$IFn$_invoke$arity$1 ? chooser.cljs$core$IFn$_invoke$arity$1(G__68205) : chooser.call(null,G__68205));
})()], null);
