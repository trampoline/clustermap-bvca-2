...
var readable__delegate = function (n,p__45178){var map__45181 = p__45178;var map__45181__$1 = ((cljs.core.seq_QMARK_(map__45181))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45181):map__45181);var default$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45181__$1,cljs.core.constant$keyword$1091);var plus_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45181__$1,cljs.core.constant$keyword$1286);var curr = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45181__$1,cljs.core.constant$keyword$1288,"\u00A3");var sf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45181__$1,cljs.core.constant$keyword$1285);if(cljs.core.truth_(n))
{var vec__45182 = clustermap.formats.number.eng_notation.cljs$core$IFn$_invoke$arity$variadic(n,cljs.core.array_seq([cljs.core.constant$keyword$1285,sf], 0));var sig = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45182,(0),null);var exp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45182,(1),null);var abs_sig = Math.abs(sig);var suffix = clustermap.formats.money.money_suffix(exp);return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3546__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3546__auto__))
{return (sig > (0));
} else
...
var p__45178 = null;if (arguments.length > 1) {
  p__45178 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return readable__delegate.call(this,n,p__45178);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__45183){
var n = cljs.core.first(arglist__45183);
var p__45178 = cljs.core.rest(arglist__45183);
return readable__delegate(n,p__45178);
});
