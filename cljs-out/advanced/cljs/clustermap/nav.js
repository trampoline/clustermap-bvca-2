...
goog.require('domina.xpath');
goog.require('jayq.core');
clustermap.nav.toggle_nav_search = (function toggle_nav_search(){return domina.events.listen_BANG_.cljs$core$IFn$_invoke$arity$3(domina.css.sel.cljs$core$IFn$_invoke$arity$1("#nav .search > a"),cljs.core.constant$keyword$108,(function (e){var target = domina.events.target(e);var parent = domina.xpath.xpath.cljs$core$IFn$_invoke$arity$2(target,"..");domina.events.prevent_default(e);
...
clustermap.nav.clear_search = (function clear_search(){return domina.events.listen_BANG_.cljs$core$IFn$_invoke$arity$3(domina.css.sel.cljs$core$IFn$_invoke$arity$1("#search button"),cljs.core.constant$keyword$108,(function (e){var search_input = domina.css.sel.cljs$core$IFn$_invoke$arity$1("#search input");return domina.set_value_BANG_(search_input,"");
}));
});
clustermap.nav.body_view_classes = new cljs.core.PersistentArrayMap(null, 2, ["map","view-map","lists","view-lists"], null);
clustermap.nav.switch_view = (function switch_view(){return domina.events.listen_BANG_.cljs$core$IFn$_invoke$arity$3(domina.css.sel.cljs$core$IFn$_invoke$arity$1("#nav .map > a, #nav .lists > a"),cljs.core.constant$keyword$108,(function (e){var target = domina.events.target(e);var li = domina.xpath.xpath.cljs$core$IFn$_invoke$arity$2(target,"..");var ul = domina.xpath.xpath.cljs$core$IFn$_invoke$arity$2(li,"..");var active_li = domina.css.sel.cljs$core$IFn$_invoke$arity$2(ul,"> .active");var body = domina.css.sel.cljs$core$IFn$_invoke$arity$1("body");domina.events.prevent_default(e);
domina.remove_class_BANG_(active_li,"active");
domina.add_class_BANG_(li,"active");
return cljs.core.dorun.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__16879){var vec__16880 = p__16879;var li_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16880,0,null);var body_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16880,1,null);if(cljs.core.truth_(domina.has_class_QMARK_(li,li_class)))
