...
domina.css.t39744.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write(writer__4009__auto__,"domina.css/t39744");
});
...
var ___$1 = this;return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__39739_SHARP_){return domina.normalize_seq(goog.dom.query(self__.expr,p1__39739_SHARP_));
}),domina.nodes(self__.base));
});
domina.css.t39744.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return cljs.core.first(cljs.core.filter(cljs.core.complement(cljs.core.nil_QMARK_),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__39740_SHARP_){return domina.normalize_seq(goog.dom.query(self__.expr,p1__39740_SHARP_));
}),domina.nodes(self__.base))));
});
