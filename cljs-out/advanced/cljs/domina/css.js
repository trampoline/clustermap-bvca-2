...
domina.css.t33041.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write(writer__3836__auto__,"domina.css/t33041");
});
...
var ___$1 = this;return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__33036_SHARP_){return domina.normalize_seq(goog.dom.query(self__.expr,p1__33036_SHARP_));
}),domina.nodes(self__.base));
});
domina.css.t33041.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return cljs.core.first(cljs.core.filter(cljs.core.complement(cljs.core.nil_QMARK_),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__33037_SHARP_){return domina.normalize_seq(goog.dom.query(self__.expr,p1__33037_SHARP_));
}),domina.nodes(self__.base))));
});
