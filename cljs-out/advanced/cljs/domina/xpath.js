...
{{
var G__27649 = (i + 1);
var G__27650 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__27649;
acc = G__27650;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t27654 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t27654 = (function (expr,base,xpath,meta27655){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t27654.cljs$lang$type = true;
domina.xpath.t27654.cljs$lang$ctorStr = "domina.xpath/t27654";
domina.xpath.t27654.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t27654");
});
domina.xpath.t27654.prototype.domina$DomContent$ = true;
domina.xpath.t27654.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27654.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27654.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27656){var self__ = this;
var _27656__$1 = this;return self__.meta27655;
});
domina.xpath.t27654.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27656,meta27655__$1){var self__ = this;
var _27656__$1 = this;return (new domina.xpath.t27654(self__.expr,self__.base,self__.xpath,meta27655__$1));
});
domina.xpath.__GT_t27654 = (function __GT_t27654(expr__$1,base__$1,xpath__$1,meta27655){return (new domina.xpath.t27654(expr__$1,base__$1,xpath__$1,meta27655));
});
}
return (new domina.xpath.t27654(expr,base,xpath,null));
});
