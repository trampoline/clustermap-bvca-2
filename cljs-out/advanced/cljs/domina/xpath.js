...
{{
var G__39459 = (i + 1);
var G__39460 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__39459;
acc = G__39460;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t39464 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t39464 = (function (expr,base,xpath,meta39465){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t39464.cljs$lang$type = true;
domina.xpath.t39464.cljs$lang$ctorStr = "domina.xpath/t39464";
domina.xpath.t39464.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write(writer__4009__auto__,"domina.xpath/t39464");
});
domina.xpath.t39464.prototype.domina$DomContent$ = true;
domina.xpath.t39464.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t39464.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t39464.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39466){var self__ = this;
var _39466__$1 = this;return self__.meta39465;
});
domina.xpath.t39464.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39466,meta39465__$1){var self__ = this;
var _39466__$1 = this;return (new domina.xpath.t39464(self__.expr,self__.base,self__.xpath,meta39465__$1));
});
domina.xpath.__GT_t39464 = (function __GT_t39464(expr__$1,base__$1,xpath__$1,meta39465){return (new domina.xpath.t39464(expr__$1,base__$1,xpath__$1,meta39465));
});
}
return (new domina.xpath.t39464(expr,base,xpath,null));
});
