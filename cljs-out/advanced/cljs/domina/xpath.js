...
{{
var G__27343 = (i + 1);
var G__27344 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__27343;
acc = G__27344;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t27348 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t27348 = (function (expr,base,xpath,meta27349){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t27348.cljs$lang$type = true;
domina.xpath.t27348.cljs$lang$ctorStr = "domina.xpath/t27348";
domina.xpath.t27348.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t27348");
});
domina.xpath.t27348.prototype.domina$DomContent$ = true;
domina.xpath.t27348.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27348.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27348.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27350){var self__ = this;
var _27350__$1 = this;return self__.meta27349;
});
domina.xpath.t27348.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27350,meta27349__$1){var self__ = this;
var _27350__$1 = this;return (new domina.xpath.t27348(self__.expr,self__.base,self__.xpath,meta27349__$1));
});
domina.xpath.__GT_t27348 = (function __GT_t27348(expr__$1,base__$1,xpath__$1,meta27349){return (new domina.xpath.t27348(expr__$1,base__$1,xpath__$1,meta27349));
});
}
return (new domina.xpath.t27348(expr,base,xpath,null));
});
