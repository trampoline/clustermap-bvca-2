...
{{
var G__27731 = (i + 1);
var G__27732 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__27731;
acc = G__27732;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t27736 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t27736 = (function (expr,base,xpath,meta27737){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t27736.cljs$lang$type = true;
domina.xpath.t27736.cljs$lang$ctorStr = "domina.xpath/t27736";
domina.xpath.t27736.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t27736");
});
domina.xpath.t27736.prototype.domina$DomContent$ = true;
domina.xpath.t27736.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27736.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27736.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27738){var self__ = this;
var _27738__$1 = this;return self__.meta27737;
});
domina.xpath.t27736.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27738,meta27737__$1){var self__ = this;
var _27738__$1 = this;return (new domina.xpath.t27736(self__.expr,self__.base,self__.xpath,meta27737__$1));
});
domina.xpath.__GT_t27736 = (function __GT_t27736(expr__$1,base__$1,xpath__$1,meta27737){return (new domina.xpath.t27736(expr__$1,base__$1,xpath__$1,meta27737));
});
}
return (new domina.xpath.t27736(expr,base,xpath,null));
});
