...
{{
var G__26447 = (i + 1);
var G__26448 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__26447;
acc = G__26448;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t26452 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t26452 = (function (expr,base,xpath,meta26453){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t26452.cljs$lang$type = true;
domina.xpath.t26452.cljs$lang$ctorStr = "domina.xpath/t26452";
domina.xpath.t26452.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t26452");
});
domina.xpath.t26452.prototype.domina$DomContent$ = true;
domina.xpath.t26452.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t26452.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t26452.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26454){var self__ = this;
var _26454__$1 = this;return self__.meta26453;
});
domina.xpath.t26452.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26454,meta26453__$1){var self__ = this;
var _26454__$1 = this;return (new domina.xpath.t26452(self__.expr,self__.base,self__.xpath,meta26453__$1));
});
domina.xpath.__GT_t26452 = (function __GT_t26452(expr__$1,base__$1,xpath__$1,meta26453){return (new domina.xpath.t26452(expr__$1,base__$1,xpath__$1,meta26453));
});
}
return (new domina.xpath.t26452(expr,base,xpath,null));
});
