...
{{
var G__27427 = (i + 1);
var G__27428 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__27427;
acc = G__27428;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t27432 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t27432 = (function (expr,base,xpath,meta27433){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t27432.cljs$lang$type = true;
domina.xpath.t27432.cljs$lang$ctorStr = "domina.xpath/t27432";
domina.xpath.t27432.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t27432");
});
domina.xpath.t27432.prototype.domina$DomContent$ = true;
domina.xpath.t27432.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27432.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27432.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27434){var self__ = this;
var _27434__$1 = this;return self__.meta27433;
});
domina.xpath.t27432.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27434,meta27433__$1){var self__ = this;
var _27434__$1 = this;return (new domina.xpath.t27432(self__.expr,self__.base,self__.xpath,meta27433__$1));
});
domina.xpath.__GT_t27432 = (function __GT_t27432(expr__$1,base__$1,xpath__$1,meta27433){return (new domina.xpath.t27432(expr__$1,base__$1,xpath__$1,meta27433));
});
}
return (new domina.xpath.t27432(expr,base,xpath,null));
});
