...
{{
var G__26704 = (i + 1);
var G__26705 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__26704;
acc = G__26705;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t26709 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t26709 = (function (expr,base,xpath,meta26710){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t26709.cljs$lang$type = true;
domina.xpath.t26709.cljs$lang$ctorStr = "domina.xpath/t26709";
domina.xpath.t26709.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t26709");
});
domina.xpath.t26709.prototype.domina$DomContent$ = true;
domina.xpath.t26709.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t26709.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t26709.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26711){var self__ = this;
var _26711__$1 = this;return self__.meta26710;
});
domina.xpath.t26709.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26711,meta26710__$1){var self__ = this;
var _26711__$1 = this;return (new domina.xpath.t26709(self__.expr,self__.base,self__.xpath,meta26710__$1));
});
domina.xpath.__GT_t26709 = (function __GT_t26709(expr__$1,base__$1,xpath__$1,meta26710){return (new domina.xpath.t26709(expr__$1,base__$1,xpath__$1,meta26710));
});
}
return (new domina.xpath.t26709(expr,base,xpath,null));
});
