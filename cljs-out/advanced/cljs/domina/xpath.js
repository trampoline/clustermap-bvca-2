...
{{
var G__46882 = (i + (1));
var G__46883 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__46882;
acc = G__46883;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t46887 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t46887 = (function (expr,base,xpath,meta46888){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t46887.cljs$lang$type = true;
domina.xpath.t46887.cljs$lang$ctorStr = "domina.xpath/t46887";
domina.xpath.t46887.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write(writer__4126__auto__,"domina.xpath/t46887");
});
domina.xpath.t46887.prototype.domina$DomContent$ = true;
domina.xpath.t46887.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t46887.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t46887.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_46889){var self__ = this;
var _46889__$1 = this;return self__.meta46888;
});
domina.xpath.t46887.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_46889,meta46888__$1){var self__ = this;
var _46889__$1 = this;return (new domina.xpath.t46887(self__.expr,self__.base,self__.xpath,meta46888__$1));
});
domina.xpath.__GT_t46887 = (function __GT_t46887(expr__$1,base__$1,xpath__$1,meta46888){return (new domina.xpath.t46887(expr__$1,base__$1,xpath__$1,meta46888));
});
}
return (new domina.xpath.t46887(expr,base,xpath,null));
});
