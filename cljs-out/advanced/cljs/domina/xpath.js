...
{{
var G__23906 = (i + 1);
var G__23907 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__23906;
acc = G__23907;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t23911 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t23911 = (function (expr,base,xpath,meta23912){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t23911.cljs$lang$type = true;
domina.xpath.t23911.cljs$lang$ctorStr = "domina.xpath/t23911";
domina.xpath.t23911.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t23911");
});
domina.xpath.t23911.prototype.domina$DomContent$ = true;
domina.xpath.t23911.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t23911.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t23911.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23913){var self__ = this;
var _23913__$1 = this;return self__.meta23912;
});
domina.xpath.t23911.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23913,meta23912__$1){var self__ = this;
var _23913__$1 = this;return (new domina.xpath.t23911(self__.expr,self__.base,self__.xpath,meta23912__$1));
});
domina.xpath.__GT_t23911 = (function __GT_t23911(expr__$1,base__$1,xpath__$1,meta23912){return (new domina.xpath.t23911(expr__$1,base__$1,xpath__$1,meta23912));
});
}
return (new domina.xpath.t23911(expr,base,xpath,null));
});
