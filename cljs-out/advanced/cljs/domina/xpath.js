...
{{
var G__26807 = (i + 1);
var G__26808 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__26807;
acc = G__26808;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t26812 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t26812 = (function (expr,base,xpath,meta26813){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t26812.cljs$lang$type = true;
domina.xpath.t26812.cljs$lang$ctorStr = "domina.xpath/t26812";
domina.xpath.t26812.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t26812");
});
domina.xpath.t26812.prototype.domina$DomContent$ = true;
domina.xpath.t26812.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t26812.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t26812.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26814){var self__ = this;
var _26814__$1 = this;return self__.meta26813;
});
domina.xpath.t26812.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26814,meta26813__$1){var self__ = this;
var _26814__$1 = this;return (new domina.xpath.t26812(self__.expr,self__.base,self__.xpath,meta26813__$1));
});
domina.xpath.__GT_t26812 = (function __GT_t26812(expr__$1,base__$1,xpath__$1,meta26813){return (new domina.xpath.t26812(expr__$1,base__$1,xpath__$1,meta26813));
});
}
return (new domina.xpath.t26812(expr,base,xpath,null));
});
