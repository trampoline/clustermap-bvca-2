...
{{
var G__39411 = (i + 1);
var G__39412 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__39411;
acc = G__39412;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t39416 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t39416 = (function (expr,base,xpath,meta39417){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t39416.cljs$lang$type = true;
domina.xpath.t39416.cljs$lang$ctorStr = "domina.xpath/t39416";
domina.xpath.t39416.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write(writer__4009__auto__,"domina.xpath/t39416");
});
domina.xpath.t39416.prototype.domina$DomContent$ = true;
domina.xpath.t39416.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t39416.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t39416.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39418){var self__ = this;
var _39418__$1 = this;return self__.meta39417;
});
domina.xpath.t39416.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39418,meta39417__$1){var self__ = this;
var _39418__$1 = this;return (new domina.xpath.t39416(self__.expr,self__.base,self__.xpath,meta39417__$1));
});
domina.xpath.__GT_t39416 = (function __GT_t39416(expr__$1,base__$1,xpath__$1,meta39417){return (new domina.xpath.t39416(expr__$1,base__$1,xpath__$1,meta39417));
});
}
return (new domina.xpath.t39416(expr,base,xpath,null));
});
