...
{{
var G__27351 = (i + 1);
var G__27352 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__27351;
acc = G__27352;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t27356 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t27356 = (function (expr,base,xpath,meta27357){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t27356.cljs$lang$type = true;
domina.xpath.t27356.cljs$lang$ctorStr = "domina.xpath/t27356";
domina.xpath.t27356.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t27356");
});
domina.xpath.t27356.prototype.domina$DomContent$ = true;
domina.xpath.t27356.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27356.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t27356.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27358){var self__ = this;
var _27358__$1 = this;return self__.meta27357;
});
domina.xpath.t27356.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27358,meta27357__$1){var self__ = this;
var _27358__$1 = this;return (new domina.xpath.t27356(self__.expr,self__.base,self__.xpath,meta27357__$1));
});
domina.xpath.__GT_t27356 = (function __GT_t27356(expr__$1,base__$1,xpath__$1,meta27357){return (new domina.xpath.t27356(expr__$1,base__$1,xpath__$1,meta27357));
});
}
return (new domina.xpath.t27356(expr,base,xpath,null));
});
