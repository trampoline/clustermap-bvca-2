...
{{
var G__52087 = (i + (1));
var G__52088 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__52087;
acc = G__52088;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t52092 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t52092 = (function (expr,base,xpath,meta52093){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t52092.cljs$lang$type = true;
domina.xpath.t52092.cljs$lang$ctorStr = "domina.xpath/t52092";
domina.xpath.t52092.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write(writer__4126__auto__,"domina.xpath/t52092");
});
domina.xpath.t52092.prototype.domina$DomContent$ = true;
domina.xpath.t52092.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t52092.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t52092.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52094){var self__ = this;
var _52094__$1 = this;return self__.meta52093;
});
domina.xpath.t52092.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52094,meta52093__$1){var self__ = this;
var _52094__$1 = this;return (new domina.xpath.t52092(self__.expr,self__.base,self__.xpath,meta52093__$1));
});
domina.xpath.__GT_t52092 = (function __GT_t52092(expr__$1,base__$1,xpath__$1,meta52093){return (new domina.xpath.t52092(expr__$1,base__$1,xpath__$1,meta52093));
});
}
return (new domina.xpath.t52092(expr,base,xpath,null));
});
