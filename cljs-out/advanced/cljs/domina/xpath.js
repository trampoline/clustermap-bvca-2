...
{{
var G__24271 = (i + 1);
var G__24272 = cljs.core.cons(result.snapshotItem(i),acc);
i = G__24271;
acc = G__24272;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t24276 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t24276 = (function (expr,base,xpath,meta24277){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t24276.cljs$lang$type = true;
domina.xpath.t24276.cljs$lang$ctorStr = "domina.xpath/t24276";
domina.xpath.t24276.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write(writer__3969__auto__,"domina.xpath/t24276");
});
domina.xpath.t24276.prototype.domina$DomContent$ = true;
domina.xpath.t24276.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t24276.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t24276.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24278){var self__ = this;
var _24278__$1 = this;return self__.meta24277;
});
domina.xpath.t24276.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24278,meta24277__$1){var self__ = this;
var _24278__$1 = this;return (new domina.xpath.t24276(self__.expr,self__.base,self__.xpath,meta24277__$1));
});
domina.xpath.__GT_t24276 = (function __GT_t24276(expr__$1,base__$1,xpath__$1,meta24277){return (new domina.xpath.t24276(expr__$1,base__$1,xpath__$1,meta24277));
});
}
return (new domina.xpath.t24276(expr,base,xpath,null));
});
