...
hiccups.runtime._STAR_html_mode_STAR_ = cljs.core.constant$keyword$355;
hiccups.runtime.xml_mode_QMARK_ = (function xml_mode_QMARK_(){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(hiccups.runtime._STAR_html_mode_STAR_,cljs.core.constant$keyword$355);
});
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_27515 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_27515;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__27516){var vec__27518 = p__27516;var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27518,0,null);var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27518,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__27519){var vec__27522 = p__27519;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27522,0,null);var content = cljs.core.nthnext(vec__27522,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else
{}
var vec__27523 = cljs.core.re_matches(hiccups.runtime.re_tag,hiccups.runtime.as_str(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27523,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27523,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27523,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27523,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$273,id,cljs.core.constant$keyword$267,(cljs.core.truth_(class$)?clojure.string.replace(class$,"."," "):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__27525 = hiccups.runtime.normalize_element(element);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27525,0,null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27525,1,null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27525,2,null);if(cljs.core.truth_((function (){var or__3406__auto__ = content;if(cljs.core.truth_(or__3406__auto__))
