...
hiccups.runtime._STAR_html_mode_STAR_ = cljs.core.constant$keyword$1542;
hiccups.runtime.xml_mode_QMARK_ = (function xml_mode_QMARK_(){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(hiccups.runtime._STAR_html_mode_STAR_,cljs.core.constant$keyword$1542);
});
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_68648 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_68648;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__68649){var vec__68651 = p__68649;var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68651,(0),null);var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68651,(1),null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__68652){var vec__68655 = p__68652;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68655,(0),null);var content = cljs.core.nthnext(vec__68655,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)+" is not a valid tag name");
} else
{}
var vec__68656 = cljs.core.re_matches(hiccups.runtime.re_tag,hiccups.runtime.as_str(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68656,(0),null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68656,(1),null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68656,(2),null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68656,(3),null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$1162,id,cljs.core.constant$keyword$1257,(cljs.core.truth_(class$)?clojure.string.replace(class$,"."," "):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__68660 = hiccups.runtime.normalize_element(element);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68660,(0),null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68660,(1),null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68660,(2),null);if(cljs.core.truth_((function (){var or__3637__auto__ = content;if(cljs.core.truth_(or__3637__auto__))
{return or__3637__auto__;
} else
{var G__68661 = tag;return (hiccups.runtime.container_tags.cljs$core$IFn$_invoke$arity$1 ? hiccups.runtime.container_tags.cljs$core$IFn$_invoke$arity$1(G__68661) : hiccups.runtime.container_tags.call(null,G__68661));
}
})()))
{return ("<"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)+cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.render_attr_map(attrs))+">"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__68662 = content;return (hiccups.runtime.render_html.cljs$core$IFn$_invoke$arity$1 ? hiccups.runtime.render_html.cljs$core$IFn$_invoke$arity$1(G__68662) : hiccups.runtime.render_html.call(null,G__68662));
