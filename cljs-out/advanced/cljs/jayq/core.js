...
var G__27299 = null;
var G__27299__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$2(this$,k);
});
var G__27299__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$3(this$,k,not_found);
});
...
;
jQuery.prototype.apply = (function (self__,args27298){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args27298)));
});
...
var hide__delegate = function ($elem,p__27300){var vec__27302 = p__27300;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27302,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27302,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__27300 = null;if (arguments.length > 1) {
  p__27300 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__27300);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__27303){
var $elem = cljs.core.first(arglist__27303);
var p__27300 = cljs.core.rest(arglist__27303);
return hide__delegate($elem,p__27300);
});
...
var show__delegate = function ($elem,p__27304){var vec__27306 = p__27304;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__27304 = null;if (arguments.length > 1) {
  p__27304 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__27304);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__27307){
var $elem = cljs.core.first(arglist__27307);
var p__27304 = cljs.core.rest(arglist__27307);
return show__delegate($elem,p__27304);
});
...
var toggle__delegate = function ($elem,p__27308){var vec__27310 = p__27308;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27310,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27310,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__27308 = null;if (arguments.length > 1) {
  p__27308 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__27308);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__27311){
var $elem = cljs.core.first(arglist__27311);
var p__27308 = cljs.core.rest(arglist__27311);
return toggle__delegate($elem,p__27308);
});
...
var fade_out__delegate = function ($elem,p__27312){var vec__27314 = p__27312;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27314,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27314,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__27312 = null;if (arguments.length > 1) {
  p__27312 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__27312);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__27315){
var $elem = cljs.core.first(arglist__27315);
var p__27312 = cljs.core.rest(arglist__27315);
return fade_out__delegate($elem,p__27312);
});
...
var fade_in__delegate = function ($elem,p__27316){var vec__27318 = p__27316;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27318,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27318,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__27316 = null;if (arguments.length > 1) {
  p__27316 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__27316);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__27319){
var $elem = cljs.core.first(arglist__27319);
var p__27316 = cljs.core.rest(arglist__27319);
return fade_in__delegate($elem,p__27316);
});
...
var slide_up__delegate = function ($elem,p__27320){var vec__27322 = p__27320;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27322,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27322,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__27320 = null;if (arguments.length > 1) {
  p__27320 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__27320);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__27323){
var $elem = cljs.core.first(arglist__27323);
var p__27320 = cljs.core.rest(arglist__27323);
return slide_up__delegate($elem,p__27320);
});
...
var slide_down__delegate = function ($elem,p__27324){var vec__27326 = p__27324;var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27326,0,null);var on_finish = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27326,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__27324 = null;if (arguments.length > 1) {
  p__27324 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__27324);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__27327){
var $elem = cljs.core.first(arglist__27327);
var p__27324 = cljs.core.rest(arglist__27327);
return slide_down__delegate($elem,p__27324);
});
...
var closest__delegate = function ($elem,selector,p__27328){var vec__27330 = p__27328;var context = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27330,0,null);return $elem.closest(jayq.core.__GT_selector(selector),context);
};
var closest = function ($elem,selector,var_args){
var p__27328 = null;if (arguments.length > 2) {
  p__27328 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__27328);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__27331){
var $elem = cljs.core.first(arglist__27331);
arglist__27331 = cljs.core.next(arglist__27331);
var selector = cljs.core.first(arglist__27331);
var p__27328 = cljs.core.rest(arglist__27331);
return closest__delegate($elem,selector,p__27328);
});
...
jQuery.ajaxSetup(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$346,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$349,"application/edn, text/edn",cljs.core.constant$keyword$350,"application/clojure, text/clojure"], null),cljs.core.constant$keyword$347,new cljs.core.PersistentArrayMap(null, 1, ["clojure",/edn|clojure/], null),cljs.core.constant$keyword$348,new cljs.core.PersistentArrayMap(null, 2, ["text edn",jayq.core.mimetype_converter,"text clojure",jayq.core.mimetype_converter], null)], null)));
...
jayq.core.preprocess_request = (function preprocess_request(p__27334){var map__27336 = p__27334;var map__27336__$1 = ((cljs.core.seq_QMARK_(map__27336))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27336):map__27336);var request = map__27336__$1;var contentType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27336__$1,cljs.core.constant$keyword$351);var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27336__$1,cljs.core.constant$keyword$352);var ct = jayq.core.__GT_content_type(contentType);return (function (p1__27333_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_(ct)))
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__27333_SHARP_,cljs.core.constant$keyword$352,cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([data], 0)));
} else
{return p1__27333_SHARP_;
}
}).call(null,(function (p1__27332_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__27332_SHARP_,cljs.core.constant$keyword$351,ct);
} else
{return p1__27332_SHARP_;
}
}).call(null,request));
});
...
;
jayq.core.xhr = (function xhr(p__27337,content,callback){var vec__27339 = p__27337;var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27339,0,null);var uri = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27339,1,null);var params = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$270,clojure.string.upper_case(cljs.core.name(method)),cljs.core.constant$keyword$352,cljs.core.clj__GT_js(content),cljs.core.constant$keyword$353,callback], null));return jQuery.ajax(uri,params);
});
/**
...
var unbind__delegate = function ($elem,ev,p__27340){var vec__27342 = p__27340;var func = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27342,0,null);return $elem.unbind(cljs.core.name(ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__27340 = null;if (arguments.length > 2) {
  p__27340 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__27340);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__27343){
var $elem = cljs.core.first(arglist__27343);
arglist__27343 = cljs.core.next(arglist__27343);
var ev = cljs.core.first(arglist__27343);
var p__27340 = cljs.core.rest(arglist__27343);
return unbind__delegate($elem,ev,p__27340);
});
...
var on__delegate = function ($elem,events,p__27344){var vec__27346 = p__27344;var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27346,0,null);var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27346,1,null);var handler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27346,2,null);return $elem.on(jayq.core.__GT_event(events),jayq.core.__GT_selector(sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__27344 = null;if (arguments.length > 2) {
  p__27344 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__27344);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__27347){
...
return on__delegate($elem,events,p__27344);
});
...
return one__delegate($elem,events,p__27348);
});
...
var off__delegate = function ($elem,events,p__27352){var vec__27354 = p__27352;var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27354,0,null);var handler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27354,1,null);return $elem.off(jayq.core.__GT_event(events),jayq.core.__GT_selector(sel),handler);
};
var off = function ($elem,events,var_args){
var p__27352 = null;if (arguments.length > 2) {
  p__27352 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__27352);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__27355){
...
return off__delegate($elem,events,p__27352);
});
...
var offset = null;
var offset__1 = (function ($elem){return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic($elem.offset(),cljs.core.array_seq([cljs.core.constant$keyword$236,true], 0));
});
...
jayq.core.position = (function position($elem){return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic($elem.position(),cljs.core.array_seq([cljs.core.constant$keyword$236,true], 0));
});
...
done.cljs$lang$applyTo = (function (arglist__27356){
var deferred = cljs.core.first(arglist__27356);
var fns_args = cljs.core.rest(arglist__27356);
...
fail.cljs$lang$applyTo = (function (arglist__27357){
var deferred = cljs.core.first(arglist__27357);
var fns_args = cljs.core.rest(arglist__27357);
...
always.cljs$lang$applyTo = (function (arglist__27358){
var deferred = cljs.core.first(arglist__27358);
var fns_args = cljs.core.rest(arglist__27358);
...
jayq.core.deferred_m = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$354,jayq.core.$when,cljs.core.constant$keyword$355,(function (x,f){var dfd = (jayq.core.$deferred.cljs$core$IFn$_invoke$arity$0 ? jayq.core.$deferred.cljs$core$IFn$_invoke$arity$0() : jayq.core.$deferred.call(null));jayq.core.done.cljs$core$IFn$_invoke$arity$variadic(x,cljs.core.array_seq([(function (v){return jayq.core.done.cljs$core$IFn$_invoke$arity$variadic((f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v) : f.call(null,v)),cljs.core.array_seq([cljs.core.partial.cljs$core$IFn$_invoke$arity$2(jayq.core.resolve,dfd)], 0));
})], 0));
return jayq.core.promise.cljs$core$IFn$_invoke$arity$1(dfd);
}),cljs.core.constant$keyword$356,cljs.core.identity], null);
jayq.core.ajax_m = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$354,cljs.core.identity,cljs.core.constant$keyword$355,(function (x,f){return jayq.core.done.cljs$core$IFn$_invoke$arity$variadic(jayq.core.ajax.cljs$core$IFn$_invoke$arity$1(x),cljs.core.array_seq([f], 0));
}),cljs.core.constant$keyword$356,cljs.core.identity], null);
