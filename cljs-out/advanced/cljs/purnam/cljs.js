...
goog.require('goog.object');
purnam.cljs.nested_val = (function nested_val(p__19504,val){var vec__19508 = p__19504;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19508,0,null);var ks = cljs.core.nthnext(vec__19508,1);if((k == null))
{return val;
} else
...
purnam.cljs.nested_delete = (function nested_delete(p__19511,val){var vec__19513 = p__19511;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19513,0,null);var ks = cljs.core.nthnext(vec__19513,1);if((ks == null))
{delete val[k];
} else
...
var aset_in__3 = (function (var$,arr,val){var vec__19515 = arr;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19515,0,null);var ks = cljs.core.nthnext(vec__19515,1);if((k == null))
{} else
...
{var svar_19517 = temp__4090__auto___19516;aset_in.cljs$core$IFn$_invoke$arity$3(svar_19517,ks,val);
} else
{if(cljs.core.truth_(val))
...
{var vec__19519 = temp__4090__auto__;var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19519,0,null);var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19519,1,null);return n;
} else
{return "Object";
}
});
...
{{
var G__19521 = o;
var G__19522 = cljs.core.first(more);
var G__19523 = cljs.core.second(more);
var G__19524 = cljs.core.nnext(more);
o = G__19521;
k = G__19522;
v = G__19523;
more = G__19524;
...
{{
var G__19526 = o;
var G__19527 = cljs.core.first(more);
var G__19528 = cljs.core.next(more);
o = G__19526;
k = G__19527;
more = G__19528;
continue;
...
;
purnam.cljs.js_empty = (function js_empty(o){var G__19535_19540 = goog.typeOf(o);if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("array",G__19535_19540))
{(o["length"] = 0);
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("object",G__19535_19540))
{var seq__19536_19541 = cljs.core.seq(cljs.core.js_keys(o));var chunk__19537_19542 = null;var count__19538_19543 = 0;var i__19539_19544 = 0;while(true){
if((i__19539_19544 < count__19538_19543))
{var k_19545 = chunk__19537_19542.cljs$core$IIndexed$_nth$arity$2(null,i__19539_19544);delete o[k_19545];
{
...
{var temp__4092__auto___19550 = cljs.core.seq(seq__19536_19541);if(temp__4092__auto___19550)
{var seq__19536_19551__$1 = temp__4092__auto___19550;if(cljs.core.chunked_seq_QMARK_(seq__19536_19551__$1))
{var c__4015__auto___19552 = cljs.core.chunk_first(seq__19536_19551__$1);{
var G__19553 = cljs.core.chunk_rest(seq__19536_19551__$1);
var G__19554 = c__4015__auto___19552;
var G__19555 = cljs.core.count(c__4015__auto___19552);
var G__19556 = 0;
...
{var k_19557 = cljs.core.first(seq__19536_19551__$1);delete o[k_19557];
{
var G__19558 = cljs.core.next(seq__19536_19551__$1);
var G__19559 = null;
var G__19560 = 0;
var G__19561 = 0;
...
var js_merge = null;
var js_merge__2 = (function (o1,o2){var seq__19566_19570 = cljs.core.seq(cljs.core.js_keys(o2));var chunk__19567_19571 = null;var count__19568_19572 = 0;var i__19569_19573 = 0;while(true){
if((i__19569_19573 < count__19568_19572))
{var k_19574 = chunk__19567_19571.cljs$core$IIndexed$_nth$arity$2(null,i__19569_19573);(o1[k_19574] = (o2[k_19574]));
{
...
{var temp__4092__auto___19579 = cljs.core.seq(seq__19566_19570);if(temp__4092__auto___19579)
{var seq__19566_19580__$1 = temp__4092__auto___19579;if(cljs.core.chunked_seq_QMARK_(seq__19566_19580__$1))
{var c__4015__auto___19581 = cljs.core.chunk_first(seq__19566_19580__$1);{
var G__19582 = cljs.core.chunk_rest(seq__19566_19580__$1);
var G__19583 = c__4015__auto___19581;
var G__19584 = cljs.core.count(c__4015__auto___19581);
var G__19585 = 0;
...
{var k_19586 = cljs.core.first(seq__19566_19580__$1);(o1[k_19586] = (o2[k_19586]));
{
var G__19587 = cljs.core.next(seq__19566_19580__$1);
var G__19588 = null;
var G__19589 = 0;
var G__19590 = 0;
...
var G__19591__delegate = function (o1,o2,more){return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(js_merge,js_merge.cljs$core$IFn$_invoke$arity$2(o1,o2),more);
};
...
var js_merge_nil__2 = (function (o1,o2){var seq__19597_19601 = cljs.core.seq(cljs.core.js_keys(o2));var chunk__19598_19602 = null;var count__19599_19603 = 0;var i__19600_19604 = 0;while(true){
if((i__19600_19604 < count__19599_19603))
{var k_19605 = chunk__19598_19602.cljs$core$IIndexed$_nth$arity$2(null,i__19600_19604);if(cljs.core.not((o1[k_19605])))
...
{var temp__4092__auto___19610 = cljs.core.seq(seq__19597_19601);if(temp__4092__auto___19610)
{var seq__19597_19611__$1 = temp__4092__auto___19610;if(cljs.core.chunked_seq_QMARK_(seq__19597_19611__$1))
{var c__4015__auto___19612 = cljs.core.chunk_first(seq__19597_19611__$1);{
var G__19613 = cljs.core.chunk_rest(seq__19597_19611__$1);
...
{var k_19617 = cljs.core.first(seq__19597_19611__$1);if(cljs.core.not((o1[k_19617])))
{(o1[k_19617] = (o2[k_19617]));
} else
{}
{
var G__19618 = cljs.core.next(seq__19597_19611__$1);
var G__19619 = null;
var G__19620 = 0;
var G__19621 = 0;
...
if(cljs.core.truth_(more))
{{
var G__19623 = js_merge_nil.cljs$core$IFn$_invoke$arity$2(o1,o2);
var G__19624 = cljs.core.first(more);
var G__19625 = cljs.core.next(more);
o1 = G__19623;
o2 = G__19624;
more = G__19625;
continue;
...
var js_deep_extend__4 = (function (to,from,visited,visitedlu){var seq__19635_19639 = cljs.core.seq(cljs.core.js_keys(from));var chunk__19636_19640 = null;var count__19637_19641 = 0;var i__19638_19642 = 0;while(true){
if((i__19638_19642 < count__19637_19641))
{var k_19643 = chunk__19636_19640.cljs$core$IIndexed$_nth$arity$2(null,i__19638_19642);var v_19644 = (from[k_19643]);var vn_19645 = purnam.cljs.js_initial_value(v_19644);if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(v_19644,vn_19645))
{var i_19646 = visited.indexOf(v_19644);if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(-1,i_19646))
{visited.push(v_19644);
visitedlu.push(vn_19645);
js_deep_extend.cljs$core$IFn$_invoke$arity$4(vn_19645,v_19644,visited,visitedlu);
(to[k_19643] = vn_19645);
} else
...
{var temp__4092__auto___19651 = cljs.core.seq(seq__19635_19639);if(temp__4092__auto___19651)
{var seq__19635_19652__$1 = temp__4092__auto___19651;if(cljs.core.chunked_seq_QMARK_(seq__19635_19652__$1))
{var c__4015__auto___19653 = cljs.core.chunk_first(seq__19635_19652__$1);{
var G__19654 = cljs.core.chunk_rest(seq__19635_19652__$1);
var G__19655 = c__4015__auto___19653;
var G__19656 = cljs.core.count(c__4015__auto___19653);
var G__19657 = 0;
...
{var k_19658 = cljs.core.first(seq__19635_19652__$1);var v_19659 = (from[k_19658]);var vn_19660 = purnam.cljs.js_initial_value(v_19659);if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(v_19659,vn_19660))
{var i_19661 = visited.indexOf(v_19659);if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(-1,i_19661))
{visited.push(v_19659);
visitedlu.push(vn_19660);
js_deep_extend.cljs$core$IFn$_invoke$arity$4(vn_19660,v_19659,visited,visitedlu);
(to[k_19658] = vn_19660);
} else
...
{
var G__19662 = cljs.core.next(seq__19635_19652__$1);
var G__19663 = null;
var G__19664 = 0;
var G__19665 = 0;
