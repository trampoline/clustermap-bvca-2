...
{var style = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4115__auto__,i__26993);cljs.core.chunk_append(b__26994,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$263,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$264,"text/css",cljs.core.constant$keyword$265,sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([style], 0)),cljs.core.constant$keyword$266,"stylesheet"], null)], null));
{
...
{var style = cljs.core.first(s__26992__$2);return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$263,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$264,"text/css",cljs.core.constant$keyword$265,sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([style], 0)),cljs.core.constant$keyword$266,"stylesheet"], null)], null),iter__26991(cljs.core.rest(s__26992__$2)));
}
} else
{return null;
}
...
*/
sablono.core.unordered_list27004 = (function unordered_list27004(coll){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$268,(function (){var iter__4117__auto__ = (function iter__27009(s__27010){return (new cljs.core.LazySeq(null,(function (){var s__27010__$1 = s__27010;while(true){
...
{var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4115__auto__,i__27011);cljs.core.chunk_append(b__27012,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$269,x], null));
{
...
{var x = cljs.core.first(s__27010__$2);return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$269,x], null),iter__27009(cljs.core.rest(s__27010__$2)));
}
} else
{return null;
}
...
*/
sablono.core.ordered_list27014 = (function ordered_list27014(coll){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$270,(function (){var iter__4117__auto__ = (function iter__27019(s__27020){return (new cljs.core.LazySeq(null,(function (){var s__27020__$1 = s__27020;while(true){
...
{var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4115__auto__,i__27021);cljs.core.chunk_append(b__27022,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$269,x], null));
{
...
{var x = cljs.core.first(s__27020__$2);return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$269,x], null),iter__27019(cljs.core.rest(s__27020__$2)));
}
} else
{return null;
}
...
var image27024 = null;
var image27024__1 = (function (src){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$271,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$272,sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([src], 0))], null)], null);
});
var image27024__2 = (function (src,alt){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$271,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$272,sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([src], 0)),cljs.core.constant$keyword$273,alt], null)], null);
});
...
var check_box27033__3 = (function (name,checked_QMARK_,value){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$262,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$264,"checkbox",cljs.core.constant$keyword$274,sablono.core.make_name(name),cljs.core.constant$keyword$260,sablono.core.make_id(name),cljs.core.constant$keyword$229,value,cljs.core.constant$keyword$275,checked_QMARK_], null)], null);
});
...
{return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$276,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$277,text], null),select_options27035.cljs$core$IFn$_invoke$arity$2(val,selected)], null);
} else
...
})():new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$278,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$279,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(x,selected)], null),x], null)),iter__27044(cljs.core.rest(s__27045__$2)));
}
} else
{return null;
}
...
var text_area27054__2 = (function (name,value){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$261,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$274,sablono.core.make_name(name),cljs.core.constant$keyword$260,sablono.core.make_id(name),cljs.core.constant$keyword$229,value], null)], null);
});
...
*/
sablono.core.label27056 = (function label27056(name,text){return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$277,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$257,sablono.core.make_id(name)], null),text], null);
});
sablono.core.label = sablono.core.wrap_attrs(sablono.core.label27056);
/**
* Creates a submit button.
*/
sablono.core.submit_button27057 = (function submit_button27057(text){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$262,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$264,"submit",cljs.core.constant$keyword$229,text], null)], null);
});
sablono.core.submit_button = sablono.core.wrap_attrs(sablono.core.submit_button27057);
/**
* Creates a form reset button.
*/
sablono.core.reset_button27058 = (function reset_button27058(text){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$262,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$264,"reset",cljs.core.constant$keyword$229,text], null)], null);
});
