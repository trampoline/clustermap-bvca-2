...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj68262 = {};return obj68262;
})();
...
{var x__4273__auto__ = (((this$ == null))?null:this$);return (function (){var or__3637__auto__ = (sablono.interpreter.interpret[(function (){var G__68266 = x__4273__auto__;return goog.typeOf(G__68266);
})()]);if(or__3637__auto__)
...
sablono.interpreter.wrap_form_element = (function wrap_form_element(ctor,display_name){var G__68270 = {"render": (function (){var this$ = this;return this$.transferPropsTo((function (){var G__68272 = {"children": (this$.props["children"]), "onChange": (this$["onChange"]), "value": (this$.state["value"])};return (ctor.cljs$core$IFn$_invoke$arity$1 ? ctor.cljs$core$IFn$_invoke$arity$1(G__68272) : ctor.call(null,G__68272));
})());
...
{var G__68271_68273 = e;(handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__68271_68273) : handler.call(null,G__68271_68273));
return this$.setState({"value": e.target.value});
}
}), "getInitialState": (function (){var this$ = this;return {"value": (this$.props["value"])};
}), "getDisplayName": (function (){return display_name;
})};return React.createClass(G__68270);
});
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__68279 = sablono.util.normalize_element(element__$1);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68279,(0),null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68279,(1),null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68279,(2),null);var f = sablono.interpreter.dom_fn(tag);var js_attrs = sablono.interpreter.attributes(attrs);if((cljs.core.sequential_QMARK_(content)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(content))))
{var G__68280 = js_attrs;var G__68281 = sablono.interpreter.interpret(cljs.core.first(content));return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__68280,G__68281) : f.call(null,G__68280,G__68281));
} else
{if(cljs.core.truth_(content))
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,js_attrs,sablono.interpreter.interpret(content));
} else
{var G__68282 = js_attrs;var G__68283 = null;return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__68282,G__68283) : f.call(null,G__68282,G__68283));
