...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj76059 = {};return obj76059;
})();
...
{var x__4273__auto__ = (((this$ == null))?null:this$);return (function (){var or__3637__auto__ = (sablono.interpreter.interpret[(function (){var G__76063 = x__4273__auto__;return goog.typeOf(G__76063);
})()]);if(or__3637__auto__)
...
sablono.interpreter.wrap_form_element = (function wrap_form_element(ctor,display_name){var G__76067 = {"render": (function (){var this$ = this;return this$.transferPropsTo((function (){var G__76069 = {"children": (this$.props["children"]), "onChange": (this$["onChange"]), "value": (this$.state["value"])};return (ctor.cljs$core$IFn$_invoke$arity$1 ? ctor.cljs$core$IFn$_invoke$arity$1(G__76069) : ctor.call(null,G__76069));
})());
...
{var G__76068_76070 = e;(handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__76068_76070) : handler.call(null,G__76068_76070));
return this$.setState({"value": e.target.value});
}
}), "getInitialState": (function (){var this$ = this;return {"value": (this$.props["value"])};
}), "getDisplayName": (function (){return display_name;
})};return React.createClass(G__76067);
});
...
{var dom_fn__$1 = temp__4124__auto__;return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$1263,sablono.interpreter.input,cljs.core.constant$keyword$1262,sablono.interpreter.option,cljs.core.constant$keyword$1261,sablono.interpreter.textarea], null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag),dom_fn__$1);
} else
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(("Unsupported HTML tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(tag))),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$1222,tag], null));
}
});
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__76076 = sablono.util.normalize_element(element__$1);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76076,(0),null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76076,(1),null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76076,(2),null);var f = sablono.interpreter.dom_fn(tag);var js_attrs = sablono.interpreter.attributes(attrs);if((cljs.core.sequential_QMARK_(content)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(content))))
{var G__76077 = js_attrs;var G__76078 = sablono.interpreter.interpret(cljs.core.first(content));return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__76077,G__76078) : f.call(null,G__76077,G__76078));
} else
{if(cljs.core.truth_(content))
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,js_attrs,sablono.interpreter.interpret(content));
} else
{var G__76079 = js_attrs;var G__76080 = null;return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__76079,G__76080) : f.call(null,G__76079,G__76080));
