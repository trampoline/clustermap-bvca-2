...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj25552 = {};return obj25552;
})();
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__25554 = sablono.util.normalize_element(element__$1);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25554,0,null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25554,1,null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25554,2,null);var dom_fn = (React.DOM[cljs.core.name(tag)]);if(cljs.core.truth_(content))
