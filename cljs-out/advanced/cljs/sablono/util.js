...
sablono.util.ToString = (function (){var obj24553 = {};return obj24553;
})();
...
sablono.util.ToURI = (function (){var obj24555 = {};return obj24555;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__24556){
var xs = cljs.core.seq(arglist__24556);
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__24557_SHARP_){if(cljs.core.list_QMARK_(p1__24557_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24557_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_(p1__24557_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__24558){
var maps = cljs.core.seq(arglist__24558);
...
*/
sablono.util.normalize_element = (function normalize_element(p__24559){var vec__24562 = p__24559;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24562,0,null);var content = cljs.core.nthnext(vec__24562,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__24563 = cljs.core.re_matches(sablono.util.re_tag,cljs.core.name(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24563,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24563,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24563,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24563,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$140,id,cljs.core.constant$keyword$137,(cljs.core.truth_(class$)?clojure.string.split.cljs$core$IFn$_invoke$arity$2(class$,/\./):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
