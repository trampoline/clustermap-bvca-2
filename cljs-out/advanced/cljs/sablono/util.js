...
sablono.util.ToString = (function (){var obj39105 = {};return obj39105;
})();
...
sablono.util.ToURI = (function (){var obj39107 = {};return obj39107;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__39108){
var xs = cljs.core.seq(arglist__39108);
...
{var vec__39110 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39110,0,null);var words = cljs.core.nthnext(vec__39110,1);if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__39111_SHARP_){if(cljs.core.list_QMARK_(p1__39111_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__39111_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_(p1__39111_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__39112){
var maps = cljs.core.seq(arglist__39112);
...
*/
sablono.util.normalize_element = (function normalize_element(p__39113){var vec__39116 = p__39113;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39116,0,null);var content = cljs.core.nthnext(vec__39116,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__39117 = cljs.core.re_matches(sablono.util.re_tag,cljs.core.name(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39117,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39117,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39117,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39117,3,null);var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$580,id,cljs.core.constant$keyword$574,(cljs.core.truth_(class$)?clojure.string.split.cljs$core$IFn$_invoke$arity$2(class$,/\./):null)], null));var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
