...
sablono.util.ToString = (function (){var obj43311 = {};return obj43311;
})();
...
sablono.util.ToURI = (function (){var obj43313 = {};return obj43313;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__43314){
var xs = cljs.core.seq(arglist__43314);
...
{var vec__43316 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43316,(0),null);var words = cljs.core.nthnext(vec__43316,(1));if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
*/
sablono.util.html_to_dom_attrs = (function html_to_dom_attrs(attrs){var dom_attrs = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.zipmap(cljs.core.keys(attrs),cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.camel_case,cljs.core.keys(attrs))),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$835,cljs.core.constant$keyword$837,cljs.core.constant$keyword$836,cljs.core.constant$keyword$838], null)], 0));return clojure.set.rename_keys(attrs,dom_attrs);
});
/**
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__43317_SHARP_){if(cljs.core.list_QMARK_(p1__43317_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__43317_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_(p1__43317_SHARP_))
{return p1__43317_SHARP_;
} else
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$835,maps))));var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);if(cljs.core.empty_QMARK_(classes))
{return maps__$1;
} else
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$835,classes);
}
};
...
merge_with_class.cljs$lang$applyTo = (function (arglist__43318){
var maps = cljs.core.seq(arglist__43318);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq(/[#.]?[^#.]+/,cljs.core.name(s));var vec__43322 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$839,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):((cljs.core.constant$keyword$779)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null):null)));var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43322,(0),null);var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43322,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter(((function (matches,vec__43322,tag_name,names){
return (function (p1__43319_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__43319_SHARP_));
});})(matches,vec__43322,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter(((function (matches,vec__43322,tag_name,names){
return (function (p1__43320_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__43320_SHARP_));
});})(matches,vec__43322,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__43323){var vec__43326 = p__43323;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43326,(0),null);var content = cljs.core.nthnext(vec__43326,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)+" is not a valid element name."),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$839,tag,cljs.core.constant$keyword$801,content], null));
} else
{}
var vec__43327 = sablono.util.match_tag(tag);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43327,(0),null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43327,(1),null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43327,(2),null);var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$824,id,cljs.core.constant$keyword$835,class$], null));var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
sablono.util.react_fn = (function react_fn(tag){var dom_fn = sablono.util.react_symbol(tag);if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$840,null,cljs.core.constant$keyword$841,null], null), null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag)))
