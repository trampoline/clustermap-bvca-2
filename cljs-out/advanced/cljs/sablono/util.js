...
sablono.util.ToString = (function (){var obj25679 = {};return obj25679;
})();
...
sablono.util.ToURI = (function (){var obj25681 = {};return obj25681;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__25682){
var xs = cljs.core.seq(arglist__25682);
...
{var vec__25684 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25684,0,null);var words = cljs.core.nthnext(vec__25684,1);if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__25685_SHARP_){if(cljs.core.list_QMARK_(p1__25685_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25685_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_(p1__25685_SHARP_))
{return p1__25685_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__25686){
var maps = cljs.core.seq(arglist__25686);
...
*/
sablono.util.normalize_element = (function normalize_element(p__25687){var vec__25690 = p__25687;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25690,0,null);var content = cljs.core.nthnext(vec__25690,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__25691 = cljs.core.re_matches(sablono.util.re_tag,cljs.core.name(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25691,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25691,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25691,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25691,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$191,id,cljs.core.constant$keyword$185,(cljs.core.truth_(class$)?clojure.string.split.cljs$core$IFn$_invoke$arity$2(class$,/\./):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
