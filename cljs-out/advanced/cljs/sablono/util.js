...
sablono.util.ToString = (function (){var obj49831 = {};return obj49831;
})();
...
sablono.util.ToURI = (function (){var obj49833 = {};return obj49833;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__49834){
var xs = cljs.core.seq(arglist__49834);
...
{var vec__49836 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49836,(0),null);var words = cljs.core.nthnext(vec__49836,(1));if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys(m);var kmap = cljs.core.zipmap(ks,cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.camel_case,ks));var G__49838 = clojure.set.rename_keys(m,kmap);var G__49838__$1 = ((cljs.core.map_QMARK_(cljs.core.constant$keyword$1226.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__49838,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$1226], null),camel_case_keys):G__49838);return G__49838__$1;
} else
{return m;
}
});
...
*/
sablono.util.html_to_dom_attrs = (function html_to_dom_attrs(attrs){return clojure.set.rename_keys(sablono.util.camel_case_keys(attrs),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$1227,cljs.core.constant$keyword$1229,cljs.core.constant$keyword$1228,cljs.core.constant$keyword$1230], null));
});
/**
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__49839_SHARP_){if(cljs.core.list_QMARK_(p1__49839_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__49839_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_(p1__49839_SHARP_))
{return p1__49839_SHARP_;
} else
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__49839_SHARP_], null);

}
}
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$1227,maps))));var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);if(cljs.core.empty_QMARK_(classes))
{return maps__$1;
} else
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$1227,classes);
}
};
...
merge_with_class.cljs$lang$applyTo = (function (arglist__49840){
var maps = cljs.core.seq(arglist__49840);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq(/[#.]?[^#.]+/,cljs.core.name(s));var vec__49844 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$1200,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49844,(0),null);var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49844,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__49844,tag_name,names){
return (function (p1__49841_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__49841_SHARP_));
});})(matches,vec__49844,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__49844,tag_name,names){
return (function (p1__49842_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__49842_SHARP_));
});})(matches,vec__49844,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__49845){var vec__49848 = p__49845;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49848,(0),null);var content = cljs.core.nthnext(vec__49848,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)+" is not a valid element name."),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$1200,tag,cljs.core.constant$keyword$1114,content], null));
} else
{}
var vec__49849 = sablono.util.match_tag(tag);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49849,(0),null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49849,(1),null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49849,(2),null);var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$1140,id,cljs.core.constant$keyword$1227,class$], null));var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
sablono.util.react_fn = (function react_fn(tag){if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$1231,null,cljs.core.constant$keyword$1232,null,cljs.core.constant$keyword$1233,null], null), null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag)))
