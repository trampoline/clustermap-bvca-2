...
sablono.util.ToString = (function (){var obj24721 = {};return obj24721;
})();
...
sablono.util.ToURI = (function (){var obj24723 = {};return obj24723;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__24724){
var xs = cljs.core.seq(arglist__24724);
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__24725_SHARP_){if(cljs.core.list_QMARK_(p1__24725_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24725_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_(p1__24725_SHARP_))
{return p1__24725_SHARP_;
} else
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$137,maps))));var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);if(cljs.core.empty_QMARK_(classes))
{return maps__$1;
} else
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$137,classes);
}
};
...
merge_with_class.cljs$lang$applyTo = (function (arglist__24726){
var maps = cljs.core.seq(arglist__24726);
...
*/
sablono.util.normalize_element = (function normalize_element(p__24727){var vec__24730 = p__24727;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24730,0,null);var content = cljs.core.nthnext(vec__24730,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str(tag),cljs.core.str(" is not a valid element name.")].join(''),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$138,tag,cljs.core.constant$keyword$139,content], null));
} else
{}
var vec__24731 = cljs.core.re_matches(sablono.util.re_tag,cljs.core.name(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24731,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24731,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24731,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24731,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$140,id,cljs.core.constant$keyword$137,(cljs.core.truth_(class$)?clojure.string.split.cljs$core$IFn$_invoke$arity$2(class$,/\./):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
