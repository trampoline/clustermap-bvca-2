...
sablono.util.ToString = (function (){var obj25903 = {};return obj25903;
})();
...
sablono.util.ToURI = (function (){var obj25905 = {};return obj25905;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__25906){
var xs = cljs.core.seq(arglist__25906);
...
{var vec__25908 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25908,0,null);var words = cljs.core.nthnext(vec__25908,1);if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
*/
sablono.util.html_to_dom_attrs = (function html_to_dom_attrs(attrs){var dom_attrs = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.zipmap(cljs.core.keys(attrs),cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.camelcase_key,cljs.core.keys(attrs))),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$209,cljs.core.constant$keyword$211,cljs.core.constant$keyword$210,cljs.core.constant$keyword$212], null)], 0));return clojure.set.rename_keys(attrs,dom_attrs);
});
/**
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__25909_SHARP_){if(cljs.core.list_QMARK_(p1__25909_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25909_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_(p1__25909_SHARP_))
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$209,maps))));var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);if(cljs.core.empty_QMARK_(classes))
{return maps__$1;
} else
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$209,classes);
}
};
...
merge_with_class.cljs$lang$applyTo = (function (arglist__25910){
var maps = cljs.core.seq(arglist__25910);
...
*/
sablono.util.normalize_element = (function normalize_element(p__25911){var vec__25914 = p__25911;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25914,0,null);var content = cljs.core.nthnext(vec__25914,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str(tag),cljs.core.str(" is not a valid element name.")].join(''),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$213,tag,cljs.core.constant$keyword$214,content], null));
} else
{}
var vec__25915 = cljs.core.re_matches(sablono.util.re_tag,cljs.core.name(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25915,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25915,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25915,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25915,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$215,id,cljs.core.constant$keyword$209,(cljs.core.truth_(class$)?clojure.string.split.cljs$core$IFn$_invoke$arity$2(class$,/\./):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
