...
sablono.util.ToString = (function (){var obj25004 = {};return obj25004;
})();
...
sablono.util.ToURI = (function (){var obj25006 = {};return obj25006;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__25007){
var xs = cljs.core.seq(arglist__25007);
...
*/
sablono.util.camelcase_key = (function camelcase_key(k){var vec__25009 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25009,0,null);var words = cljs.core.nthnext(vec__25009,1);if(cljs.core.empty_QMARK_(words))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__25010_SHARP_){if(cljs.core.list_QMARK_(p1__25010_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25010_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_(p1__25010_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__25011){
var maps = cljs.core.seq(arglist__25011);
...
*/
sablono.util.normalize_element = (function normalize_element(p__25012){var vec__25015 = p__25012;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25015,0,null);var content = cljs.core.nthnext(vec__25015,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__25016 = cljs.core.re_matches(sablono.util.re_tag,cljs.core.name(tag));var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25016,0,null);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25016,1,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25016,2,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25016,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$170,id,cljs.core.constant$keyword$165,(cljs.core.truth_(class$)?clojure.string.split.cljs$core$IFn$_invoke$arity$2(class$,/\./):null)], null);var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
