...
sablono.util.ToString = (function (){var obj51991 = {};return obj51991;
})();
...
sablono.util.ToURI = (function (){var obj51993 = {};return obj51993;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__51994){
var xs = cljs.core.seq(arglist__51994);
...
{var vec__51996 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51996,(0),null);var words = cljs.core.nthnext(vec__51996,(1));if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys(m);var kmap = cljs.core.zipmap(ks,cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.camel_case,ks));var G__51998 = clojure.set.rename_keys(m,kmap);var G__51998__$1 = ((cljs.core.map_QMARK_(cljs.core.constant$keyword$1048.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__51998,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$1048], null),camel_case_keys):G__51998);return G__51998__$1;
} else
{return m;
}
});
...
*/
sablono.util.html_to_dom_attrs = (function html_to_dom_attrs(attrs){return clojure.set.rename_keys(sablono.util.camel_case_keys(attrs),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$1049,cljs.core.constant$keyword$1051,cljs.core.constant$keyword$1050,cljs.core.constant$keyword$1052], null));
});
/**
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__51999_SHARP_){if(cljs.core.list_QMARK_(p1__51999_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__51999_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_(p1__51999_SHARP_))
{return p1__51999_SHARP_;
} else
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__51999_SHARP_], null);

}
}
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$1049,maps))));var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);if(cljs.core.empty_QMARK_(classes))
{return maps__$1;
} else
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$1049,classes);
}
};
...
merge_with_class.cljs$lang$applyTo = (function (arglist__52000){
var maps = cljs.core.seq(arglist__52000);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq(/[#.]?[^#.]+/,cljs.core.name(s));var vec__52004 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$1024,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52004,(0),null);var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52004,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__52004,tag_name,names){
return (function (p1__52001_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__52001_SHARP_));
});})(matches,vec__52004,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__52004,tag_name,names){
return (function (p1__52002_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__52002_SHARP_));
});})(matches,vec__52004,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__52005){var vec__52008 = p__52005;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52008,(0),null);var content = cljs.core.nthnext(vec__52008,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)+" is not a valid element name."),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$1024,tag,cljs.core.constant$keyword$950,content], null));
} else
{}
var vec__52009 = sablono.util.match_tag(tag);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52009,(0),null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52009,(1),null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52009,(2),null);var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$976,id,cljs.core.constant$keyword$1049,class$], null));var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
sablono.util.react_fn = (function react_fn(tag){if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$1053,null,cljs.core.constant$keyword$1054,null,cljs.core.constant$keyword$1055,null], null), null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag)))
