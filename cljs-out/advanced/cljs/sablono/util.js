...
sablono.util.ToString = (function (){var obj43869 = {};return obj43869;
})();
...
sablono.util.ToURI = (function (){var obj43871 = {};return obj43871;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__43872){
var xs = cljs.core.seq(arglist__43872);
...
{var vec__43874 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43874,(0),null);var words = cljs.core.nthnext(vec__43874,(1));if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys(m);var kmap = cljs.core.zipmap(ks,cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.camel_case,ks));var G__43876 = clojure.set.rename_keys(m,kmap);var G__43876__$1 = ((cljs.core.map_QMARK_(cljs.core.constant$keyword$893.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__43876,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$893], null),camel_case_keys):G__43876);return G__43876__$1;
} else
{return m;
}
});
...
*/
sablono.util.html_to_dom_attrs = (function html_to_dom_attrs(attrs){return clojure.set.rename_keys(sablono.util.camel_case_keys(attrs),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$894,cljs.core.constant$keyword$896,cljs.core.constant$keyword$895,cljs.core.constant$keyword$897], null));
});
/**
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__43877_SHARP_){if(cljs.core.list_QMARK_(p1__43877_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__43877_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_(p1__43877_SHARP_))
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$894,maps))));var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);if(cljs.core.empty_QMARK_(classes))
{return maps__$1;
} else
{return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$894,classes);
}
};
...
merge_with_class.cljs$lang$applyTo = (function (arglist__43878){
var maps = cljs.core.seq(arglist__43878);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq(/[#.]?[^#.]+/,cljs.core.name(s));var vec__43882 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$898,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43882,(0),null);var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43882,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__43882,tag_name,names){
return (function (p1__43879_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__43879_SHARP_));
});})(matches,vec__43882,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__43882,tag_name,names){
return (function (p1__43880_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__43880_SHARP_));
});})(matches,vec__43882,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__43883){var vec__43886 = p__43883;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43886,(0),null);var content = cljs.core.nthnext(vec__43886,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)+" is not a valid element name."),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$898,tag,cljs.core.constant$keyword$858,content], null));
} else
{}
var vec__43887 = sablono.util.match_tag(tag);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(0),null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(1),null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(2),null);var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$882,id,cljs.core.constant$keyword$894,class$], null));var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
...
*/
sablono.util.react_fn = (function react_fn(tag){if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$899,null,cljs.core.constant$keyword$900,null,cljs.core.constant$keyword$901,null], null), null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag)))
