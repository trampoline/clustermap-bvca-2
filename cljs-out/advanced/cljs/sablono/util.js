...
sablono.util.ToString = (function (){var obj39722 = {};return obj39722;
})();
...
sablono.util.ToURI = (function (){var obj39724 = {};return obj39724;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__39725){
var xs = cljs.core.seq(arglist__39725);
...
{var vec__39727 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39727,0,null);var words = cljs.core.nthnext(vec__39727,1);if((cljs.core.empty_QMARK_(words)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("aria",first_word)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec(cljs.core.remove(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (p1__39728_SHARP_){if(cljs.core.list_QMARK_(p1__39728_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__39728_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_(p1__39728_SHARP_))
{return p1__39728_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__39729){
var maps = cljs.core.seq(arglist__39729);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq(/[#.]?[^#.]+/,cljs.core.name(s));var vec__39733 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$631,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):((cljs.core.constant$keyword$581)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null):null)));var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39733,0,null);var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39733,1,null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter(((function (matches,vec__39733,tag_name,names){
return (function (p1__39730_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__39730_SHARP_));
});})(matches,vec__39733,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter(((function (matches,vec__39733,tag_name,names){
return (function (p1__39731_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__39731_SHARP_));
});})(matches,vec__39733,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__39734){var vec__39737 = p__39734;var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39737,0,null);var content = cljs.core.nthnext(vec__39737,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__39738 = sablono.util.match_tag(tag);var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39738,0,null);var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39738,1,null);var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39738,2,null);var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$616,id,cljs.core.constant$keyword$627,class$], null));var map_attrs = cljs.core.first(content);if(cljs.core.map_QMARK_(map_attrs))
