...
goog.require('clojure.string');
secretary.core._STAR_config_STAR_ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$387,""], null));
...
{return cljs.core.every_QMARK_(cljs.core.true_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__26919_SHARP_,p2__26920_SHARP_){return secretary.core.component_matches_QMARK_(p1__26919_SHARP_,p2__26920_SHARP_);
}),r,u));
} else
{return null;
}
});
secretary.core.filter_routes = (function filter_routes(pred,uri_path){return cljs.core.filter((function (p1__26921_SHARP_){return (pred.cljs$core$IFn$_invoke$arity$2 ? pred.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__26921_SHARP_),uri_path) : pred.call(null,cljs.core.first(p1__26921_SHARP_),uri_path));
}),cljs.core.deref(secretary.core._STAR_routes_STAR_));
});
/**
* Turns a map of query parameters into url encoded string.
*/
secretary.core.encode_query_params = (function encode_query_params(query_params){return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__26924){var vec__26925 = p__26924;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26925,0,null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26925,1,null);return [cljs.core.str(cljs.core.name(k)),cljs.core.str("="),cljs.core.str(encodeURIComponent([cljs.core.str(v)].join('')))].join('');
}),query_params));
});
/**
* Extract a map of query parameters from a query string.
*/
secretary.core.decode_query_params = (function decode_query_params(query_string){return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,param){var vec__26927 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(param,/=/,2);var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26927,0,null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26927,1,null);var v__$1 = decodeURIComponent(v);return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,v__$1);
...
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,(function (){var iter__4117__auto__ = (function iter__26932(s__26933){return (new cljs.core.LazySeq(null,(function (){var s__26933__$1 = s__26933;while(true){
...
{var z = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4115__auto__,i__26934);var c = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(secretary.core.extract_component,z);if(!((c == null)))
{cljs.core.chunk_append(b__26935,c);
{
var G__26936 = (i__26934 + 1);
i__26934 = G__26936;
continue;
}
} else
{{
var G__26937 = (i__26934 + 1);
i__26934 = G__26937;
continue;
}
}
...
{var z = cljs.core.first(s__26933__$2);var c = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(secretary.core.extract_component,z);if(!((c == null)))
{return cljs.core.cons(c,iter__26932(cljs.core.rest(s__26933__$2)));
} else
{{
var G__26938 = cljs.core.rest(s__26933__$2);
s__26933__$1 = G__26938;
continue;
}
}
}
...
{var vec__26941 = temp__4090__auto__;var route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26941,0,null);var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26941,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [action,cljs.core.PersistentArrayMap.EMPTY], null);
} else
...
{var xs__4579__auto__ = temp__4092__auto__;var vec__26942 = cljs.core.first(xs__4579__auto__);var route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26942,0,null);var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26942,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [action,secretary.core.extract_components(route,uri_path)], null);
} else
{return null;
}
}
...
*/
secretary.core.dispatch_BANG_ = (function dispatch_BANG_(uri){var vec__26945 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(uri,/\?/);var uri_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26945,0,null);var query_string = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26945,1,null);var query_params = (cljs.core.truth_(query_string)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$388,secretary.core.decode_query_params(query_string)], null):null);var vec__26946 = secretary.core.parse_action(uri_path);var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26946,0,null);var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26946,1,null);var action__$1 = (function (){var or__3406__auto__ = action;if(cljs.core.truth_(or__3406__auto__))
...
var render_route__2 = (function (route,p__26947){var map__26949 = p__26947;var map__26949__$1 = ((cljs.core.seq_QMARK_(map__26949))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26949):map__26949);var m = map__26949__$1;var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26949__$1,cljs.core.constant$keyword$388);var path = route.replace((new RegExp(":[^/]+","g")),(function ($1){var lookup = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$2($1,1));return (m.cljs$core$IFn$_invoke$arity$2 ? m.cljs$core$IFn$_invoke$arity$2(lookup,$1) : m.call(null,lookup,$1));
}));var path__$1 = [cljs.core.str(secretary.core.get_config(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$387], null))),cljs.core.str(path)].join('');var temp__4090__auto__ = (function (){var and__3394__auto__ = query_params;if(cljs.core.truth_(and__3394__auto__))
