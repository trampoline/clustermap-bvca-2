...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj44291 = {};return obj44291;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__3546__auto__ = this$;if(and__3546__auto__)
...
{var x__4185__auto__ = (((this$ == null))?null:this$);return (function (){var or__3558__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__4185__auto__)]);if(or__3558__auto__)
{return or__3558__auto__;
} else
{var or__3558__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__3558__auto____$1)
...
return (function (p__44292){var vec__44293 = p__44292;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44293,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44293,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k.toLowerCase()),v], null);
});})(this$__$1))
