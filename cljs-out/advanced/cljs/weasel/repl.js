...
}catch (e53612){if((e53612 instanceof Error))
{var e = e53612;return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$1586,cljs.core.constant$keyword$1588,cljs.core.constant$keyword$1147,cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([e], 0)),cljs.core.constant$keyword$1587,(cljs.core.truth_(e.hasOwnProperty("stack"))?e.stack:"No stacktrace available.")], null);
} else
{var e = e53612;return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$1586,cljs.core.constant$keyword$1588,cljs.core.constant$keyword$1147,cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([e], 0)),cljs.core.constant$keyword$1587,"No stacktrace available."], null);
...
var connect__delegate = function (repl_server_url,p__53613){var map__53616 = p__53613;var map__53616__$1 = ((cljs.core.seq_QMARK_(map__53616))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53616):map__53616);var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53616__$1,cljs.core.constant$keyword$1590);var on_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53616__$1,cljs.core.constant$keyword$1591);var on_open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53616__$1,cljs.core.constant$keyword$1592);var verbose = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53616__$1,cljs.core.constant$keyword$1593,true);var repl_connection = weasel.impls.websocket.websocket_connection.cljs$core$IFn$_invoke$arity$0();cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(weasel.repl.ws_connection,cljs.core.constantly(repl_connection));
clojure.browser.event.listen.cljs$core$IFn$_invoke$arity$3(repl_connection,cljs.core.constant$keyword$1594,((function (repl_connection,map__53616,map__53616__$1,on_close,on_error,on_open,verbose){
...
});})(repl_connection,map__53616,map__53616__$1,on_close,on_error,on_open,verbose))
);
clojure.browser.event.listen.cljs$core$IFn$_invoke$arity$3(repl_connection,cljs.core.constant$keyword$1319,((function (repl_connection,map__53616,map__53616__$1,on_close,on_error,on_open,verbose){
return (function (evt){var map__53617 = cljs.reader.read_string(evt.message);var map__53617__$1 = ((cljs.core.seq_QMARK_(map__53617))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53617):map__53617);var message = map__53617__$1;var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53617__$1,cljs.core.constant$keyword$1582);var response = cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(weasel.repl.process_message.cljs$core$IFn$_invoke$arity$1 ? weasel.repl.process_message.cljs$core$IFn$_invoke$arity$1(message) : weasel.repl.process_message.call(null,message))], 0));return clojure.browser.net.transmit.cljs$core$IFn$_invoke$arity$2(repl_connection,response);
});})(repl_connection,map__53616,map__53616__$1,on_close,on_error,on_open,verbose))
);
clojure.browser.event.listen.cljs$core$IFn$_invoke$arity$3(repl_connection,cljs.core.constant$keyword$1596,((function (repl_connection,map__53616,map__53616__$1,on_close,on_error,on_open,verbose){
...
clojure.browser.event.listen.cljs$core$IFn$_invoke$arity$3(repl_connection,cljs.core.constant$keyword$1145,((function (repl_connection,map__53616,map__53616__$1,on_close,on_error,on_open,verbose){
...
var p__53613 = null;if (arguments.length > 1) {
  p__53613 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return connect__delegate.call(this,repl_server_url,p__53613);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__53618){
var repl_server_url = cljs.core.first(arglist__53618);
var p__53613 = cljs.core.rest(arglist__53618);
return connect__delegate(repl_server_url,p__53613);
});
