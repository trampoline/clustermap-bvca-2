...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18480 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18480 = (function (val,box,meta18481){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18480.cljs$lang$type = true;
cljs.core.async.impl.channels.t18480.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18480";
cljs.core.async.impl.channels.t18480.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"cljs.core.async.impl.channels/t18480");
});
cljs.core.async.impl.channels.t18480.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18480.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18482){var self__ = this;
var _18482__$1 = this;return self__.meta18481;
});
cljs.core.async.impl.channels.t18480.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18482,meta18481__$1){var self__ = this;
var _18482__$1 = this;return (new cljs.core.async.impl.channels.t18480(self__.val,self__.box,meta18481__$1));
});
cljs.core.async.impl.channels.__GT_t18480 = (function __GT_t18480(val__$1,box__$1,meta18481){return (new cljs.core.async.impl.channels.t18480(val__$1,box__$1,meta18481));
});
}
return (new cljs.core.async.impl.channels.t18480(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_18483 = self__.takes.pop();if((taker_18483 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18483))
{var take_cb_18484 = cljs.core.async.impl.protocols.commit.call(null,taker_18483);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18484,taker_18483){
return (function (){return take_cb_18484.call(null,null);
});})(take_cb_18484,taker_18483))
);
} else
{}
{
