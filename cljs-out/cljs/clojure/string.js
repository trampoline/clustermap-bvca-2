...
{{
var G__19156 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19156;
continue;
}
} else
...
{var pred__19160 = cljs.core._EQ_;var expr__19161 = limit;if(cljs.core.truth_(pred__19160.call(null,1,expr__19161)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__19160.call(null,2,expr__19161)))
...
var G__19163 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19164 = (limit__$1 - 1);
var G__19165 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19163;
limit__$1 = G__19164;
parts = G__19165;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___19167 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___19167))
{var replacement_19168 = temp__4090__auto___19167;buffer.append([cljs.core.str(replacement_19168)].join(''));
} else
{buffer.append(ch);
}
{
var G__19169 = (index + 1);
index = G__19169;
continue;
}
}
