...
{{
var G__18696 = (i + 1);
var G__18697 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__18696;
acc = G__18697;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t18701 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t18701 = (function (expr,base,xpath,meta18702){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t18701.cljs$lang$type = true;
domina.xpath.t18701.cljs$lang$ctorStr = "domina.xpath/t18701";
domina.xpath.t18701.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"domina.xpath/t18701");
});
domina.xpath.t18701.prototype.domina$DomContent$ = true;
domina.xpath.t18701.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t18701.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t18701.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18703){var self__ = this;
var _18703__$1 = this;return self__.meta18702;
});
domina.xpath.t18701.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18703,meta18702__$1){var self__ = this;
var _18703__$1 = this;return (new domina.xpath.t18701(self__.expr,self__.base,self__.xpath,meta18702__$1));
});
domina.xpath.__GT_t18701 = (function __GT_t18701(expr__$1,base__$1,xpath__$1,meta18702){return (new domina.xpath.t18701(expr__$1,base__$1,xpath__$1,meta18702));
});
}
return (new domina.xpath.t18701(expr,base,xpath,null));
});
