...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18243 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18243 = (function (val,box,meta18244){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18243.cljs$lang$type = true;
cljs.core.async.impl.channels.t18243.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18243";
cljs.core.async.impl.channels.t18243.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"cljs.core.async.impl.channels/t18243");
});
cljs.core.async.impl.channels.t18243.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18243.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18245){var self__ = this;
var _18245__$1 = this;return self__.meta18244;
});
cljs.core.async.impl.channels.t18243.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18245,meta18244__$1){var self__ = this;
var _18245__$1 = this;return (new cljs.core.async.impl.channels.t18243(self__.val,self__.box,meta18244__$1));
});
cljs.core.async.impl.channels.__GT_t18243 = (function __GT_t18243(val__$1,box__$1,meta18244){return (new cljs.core.async.impl.channels.t18243(val__$1,box__$1,meta18244));
});
}
return (new cljs.core.async.impl.channels.t18243(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_18246 = self__.takes.pop();if((taker_18246 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18246))
{var take_cb_18247 = cljs.core.async.impl.protocols.commit.call(null,taker_18246);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18247,taker_18246,this$__$1){
return (function (){return take_cb_18247.call(null,null);
});})(take_cb_18247,taker_18246,this$__$1))
);
} else
{}
{
