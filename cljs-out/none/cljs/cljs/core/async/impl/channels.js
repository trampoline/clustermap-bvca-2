...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15709 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15709 = (function (val,box,meta15710){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15709.cljs$lang$type = true;
cljs.core.async.impl.channels.t15709.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15709";
cljs.core.async.impl.channels.t15709.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t15709");
});
cljs.core.async.impl.channels.t15709.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15709.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15711){var self__ = this;
var _15711__$1 = this;return self__.meta15710;
});
cljs.core.async.impl.channels.t15709.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15711,meta15710__$1){var self__ = this;
var _15711__$1 = this;return (new cljs.core.async.impl.channels.t15709(self__.val,self__.box,meta15710__$1));
});
cljs.core.async.impl.channels.__GT_t15709 = (function __GT_t15709(val__$1,box__$1,meta15710){return (new cljs.core.async.impl.channels.t15709(val__$1,box__$1,meta15710));
});
}
return (new cljs.core.async.impl.channels.t15709(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15712 = self__.takes.pop();if((taker_15712 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15712))
{var take_cb_15713 = cljs.core.async.impl.protocols.commit.call(null,taker_15712);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15713,taker_15712){
return (function (){return take_cb_15713.call(null,null);
});})(take_cb_15713,taker_15712))
);
} else
{}
{
