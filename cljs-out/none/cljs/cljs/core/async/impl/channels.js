...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14542 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14542 = (function (val,box,meta14543){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14542.cljs$lang$type = true;
cljs.core.async.impl.channels.t14542.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14542";
cljs.core.async.impl.channels.t14542.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t14542");
});
cljs.core.async.impl.channels.t14542.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14542.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14544){var self__ = this;
var _14544__$1 = this;return self__.meta14543;
});
cljs.core.async.impl.channels.t14542.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14544,meta14543__$1){var self__ = this;
var _14544__$1 = this;return (new cljs.core.async.impl.channels.t14542(self__.val,self__.box,meta14543__$1));
});
cljs.core.async.impl.channels.__GT_t14542 = (function __GT_t14542(val__$1,box__$1,meta14543){return (new cljs.core.async.impl.channels.t14542(val__$1,box__$1,meta14543));
});
}
return (new cljs.core.async.impl.channels.t14542(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14545 = self__.takes.pop();if((taker_14545 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14545))
{var take_cb_14546 = cljs.core.async.impl.protocols.commit.call(null,taker_14545);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14546,taker_14545){
return (function (){return take_cb_14546.call(null,null);
});})(take_cb_14546,taker_14545))
);
} else
{}
{
