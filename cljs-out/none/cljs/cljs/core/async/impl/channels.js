...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14398 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14398 = (function (val,box,meta14399){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14398.cljs$lang$type = true;
cljs.core.async.impl.channels.t14398.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14398";
cljs.core.async.impl.channels.t14398.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t14398");
});
cljs.core.async.impl.channels.t14398.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14398.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14400){var self__ = this;
var _14400__$1 = this;return self__.meta14399;
});
cljs.core.async.impl.channels.t14398.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14400,meta14399__$1){var self__ = this;
var _14400__$1 = this;return (new cljs.core.async.impl.channels.t14398(self__.val,self__.box,meta14399__$1));
});
cljs.core.async.impl.channels.__GT_t14398 = (function __GT_t14398(val__$1,box__$1,meta14399){return (new cljs.core.async.impl.channels.t14398(val__$1,box__$1,meta14399));
});
}
return (new cljs.core.async.impl.channels.t14398(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14401 = self__.takes.pop();if((taker_14401 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14401))
{var take_cb_14402 = cljs.core.async.impl.protocols.commit.call(null,taker_14401);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14402,taker_14401){
return (function (){return take_cb_14402.call(null,null);
});})(take_cb_14402,taker_14401))
);
} else
{}
{
