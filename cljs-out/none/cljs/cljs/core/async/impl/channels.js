...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15802 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15802 = (function (val,box,meta15803){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15802.cljs$lang$type = true;
cljs.core.async.impl.channels.t15802.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15802";
cljs.core.async.impl.channels.t15802.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t15802");
});
cljs.core.async.impl.channels.t15802.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15802.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15804){var self__ = this;
var _15804__$1 = this;return self__.meta15803;
});
cljs.core.async.impl.channels.t15802.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15804,meta15803__$1){var self__ = this;
var _15804__$1 = this;return (new cljs.core.async.impl.channels.t15802(self__.val,self__.box,meta15803__$1));
});
cljs.core.async.impl.channels.__GT_t15802 = (function __GT_t15802(val__$1,box__$1,meta15803){return (new cljs.core.async.impl.channels.t15802(val__$1,box__$1,meta15803));
});
}
return (new cljs.core.async.impl.channels.t15802(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15805 = self__.takes.pop();if((taker_15805 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15805))
{var take_cb_15806 = cljs.core.async.impl.protocols.commit.call(null,taker_15805);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15806,taker_15805){
return (function (){return take_cb_15806.call(null,null);
});})(take_cb_15806,taker_15805))
);
} else
{}
{
