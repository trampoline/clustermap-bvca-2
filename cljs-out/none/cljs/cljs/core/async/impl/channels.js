...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15859 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15859 = (function (val,box,meta15860){
this.val = val;
this.box = box;
this.meta15860 = meta15860;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t15859.cljs$lang$type = true;
cljs.core.async.impl.channels.t15859.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15859";
cljs.core.async.impl.channels.t15859.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t15859");
});
cljs.core.async.impl.channels.t15859.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15859.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15861){var self__ = this;
var _15861__$1 = this;return self__.meta15860;
});
cljs.core.async.impl.channels.t15859.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15861,meta15860__$1){var self__ = this;
var _15861__$1 = this;return (new cljs.core.async.impl.channels.t15859(self__.val,self__.box,meta15860__$1));
});
cljs.core.async.impl.channels.__GT_t15859 = (function __GT_t15859(val__$1,box__$1,meta15860){return (new cljs.core.async.impl.channels.t15859(val__$1,box__$1,meta15860));
});
}
return (new cljs.core.async.impl.channels.t15859(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15862 = self__.takes.pop();if((taker_15862 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15862))
{var take_cb_15863 = cljs.core.async.impl.protocols.commit.call(null,taker_15862);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15863,taker_15862){
return (function (){return take_cb_15863.call(null,null);
});})(take_cb_15863,taker_15862))
);
} else
{}
{
