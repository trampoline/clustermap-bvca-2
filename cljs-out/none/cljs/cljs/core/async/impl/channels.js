...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14512 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14512 = (function (val,box,meta14513){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14512.cljs$lang$type = true;
cljs.core.async.impl.channels.t14512.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14512";
cljs.core.async.impl.channels.t14512.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t14512");
});
cljs.core.async.impl.channels.t14512.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14512.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14514){var self__ = this;
var _14514__$1 = this;return self__.meta14513;
});
cljs.core.async.impl.channels.t14512.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14514,meta14513__$1){var self__ = this;
var _14514__$1 = this;return (new cljs.core.async.impl.channels.t14512(self__.val,self__.box,meta14513__$1));
});
cljs.core.async.impl.channels.__GT_t14512 = (function __GT_t14512(val__$1,box__$1,meta14513){return (new cljs.core.async.impl.channels.t14512(val__$1,box__$1,meta14513));
});
}
return (new cljs.core.async.impl.channels.t14512(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14515 = self__.takes.pop();if((taker_14515 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14515))
{var take_cb_14516 = cljs.core.async.impl.protocols.commit.call(null,taker_14515);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14516,taker_14515){
return (function (){return take_cb_14516.call(null,null);
});})(take_cb_14516,taker_14515))
);
} else
{}
{
