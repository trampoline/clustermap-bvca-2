...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14192 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14192 = (function (val,box,meta14193){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14192.cljs$lang$type = true;
cljs.core.async.impl.channels.t14192.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14192";
cljs.core.async.impl.channels.t14192.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t14192");
});
cljs.core.async.impl.channels.t14192.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14192.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14194){var self__ = this;
var _14194__$1 = this;return self__.meta14193;
});
cljs.core.async.impl.channels.t14192.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14194,meta14193__$1){var self__ = this;
var _14194__$1 = this;return (new cljs.core.async.impl.channels.t14192(self__.val,self__.box,meta14193__$1));
});
cljs.core.async.impl.channels.__GT_t14192 = (function __GT_t14192(val__$1,box__$1,meta14193){return (new cljs.core.async.impl.channels.t14192(val__$1,box__$1,meta14193));
});
}
return (new cljs.core.async.impl.channels.t14192(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14195 = self__.takes.pop();if((taker_14195 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14195))
{var take_cb_14196 = cljs.core.async.impl.protocols.commit.call(null,taker_14195);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14196,taker_14195){
return (function (){return take_cb_14196.call(null,null);
});})(take_cb_14196,taker_14195))
);
} else
{}
{
