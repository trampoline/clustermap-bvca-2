...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12592 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12592 = (function (val,box,meta12593){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12592.cljs$lang$type = true;
cljs.core.async.impl.channels.t12592.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12592";
cljs.core.async.impl.channels.t12592.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t12592");
});
cljs.core.async.impl.channels.t12592.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12592.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12594){var self__ = this;
var _12594__$1 = this;return self__.meta12593;
});
cljs.core.async.impl.channels.t12592.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12594,meta12593__$1){var self__ = this;
var _12594__$1 = this;return (new cljs.core.async.impl.channels.t12592(self__.val,self__.box,meta12593__$1));
});
cljs.core.async.impl.channels.__GT_t12592 = (function __GT_t12592(val__$1,box__$1,meta12593){return (new cljs.core.async.impl.channels.t12592(val__$1,box__$1,meta12593));
});
}
return (new cljs.core.async.impl.channels.t12592(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12595 = self__.takes.pop();if((taker_12595 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12595))
{var take_cb_12596 = cljs.core.async.impl.protocols.commit.call(null,taker_12595);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12596,taker_12595){
return (function (){return take_cb_12596.call(null,null);
});})(take_cb_12596,taker_12595))
);
} else
{}
{
