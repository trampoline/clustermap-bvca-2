...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16279 = 0;while(true){
var m_16280 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16280 == null))
{} else
{m_16280.call(null);
if((count_16279 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16281 = (count_16279 + 1);
count_16279 = G__16281;
continue;
}
} else
{}
