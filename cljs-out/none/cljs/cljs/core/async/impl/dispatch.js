...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16281 = 0;while(true){
var m_16282 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16282 == null))
{} else
{m_16282.call(null);
if((count_16281 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16283 = (count_16281 + 1);
count_16281 = G__16283;
continue;
}
} else
{}
