...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15796 = 0;while(true){
var m_15797 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15797 == null))
{} else
{m_15797.call(null);
if((count_15796 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15798 = (count_15796 + 1);
count_15796 = G__15798;
continue;
}
} else
{}
