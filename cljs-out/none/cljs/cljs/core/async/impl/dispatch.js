...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16283 = 0;while(true){
var m_16284 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16284 == null))
{} else
{m_16284.call(null);
if((count_16283 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16285 = (count_16283 + 1);
count_16283 = G__16285;
continue;
}
} else
{}
