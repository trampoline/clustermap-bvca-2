...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14503 = 0;while(true){
var m_14504 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14504 == null))
{} else
{m_14504.call(null);
if((count_14503 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14505 = (count_14503 + 1);
count_14503 = G__14505;
continue;
}
} else
{}
