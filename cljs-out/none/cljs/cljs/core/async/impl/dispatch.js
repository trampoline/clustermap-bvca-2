...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18237 = (0);while(true){
var m_18238 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18238 == null))
{} else
{m_18238.call(null);
if((count_18237 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18239 = (count_18237 + (1));
count_18237 = G__18239;
continue;
}
} else
{}
