...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15776 = 0;while(true){
var m_15777 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15777 == null))
{} else
{m_15777.call(null);
if((count_15776 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15778 = (count_15776 + 1);
count_15776 = G__15778;
continue;
}
} else
{}
