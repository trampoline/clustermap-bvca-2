...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15829 = 0;while(true){
var m_15830 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15830 == null))
{} else
{m_15830.call(null);
if((count_15829 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15831 = (count_15829 + 1);
count_15829 = G__15831;
continue;
}
} else
{}
