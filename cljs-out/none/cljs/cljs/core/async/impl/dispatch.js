...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15797 = 0;while(true){
var m_15798 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15798 == null))
{} else
{m_15798.call(null);
if((count_15797 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15799 = (count_15797 + 1);
count_15797 = G__15799;
continue;
}
} else
{}
