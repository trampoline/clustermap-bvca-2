...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15673 = 0;while(true){
var m_15674 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15674 == null))
{} else
{m_15674.call(null);
if((count_15673 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15675 = (count_15673 + 1);
count_15673 = G__15675;
continue;
}
} else
{}
