...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15054 = 0;while(true){
var m_15055 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15055 == null))
{} else
{m_15055.call(null);
if((count_15054 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15056 = (count_15054 + 1);
count_15054 = G__15056;
continue;
}
} else
{}
