...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_27669 = 0;while(true){
var m_27670 = cljs.core.async.impl.dispatch.tasks.pop();if((m_27670 == null))
{} else
{m_27670.call(null);
if((count_27669 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__27671 = (count_27669 + 1);
count_27669 = G__27671;
continue;
}
} else
{}
