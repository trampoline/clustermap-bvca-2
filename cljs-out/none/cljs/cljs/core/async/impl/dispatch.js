...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_53514 = (0);while(true){
var m_53515 = cljs.core.async.impl.dispatch.tasks.pop();if((m_53515 == null))
{} else
{m_53515.call(null);
if((count_53514 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__53516 = (count_53514 + (1));
count_53514 = G__53516;
continue;
}
} else
{}
