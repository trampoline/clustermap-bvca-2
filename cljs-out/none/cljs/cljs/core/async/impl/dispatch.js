...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_63322 = (0);while(true){
var m_63323 = cljs.core.async.impl.dispatch.tasks.pop();if((m_63323 == null))
{} else
{m_63323.call(null);
if((count_63322 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__63324 = (count_63322 + (1));
count_63322 = G__63324;
continue;
}
} else
{}
