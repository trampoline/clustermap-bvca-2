...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15086 = 0;while(true){
if((i_15086 < arr.length))
{(arr[i_15086] = null);
{
...
{var i_15093 = (self__.level + 1);while(true){
if((i_15093 <= (new_level + 1)))
{(update[i_15093] = self__.header);
{
var G__15094 = (i_15093 + 1);
i_15093 = G__15094;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15095 = 0;while(true){
if((i_15095 <= self__.level))
{var links_15096 = (update[i_15095]).forward;if(((links_15096[i_15095]) === x__$1))
{(links_15096[i_15095] = (x__$1.forward[i_15095]));
{
var G__15097 = (i_15095 + 1);
i_15095 = G__15097;
continue;
}
} else
{{
var G__15098 = (i_15095 + 1);
i_15095 = G__15098;
continue;
}
}
