...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15651 = 0;while(true){
if((i_15651 < arr.length))
{(arr[i_15651] = null);
{
var G__15652 = (i_15651 + 1);
i_15651 = G__15652;
continue;
}
} else
...
{var i_15658 = (self__.level + 1);while(true){
if((i_15658 <= (new_level + 1)))
{(update[i_15658] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15660 = 0;while(true){
if((i_15660 <= self__.level))
{var links_15661 = (update[i_15660]).forward;if(((links_15661[i_15660]) === x__$1))
{(links_15661[i_15660] = (x__$1.forward[i_15660]));
{
var G__15662 = (i_15660 + 1);
i_15660 = G__15662;
continue;
}
} else
{{
var G__15663 = (i_15660 + 1);
i_15660 = G__15663;
continue;
}
}
