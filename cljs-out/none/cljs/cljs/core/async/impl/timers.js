...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14501 = 0;while(true){
if((i_14501 < arr.length))
{(arr[i_14501] = null);
{
var G__14502 = (i_14501 + 1);
i_14501 = G__14502;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14508 = (self__.level + 1);while(true){
if((i_14508 <= (new_level + 1)))
{(update[i_14508] = self__.header);
{
var G__14509 = (i_14508 + 1);
i_14508 = G__14509;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14510 = 0;while(true){
if((i_14510 <= self__.level))
{var links_14511 = (update[i_14510]).forward;if(((links_14511[i_14510]) === x__$1))
{(links_14511[i_14510] = (x__$1.forward[i_14510]));
{
var G__14512 = (i_14510 + 1);
i_14510 = G__14512;
continue;
}
} else
{{
var G__14513 = (i_14510 + 1);
i_14510 = G__14513;
continue;
}
}
