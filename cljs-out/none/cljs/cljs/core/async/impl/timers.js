...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8467__auto__,writer__8468__auto__,opt__8469__auto__){return cljs.core._write.call(null,writer__8468__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_25945 = (0);while(true){
if((i_25945 < arr.length))
{(arr[i_25945] = null);
{
var G__25946 = (i_25945 + (1));
i_25945 = G__25946;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8467__auto__,writer__8468__auto__,opt__8469__auto__){return cljs.core._write.call(null,writer__8468__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_25952 = (self__.level + (1));while(true){
if((i_25952 <= (new_level + (1))))
{(update[i_25952] = self__.header);
{
var G__25953 = (i_25952 + (1));
i_25952 = G__25953;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_25954 = (0);while(true){
if((i_25954 <= self__.level))
{var links_25955 = (update[i_25954]).forward;if(((links_25955[i_25954]) === x__$1))
{(links_25955[i_25954] = (x__$1.forward[i_25954]));
{
var G__25956 = (i_25954 + (1));
i_25954 = G__25956;
continue;
}
} else
{{
var G__25957 = (i_25954 + (1));
i_25954 = G__25957;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7900__auto__ = (cljs.core.truth_((function (){var and__7888__auto__ = me;if(cljs.core.truth_(and__7888__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7888__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7900__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7900__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7900__auto__,timeout__$1,me))
,msecs);
