...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj27826 = {};return obj27826;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7888__auto__ = this$;if(and__7888__auto__)
...
{var x__8527__auto__ = (((this$ == null))?null:this$);return (function (){var or__7900__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8527__auto__)]);if(or__7900__auto__)
{return or__7900__auto__;
} else
{var or__7900__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7900__auto____$1)
...
return (function (p__27827){var vec__27828 = p__27827;var k = cljs.core.nth.call(null,vec__27828,(0),null);var v = cljs.core.nth.call(null,vec__27828,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__27829){var vec__27830 = p__27829;var k = cljs.core.nth.call(null,vec__27830,(0),null);var v = cljs.core.nth.call(null,vec__27830,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
