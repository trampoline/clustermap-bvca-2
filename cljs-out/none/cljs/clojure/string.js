...
{{
var G__13573 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13573;
continue;
}
} else
...
{var pred__13577 = cljs.core._EQ_;var expr__13578 = limit;if(cljs.core.truth_(pred__13577.call(null,1,expr__13578)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13577.call(null,2,expr__13578)))
...
var G__13580 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13581 = (limit__$1 - 1);
var G__13582 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13580;
limit__$1 = G__13581;
parts = G__13582;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13584 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13584))
{var replacement_13585 = temp__4090__auto___13584;buffer.append([cljs.core.str(replacement_13585)].join(''));
} else
{buffer.append(ch);
}
{
var G__13586 = (index + 1);
index = G__13586;
continue;
}
}
