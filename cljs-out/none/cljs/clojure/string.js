...
{{
var G__13093 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13093;
continue;
}
} else
...
{var pred__13097 = cljs.core._EQ_;var expr__13098 = limit;if(cljs.core.truth_(pred__13097.call(null,1,expr__13098)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13097.call(null,2,expr__13098)))
...
var G__13100 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13101 = (limit__$1 - 1);
var G__13102 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13100;
limit__$1 = G__13101;
parts = G__13102;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13104 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13104))
{var replacement_13105 = temp__4090__auto___13104;buffer.append([cljs.core.str(replacement_13105)].join(''));
} else
{buffer.append(ch);
}
{
var G__13106 = (index + 1);
index = G__13106;
continue;
}
}
