...
{{
var G__13701 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13701;
continue;
}
} else
...
{var pred__13705 = cljs.core._EQ_;var expr__13706 = limit;if(cljs.core.truth_(pred__13705.call(null,1,expr__13706)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13705.call(null,2,expr__13706)))
...
var G__13708 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13709 = (limit__$1 - 1);
var G__13710 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13708;
limit__$1 = G__13709;
parts = G__13710;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13712 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13712))
{var replacement_13713 = temp__4090__auto___13712;buffer.append([cljs.core.str(replacement_13713)].join(''));
} else
{buffer.append(ch);
}
{
var G__13714 = (index + 1);
index = G__13714;
continue;
}
}
