...
{{
var G__55095 = cljs.core.pop.call(null,v__$1);
v__$1 = G__55095;
continue;
}
} else
...
{var pred__55099 = cljs.core._EQ_;var expr__55100 = limit;if(cljs.core.truth_(pred__55099.call(null,(1),expr__55100)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__55099.call(null,(2),expr__55100)))
...
var G__55102 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__55103 = (limit__$1 - (1));
var G__55104 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__55102;
limit__$1 = G__55103;
parts = G__55104;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___55106 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___55106))
{var replacement_55107 = temp__4124__auto___55106;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_55107)));
} else
{buffer.append(ch);
}
{
var G__55108 = (index + (1));
index = G__55108;
continue;
}
}
