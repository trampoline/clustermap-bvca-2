...
{{
var G__11894 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11894;
continue;
}
} else
...
{var pred__11898 = cljs.core._EQ_;var expr__11899 = limit;if(cljs.core.truth_(pred__11898.call(null,1,expr__11899)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11898.call(null,2,expr__11899)))
...
var G__11901 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11902 = (limit__$1 - 1);
var G__11903 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11901;
limit__$1 = G__11902;
parts = G__11903;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11905 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11905))
{var replacement_11906 = temp__4090__auto___11905;buffer.append([cljs.core.str(replacement_11906)].join(''));
} else
{buffer.append(ch);
}
{
var G__11907 = (index + 1);
index = G__11907;
continue;
}
}
