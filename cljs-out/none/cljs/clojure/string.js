...
{{
var G__13004 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13004;
continue;
}
} else
...
{var pred__13008 = cljs.core._EQ_;var expr__13009 = limit;if(cljs.core.truth_(pred__13008.call(null,1,expr__13009)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13008.call(null,2,expr__13009)))
...
var G__13011 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13012 = (limit__$1 - 1);
var G__13013 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13011;
limit__$1 = G__13012;
parts = G__13013;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13015 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13015))
{var replacement_13016 = temp__4090__auto___13015;buffer.append([cljs.core.str(replacement_13016)].join(''));
} else
{buffer.append(ch);
}
{
