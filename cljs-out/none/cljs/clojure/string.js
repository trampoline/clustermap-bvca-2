...
{{
var G__11987 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11987;
continue;
}
} else
...
{var pred__11991 = cljs.core._EQ_;var expr__11992 = limit;if(cljs.core.truth_(pred__11991.call(null,1,expr__11992)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11991.call(null,2,expr__11992)))
...
var G__11994 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11995 = (limit__$1 - 1);
var G__11996 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11994;
limit__$1 = G__11995;
parts = G__11996;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11998 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11998))
{var replacement_11999 = temp__4090__auto___11998;buffer.append([cljs.core.str(replacement_11999)].join(''));
} else
{buffer.append(ch);
}
{
var G__12000 = (index + 1);
index = G__12000;
continue;
}
}
