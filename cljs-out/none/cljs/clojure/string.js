...
{{
var G__28050 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28050;
continue;
}
} else
...
{var pred__28054 = cljs.core._EQ_;var expr__28055 = limit;if(cljs.core.truth_(pred__28054.call(null,1,expr__28055)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__28054.call(null,2,expr__28055)))
...
var G__28057 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28058 = (limit__$1 - 1);
var G__28059 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28057;
limit__$1 = G__28058;
parts = G__28059;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___28061 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___28061))
{var replacement_28062 = temp__4124__auto___28061;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_28062)));
} else
{buffer.append(ch);
}
{
var G__28063 = (index + 1);
index = G__28063;
continue;
}
}
