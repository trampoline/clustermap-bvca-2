...
{{
var G__12935 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12935;
continue;
}
} else
...
{var pred__12939 = cljs.core._EQ_;var expr__12940 = limit;if(cljs.core.truth_(pred__12939.call(null,1,expr__12940)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12939.call(null,2,expr__12940)))
...
var G__12942 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12943 = (limit__$1 - 1);
var G__12944 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12942;
limit__$1 = G__12943;
parts = G__12944;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12946 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12946))
{var replacement_12947 = temp__4090__auto___12946;buffer.append([cljs.core.str(replacement_12947)].join(''));
} else
{buffer.append(ch);
}
{
