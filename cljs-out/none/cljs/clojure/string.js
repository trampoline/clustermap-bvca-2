...
{{
var G__11904 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11904;
continue;
}
} else
...
{var pred__11908 = cljs.core._EQ_;var expr__11909 = limit;if(cljs.core.truth_(pred__11908.call(null,1,expr__11909)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11908.call(null,2,expr__11909)))
...
var G__11911 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11912 = (limit__$1 - 1);
var G__11913 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11911;
limit__$1 = G__11912;
parts = G__11913;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11915 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11915))
{var replacement_11916 = temp__4090__auto___11915;buffer.append([cljs.core.str(replacement_11916)].join(''));
} else
{buffer.append(ch);
}
{
var G__11917 = (index + 1);
index = G__11917;
continue;
}
}
