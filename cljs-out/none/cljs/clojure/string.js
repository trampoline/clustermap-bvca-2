...
{{
var G__13689 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13689;
continue;
}
} else
...
{var pred__13693 = cljs.core._EQ_;var expr__13694 = limit;if(cljs.core.truth_(pred__13693.call(null,1,expr__13694)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13693.call(null,2,expr__13694)))
...
var G__13696 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13697 = (limit__$1 - 1);
var G__13698 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13696;
limit__$1 = G__13697;
parts = G__13698;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13700 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13700))
{var replacement_13701 = temp__4090__auto___13700;buffer.append([cljs.core.str(replacement_13701)].join(''));
} else
{buffer.append(ch);
}
{
var G__13702 = (index + 1);
index = G__13702;
continue;
}
}
