...
{{
var G__14748 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14748;
continue;
}
} else
...
{var pred__14752 = cljs.core._EQ_;var expr__14753 = limit;if(cljs.core.truth_(pred__14752.call(null,1,expr__14753)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14752.call(null,2,expr__14753)))
...
var G__14755 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14756 = (limit__$1 - 1);
var G__14757 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14755;
limit__$1 = G__14756;
parts = G__14757;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14759 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14759))
{var replacement_14760 = temp__4090__auto___14759;buffer.append([cljs.core.str(replacement_14760)].join(''));
} else
{buffer.append(ch);
}
{
var G__14761 = (index + 1);
index = G__14761;
continue;
}
}
