...
{{
var G__13955 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13955;
continue;
}
} else
...
{var pred__13959 = cljs.core._EQ_;var expr__13960 = limit;if(cljs.core.truth_(pred__13959.call(null,1,expr__13960)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13959.call(null,2,expr__13960)))
...
var G__13962 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13963 = (limit__$1 - 1);
var G__13964 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13962;
limit__$1 = G__13963;
parts = G__13964;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13966 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13966))
{var replacement_13967 = temp__4090__auto___13966;buffer.append([cljs.core.str(replacement_13967)].join(''));
} else
{buffer.append(ch);
}
{
var G__13968 = (index + 1);
index = G__13968;
continue;
}
}
