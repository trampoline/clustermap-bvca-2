...
{{
var G__13225 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13225;
continue;
}
} else
...
{var pred__13229 = cljs.core._EQ_;var expr__13230 = limit;if(cljs.core.truth_(pred__13229.call(null,1,expr__13230)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13229.call(null,2,expr__13230)))
...
var G__13232 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13233 = (limit__$1 - 1);
var G__13234 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13232;
limit__$1 = G__13233;
parts = G__13234;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13236 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13236))
{var replacement_13237 = temp__4090__auto___13236;buffer.append([cljs.core.str(replacement_13237)].join(''));
} else
{buffer.append(ch);
}
{
var G__13238 = (index + 1);
index = G__13238;
continue;
}
}
