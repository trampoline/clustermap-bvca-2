...
{{
var G__12517 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12517;
continue;
}
} else
...
{var pred__12521 = cljs.core._EQ_;var expr__12522 = limit;if(cljs.core.truth_(pred__12521.call(null,1,expr__12522)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12521.call(null,2,expr__12522)))
...
var G__12524 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12525 = (limit__$1 - 1);
var G__12526 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12524;
limit__$1 = G__12525;
parts = G__12526;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12528 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12528))
{var replacement_12529 = temp__4090__auto___12528;buffer.append([cljs.core.str(replacement_12529)].join(''));
} else
{buffer.append(ch);
}
{
var G__12530 = (index + 1);
index = G__12530;
continue;
}
}
