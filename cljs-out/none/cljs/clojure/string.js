...
{{
var G__12399 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12399;
continue;
}
} else
...
{var pred__12403 = cljs.core._EQ_;var expr__12404 = limit;if(cljs.core.truth_(pred__12403.call(null,1,expr__12404)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12403.call(null,2,expr__12404)))
...
var G__12406 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12407 = (limit__$1 - 1);
var G__12408 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12406;
limit__$1 = G__12407;
parts = G__12408;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12410 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12410))
{var replacement_12411 = temp__4090__auto___12410;buffer.append([cljs.core.str(replacement_12411)].join(''));
} else
{buffer.append(ch);
}
{
var G__12412 = (index + 1);
index = G__12412;
continue;
}
}
