...
{{
var G__12751 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12751;
continue;
}
} else
...
{var pred__12755 = cljs.core._EQ_;var expr__12756 = limit;if(cljs.core.truth_(pred__12755.call(null,1,expr__12756)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12755.call(null,2,expr__12756)))
...
var G__12758 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12759 = (limit__$1 - 1);
var G__12760 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12758;
limit__$1 = G__12759;
parts = G__12760;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12762 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12762))
{var replacement_12763 = temp__4090__auto___12762;buffer.append([cljs.core.str(replacement_12763)].join(''));
} else
{buffer.append(ch);
}
{
var G__12764 = (index + 1);
index = G__12764;
continue;
}
}
