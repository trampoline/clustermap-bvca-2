...
{{
var G__12712 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12712;
continue;
}
} else
...
{var pred__12716 = cljs.core._EQ_;var expr__12717 = limit;if(cljs.core.truth_(pred__12716.call(null,1,expr__12717)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12716.call(null,2,expr__12717)))
...
var G__12719 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12720 = (limit__$1 - 1);
var G__12721 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12719;
limit__$1 = G__12720;
parts = G__12721;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12723 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12723))
{var replacement_12724 = temp__4090__auto___12723;buffer.append([cljs.core.str(replacement_12724)].join(''));
} else
{buffer.append(ch);
}
{
var G__12725 = (index + 1);
index = G__12725;
continue;
}
}
