...
{{
var G__25065 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25065;
continue;
}
} else
...
{var pred__25069 = cljs.core._EQ_;var expr__25070 = limit;if(cljs.core.truth_(pred__25069.call(null,1,expr__25070)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__25069.call(null,2,expr__25070)))
...
var G__25072 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25073 = (limit__$1 - 1);
var G__25074 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25072;
limit__$1 = G__25073;
parts = G__25074;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___25076 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___25076))
{var replacement_25077 = temp__4090__auto___25076;buffer.append([cljs.core.str(replacement_25077)].join(''));
} else
{buffer.append(ch);
}
{
var G__25078 = (index + 1);
index = G__25078;
continue;
}
}
