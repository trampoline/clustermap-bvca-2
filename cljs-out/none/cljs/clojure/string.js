...
{{
var G__13511 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13511;
continue;
}
} else
...
{var pred__13515 = cljs.core._EQ_;var expr__13516 = limit;if(cljs.core.truth_(pred__13515.call(null,1,expr__13516)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13515.call(null,2,expr__13516)))
...
var G__13518 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13519 = (limit__$1 - 1);
var G__13520 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13518;
limit__$1 = G__13519;
parts = G__13520;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13522 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13522))
{var replacement_13523 = temp__4090__auto___13522;buffer.append([cljs.core.str(replacement_13523)].join(''));
} else
{buffer.append(ch);
}
{
var G__13524 = (index + 1);
index = G__13524;
continue;
}
}
