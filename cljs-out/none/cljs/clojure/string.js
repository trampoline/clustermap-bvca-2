...
{{
var G__13675 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13675;
continue;
}
} else
...
{var pred__13679 = cljs.core._EQ_;var expr__13680 = limit;if(cljs.core.truth_(pred__13679.call(null,1,expr__13680)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13679.call(null,2,expr__13680)))
...
var G__13682 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13683 = (limit__$1 - 1);
var G__13684 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13682;
limit__$1 = G__13683;
parts = G__13684;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13686 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13686))
{var replacement_13687 = temp__4090__auto___13686;buffer.append([cljs.core.str(replacement_13687)].join(''));
} else
{buffer.append(ch);
}
{
var G__13688 = (index + 1);
index = G__13688;
continue;
}
}
