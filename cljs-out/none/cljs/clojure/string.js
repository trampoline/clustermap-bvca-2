...
{{
var G__54533 = cljs.core.pop.call(null,v__$1);
v__$1 = G__54533;
continue;
}
} else
...
{var pred__54537 = cljs.core._EQ_;var expr__54538 = limit;if(cljs.core.truth_(pred__54537.call(null,(1),expr__54538)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__54537.call(null,(2),expr__54538)))
...
var G__54540 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__54541 = (limit__$1 - (1));
var G__54542 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__54540;
limit__$1 = G__54541;
parts = G__54542;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___54544 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___54544))
{var replacement_54545 = temp__4124__auto___54544;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_54545)));
} else
{buffer.append(ch);
}
{
var G__54546 = (index + (1));
index = G__54546;
continue;
}
}
