...
{{
var G__13681 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13681;
continue;
}
} else
...
{var pred__13685 = cljs.core._EQ_;var expr__13686 = limit;if(cljs.core.truth_(pred__13685.call(null,1,expr__13686)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13685.call(null,2,expr__13686)))
...
var G__13688 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13689 = (limit__$1 - 1);
var G__13690 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13688;
limit__$1 = G__13689;
parts = G__13690;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13692 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13692))
{var replacement_13693 = temp__4090__auto___13692;buffer.append([cljs.core.str(replacement_13693)].join(''));
} else
{buffer.append(ch);
}
{
var G__13694 = (index + 1);
index = G__13694;
continue;
}
}
