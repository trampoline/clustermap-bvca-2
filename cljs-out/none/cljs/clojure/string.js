...
{{
var G__13249 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13249;
continue;
}
} else
...
{var pred__13253 = cljs.core._EQ_;var expr__13254 = limit;if(cljs.core.truth_(pred__13253.call(null,1,expr__13254)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13253.call(null,2,expr__13254)))
...
var G__13256 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13257 = (limit__$1 - 1);
var G__13258 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13256;
limit__$1 = G__13257;
parts = G__13258;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13260 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13260))
{var replacement_13261 = temp__4090__auto___13260;buffer.append([cljs.core.str(replacement_13261)].join(''));
} else
{buffer.append(ch);
}
{
