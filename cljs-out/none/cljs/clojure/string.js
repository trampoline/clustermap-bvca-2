...
{{
var G__13099 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13099;
continue;
}
} else
...
{var pred__13103 = cljs.core._EQ_;var expr__13104 = limit;if(cljs.core.truth_(pred__13103.call(null,1,expr__13104)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13103.call(null,2,expr__13104)))
...
var G__13106 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13107 = (limit__$1 - 1);
var G__13108 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13106;
limit__$1 = G__13107;
parts = G__13108;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13110 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13110))
{var replacement_13111 = temp__4090__auto___13110;buffer.append([cljs.core.str(replacement_13111)].join(''));
} else
{buffer.append(ch);
}
{
var G__13112 = (index + 1);
index = G__13112;
continue;
}
}
