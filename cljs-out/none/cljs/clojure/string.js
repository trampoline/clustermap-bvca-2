...
{{
var G__12450 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12450;
continue;
}
} else
...
{var pred__12454 = cljs.core._EQ_;var expr__12455 = limit;if(cljs.core.truth_(pred__12454.call(null,1,expr__12455)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12454.call(null,2,expr__12455)))
...
var G__12457 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12458 = (limit__$1 - 1);
var G__12459 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12457;
limit__$1 = G__12458;
parts = G__12459;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12461 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12461))
{var replacement_12462 = temp__4090__auto___12461;buffer.append([cljs.core.str(replacement_12462)].join(''));
} else
{buffer.append(ch);
}
{
var G__12463 = (index + 1);
index = G__12463;
continue;
}
}
