...
{{
var G__58384 = cljs.core.pop.call(null,v__$1);
v__$1 = G__58384;
continue;
}
} else
...
{var pred__58388 = cljs.core._EQ_;var expr__58389 = limit;if(cljs.core.truth_(pred__58388.call(null,(1),expr__58389)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__58388.call(null,(2),expr__58389)))
...
var G__58391 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__58392 = (limit__$1 - (1));
var G__58393 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__58391;
limit__$1 = G__58392;
parts = G__58393;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___58395 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___58395))
{var replacement_58396 = temp__4124__auto___58395;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_58396)));
} else
{buffer.append(ch);
}
{
var G__58397 = (index + (1));
index = G__58397;
continue;
}
}
