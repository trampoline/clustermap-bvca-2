...
{{
var G__24985 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24985;
continue;
}
} else
...
{var pred__24989 = cljs.core._EQ_;var expr__24990 = limit;if(cljs.core.truth_(pred__24989.call(null,1,expr__24990)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24989.call(null,2,expr__24990)))
...
var G__24992 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24993 = (limit__$1 - 1);
var G__24994 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24992;
limit__$1 = G__24993;
parts = G__24994;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24996 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24996))
{var replacement_24997 = temp__4090__auto___24996;buffer.append([cljs.core.str(replacement_24997)].join(''));
} else
{buffer.append(ch);
}
{
var G__24998 = (index + 1);
index = G__24998;
continue;
}
}
