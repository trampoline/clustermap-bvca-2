...
{{
var G__89349 = cljs.core.pop.call(null,v__$1);
v__$1 = G__89349;
continue;
}
} else
...
{var pred__89353 = cljs.core._EQ_;var expr__89354 = limit;if(cljs.core.truth_(pred__89353.call(null,(1),expr__89354)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__89353.call(null,(2),expr__89354)))
...
var G__89356 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__89357 = (limit__$1 - (1));
var G__89358 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__89356;
limit__$1 = G__89357;
parts = G__89358;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___89360 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___89360))
{var replacement_89361 = temp__4124__auto___89360;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_89361)));
} else
{buffer.append(ch);
}
{
var G__89362 = (index + (1));
index = G__89362;
continue;
}
}
