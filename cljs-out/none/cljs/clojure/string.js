...
{{
var G__55896 = cljs.core.pop.call(null,v__$1);
v__$1 = G__55896;
continue;
}
} else
...
{var pred__55900 = cljs.core._EQ_;var expr__55901 = limit;if(cljs.core.truth_(pred__55900.call(null,(1),expr__55901)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__55900.call(null,(2),expr__55901)))
...
var G__55903 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__55904 = (limit__$1 - (1));
var G__55905 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__55903;
limit__$1 = G__55904;
parts = G__55905;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___55907 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___55907))
{var replacement_55908 = temp__4124__auto___55907;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_55908)));
} else
{buffer.append(ch);
}
{
var G__55909 = (index + (1));
index = G__55909;
continue;
}
}
