...
{{
var G__14813 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14813;
continue;
}
} else
...
{var pred__14817 = cljs.core._EQ_;var expr__14818 = limit;if(cljs.core.truth_(pred__14817.call(null,1,expr__14818)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14817.call(null,2,expr__14818)))
...
var G__14820 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14821 = (limit__$1 - 1);
var G__14822 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14820;
limit__$1 = G__14821;
parts = G__14822;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14824 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14824))
{var replacement_14825 = temp__4090__auto___14824;buffer.append([cljs.core.str(replacement_14825)].join(''));
} else
{buffer.append(ch);
}
{
var G__14826 = (index + 1);
index = G__14826;
continue;
}
}
