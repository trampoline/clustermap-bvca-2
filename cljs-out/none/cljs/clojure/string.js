...
{{
var G__18248 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18248;
continue;
}
} else
...
{var pred__18252 = cljs.core._EQ_;var expr__18253 = limit;if(cljs.core.truth_(pred__18252.call(null,(1),expr__18253)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18252.call(null,(2),expr__18253)))
...
{var ch = s.charAt(index);var temp__4124__auto___18259 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___18259))
{var replacement_18260 = temp__4124__auto___18259;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_18260)));
} else
{buffer.append(ch);
}
{
var G__18261 = (index + (1));
index = G__18261;
continue;
}
}
