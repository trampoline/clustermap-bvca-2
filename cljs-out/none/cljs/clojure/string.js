...
{{
var G__13239 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13239;
continue;
}
} else
...
{var pred__13243 = cljs.core._EQ_;var expr__13244 = limit;if(cljs.core.truth_(pred__13243.call(null,1,expr__13244)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13243.call(null,2,expr__13244)))
...
var G__13246 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13247 = (limit__$1 - 1);
var G__13248 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13246;
limit__$1 = G__13247;
parts = G__13248;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13250 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13250))
{var replacement_13251 = temp__4090__auto___13250;buffer.append([cljs.core.str(replacement_13251)].join(''));
} else
{buffer.append(ch);
}
{
var G__13252 = (index + 1);
index = G__13252;
continue;
}
}
