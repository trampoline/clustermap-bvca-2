...
{{
var G__55800 = cljs.core.pop.call(null,v__$1);
v__$1 = G__55800;
continue;
}
} else
...
{var pred__55804 = cljs.core._EQ_;var expr__55805 = limit;if(cljs.core.truth_(pred__55804.call(null,(1),expr__55805)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__55804.call(null,(2),expr__55805)))
...
var G__55807 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__55808 = (limit__$1 - (1));
var G__55809 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__55807;
limit__$1 = G__55808;
parts = G__55809;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___55811 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___55811))
{var replacement_55812 = temp__4124__auto___55811;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_55812)));
} else
{buffer.append(ch);
}
{
var G__55813 = (index + (1));
index = G__55813;
continue;
}
}
