...
{{
var G__24881 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24881;
continue;
}
} else
...
{var pred__24885 = cljs.core._EQ_;var expr__24886 = limit;if(cljs.core.truth_(pred__24885.call(null,1,expr__24886)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24885.call(null,2,expr__24886)))
...
var G__24888 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24889 = (limit__$1 - 1);
var G__24890 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24888;
limit__$1 = G__24889;
parts = G__24890;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24892 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24892))
{var replacement_24893 = temp__4090__auto___24892;buffer.append([cljs.core.str(replacement_24893)].join(''));
} else
{buffer.append(ch);
}
{
var G__24894 = (index + 1);
index = G__24894;
continue;
}
}
