...
{{
var G__13549 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13549;
continue;
}
} else
...
{var pred__13553 = cljs.core._EQ_;var expr__13554 = limit;if(cljs.core.truth_(pred__13553.call(null,1,expr__13554)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13553.call(null,2,expr__13554)))
...
var G__13556 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13557 = (limit__$1 - 1);
var G__13558 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13556;
limit__$1 = G__13557;
parts = G__13558;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13560 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13560))
{var replacement_13561 = temp__4090__auto___13560;buffer.append([cljs.core.str(replacement_13561)].join(''));
} else
{buffer.append(ch);
}
{
var G__13562 = (index + 1);
index = G__13562;
continue;
}
}
