...
{{
var G__26049 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26049;
continue;
}
} else
...
{var pred__26053 = cljs.core._EQ_;var expr__26054 = limit;if(cljs.core.truth_(pred__26053.call(null,(1),expr__26054)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26053.call(null,(2),expr__26054)))
...
var G__26056 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26057 = (limit__$1 - (1));
var G__26058 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__26056;
limit__$1 = G__26057;
parts = G__26058;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___26060 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___26060))
{var replacement_26061 = temp__4124__auto___26060;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_26061)));
} else
{buffer.append(ch);
}
{
var G__26062 = (index + (1));
index = G__26062;
continue;
}
}
