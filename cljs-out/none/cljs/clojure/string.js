...
{var pred__14847 = cljs.core._EQ_;var expr__14848 = limit;if(cljs.core.truth_(pred__14847.call(null,1,expr__14848)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14847.call(null,2,expr__14848)))
...
{var ch = s.charAt(index);var temp__4090__auto___14854 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14854))
{var replacement_14855 = temp__4090__auto___14854;buffer.append([cljs.core.str(replacement_14855)].join(''));
} else
{buffer.append(ch);
}
{
var G__14856 = (index + 1);
index = G__14856;
continue;
}
}
