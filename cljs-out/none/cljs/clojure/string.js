...
{{
var G__19541 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19541;
continue;
}
} else
...
{var pred__19545 = cljs.core._EQ_;var expr__19546 = limit;if(cljs.core.truth_(pred__19545.call(null,1,expr__19546)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__19545.call(null,2,expr__19546)))
...
var G__19548 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19549 = (limit__$1 - 1);
var G__19550 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19548;
limit__$1 = G__19549;
parts = G__19550;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___19552 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___19552))
{var replacement_19553 = temp__4090__auto___19552;buffer.append([cljs.core.str(replacement_19553)].join(''));
} else
{buffer.append(ch);
}
{
var G__19554 = (index + 1);
index = G__19554;
continue;
}
}
