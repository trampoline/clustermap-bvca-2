...
{{
var G__13575 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13575;
continue;
}
} else
...
{var pred__13579 = cljs.core._EQ_;var expr__13580 = limit;if(cljs.core.truth_(pred__13579.call(null,1,expr__13580)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13579.call(null,2,expr__13580)))
...
var G__13582 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13583 = (limit__$1 - 1);
var G__13584 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13582;
limit__$1 = G__13583;
parts = G__13584;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13586 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13586))
{var replacement_13587 = temp__4090__auto___13586;buffer.append([cljs.core.str(replacement_13587)].join(''));
} else
{buffer.append(ch);
}
{
var G__13588 = (index + 1);
index = G__13588;
continue;
}
}
