...
{{
var G__13080 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13080;
continue;
}
} else
...
{var pred__13084 = cljs.core._EQ_;var expr__13085 = limit;if(cljs.core.truth_(pred__13084.call(null,1,expr__13085)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13084.call(null,2,expr__13085)))
...
var G__13087 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13088 = (limit__$1 - 1);
var G__13089 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13087;
limit__$1 = G__13088;
parts = G__13089;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13091 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13091))
{var replacement_13092 = temp__4090__auto___13091;buffer.append([cljs.core.str(replacement_13092)].join(''));
} else
{buffer.append(ch);
}
{
var G__13093 = (index + 1);
index = G__13093;
continue;
}
}
