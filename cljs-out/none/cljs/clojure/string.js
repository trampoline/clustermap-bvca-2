...
{{
var G__25017 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25017;
continue;
}
} else
...
{var pred__25021 = cljs.core._EQ_;var expr__25022 = limit;if(cljs.core.truth_(pred__25021.call(null,1,expr__25022)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__25021.call(null,2,expr__25022)))
...
var G__25024 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25025 = (limit__$1 - 1);
var G__25026 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25024;
limit__$1 = G__25025;
parts = G__25026;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___25028 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___25028))
{var replacement_25029 = temp__4090__auto___25028;buffer.append([cljs.core.str(replacement_25029)].join(''));
} else
{buffer.append(ch);
}
{
var G__25030 = (index + 1);
index = G__25030;
continue;
}
}
