...
{{
var G__13192 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13192;
continue;
}
} else
...
{var pred__13196 = cljs.core._EQ_;var expr__13197 = limit;if(cljs.core.truth_(pred__13196.call(null,1,expr__13197)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13196.call(null,2,expr__13197)))
...
var G__13199 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13200 = (limit__$1 - 1);
var G__13201 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13199;
limit__$1 = G__13200;
parts = G__13201;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13203 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13203))
{var replacement_13204 = temp__4090__auto___13203;buffer.append([cljs.core.str(replacement_13204)].join(''));
} else
{buffer.append(ch);
}
{
var G__13205 = (index + 1);
index = G__13205;
continue;
}
}
