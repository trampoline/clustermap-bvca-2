...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3441__auto__ = cljs.core.some.call(null,(function (p__22973){var vec__22974 = p__22973;var z = cljs.core.nth.call(null,vec__22974,0,null);var t = cljs.core.nth.call(null,vec__22974,1,null);if(cljs.core.truth_((function (){var and__3429__auto__ = z;if(cljs.core.truth_(and__3429__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5562__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5563__auto__ = (function (){var switch__5547__auto__ = (function (state_22994){var state_val_22995 = (state_22994[1]);if((state_val_22995 === 2))
{var inst_22990 = (state_22994[2]);var inst_22991 = (function (){var bl = inst_22990;return ((function (bl,inst_22990,state_val_22995){
return (function (old){return bl;
});
;})(bl,inst_22990,state_val_22995))
})();var inst_22992 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_22991);var state_22994__$1 = state_22994;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_22994__$1,inst_22992);
} else
{if((state_val_22995 === 1))
{var state_22994__$1 = state_22994;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_22994__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5548__auto____0 = (function (){var statearr_22999 = [null,null,null,null,null,null,null];(statearr_22999[0] = state_machine__5548__auto__);
(statearr_22999[1] = 1);
return statearr_22999;
});
var state_machine__5548__auto____1 = (function (state_22994){while(true){
var ret_value__5549__auto__ = (function (){try{while(true){
var result__5550__auto__ = switch__5547__auto__.call(null,state_22994);if(cljs.core.keyword_identical_QMARK_.call(null,result__5550__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__5551__auto__ = e23000;var statearr_23001_23003 = state_22994;(statearr_23001_23003[5] = ex__5551__auto__);
...
{{
var G__23004 = state_22994;
state_22994 = G__23004;
continue;
}
} else
...
state_machine__5548__auto__ = function(state_22994){
switch(arguments.length){
case 0:
return state_machine__5548__auto____0.call(this);
case 1:
return state_machine__5548__auto____1.call(this,state_22994);
}
...
})();var state__5564__auto__ = (function (){var statearr_23002 = f__5563__auto__.call(null);(statearr_23002[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5562__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__23005){var map__23007 = p__23005;var map__23007__$1 = ((cljs.core.seq_QMARK_.call(null,map__23007))?cljs.core.apply.call(null,cljs.core.hash_map,map__23007):map__23007);var min_zoom = cljs.core.get.call(null,map__23007__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3429__auto__ = min_zoom;if(cljs.core.truth_(and__3429__auto__))
...
var p__23005 = null;if (arguments.length > 4) {
  p__23005 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__23005);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__23008){
var app_state = cljs.core.first(arglist__23008);
arglist__23008 = cljs.core.next(arglist__23008);
var korks = cljs.core.first(arglist__23008);
arglist__23008 = cljs.core.next(arglist__23008);
var boundaryline_id = cljs.core.first(arglist__23008);
arglist__23008 = cljs.core.next(arglist__23008);
var zoom = cljs.core.first(arglist__23008);
var p__23005 = cljs.core.rest(arglist__23008);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__23005);
});
