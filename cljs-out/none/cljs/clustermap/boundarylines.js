...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__11701){var vec__11702 = p__11701;var z = cljs.core.nth.call(null,vec__11702,0,null);var t = cljs.core.nth.call(null,vec__11702,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_11722){var state_val_11723 = (state_11722[1]);if((state_val_11723 === 2))
{var inst_11718 = (state_11722[2]);var inst_11719 = (function (){var bl = inst_11718;return ((function (bl,inst_11718,state_val_11723){
return (function (old){return bl;
});
;})(bl,inst_11718,state_val_11723))
})();var inst_11720 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_11719);var state_11722__$1 = state_11722;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_11722__$1,inst_11720);
} else
{if((state_val_11723 === 1))
{var state_11722__$1 = state_11722;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_11722__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_11727 = [null,null,null,null,null,null,null];(statearr_11727[0] = state_machine__5507__auto__);
(statearr_11727[1] = 1);
return statearr_11727;
});
var state_machine__5507__auto____1 = (function (state_11722){while(true){
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__.call(null,state_11722);if(cljs.core.keyword_identical_QMARK_.call(null,result__5509__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__5510__auto__ = e11728;var statearr_11729_11731 = state_11722;(statearr_11729_11731[5] = ex__5510__auto__);
...
{{
var G__11732 = state_11722;
state_11722 = G__11732;
continue;
}
} else
...
state_machine__5507__auto__ = function(state_11722){
switch(arguments.length){
case 0:
return state_machine__5507__auto____0.call(this);
case 1:
return state_machine__5507__auto____1.call(this,state_11722);
}
...
})();var state__5523__auto__ = (function (){var statearr_11730 = f__5522__auto__.call(null);(statearr_11730[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__11733){var map__11735 = p__11733;var map__11735__$1 = ((cljs.core.seq_QMARK_.call(null,map__11735))?cljs.core.apply.call(null,cljs.core.hash_map,map__11735):map__11735);var min_zoom = cljs.core.get.call(null,map__11735__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
...
var p__11733 = null;if (arguments.length > 4) {
  p__11733 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__11733);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__11736){
var app_state = cljs.core.first(arglist__11736);
arglist__11736 = cljs.core.next(arglist__11736);
var korks = cljs.core.first(arglist__11736);
arglist__11736 = cljs.core.next(arglist__11736);
var boundaryline_id = cljs.core.first(arglist__11736);
arglist__11736 = cljs.core.next(arglist__11736);
var zoom = cljs.core.first(arglist__11736);
var p__11733 = cljs.core.rest(arglist__11736);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__11733);
});
