...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__11650){var vec__11651 = p__11650;var z = cljs.core.nth.call(null,vec__11651,0,null);var t = cljs.core.nth.call(null,vec__11651,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_11671){var state_val_11672 = (state_11671[1]);if((state_val_11672 === 2))
...
})();var inst_11669 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_11668);var state_11671__$1 = state_11671;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_11671__$1,inst_11669);
} else
{if((state_val_11672 === 1))
{var state_11671__$1 = state_11671;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_11671__$1,2,comm);
} else
{return null;
}
}
...
var result__5509__auto__ = switch__5506__auto__.call(null,state_11671);if(cljs.core.keyword_identical_QMARK_.call(null,result__5509__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
})();var state__5523__auto__ = (function (){var statearr_11679 = f__5522__auto__.call(null);(statearr_11679[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__11682){var map__11684 = p__11682;var map__11684__$1 = ((cljs.core.seq_QMARK_.call(null,map__11684))?cljs.core.apply.call(null,cljs.core.hash_map,map__11684):map__11684);var min_zoom = cljs.core.get.call(null,map__11684__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
