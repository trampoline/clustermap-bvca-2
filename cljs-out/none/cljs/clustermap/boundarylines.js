...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__11667){var vec__11668 = p__11667;var z = cljs.core.nth.call(null,vec__11668,0,null);var t = cljs.core.nth.call(null,vec__11668,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_11688){var state_val_11689 = (state_11688[1]);if((state_val_11689 === 2))
{var inst_11684 = (state_11688[2]);var inst_11685 = (function (){var bl = inst_11684;return ((function (bl,inst_11684,state_val_11689){
return (function (old){return bl;
});
;})(bl,inst_11684,state_val_11689))
})();var inst_11686 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_11685);var state_11688__$1 = state_11688;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_11688__$1,inst_11686);
} else
{if((state_val_11689 === 1))
{var state_11688__$1 = state_11688;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_11688__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_11693 = [null,null,null,null,null,null,null];(statearr_11693[0] = state_machine__5507__auto__);
(statearr_11693[1] = 1);
return statearr_11693;
});
var state_machine__5507__auto____1 = (function (state_11688){while(true){
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__.call(null,state_11688);if(cljs.core.keyword_identical_QMARK_.call(null,result__5509__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__5510__auto__ = e11694;var statearr_11695_11697 = state_11688;(statearr_11695_11697[5] = ex__5510__auto__);
...
{{
var G__11698 = state_11688;
state_11688 = G__11698;
continue;
}
} else
...
state_machine__5507__auto__ = function(state_11688){
switch(arguments.length){
case 0:
return state_machine__5507__auto____0.call(this);
case 1:
return state_machine__5507__auto____1.call(this,state_11688);
}
...
})();var state__5523__auto__ = (function (){var statearr_11696 = f__5522__auto__.call(null);(statearr_11696[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__11699){var map__11701 = p__11699;var map__11701__$1 = ((cljs.core.seq_QMARK_.call(null,map__11701))?cljs.core.apply.call(null,cljs.core.hash_map,map__11701):map__11701);var min_zoom = cljs.core.get.call(null,map__11701__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
...
var p__11699 = null;if (arguments.length > 4) {
  p__11699 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__11699);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__11702){
var app_state = cljs.core.first(arglist__11702);
arglist__11702 = cljs.core.next(arglist__11702);
var korks = cljs.core.first(arglist__11702);
arglist__11702 = cljs.core.next(arglist__11702);
var boundaryline_id = cljs.core.first(arglist__11702);
arglist__11702 = cljs.core.next(arglist__11702);
var zoom = cljs.core.first(arglist__11702);
var p__11699 = cljs.core.rest(arglist__11702);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__11699);
});
