...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__11532){var vec__11533 = p__11532;var z = cljs.core.nth.call(null,vec__11533,0,null);var t = cljs.core.nth.call(null,vec__11533,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_11553){var state_val_11554 = (state_11553[1]);if((state_val_11554 === 2))
{var inst_11549 = (state_11553[2]);var inst_11550 = (function (){var bl = inst_11549;return ((function (bl,inst_11549,state_val_11554){
return (function (old){return bl;
});
;})(bl,inst_11549,state_val_11554))
})();var inst_11551 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_11550);var state_11553__$1 = state_11553;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_11553__$1,inst_11551);
} else
{if((state_val_11554 === 1))
{var state_11553__$1 = state_11553;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_11553__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_11558 = [null,null,null,null,null,null,null];(statearr_11558[0] = state_machine__5507__auto__);
(statearr_11558[1] = 1);
...
{var ex__5510__auto__ = e11559;var statearr_11560_11562 = state_11553;(statearr_11560_11562[5] = ex__5510__auto__);
...
{{
var G__11563 = state_11553;
state_11553 = G__11563;
continue;
}
} else
...
})();var state__5523__auto__ = (function (){var statearr_11561 = f__5522__auto__.call(null);(statearr_11561[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__11564){var map__11566 = p__11564;var map__11566__$1 = ((cljs.core.seq_QMARK_.call(null,map__11566))?cljs.core.apply.call(null,cljs.core.hash_map,map__11566):map__11566);var min_zoom = cljs.core.get.call(null,map__11566__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
...
var p__11564 = null;if (arguments.length > 4) {
  p__11564 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__11564);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__11567){
var app_state = cljs.core.first(arglist__11567);
arglist__11567 = cljs.core.next(arglist__11567);
var korks = cljs.core.first(arglist__11567);
arglist__11567 = cljs.core.next(arglist__11567);
var boundaryline_id = cljs.core.first(arglist__11567);
arglist__11567 = cljs.core.next(arglist__11567);
var zoom = cljs.core.first(arglist__11567);
var p__11564 = cljs.core.rest(arglist__11567);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__11564);
});
