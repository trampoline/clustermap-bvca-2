...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__11679){var vec__11680 = p__11679;var z = cljs.core.nth.call(null,vec__11680,0,null);var t = cljs.core.nth.call(null,vec__11680,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_11700){var state_val_11701 = (state_11700[1]);if((state_val_11701 === 2))
{var inst_11696 = (state_11700[2]);var inst_11697 = (function (){var bl = inst_11696;return ((function (bl,inst_11696,state_val_11701){
return (function (old){return bl;
});
;})(bl,inst_11696,state_val_11701))
})();var inst_11698 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_11697);var state_11700__$1 = state_11700;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_11700__$1,inst_11698);
} else
{if((state_val_11701 === 1))
{var state_11700__$1 = state_11700;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_11700__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_11705 = [null,null,null,null,null,null,null];(statearr_11705[0] = state_machine__5507__auto__);
(statearr_11705[1] = 1);
return statearr_11705;
});
var state_machine__5507__auto____1 = (function (state_11700){while(true){
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__.call(null,state_11700);if(cljs.core.keyword_identical_QMARK_.call(null,result__5509__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__5510__auto__ = e11706;var statearr_11707_11709 = state_11700;(statearr_11707_11709[5] = ex__5510__auto__);
...
{{
var G__11710 = state_11700;
state_11700 = G__11710;
continue;
}
} else
...
state_machine__5507__auto__ = function(state_11700){
switch(arguments.length){
case 0:
return state_machine__5507__auto____0.call(this);
case 1:
return state_machine__5507__auto____1.call(this,state_11700);
}
...
})();var state__5523__auto__ = (function (){var statearr_11708 = f__5522__auto__.call(null);(statearr_11708[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var p__11711 = null;if (arguments.length > 4) {
  p__11711 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__11711);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__11714){
var app_state = cljs.core.first(arglist__11714);
arglist__11714 = cljs.core.next(arglist__11714);
var korks = cljs.core.first(arglist__11714);
arglist__11714 = cljs.core.next(arglist__11714);
var boundaryline_id = cljs.core.first(arglist__11714);
arglist__11714 = cljs.core.next(arglist__11714);
var zoom = cljs.core.first(arglist__11714);
var p__11711 = cljs.core.rest(arglist__11714);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__11711);
});
