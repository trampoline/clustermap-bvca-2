...
goog.require('clustermap.api');
goog.require('clustermap.ordered_resource');
clustermap.components.filter.render = (function render(p__83709,owner,state){var map__83811 = p__83709;var map__83811__$1 = ((cljs.core.seq_QMARK_.call(null,map__83811))?cljs.core.apply.call(null,cljs.core.hash_map,map__83811):map__83811);var bounds = cljs.core.get.call(null,map__83811__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var filter_spec = cljs.core.get.call(null,map__83811__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"filter by view"),React.DOM.div({"className": "tbl-cell"},sablono.interpreter.input.call(null,{"type": "checkbox", "name": "filter-by-view", "value": "true", "onChange": ((function (map__83811,map__83811__$1,bounds,filter_spec){
...
});})(map__83811,map__83811__$1,bounds,filter_spec))
}))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__83811,map__83811__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__83900 = cljs.core._EQ_;var expr__83901 = val;if(cljs.core.truth_(pred__83900.call(null,"new",expr__83901)))
...
{if(cljs.core.truth_(pred__83900.call(null,"old",expr__83901)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "new"},"< 5 years old"),sablono.interpreter.option.call(null,{"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__83811,map__83811__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__83903 = cljs.core._EQ_;var expr__83904 = val;if(cljs.core.truth_(pred__83903.call(null,"group",expr__83904)))
...
{if(cljs.core.truth_(pred__83903.call(null,"notgroup",expr__83904)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "group"},"group"),sablono.interpreter.option.call(null,{"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__83811,map__83811__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__83906 = cljs.core._EQ_;var expr__83907 = val;if(cljs.core.truth_(pred__83906.call(null,"low",expr__83907)))
...
{if(cljs.core.truth_(pred__83906.call(null,"high",expr__83907)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "low"},"< \u00A31 million"),sablono.interpreter.option.call(null,{"value": "high"},">= \u00A31 million")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"SIC section"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"style": {"width": "100%"}, "onChange": ((function (map__83811,map__83811__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(e.target.value);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__83909 = cljs.core._EQ_;var expr__83910 = val;if(cljs.core.truth_(pred__83909.call(null,"A",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"B",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"C",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"D",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"E",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"F",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"G",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"H",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"I",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"J",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"K",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"L",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"M",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"N",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"O",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"P",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"Q",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"R",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"S",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"T",expr__83910)))
...
{if(cljs.core.truth_(pred__83909.call(null,"U",expr__83910)))
...
clustermap.components.filter.filter_component = (function filter_component(p__83912,owner){var map__83921 = p__83912;var map__83921__$1 = ((cljs.core.seq_QMARK_.call(null,map__83921))?cljs.core.apply.call(null,cljs.core.hash_map,map__83921):map__83921);var props = map__83921__$1;var map__83922 = cljs.core.get.call(null,map__83921__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__83922__$1 = ((cljs.core.seq_QMARK_.call(null,map__83922))?cljs.core.apply.call(null,cljs.core.hash_map,map__83922):map__83922);var filter_spec = map__83922__$1;var components = cljs.core.get.call(null,map__83922__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var filter_by_view = cljs.core.get.call(null,map__83922__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var compiled = cljs.core.get.call(null,map__83922__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var bounds = cljs.core.get.call(null,map__83921__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));if(typeof clustermap.components.filter.t83923 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t83923 = (function (filter_component,map__83921,owner,filter_by_view,props,filter_spec,map__83922,compiled,p__83912,bounds,components,meta83924){
this.filter_component = filter_component;
this.map__83921 = map__83921;
this.owner = owner;
this.filter_by_view = filter_by_view;
this.props = props;
this.filter_spec = filter_spec;
this.map__83922 = map__83922;
this.compiled = compiled;
this.p__83912 = p__83912;
this.bounds = bounds;
this.components = components;
this.meta83924 = meta83924;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t83923.cljs$lang$type = true;
clustermap.components.filter.t83923.cljs$lang$ctorStr = "clustermap.components.filter/t83923";
clustermap.components.filter.t83923.cljs$lang$ctorPrWriter = ((function (map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (this__4213__auto__,writer__4214__auto__,opt__4215__auto__){return cljs.core._write.call(null,writer__4214__auto__,"clustermap.components.filter/t83923");
});})(map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t83923.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t83923.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,p__83926,next_state){var self__ = this;
var map__83927 = p__83926;var map__83927__$1 = ((cljs.core.seq_QMARK_.call(null,map__83927))?cljs.core.apply.call(null,cljs.core.hash_map,map__83927):map__83927);var map__83928 = cljs.core.get.call(null,map__83927__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__83928__$1 = ((cljs.core.seq_QMARK_.call(null,map__83928))?cljs.core.apply.call(null,cljs.core.hash_map,map__83928):map__83928);var next_components = cljs.core.get.call(null,map__83928__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_filter_by_view = cljs.core.get.call(null,map__83928__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var next_compiled = cljs.core.get.call(null,map__83928__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var next_bounds = cljs.core.get.call(null,map__83927__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var ___$1 = this;if(cljs.core.truth_((function (){var or__3637__auto__ = cljs.core.not_EQ_.call(null,next_components,self__.components);if(or__3637__auto__)
...
;
clustermap.components.filter.t83923.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t83923.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.props,self__.owner,state);
});})(map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t83923.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_83925){var self__ = this;
var _83925__$1 = this;return self__.meta83924;
});})(map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t83923.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_83925,meta83924__$1){var self__ = this;
var _83925__$1 = this;return (new clustermap.components.filter.t83923(self__.filter_component,self__.map__83921,self__.owner,self__.filter_by_view,self__.props,self__.filter_spec,self__.map__83922,self__.compiled,self__.p__83912,self__.bounds,self__.components,meta83924__$1));
});})(map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.__GT_t83923 = ((function (map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function __GT_t83923(filter_component__$1,map__83921__$2,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,map__83922__$2,compiled__$1,p__83912__$1,bounds__$1,components__$1,meta83924){return (new clustermap.components.filter.t83923(filter_component__$1,map__83921__$2,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,map__83922__$2,compiled__$1,p__83912__$1,bounds__$1,components__$1,meta83924));
});})(map__83921,map__83921__$1,props,map__83922,map__83922__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
}
return (new clustermap.components.filter.t83923(filter_component,map__83921__$1,owner,filter_by_view,props,filter_spec,map__83922__$1,compiled,p__83912,bounds,components,null));
});
