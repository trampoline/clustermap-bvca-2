...
goog.require('clustermap.api');
goog.require('clustermap.ordered_resource');
clustermap.components.filter.render = (function render(p__52800,owner,state){var map__52888 = p__52800;var map__52888__$1 = ((cljs.core.seq_QMARK_.call(null,map__52888))?cljs.core.apply.call(null,cljs.core.hash_map,map__52888):map__52888);var bounds = cljs.core.get.call(null,map__52888__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var filter_spec = cljs.core.get.call(null,map__52888__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"filter by view"),React.DOM.div({"className": "tbl-cell"},sablono.interpreter.input.call(null,{"type": "checkbox", "name": "filter-by-view", "value": "true", "onChange": ((function (map__52888,map__52888__$1,bounds,filter_spec){
...
});})(map__52888,map__52888__$1,bounds,filter_spec))
}))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__52888,map__52888__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__52963 = cljs.core._EQ_;var expr__52964 = val;if(cljs.core.truth_(pred__52963.call(null,"new",expr__52964)))
...
{if(cljs.core.truth_(pred__52963.call(null,"old",expr__52964)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "new"},"< 5 years old"),sablono.interpreter.option.call(null,{"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__52888,map__52888__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__52966 = cljs.core._EQ_;var expr__52967 = val;if(cljs.core.truth_(pred__52966.call(null,"group",expr__52967)))
...
{if(cljs.core.truth_(pred__52966.call(null,"notgroup",expr__52967)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "group"},"group"),sablono.interpreter.option.call(null,{"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__52888,map__52888__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__52969 = cljs.core._EQ_;var expr__52970 = val;if(cljs.core.truth_(pred__52969.call(null,"low",expr__52970)))
...
{if(cljs.core.truth_(pred__52969.call(null,"high",expr__52970)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "low"},"< \u00A31 million"),sablono.interpreter.option.call(null,{"value": "high"},">= \u00A31 million")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"SIC section"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"style": {"width": "100%"}, "onChange": ((function (map__52888,map__52888__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(e.target.value);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__52972 = cljs.core._EQ_;var expr__52973 = val;if(cljs.core.truth_(pred__52972.call(null,"A",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"B",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"C",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"D",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"E",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"F",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"G",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"H",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"I",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"J",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"K",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"L",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"M",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"N",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"O",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"P",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"Q",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"R",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"S",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"T",expr__52973)))
...
{if(cljs.core.truth_(pred__52972.call(null,"U",expr__52973)))
...
clustermap.components.filter.filter_component = (function filter_component(p__52975,owner){var map__52984 = p__52975;var map__52984__$1 = ((cljs.core.seq_QMARK_.call(null,map__52984))?cljs.core.apply.call(null,cljs.core.hash_map,map__52984):map__52984);var props = map__52984__$1;var map__52985 = cljs.core.get.call(null,map__52984__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__52985__$1 = ((cljs.core.seq_QMARK_.call(null,map__52985))?cljs.core.apply.call(null,cljs.core.hash_map,map__52985):map__52985);var filter_spec = map__52985__$1;var components = cljs.core.get.call(null,map__52985__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var filter_by_view = cljs.core.get.call(null,map__52985__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var compiled = cljs.core.get.call(null,map__52985__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var bounds = cljs.core.get.call(null,map__52984__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));if(typeof clustermap.components.filter.t52986 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t52986 = (function (filter_component,owner,filter_by_view,props,map__52984,filter_spec,compiled,bounds,map__52985,p__52975,components,meta52987){
this.filter_component = filter_component;
this.owner = owner;
this.filter_by_view = filter_by_view;
this.props = props;
this.map__52984 = map__52984;
this.filter_spec = filter_spec;
this.compiled = compiled;
this.bounds = bounds;
this.map__52985 = map__52985;
this.p__52975 = p__52975;
this.components = components;
this.meta52987 = meta52987;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t52986.cljs$lang$type = true;
clustermap.components.filter.t52986.cljs$lang$ctorStr = "clustermap.components.filter/t52986";
clustermap.components.filter.t52986.cljs$lang$ctorPrWriter = ((function (map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t52986");
});})(map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t52986.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t52986.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,p__52989,next_state){var self__ = this;
var map__52990 = p__52989;var map__52990__$1 = ((cljs.core.seq_QMARK_.call(null,map__52990))?cljs.core.apply.call(null,cljs.core.hash_map,map__52990):map__52990);var map__52991 = cljs.core.get.call(null,map__52990__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__52991__$1 = ((cljs.core.seq_QMARK_.call(null,map__52991))?cljs.core.apply.call(null,cljs.core.hash_map,map__52991):map__52991);var next_components = cljs.core.get.call(null,map__52991__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_filter_by_view = cljs.core.get.call(null,map__52991__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var next_compiled = cljs.core.get.call(null,map__52991__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var next_bounds = cljs.core.get.call(null,map__52990__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var ___$1 = this;if(cljs.core.truth_((function (){var or__3558__auto__ = cljs.core.not_EQ_.call(null,next_components,self__.components);if(or__3558__auto__)
...
;
clustermap.components.filter.t52986.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t52986.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.props,self__.owner,state);
});})(map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t52986.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_52988){var self__ = this;
var _52988__$1 = this;return self__.meta52987;
});})(map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t52986.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_52988,meta52987__$1){var self__ = this;
var _52988__$1 = this;return (new clustermap.components.filter.t52986(self__.filter_component,self__.owner,self__.filter_by_view,self__.props,self__.map__52984,self__.filter_spec,self__.compiled,self__.bounds,self__.map__52985,self__.p__52975,self__.components,meta52987__$1));
});})(map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.__GT_t52986 = ((function (map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function __GT_t52986(filter_component__$1,owner__$1,filter_by_view__$1,props__$1,map__52984__$2,filter_spec__$1,compiled__$1,bounds__$1,map__52985__$2,p__52975__$1,components__$1,meta52987){return (new clustermap.components.filter.t52986(filter_component__$1,owner__$1,filter_by_view__$1,props__$1,map__52984__$2,filter_spec__$1,compiled__$1,bounds__$1,map__52985__$2,p__52975__$1,components__$1,meta52987));
});})(map__52984,map__52984__$1,props,map__52985,map__52985__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
}
return (new clustermap.components.filter.t52986(filter_component,owner,filter_by_view,props,map__52984__$1,filter_spec,compiled,bounds,map__52985__$1,p__52975,components,null));
});
