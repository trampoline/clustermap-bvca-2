...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__51180,owner){var map__51272 = p__51180;var map__51272__$1 = ((cljs.core.seq_QMARK_.call(null,map__51272))?cljs.core.apply.call(null,cljs.core.hash_map,map__51272):map__51272);var cursor = map__51272__$1;if(typeof clustermap.components.filter.t51273 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t51273 = (function (cursor,map__51272,owner,p__51180,filter_component,meta51274){
this.cursor = cursor;
this.map__51272 = map__51272;
this.owner = owner;
this.p__51180 = p__51180;
this.filter_component = filter_component;
this.meta51274 = meta51274;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t51273.cljs$lang$type = true;
clustermap.components.filter.t51273.cljs$lang$ctorStr = "clustermap.components.filter/t51273";
clustermap.components.filter.t51273.cljs$lang$ctorPrWriter = ((function (map__51272,map__51272__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t51273");
});})(map__51272,map__51272__$1,cursor))
;
clustermap.components.filter.t51273.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t51273.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__51272,map__51272__$1,cursor){
return (function (this$,p__51276,next_state){var self__ = this;
var map__51277 = p__51276;var map__51277__$1 = ((cljs.core.seq_QMARK_.call(null,map__51277))?cljs.core.apply.call(null,cljs.core.hash_map,map__51277):map__51277);var next_components = cljs.core.get.call(null,map__51277__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__51277__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__51278 = om.core.get_props.call(null,self__.owner);var map__51278__$1 = ((cljs.core.seq_QMARK_.call(null,map__51278))?cljs.core.apply.call(null,cljs.core.hash_map,map__51278):map__51278);var components = cljs.core.get.call(null,map__51278__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__51278__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t51273.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t51273.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__51272,map__51272__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__51272,map__51272__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__51351 = cljs.core._EQ_;var expr__51352 = val;if(cljs.core.truth_(pred__51351.call(null,"new",expr__51352)))
...
{if(cljs.core.truth_(pred__51351.call(null,"old",expr__51352)))
...
});})(this$__$1,map__51272,map__51272__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__51272,map__51272__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__51354 = cljs.core._EQ_;var expr__51355 = val;if(cljs.core.truth_(pred__51354.call(null,"group",expr__51355)))
...
{if(cljs.core.truth_(pred__51354.call(null,"notgroup",expr__51355)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__51272,map__51272__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__51357 = cljs.core._EQ_;var expr__51358 = val;if(cljs.core.truth_(pred__51357.call(null,"low",expr__51358)))
...
{if(cljs.core.truth_(pred__51357.call(null,"high",expr__51358)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__51360 = cljs.core._EQ_;var expr__51361 = val;if(cljs.core.truth_(pred__51360.call(null,"A",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"B",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"C",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"D",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"E",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"F",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"G",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"H",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"I",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"J",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"K",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"L",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"M",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"N",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"O",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"P",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"Q",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"R",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"S",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"T",expr__51361)))
...
{if(cljs.core.truth_(pred__51360.call(null,"U",expr__51361)))
...
;
clustermap.components.filter.t51273.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__51272,map__51272__$1,cursor){
return (function (_51275){var self__ = this;
var _51275__$1 = this;return self__.meta51274;
});})(map__51272,map__51272__$1,cursor))
;
clustermap.components.filter.t51273.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__51272,map__51272__$1,cursor){
return (function (_51275,meta51274__$1){var self__ = this;
var _51275__$1 = this;return (new clustermap.components.filter.t51273(self__.cursor,self__.map__51272,self__.owner,self__.p__51180,self__.filter_component,meta51274__$1));
});})(map__51272,map__51272__$1,cursor))
;
clustermap.components.filter.__GT_t51273 = ((function (map__51272,map__51272__$1,cursor){
return (function __GT_t51273(cursor__$1,map__51272__$2,owner__$1,p__51180__$1,filter_component__$1,meta51274){return (new clustermap.components.filter.t51273(cursor__$1,map__51272__$2,owner__$1,p__51180__$1,filter_component__$1,meta51274));
});})(map__51272,map__51272__$1,cursor))
;
}
return (new clustermap.components.filter.t51273(cursor,map__51272__$1,owner,p__51180,filter_component,null));
});
