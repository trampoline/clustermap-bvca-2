...
goog.require('clustermap.api');
goog.require('clustermap.ordered_resource');
clustermap.components.filter.render = (function render(p__61253,owner,state){var map__61341 = p__61253;var map__61341__$1 = ((cljs.core.seq_QMARK_.call(null,map__61341))?cljs.core.apply.call(null,cljs.core.hash_map,map__61341):map__61341);var bounds = cljs.core.get.call(null,map__61341__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var filter_spec = cljs.core.get.call(null,map__61341__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"filter by view"),React.DOM.div({"className": "tbl-cell"},sablono.interpreter.input.call(null,{"type": "checkbox", "name": "filter-by-view", "value": "true", "onChange": ((function (map__61341,map__61341__$1,bounds,filter_spec){
...
});})(map__61341,map__61341__$1,bounds,filter_spec))
}))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__61341,map__61341__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__61416 = cljs.core._EQ_;var expr__61417 = val;if(cljs.core.truth_(pred__61416.call(null,"new",expr__61417)))
...
{if(cljs.core.truth_(pred__61416.call(null,"old",expr__61417)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "new"},"< 5 years old"),sablono.interpreter.option.call(null,{"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__61341,map__61341__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__61419 = cljs.core._EQ_;var expr__61420 = val;if(cljs.core.truth_(pred__61419.call(null,"group",expr__61420)))
...
{if(cljs.core.truth_(pred__61419.call(null,"notgroup",expr__61420)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "group"},"group"),sablono.interpreter.option.call(null,{"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__61341,map__61341__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__61422 = cljs.core._EQ_;var expr__61423 = val;if(cljs.core.truth_(pred__61422.call(null,"low",expr__61423)))
...
{if(cljs.core.truth_(pred__61422.call(null,"high",expr__61423)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "low"},"< \u00A31 million"),sablono.interpreter.option.call(null,{"value": "high"},">= \u00A31 million")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"SIC section"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"style": {"width": "100%"}, "onChange": ((function (map__61341,map__61341__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(e.target.value);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__61425 = cljs.core._EQ_;var expr__61426 = val;if(cljs.core.truth_(pred__61425.call(null,"A",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"B",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"C",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"D",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"E",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"F",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"G",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"H",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"I",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"J",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"K",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"L",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"M",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"N",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"O",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"P",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"Q",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"R",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"S",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"T",expr__61426)))
...
{if(cljs.core.truth_(pred__61425.call(null,"U",expr__61426)))
...
clustermap.components.filter.filter_component = (function filter_component(p__61428,owner){var map__61437 = p__61428;var map__61437__$1 = ((cljs.core.seq_QMARK_.call(null,map__61437))?cljs.core.apply.call(null,cljs.core.hash_map,map__61437):map__61437);var props = map__61437__$1;var map__61438 = cljs.core.get.call(null,map__61437__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__61438__$1 = ((cljs.core.seq_QMARK_.call(null,map__61438))?cljs.core.apply.call(null,cljs.core.hash_map,map__61438):map__61438);var filter_spec = map__61438__$1;var components = cljs.core.get.call(null,map__61438__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var filter_by_view = cljs.core.get.call(null,map__61438__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var compiled = cljs.core.get.call(null,map__61438__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var bounds = cljs.core.get.call(null,map__61437__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));if(typeof clustermap.components.filter.t61439 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t61439 = (function (filter_component,owner,filter_by_view,props,filter_spec,map__61437,compiled,p__61428,bounds,components,map__61438,meta61440){
this.filter_component = filter_component;
this.owner = owner;
this.filter_by_view = filter_by_view;
this.props = props;
this.filter_spec = filter_spec;
this.map__61437 = map__61437;
this.compiled = compiled;
this.p__61428 = p__61428;
this.bounds = bounds;
this.components = components;
this.map__61438 = map__61438;
this.meta61440 = meta61440;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t61439.cljs$lang$type = true;
clustermap.components.filter.t61439.cljs$lang$ctorStr = "clustermap.components.filter/t61439";
clustermap.components.filter.t61439.cljs$lang$ctorPrWriter = ((function (map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t61439");
});})(map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t61439.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t61439.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,p__61442,next_state){var self__ = this;
var map__61443 = p__61442;var map__61443__$1 = ((cljs.core.seq_QMARK_.call(null,map__61443))?cljs.core.apply.call(null,cljs.core.hash_map,map__61443):map__61443);var map__61444 = cljs.core.get.call(null,map__61443__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__61444__$1 = ((cljs.core.seq_QMARK_.call(null,map__61444))?cljs.core.apply.call(null,cljs.core.hash_map,map__61444):map__61444);var next_components = cljs.core.get.call(null,map__61444__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_filter_by_view = cljs.core.get.call(null,map__61444__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var next_compiled = cljs.core.get.call(null,map__61444__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var next_bounds = cljs.core.get.call(null,map__61443__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var ___$1 = this;if(cljs.core.truth_((function (){var or__3558__auto__ = cljs.core.not_EQ_.call(null,next_components,self__.components);if(or__3558__auto__)
...
;
clustermap.components.filter.t61439.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t61439.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.props,self__.owner,state);
});})(map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t61439.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_61441){var self__ = this;
var _61441__$1 = this;return self__.meta61440;
});})(map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t61439.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_61441,meta61440__$1){var self__ = this;
var _61441__$1 = this;return (new clustermap.components.filter.t61439(self__.filter_component,self__.owner,self__.filter_by_view,self__.props,self__.filter_spec,self__.map__61437,self__.compiled,self__.p__61428,self__.bounds,self__.components,self__.map__61438,meta61440__$1));
});})(map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.__GT_t61439 = ((function (map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function __GT_t61439(filter_component__$1,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,map__61437__$2,compiled__$1,p__61428__$1,bounds__$1,components__$1,map__61438__$2,meta61440){return (new clustermap.components.filter.t61439(filter_component__$1,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,map__61437__$2,compiled__$1,p__61428__$1,bounds__$1,components__$1,map__61438__$2,meta61440));
});})(map__61437,map__61437__$1,props,map__61438,map__61438__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
}
return (new clustermap.components.filter.t61439(filter_component,owner,filter_by_view,props,filter_spec,map__61437__$1,compiled,p__61428,bounds,components,map__61438__$1,null));
});
