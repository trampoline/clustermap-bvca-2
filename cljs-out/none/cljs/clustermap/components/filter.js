...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__48585,owner){var map__48677 = p__48585;var map__48677__$1 = ((cljs.core.seq_QMARK_.call(null,map__48677))?cljs.core.apply.call(null,cljs.core.hash_map,map__48677):map__48677);var cursor = map__48677__$1;if(typeof clustermap.components.filter.t48678 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t48678 = (function (cursor,map__48677,owner,p__48585,filter_component,meta48679){
this.cursor = cursor;
this.map__48677 = map__48677;
this.owner = owner;
this.p__48585 = p__48585;
this.filter_component = filter_component;
this.meta48679 = meta48679;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t48678.cljs$lang$type = true;
clustermap.components.filter.t48678.cljs$lang$ctorStr = "clustermap.components.filter/t48678";
clustermap.components.filter.t48678.cljs$lang$ctorPrWriter = ((function (map__48677,map__48677__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t48678");
});})(map__48677,map__48677__$1,cursor))
;
clustermap.components.filter.t48678.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t48678.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__48677,map__48677__$1,cursor){
return (function (this$,p__48681,next_state){var self__ = this;
var map__48682 = p__48681;var map__48682__$1 = ((cljs.core.seq_QMARK_.call(null,map__48682))?cljs.core.apply.call(null,cljs.core.hash_map,map__48682):map__48682);var next_components = cljs.core.get.call(null,map__48682__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__48682__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__48683 = om.core.get_props.call(null,self__.owner);var map__48683__$1 = ((cljs.core.seq_QMARK_.call(null,map__48683))?cljs.core.apply.call(null,cljs.core.hash_map,map__48683):map__48683);var components = cljs.core.get.call(null,map__48683__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__48683__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t48678.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t48678.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__48677,map__48677__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__48677,map__48677__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__48756 = cljs.core._EQ_;var expr__48757 = val;if(cljs.core.truth_(pred__48756.call(null,"new",expr__48757)))
...
{if(cljs.core.truth_(pred__48756.call(null,"old",expr__48757)))
...
});})(this$__$1,map__48677,map__48677__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__48677,map__48677__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__48759 = cljs.core._EQ_;var expr__48760 = val;if(cljs.core.truth_(pred__48759.call(null,"group",expr__48760)))
...
{if(cljs.core.truth_(pred__48759.call(null,"notgroup",expr__48760)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__48677,map__48677__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__48762 = cljs.core._EQ_;var expr__48763 = val;if(cljs.core.truth_(pred__48762.call(null,"low",expr__48763)))
...
{if(cljs.core.truth_(pred__48762.call(null,"high",expr__48763)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__48765 = cljs.core._EQ_;var expr__48766 = val;if(cljs.core.truth_(pred__48765.call(null,"A",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"B",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"C",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"D",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"E",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"F",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"G",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"H",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"I",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"J",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"K",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"L",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"M",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"N",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"O",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"P",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"Q",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"R",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"S",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"T",expr__48766)))
...
{if(cljs.core.truth_(pred__48765.call(null,"U",expr__48766)))
...
;
clustermap.components.filter.t48678.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__48677,map__48677__$1,cursor){
return (function (_48680){var self__ = this;
var _48680__$1 = this;return self__.meta48679;
});})(map__48677,map__48677__$1,cursor))
;
clustermap.components.filter.t48678.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__48677,map__48677__$1,cursor){
return (function (_48680,meta48679__$1){var self__ = this;
var _48680__$1 = this;return (new clustermap.components.filter.t48678(self__.cursor,self__.map__48677,self__.owner,self__.p__48585,self__.filter_component,meta48679__$1));
});})(map__48677,map__48677__$1,cursor))
;
clustermap.components.filter.__GT_t48678 = ((function (map__48677,map__48677__$1,cursor){
return (function __GT_t48678(cursor__$1,map__48677__$2,owner__$1,p__48585__$1,filter_component__$1,meta48679){return (new clustermap.components.filter.t48678(cursor__$1,map__48677__$2,owner__$1,p__48585__$1,filter_component__$1,meta48679));
});})(map__48677,map__48677__$1,cursor))
;
}
return (new clustermap.components.filter.t48678(cursor,map__48677__$1,owner,p__48585,filter_component,null));
});
