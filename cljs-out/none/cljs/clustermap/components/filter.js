...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__51162,owner){var map__51254 = p__51162;var map__51254__$1 = ((cljs.core.seq_QMARK_.call(null,map__51254))?cljs.core.apply.call(null,cljs.core.hash_map,map__51254):map__51254);var cursor = map__51254__$1;if(typeof clustermap.components.filter.t51255 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t51255 = (function (cursor,map__51254,owner,p__51162,filter_component,meta51256){
this.cursor = cursor;
this.map__51254 = map__51254;
this.owner = owner;
this.p__51162 = p__51162;
this.filter_component = filter_component;
this.meta51256 = meta51256;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t51255.cljs$lang$type = true;
clustermap.components.filter.t51255.cljs$lang$ctorStr = "clustermap.components.filter/t51255";
clustermap.components.filter.t51255.cljs$lang$ctorPrWriter = ((function (map__51254,map__51254__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t51255");
});})(map__51254,map__51254__$1,cursor))
;
clustermap.components.filter.t51255.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t51255.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__51254,map__51254__$1,cursor){
return (function (this$,p__51258,next_state){var self__ = this;
var map__51259 = p__51258;var map__51259__$1 = ((cljs.core.seq_QMARK_.call(null,map__51259))?cljs.core.apply.call(null,cljs.core.hash_map,map__51259):map__51259);var next_components = cljs.core.get.call(null,map__51259__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__51259__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__51260 = om.core.get_props.call(null,self__.owner);var map__51260__$1 = ((cljs.core.seq_QMARK_.call(null,map__51260))?cljs.core.apply.call(null,cljs.core.hash_map,map__51260):map__51260);var components = cljs.core.get.call(null,map__51260__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__51260__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t51255.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t51255.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__51254,map__51254__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__51254,map__51254__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__51333 = cljs.core._EQ_;var expr__51334 = val;if(cljs.core.truth_(pred__51333.call(null,"new",expr__51334)))
...
{if(cljs.core.truth_(pred__51333.call(null,"old",expr__51334)))
...
});})(this$__$1,map__51254,map__51254__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__51254,map__51254__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__51336 = cljs.core._EQ_;var expr__51337 = val;if(cljs.core.truth_(pred__51336.call(null,"group",expr__51337)))
...
{if(cljs.core.truth_(pred__51336.call(null,"notgroup",expr__51337)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__51254,map__51254__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__51339 = cljs.core._EQ_;var expr__51340 = val;if(cljs.core.truth_(pred__51339.call(null,"low",expr__51340)))
...
{if(cljs.core.truth_(pred__51339.call(null,"high",expr__51340)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__51342 = cljs.core._EQ_;var expr__51343 = val;if(cljs.core.truth_(pred__51342.call(null,"A",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"B",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"C",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"D",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"E",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"F",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"G",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"H",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"I",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"J",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"K",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"L",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"M",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"N",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"O",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"P",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"Q",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"R",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"S",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"T",expr__51343)))
...
{if(cljs.core.truth_(pred__51342.call(null,"U",expr__51343)))
...
;
clustermap.components.filter.t51255.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__51254,map__51254__$1,cursor){
return (function (_51257){var self__ = this;
var _51257__$1 = this;return self__.meta51256;
});})(map__51254,map__51254__$1,cursor))
;
clustermap.components.filter.t51255.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__51254,map__51254__$1,cursor){
return (function (_51257,meta51256__$1){var self__ = this;
var _51257__$1 = this;return (new clustermap.components.filter.t51255(self__.cursor,self__.map__51254,self__.owner,self__.p__51162,self__.filter_component,meta51256__$1));
});})(map__51254,map__51254__$1,cursor))
;
clustermap.components.filter.__GT_t51255 = ((function (map__51254,map__51254__$1,cursor){
return (function __GT_t51255(cursor__$1,map__51254__$2,owner__$1,p__51162__$1,filter_component__$1,meta51256){return (new clustermap.components.filter.t51255(cursor__$1,map__51254__$2,owner__$1,p__51162__$1,filter_component__$1,meta51256));
});})(map__51254,map__51254__$1,cursor))
;
}
return (new clustermap.components.filter.t51255(cursor,map__51254__$1,owner,p__51162,filter_component,null));
});
