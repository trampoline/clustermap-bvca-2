...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__50681 = cljs.core._EQ_;var expr__50682 = val;if(cljs.core.truth_(pred__50681.call(null,"new",expr__50682)))
...
{if(cljs.core.truth_(pred__50681.call(null,"old",expr__50682)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__50684 = cljs.core._EQ_;var expr__50685 = val;if(cljs.core.truth_(pred__50684.call(null,"group",expr__50685)))
...
{if(cljs.core.truth_(pred__50684.call(null,"notgroup",expr__50685)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__50687 = cljs.core._EQ_;var expr__50688 = val;if(cljs.core.truth_(pred__50687.call(null,"low",expr__50688)))
...
{if(cljs.core.truth_(pred__50687.call(null,"high",expr__50688)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__50690 = cljs.core._EQ_;var expr__50691 = val;if(cljs.core.truth_(pred__50690.call(null,"A",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"B",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"C",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"D",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"E",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"F",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"G",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"H",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"I",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"J",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"K",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"L",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"M",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"N",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"O",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"P",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"Q",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"R",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"S",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"T",expr__50691)))
...
{if(cljs.core.truth_(pred__50690.call(null,"U",expr__50691)))
...
clustermap.components.filter.filter_component = (function filter_component(p__50693,owner){var map__50700 = p__50693;var map__50700__$1 = ((cljs.core.seq_QMARK_.call(null,map__50700))?cljs.core.apply.call(null,cljs.core.hash_map,map__50700):map__50700);var cursor = map__50700__$1;var components = cljs.core.get.call(null,map__50700__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__50700__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(typeof clustermap.components.filter.t50701 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t50701 = (function (compiled,components,cursor,map__50700,owner,p__50693,filter_component,meta50702){
this.compiled = compiled;
this.components = components;
this.cursor = cursor;
this.map__50700 = map__50700;
this.owner = owner;
this.p__50693 = p__50693;
this.filter_component = filter_component;
this.meta50702 = meta50702;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t50701.cljs$lang$type = true;
clustermap.components.filter.t50701.cljs$lang$ctorStr = "clustermap.components.filter/t50701";
clustermap.components.filter.t50701.cljs$lang$ctorPrWriter = ((function (map__50700,map__50700__$1,cursor,components,compiled){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t50701");
});})(map__50700,map__50700__$1,cursor,components,compiled))
;
clustermap.components.filter.t50701.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t50701.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__50700,map__50700__$1,cursor,components,compiled){
return (function (_,p__50704,next_state){var self__ = this;
var map__50705 = p__50704;var map__50705__$1 = ((cljs.core.seq_QMARK_.call(null,map__50705))?cljs.core.apply.call(null,cljs.core.hash_map,map__50705):map__50705);var next_components = cljs.core.get.call(null,map__50705__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__50705__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var ___$1 = this;if(cljs.core.not_EQ_.call(null,next_components,self__.components))
...
;
clustermap.components.filter.t50701.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t50701.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__50700,map__50700__$1,cursor,components,compiled){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.cursor,self__.owner,state);
});})(map__50700,map__50700__$1,cursor,components,compiled))
;
clustermap.components.filter.t50701.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__50700,map__50700__$1,cursor,components,compiled){
return (function (_50703){var self__ = this;
var _50703__$1 = this;return self__.meta50702;
});})(map__50700,map__50700__$1,cursor,components,compiled))
;
clustermap.components.filter.t50701.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__50700,map__50700__$1,cursor,components,compiled){
return (function (_50703,meta50702__$1){var self__ = this;
var _50703__$1 = this;return (new clustermap.components.filter.t50701(self__.compiled,self__.components,self__.cursor,self__.map__50700,self__.owner,self__.p__50693,self__.filter_component,meta50702__$1));
});})(map__50700,map__50700__$1,cursor,components,compiled))
;
clustermap.components.filter.__GT_t50701 = ((function (map__50700,map__50700__$1,cursor,components,compiled){
return (function __GT_t50701(compiled__$1,components__$1,cursor__$1,map__50700__$2,owner__$1,p__50693__$1,filter_component__$1,meta50702){return (new clustermap.components.filter.t50701(compiled__$1,components__$1,cursor__$1,map__50700__$2,owner__$1,p__50693__$1,filter_component__$1,meta50702));
});})(map__50700,map__50700__$1,cursor,components,compiled))
;
}
return (new clustermap.components.filter.t50701(compiled,components,cursor,map__50700__$1,owner,p__50693,filter_component,null));
});
