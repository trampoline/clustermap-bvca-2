...
{var attrs11693 = link_fn.call(null,type,first_obj);if(cljs.core.map_QMARK_.call(null,attrs11693))
{return React.DOM.div(sablono.interpreter.attributes.call(null,attrs11693),React.DOM.a({"href": owner_path},"\u00A0(",sablono.interpreter.interpret.call(null,cljs.core.count.call(null,next_objs))," more...)"));
} else
{return React.DOM.div(null,sablono.interpreter.interpret.call(null,attrs11693),React.DOM.a({"href": owner_path},"\u00A0(",sablono.interpreter.interpret.call(null,cljs.core.count.call(null,next_objs))," more...)"));
}
} else
...
clustermap.components.full_report.company_list.portfolio_company_site = (function portfolio_company_site(site,owner,p__11702){var map__11718 = p__11702;var map__11718__$1 = ((cljs.core.seq_QMARK_.call(null,map__11718))?cljs.core.apply.call(null,cljs.core.hash_map,map__11718):map__11718);var opts = map__11718__$1;var path_fn = cljs.core.get.call(null,map__11718__$1,new cljs.core.Keyword(null,"path-fn","path-fn",4517369570));var link_fn = cljs.core.get.call(null,map__11718__$1,new cljs.core.Keyword(null,"link-fn","link-fn",1190936301));var company_path = path_fn.call(null,new cljs.core.Keyword(null,"portfolio-company","portfolio-company",3606204522),site);if(typeof clustermap.components.full_report.company_list.t11719 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.full_report.company_list.t11719 = (function (company_path,link_fn,path_fn,opts,map__11718,p__11702,owner,site,portfolio_company_site,meta11720){
this.company_path = company_path;
this.link_fn = link_fn;
this.path_fn = path_fn;
this.opts = opts;
this.map__11718 = map__11718;
this.p__11702 = p__11702;
this.owner = owner;
this.site = site;
...
clustermap.components.full_report.company_list.t11719.cljs$lang$type = true;
clustermap.components.full_report.company_list.t11719.cljs$lang$ctorStr = "clustermap.components.full-report.company-list/t11719";
clustermap.components.full_report.company_list.t11719.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.full-report.company-list/t11719");
});
clustermap.components.full_report.company_list.t11719.prototype.om$core$IRender$ = true;
clustermap.components.full_report.company_list.t11719.prototype.om$core$IRender$render$arity$1 = (function (this__9212__auto__){var self__ = this;
var this__9212__auto____$1 = this;return React.DOM.tr(null,(function (){var attrs11722 = self__.link_fn.call(null,new cljs.core.Keyword(null,"portfolio-company","portfolio-company",3606204522),self__.site);if(cljs.core.map_QMARK_.call(null,attrs11722))
{return React.DOM.td(sablono.interpreter.attributes.call(null,attrs11722),null);
} else
{return React.DOM.td(null,sablono.interpreter.interpret.call(null,attrs11722));
}
})(),(function (){var attrs11723 = new cljs.core.Keyword(null,"postcode","postcode",1771366911).cljs$core$IFn$_invoke$arity$1(self__.site);if(cljs.core.map_QMARK_.call(null,attrs11723))
...
clustermap.components.full_report.company_list.t11719.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11721){var self__ = this;
var _11721__$1 = this;return self__.meta11720;
});
clustermap.components.full_report.company_list.t11719.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11721,meta11720__$1){var self__ = this;
var _11721__$1 = this;return (new clustermap.components.full_report.company_list.t11719(self__.company_path,self__.link_fn,self__.path_fn,self__.opts,self__.map__11718,self__.p__11702,self__.owner,self__.site,self__.portfolio_company_site,meta11720__$1));
});
clustermap.components.full_report.company_list.__GT_t11719 = (function __GT_t11719(company_path__$1,link_fn__$1,path_fn__$1,opts__$1,map__11718__$2,p__11702__$1,owner__$1,site__$1,portfolio_company_site__$1,meta11720){return (new clustermap.components.full_report.company_list.t11719(company_path__$1,link_fn__$1,path_fn__$1,opts__$1,map__11718__$2,p__11702__$1,owner__$1,site__$1,portfolio_company_site__$1,meta11720));
});
}
return (new clustermap.components.full_report.company_list.t11719(company_path,link_fn,path_fn,opts,map__11718__$1,p__11702,owner,site,portfolio_company_site,null));
});
...
var this__9212__auto____$1 = this;return React.DOM.div({"className": "full-report-list"},React.DOM.div({"className": "table-responsive"},React.DOM.table({"className": "table"},React.DOM.thead(null,React.DOM.tr(null,React.DOM.th(null,"Portfolio Company"),React.DOM.th(null,"Postcode"),React.DOM.th(null,"Investor"),React.DOM.th(null,"Constituency"),React.DOM.th(null,"Revenue"),React.DOM.th({"colSpan": "2"},"Rev. change"),React.DOM.th(null,"Employees"),React.DOM.th({"colSpan": "2"},"Emp. change"))),(function (){var attrs11744 = om.core.build_all.call(null,clustermap.components.full_report.company_list.portfolio_company_site,new cljs.core.Keyword(null,"records","records",2096501172).cljs$core$IFn$_invoke$arity$1(self__.selection_portfolio_company_sites),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",1014010321),new cljs.core.Keyword(null,"portfolio_company_site_uid","portfolio_company_site_uid",3220116067),new cljs.core.Keyword(null,"opts","opts",1017322386),self__.opts], null));if(cljs.core.map_QMARK_.call(null,attrs11744))
