...
goog.require('clustermap.formats.number');
goog.require('clustermap.formats.number');
clustermap.components.full_report.details.details = (function details(data,owner){if(typeof clustermap.components.full_report.details.t11537 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.full_report.details.t11537 = (function (owner,data,details,meta11538){
this.owner = owner;
this.data = data;
...
clustermap.components.full_report.details.t11537.cljs$lang$type = true;
clustermap.components.full_report.details.t11537.cljs$lang$ctorStr = "clustermap.components.full-report.details/t11537";
clustermap.components.full_report.details.t11537.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.full-report.details/t11537");
});
clustermap.components.full_report.details.t11537.prototype.om$core$IRender$ = true;
clustermap.components.full_report.details.t11537.prototype.om$core$IRender$render$arity$1 = (function (this__9212__auto__){var self__ = this;
var this__9212__auto____$1 = this;var attrs11540 = (function (){var temp__4090__auto__ = new cljs.core.Keyword(null,"selection-portfolio-company-site-account-timelines","selection-portfolio-company-site-account-timelines",3586704052).cljs$core$IFn$_invoke$arity$1(self__.data);if(cljs.core.truth_(temp__4090__auto__))
...
})();if(cljs.core.map_QMARK_.call(null,attrs11540))
{return React.DOM.div(sablono.interpreter.attributes.call(null,sablono.util.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",1108647146),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["full-report-details"], null)], null),attrs11540)),null);
} else
{return React.DOM.div({"className": "full-report-details"},sablono.interpreter.interpret.call(null,attrs11540));
}
});
clustermap.components.full_report.details.t11537.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11539){var self__ = this;
var _11539__$1 = this;return self__.meta11538;
});
clustermap.components.full_report.details.t11537.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11539,meta11538__$1){var self__ = this;
var _11539__$1 = this;return (new clustermap.components.full_report.details.t11537(self__.owner,self__.data,self__.details,meta11538__$1));
});
clustermap.components.full_report.details.__GT_t11537 = (function __GT_t11537(owner__$1,data__$1,details__$1,meta11538){return (new clustermap.components.full_report.details.t11537(owner__$1,data__$1,details__$1,meta11538));
});
}
return (new clustermap.components.full_report.details.t11537(owner,data,details,null));
});
