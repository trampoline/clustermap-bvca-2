...
clustermap.components.map_report.constituency_report = (function constituency_report(constituency,site_stats,comm){var map__12320 = clustermap.components.map_report.type_counts.call(null,site_stats);var map__12320__$1 = ((cljs.core.seq_QMARK_.call(null,map__12320))?cljs.core.apply.call(null,cljs.core.hash_map,map__12320):map__12320);var const_count = cljs.core.get.call(null,map__12320__$1,new cljs.core.Keyword(null,"const-count","const-count",1728788887));var ic_count = cljs.core.get.call(null,map__12320__$1,new cljs.core.Keyword(null,"ic-count","ic-count",2672077326));var pc_count = cljs.core.get.call(null,map__12320__$1,new cljs.core.Keyword(null,"pc-count","pc-count",1986847783));if(typeof clustermap.components.map_report.t12321 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.map_report.t12321 = (function (pc_count,ic_count,const_count,map__12320,comm,site_stats,constituency,constituency_report,meta12322){
this.pc_count = pc_count;
this.ic_count = ic_count;
this.const_count = const_count;
this.map__12320 = map__12320;
this.comm = comm;
this.site_stats = site_stats;
...
clustermap.components.map_report.t12321.cljs$lang$type = true;
clustermap.components.map_report.t12321.cljs$lang$ctorStr = "clustermap.components.map-report/t12321";
clustermap.components.map_report.t12321.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.map-report/t12321");
});
clustermap.components.map_report.t12321.prototype.om$core$IRender$ = true;
clustermap.components.map_report.t12321.prototype.om$core$IRender$render$arity$1 = (function (this__9212__auto__){var self__ = this;
var this__9212__auto____$1 = this;return React.DOM.div(null,React.DOM.header({"className": "secondary"},React.DOM.h2(null,"Constituency"),(function (){var attrs12326 = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(self__.constituency);if(cljs.core.map_QMARK_.call(null,attrs12326))
{return React.DOM.h3(sablono.interpreter.attributes.call(null,attrs12326),React.DOM.small(null,"(",sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"mp","mp",1013907733).cljs$core$IFn$_invoke$arity$1(self__.constituency)),", ",sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"political_party","political_party",2564439702).cljs$core$IFn$_invoke$arity$1(self__.constituency)),")"));
} else
{return React.DOM.h3(null,sablono.interpreter.interpret.call(null,attrs12326),React.DOM.small(null,"(",sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"mp","mp",1013907733).cljs$core$IFn$_invoke$arity$1(self__.constituency)),", ",sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"political_party","political_party",2564439702).cljs$core$IFn$_invoke$arity$1(self__.constituency)),")"));
}
...
clustermap.components.map_report.t12321.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12323){var self__ = this;
var _12323__$1 = this;return self__.meta12322;
});
clustermap.components.map_report.t12321.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12323,meta12322__$1){var self__ = this;
var _12323__$1 = this;return (new clustermap.components.map_report.t12321(self__.pc_count,self__.ic_count,self__.const_count,self__.map__12320,self__.comm,self__.site_stats,self__.constituency,self__.constituency_report,meta12322__$1));
});
clustermap.components.map_report.__GT_t12321 = (function __GT_t12321(pc_count__$1,ic_count__$1,const_count__$1,map__12320__$2,comm__$1,site_stats__$1,constituency__$1,constituency_report__$1,meta12322){return (new clustermap.components.map_report.t12321(pc_count__$1,ic_count__$1,const_count__$1,map__12320__$2,comm__$1,site_stats__$1,constituency__$1,constituency_report__$1,meta12322));
});
}
return (new clustermap.components.map_report.t12321(pc_count,ic_count,const_count,map__12320__$1,comm,site_stats,constituency,constituency_report,null));
});
