...
clustermap.components.map_report.t12386.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.map-report/t12386");
});
clustermap.components.map_report.t12386.prototype.om$core$IRender$ = true;
clustermap.components.map_report.t12386.prototype.om$core$IRender$render$arity$1 = (function (this__9212__auto__){var self__ = this;
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12391),React.DOM.small(null,"Portfolio Companies listed"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12391),React.DOM.small(null,"Portfolio Companies listed"));
}
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12396),React.DOM.small(null,"Investors listed"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12396),React.DOM.small(null,"Investors listed"));
}
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12404),React.DOM.small(null,"Portfolio Company Turnover"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12404),React.DOM.small(null,"Portfolio Company Turnover"));
}
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12409),React.DOM.small(null,"Portfolio Company Employees"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12409),React.DOM.small(null,"Portfolio Company Employees"));
}
...
clustermap.components.map_report.t12442.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.map-report/t12442");
});
clustermap.components.map_report.t12442.prototype.om$core$IRender$ = true;
clustermap.components.map_report.t12442.prototype.om$core$IRender$render$arity$1 = (function (this__9212__auto__){var self__ = this;
var this__9212__auto____$1 = this;return React.DOM.div(null,React.DOM.header({"className": "secondary"},React.DOM.h2(null,"Portfolio Company"),(function (){var attrs12447 = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(self__.portfolio_company);if(cljs.core.map_QMARK_.call(null,attrs12447))
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12454),React.DOM.small(null,"Portfolio Company Turnover"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12454),React.DOM.small(null,"Portfolio Company Turnover"));
}
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12459),React.DOM.small(null,"Portfolio Company Employees"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12459),React.DOM.small(null,"Portfolio Company Employees"));
}
})()),sablono.interpreter.interpret.call(null,clustermap.components.map_report.full_report_button.call(null,self__.comm)));
});
...
clustermap.components.map_report.t12492.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.map-report/t12492");
});
clustermap.components.map_report.t12492.prototype.om$core$IRender$ = true;
clustermap.components.map_report.t12492.prototype.om$core$IRender$render$arity$1 = (function (this__9212__auto__){var self__ = this;
var this__9212__auto____$1 = this;return React.DOM.div(null,React.DOM.header({"className": "secondary"},React.DOM.h2(null,"Investor"),(function (){var attrs12497 = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(self__.investor_company);if(cljs.core.map_QMARK_.call(null,attrs12497))
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12498),(function (){var attrs12499 = clustermap.formats.string.pluralize.call(null,self__.pc_count,"Portfolio Company","Portfolio Companies");if(cljs.core.map_QMARK_.call(null,attrs12499))
...
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12498),(function (){var attrs12500 = clustermap.formats.string.pluralize.call(null,self__.pc_count,"Portfolio Company","Portfolio Companies");if(cljs.core.map_QMARK_.call(null,attrs12500))
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12504),React.DOM.small(null,"Portfolio Company Turnover"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12504),React.DOM.small(null,"Portfolio Company Turnover"));
}
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12509),React.DOM.small(null,"Portfolio Company Employees"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12509),React.DOM.small(null,"Portfolio Company Employees"));
}
})()),sablono.interpreter.interpret.call(null,clustermap.components.map_report.full_report_button.call(null,self__.comm)));
});
...
clustermap.components.map_report.t12546.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.map-report/t12546");
});
clustermap.components.map_report.t12546.prototype.om$core$IRender$ = true;
clustermap.components.map_report.t12546.prototype.om$core$IRender$render$arity$1 = (function (this__9212__auto__){var self__ = this;
var this__9212__auto____$1 = this;return React.DOM.div(null,React.DOM.header({"className": "secondary"},React.DOM.h2(null,"Constituency"),(function (){var attrs12551 = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(self__.constituency);if(cljs.core.map_QMARK_.call(null,attrs12551))
{return React.DOM.h3(sablono.interpreter.attributes.call(null,attrs12551),React.DOM.br(null),(cljs.core.truth_((function (){var or__3406__auto__ = new cljs.core.Keyword(null,"mp","mp",1013907733).cljs$core$IFn$_invoke$arity$1(self__.constituency);if(cljs.core.truth_(or__3406__auto__))
...
{return React.DOM.h3(null,sablono.interpreter.interpret.call(null,attrs12551),React.DOM.br(null),(cljs.core.truth_((function (){var or__3406__auto__ = new cljs.core.Keyword(null,"mp","mp",1013907733).cljs$core$IFn$_invoke$arity$1(self__.constituency);if(cljs.core.truth_(or__3406__auto__))
{return or__3406__auto__;
} else
{return new cljs.core.Keyword(null,"political_party","political_party",2564439702).cljs$core$IFn$_invoke$arity$1(self__.constituency);
}
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12556),(function (){var attrs12557 = clustermap.formats.string.pluralize.call(null,self__.pc_count,"Portfolio Company","Portfolio Companies");if(cljs.core.map_QMARK_.call(null,attrs12557))
...
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12556),(function (){var attrs12558 = clustermap.formats.string.pluralize.call(null,self__.pc_count,"Portfolio Company","Portfolio Companies");if(cljs.core.map_QMARK_.call(null,attrs12558))
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12562),React.DOM.small(null,"Portfolio Company Turnover"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12562),React.DOM.small(null,"Portfolio Company Turnover"));
}
...
{return React.DOM.li(sablono.interpreter.attributes.call(null,attrs12567),React.DOM.small(null,"Portfolio Company Employees"));
} else
{return React.DOM.li(null,sablono.interpreter.interpret.call(null,attrs12567),React.DOM.small(null,"Portfolio Company Employees"));
}
})()),sablono.interpreter.interpret.call(null,clustermap.components.map_report.full_report_button.call(null,self__.comm)));
});
...
clustermap.components.map_report.map_report_component = (function map_report_component(data,owner){var map__12578 = om.core.get_shared.call(null,owner);var map__12578__$1 = ((cljs.core.seq_QMARK_.call(null,map__12578))?cljs.core.apply.call(null,cljs.core.hash_map,map__12578):map__12578);var path_fn = cljs.core.get.call(null,map__12578__$1,new cljs.core.Keyword(null,"path-fn","path-fn",4517369570));var comm = cljs.core.get.call(null,map__12578__$1,new cljs.core.Keyword(null,"comm","comm",1016963710));var type = cljs.core.get_in.call(null,data,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"selection","selection",3592905982),new cljs.core.Keyword(null,"type","type",1017479852)], null));var value = cljs.core.get_in.call(null,data,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"selection","selection",3592905982),new cljs.core.Keyword(null,"value","value",1125876963)], null));var site_stats = new cljs.core.Keyword(null,"selection-investment-stats","selection-investment-stats",4568560312).cljs$core$IFn$_invoke$arity$1(data);var pred__12579 = cljs.core._EQ__EQ_;var expr__12580 = type;if(cljs.core.truth_(pred__12579.call(null,new cljs.core.Keyword(null,"portfolio-company","portfolio-company",3606204522),expr__12580)))
