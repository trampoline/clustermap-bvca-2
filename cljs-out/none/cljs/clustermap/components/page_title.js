...
goog.require('cljs.core.async');
goog.require('clustermap.formats.number');
clustermap.components.page_title.describe_type = (function describe_type(type){var pred__23502 = cljs.core._EQ_;var expr__23503 = type;if(cljs.core.truth_(pred__23502.call(null,new cljs.core.Keyword(null,"portfolio-company","portfolio-company",3606204522),expr__23503)))
{return "Investor-backed company";
} else
{if(cljs.core.truth_(pred__23502.call(null,new cljs.core.Keyword(null,"investor-company","investor-company",3983736762),expr__23503)))
{return "Investor";
} else
{if(cljs.core.truth_(pred__23502.call(null,new cljs.core.Keyword(null,"constituency","constituency",3902864696),expr__23503)))
{return "Constituency";
} else
...
clustermap.components.page_title.page_title_component = (function page_title_component(p__23505,owner){var map__23516 = p__23505;var map__23516__$1 = ((cljs.core.seq_QMARK_.call(null,map__23516))?cljs.core.apply.call(null,cljs.core.hash_map,map__23516):map__23516);var selection = map__23516__$1;var value = cljs.core.get.call(null,map__23516__$1,new cljs.core.Keyword(null,"value","value",1125876963));var type = cljs.core.get.call(null,map__23516__$1,new cljs.core.Keyword(null,"type","type",1017479852));var map__23517 = om.core.get_shared.call(null,owner);var map__23517__$1 = ((cljs.core.seq_QMARK_.call(null,map__23517))?cljs.core.apply.call(null,cljs.core.hash_map,map__23517):map__23517);var path_fn = cljs.core.get.call(null,map__23517__$1,new cljs.core.Keyword(null,"path-fn","path-fn",4517369570));var comm = cljs.core.get.call(null,map__23517__$1,new cljs.core.Keyword(null,"comm","comm",1016963710));var path_fn__$1 = cljs.core.partial.call(null,path_fn,new cljs.core.Keyword(null,"lists","lists",1116886791));var type_descr = (function (){var G__23518 = selection;var G__23518__$1 = (((G__23518 == null))?null:new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(G__23518));var G__23518__$2 = (((G__23518__$1 == null))?null:clustermap.components.page_title.describe_type.call(null,G__23518__$1));return G__23518__$2;
})();var name = (function (){var G__23519 = selection;var G__23519__$1 = (((G__23519 == null))?null:new cljs.core.Keyword(null,"value","value",1125876963).cljs$core$IFn$_invoke$arity$1(G__23519));var G__23519__$2 = (((G__23519__$1 == null))?null:new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(G__23519__$1));return G__23519__$2;
})();var url = (function (){var G__23520 = selection;var G__23520__$1 = (((G__23520 == null))?null:new cljs.core.Keyword(null,"value","value",1125876963).cljs$core$IFn$_invoke$arity$1(G__23520));var G__23520__$2 = (((G__23520__$1 == null))?null:new cljs.core.Keyword(null,"web_url","web_url",2237655414).cljs$core$IFn$_invoke$arity$1(G__23520__$1));return G__23520__$2;
...
clustermap.components.page_title.t23521.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"clustermap.components.page-title/t23521");
});
...
})},"View on map"),sablono.interpreter.interpret.call(null,(cljs.core.truth_(self__.type_descr)?clustermap.components.reset_selection_button.reset_selection_button.call(null,self__.path_fn):null)),(function (){var attrs23524 = (function (){var or__3441__auto__ = self__.type_descr;if(cljs.core.truth_(or__3441__auto__))
{return or__3441__auto__;
} else
{return "All investor-backed companies";
}
})();if(cljs.core.map_QMARK_.call(null,attrs23524))
{return React.DOM.h2(sablono.interpreter.attributes.call(null,attrs23524),null);
} else
{return React.DOM.h2(null,sablono.interpreter.interpret.call(null,attrs23524));
}
