...
goog.require('clojure.set');
goog.require('jayq.core');
clustermap.components.timeline_chart.create_chart = (function create_chart(data,node,p__12082){var map__12084 = p__12082;var map__12084__$1 = ((cljs.core.seq_QMARK_.call(null,map__12084))?cljs.core.apply.call(null,cljs.core.hash_map,map__12084):map__12084);var opts = map__12084__$1;var y1_title = cljs.core.get.call(null,map__12084__$1,new cljs.core.Keyword(null,"y1-title","y1-title",3377247893));var y0_title = cljs.core.get.call(null,map__12084__$1,new cljs.core.Keyword(null,"y0-title","y0-title",2489744212));var x_labels = cljs.core.map.call(null,new cljs.core.Keyword(null,"time","time",1017464383),data);var y_mean = cljs.core.map.call(null,new cljs.core.Keyword(null,"mean","mean",1017251639),data);var y_count = cljs.core.map.call(null,new cljs.core.Keyword(null,"count","count",1108755585),data);var yt = cljs.core.map.call(null,((function (x_labels,y_mean,y_count){
...
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,opts){if(typeof clustermap.components.timeline_chart.t12090 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.timeline_chart.t12090 = (function (opts,owner,data,timeline_chart,meta12091){
this.opts = opts;
this.owner = owner;
this.data = data;
...
clustermap.components.timeline_chart.t12090.cljs$lang$type = true;
clustermap.components.timeline_chart.t12090.cljs$lang$ctorStr = "clustermap.components.timeline-chart/t12090";
clustermap.components.timeline_chart.t12090.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.timeline-chart/t12090");
});
clustermap.components.timeline_chart.t12090.prototype.om$core$IDidUpdate$ = true;
clustermap.components.timeline_chart.t12090.prototype.om$core$IDidUpdate$did_update$arity$4 = (function (this$,prev_props,prev_state,root_node){var self__ = this;
...
clustermap.components.timeline_chart.t12090.prototype.om$core$IDidMount$ = true;
clustermap.components.timeline_chart.t12090.prototype.om$core$IDidMount$did_mount$arity$2 = (function (this$,node){var self__ = this;
var this$__$1 = this;return clustermap.components.timeline_chart.create_chart.call(null,self__.data,om.core.get_node.call(null,self__.owner,"chart"),self__.opts);
});
clustermap.components.timeline_chart.t12090.prototype.om$core$IRender$ = true;
clustermap.components.timeline_chart.t12090.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "timeline-chart", "ref": "chart"});
});
clustermap.components.timeline_chart.t12090.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12092){var self__ = this;
var _12092__$1 = this;return self__.meta12091;
});
clustermap.components.timeline_chart.t12090.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12092,meta12091__$1){var self__ = this;
var _12092__$1 = this;return (new clustermap.components.timeline_chart.t12090(self__.opts,self__.owner,self__.data,self__.timeline_chart,meta12091__$1));
});
clustermap.components.timeline_chart.__GT_t12090 = (function __GT_t12090(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta12091){return (new clustermap.components.timeline_chart.t12090(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta12091));
});
}
return (new clustermap.components.timeline_chart.t12090(opts,owner,data,timeline_chart,null));
});
