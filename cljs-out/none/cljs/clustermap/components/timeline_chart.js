...
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,opts){if(typeof clustermap.components.timeline_chart.t12483 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.timeline_chart.t12483 = (function (opts,owner,data,timeline_chart,meta12484){
this.opts = opts;
this.owner = owner;
this.data = data;
...
var _12485__$1 = this;return (new clustermap.components.timeline_chart.t12483(self__.opts,self__.owner,self__.data,self__.timeline_chart,meta12484__$1));
});
clustermap.components.timeline_chart.__GT_t12483 = (function __GT_t12483(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta12484){return (new clustermap.components.timeline_chart.t12483(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta12484));
});
}
return (new clustermap.components.timeline_chart.t12483(opts,owner,data,timeline_chart,null));
});
