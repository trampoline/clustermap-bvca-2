...
goog.require('clojure.set');
goog.require('jayq.core');
clustermap.components.timeline_chart.create_chart = (function create_chart(data,node,p__11600){var map__11602 = p__11600;var map__11602__$1 = ((cljs.core.seq_QMARK_.call(null,map__11602))?cljs.core.apply.call(null,cljs.core.hash_map,map__11602):map__11602);var opts = map__11602__$1;var y1_title = cljs.core.get.call(null,map__11602__$1,new cljs.core.Keyword(null,"y1-title","y1-title",3377247893));var y0_title = cljs.core.get.call(null,map__11602__$1,new cljs.core.Keyword(null,"y0-title","y0-title",2489744212));console.log(cljs.core.clj__GT_js.call(null,opts));
...
if(typeof clustermap.components.timeline_chart.t11610 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.timeline_chart.t11610 = (function (opts,owner,data,timeline_chart,meta11611){
this.opts = opts;
this.owner = owner;
this.data = data;
...
clustermap.components.timeline_chart.t11610.cljs$lang$type = true;
clustermap.components.timeline_chart.t11610.cljs$lang$ctorStr = "clustermap.components.timeline-chart/t11610";
clustermap.components.timeline_chart.t11610.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.timeline-chart/t11610");
});
clustermap.components.timeline_chart.t11610.prototype.om$core$IDidUpdate$ = true;
clustermap.components.timeline_chart.t11610.prototype.om$core$IDidUpdate$did_update$arity$4 = (function (this$,prev_props,prev_state,root_node){var self__ = this;
...
clustermap.components.timeline_chart.t11610.prototype.om$core$IRenderState$ = true;
clustermap.components.timeline_chart.t11610.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,p__11613){var self__ = this;
var map__11614 = p__11613;var map__11614__$1 = ((cljs.core.seq_QMARK_.call(null,map__11614))?cljs.core.apply.call(null,cljs.core.hash_map,map__11614):map__11614);var rendered_data = cljs.core.get.call(null,map__11614__$1,new cljs.core.Keyword(null,"rendered-data","rendered-data",809233716));var this$__$1 = this;var new_data_11617 = cljs.core.deref.call(null,self__.data);if(cljs.core._EQ_.call(null,rendered_data,new_data_11617))
{} else
{om.core.set_state_BANG_.call(null,self__.owner,new cljs.core.Keyword(null,"rendered-data","rendered-data",809233716),new_data_11617);
}
return React.DOM.div({"className": "timeline-chart", "ref": "chart"});
});
clustermap.components.timeline_chart.t11610.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11612){var self__ = this;
var _11612__$1 = this;return self__.meta11611;
});
clustermap.components.timeline_chart.t11610.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11612,meta11611__$1){var self__ = this;
var _11612__$1 = this;return (new clustermap.components.timeline_chart.t11610(self__.opts,self__.owner,self__.data,self__.timeline_chart,meta11611__$1));
});
clustermap.components.timeline_chart.__GT_t11610 = (function __GT_t11610(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta11611){return (new clustermap.components.timeline_chart.t11610(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta11611));
});
}
return (new clustermap.components.timeline_chart.t11610(opts,owner,data,timeline_chart,null));
});
