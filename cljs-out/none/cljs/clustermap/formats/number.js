...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__24207_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__24207_SHARP_);
...
return eng_notation__delegate.call(this,n,p__24208);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__24217){
var n = cljs.core.first(arglist__24217);
var p__24208 = cljs.core.rest(arglist__24217);
return eng_notation__delegate(n,p__24208);
});
...
var readable__delegate = function (n,p__24218){var map__24221 = p__24218;var map__24221__$1 = ((cljs.core.seq_QMARK_.call(null,map__24221))?cljs.core.apply.call(null,cljs.core.hash_map,map__24221):map__24221);var default$ = cljs.core.get.call(null,map__24221__$1,new cljs.core.Keyword(null,"default","default",2558708147));var plus_QMARK_ = cljs.core.get.call(null,map__24221__$1,new cljs.core.Keyword(null,"plus?","plus?",1120672087));var dec = cljs.core.get.call(null,map__24221__$1,new cljs.core.Keyword(null,"dec","dec",1014003572));if(cljs.core.truth_(n))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(round_n));var vec__24222 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__24222,0,null);var d_str = cljs.core.nth.call(null,vec__24222,1,null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return clustermap.formats.number.prefix_sign.call(null,t_dec_str,n,plus_QMARK_);
} else
{return default$;
}
};
var readable = function (n,var_args){
var p__24218 = null;if (arguments.length > 1) {
  p__24218 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return readable__delegate.call(this,n,p__24218);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__24223){
var n = cljs.core.first(arglist__24223);
var p__24218 = cljs.core.rest(arglist__24223);
return readable__delegate(n,p__24218);
});
