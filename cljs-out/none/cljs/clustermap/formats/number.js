...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__10698_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__10698_SHARP_);
...
return eng_notation__delegate.call(this,n,p__10699);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__10708){
var n = cljs.core.first(arglist__10708);
var p__10699 = cljs.core.rest(arglist__10708);
return eng_notation__delegate(n,p__10699);
});
...
var readable__delegate = function (n,p__10709){var map__10712 = p__10709;var map__10712__$1 = ((cljs.core.seq_QMARK_.call(null,map__10712))?cljs.core.apply.call(null,cljs.core.hash_map,map__10712):map__10712);var plus_QMARK_ = cljs.core.get.call(null,map__10712__$1,new cljs.core.Keyword(null,"plus?","plus?",1120672087));var dec = cljs.core.get.call(null,map__10712__$1,new cljs.core.Keyword(null,"dec","dec",1014003572));var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = [cljs.core.str(round_n)].join('');var vec__10713 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__10713,0,null);var d_str = cljs.core.nth.call(null,vec__10713,1,null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return clustermap.formats.number.prefix_sign.call(null,t_dec_str,n,plus_QMARK_);
};
...
return readable__delegate.call(this,n,p__10709);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__10714){
var n = cljs.core.first(arglist__10714);
var p__10709 = cljs.core.rest(arglist__10714);
return readable__delegate(n,p__10709);
});
