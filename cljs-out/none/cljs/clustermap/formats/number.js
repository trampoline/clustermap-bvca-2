...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__12455_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__12455_SHARP_);
...
var p__12456 = null;if (arguments.length > 1) {
  p__12456 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return eng_notation__delegate.call(this,n,p__12456);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__12465){
var n = cljs.core.first(arglist__12465);
var p__12456 = cljs.core.rest(arglist__12465);
return eng_notation__delegate(n,p__12456);
});
...
var readable__delegate = function (n,p__12466){var map__12469 = p__12466;var map__12469__$1 = ((cljs.core.seq_QMARK_.call(null,map__12469))?cljs.core.apply.call(null,cljs.core.hash_map,map__12469):map__12469);var default$ = cljs.core.get.call(null,map__12469__$1,new cljs.core.Keyword(null,"default","default",2558708147));var plus_QMARK_ = cljs.core.get.call(null,map__12469__$1,new cljs.core.Keyword(null,"plus?","plus?",1120672087));var dec = cljs.core.get.call(null,map__12469__$1,new cljs.core.Keyword(null,"dec","dec",1014003572));if(cljs.core.truth_(n))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = [cljs.core.str(round_n)].join('');var vec__12470 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__12470,0,null);var d_str = cljs.core.nth.call(null,vec__12470,1,null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return clustermap.formats.number.prefix_sign.call(null,t_dec_str,n,plus_QMARK_);
} else
{return default$;
}
};
var readable = function (n,var_args){
var p__12466 = null;if (arguments.length > 1) {
  p__12466 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return readable__delegate.call(this,n,p__12466);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__12471){
var n = cljs.core.first(arglist__12471);
var p__12466 = cljs.core.rest(arglist__12471);
return readable__delegate(n,p__12466);
});
