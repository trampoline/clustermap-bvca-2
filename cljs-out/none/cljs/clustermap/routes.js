...
clustermap.routes.portfolio_company_path = (function portfolio_company_path(view_id,obj){return [cljs.core.str("#/"),cljs.core.str(cljs.core.name.call(null,view_id)),cljs.core.str("/portfolio-company/"),cljs.core.str(new cljs.core.Keyword(null,"company_no","company_no",4461198389).cljs$core$IFn$_invoke$arity$1(obj))].join('');
});
clustermap.routes.investor_company_path = (function investor_company_path(view_id,obj){return [cljs.core.str("#/"),cljs.core.str(cljs.core.name.call(null,view_id)),cljs.core.str("/investor-company/"),cljs.core.str(new cljs.core.Keyword(null,"investor_company_uid","investor_company_uid",4184005593).cljs$core$IFn$_invoke$arity$1(obj))].join('');
});
clustermap.routes.constituency_path = (function constituency_path(view_id,obj){return [cljs.core.str("#/"),cljs.core.str(cljs.core.name.call(null,view_id)),cljs.core.str("/constituency/"),cljs.core.str(new cljs.core.Keyword(null,"boundaryline_id","boundaryline_id",3312170318).cljs$core$IFn$_invoke$arity$1(obj))].join('');
});
clustermap.routes.no_selection_path = (function no_selection_path(view_id,_){return [cljs.core.str("#/"),cljs.core.str(cljs.core.name.call(null,view_id))].join('');
});
