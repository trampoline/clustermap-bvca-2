...
{{
var G__52240 = (i + (1));
var G__52241 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__52240;
acc = G__52241;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t52245 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t52245 = (function (expr,base,xpath,meta52246){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t52245.cljs$lang$type = true;
domina.xpath.t52245.cljs$lang$ctorStr = "domina.xpath/t52245";
domina.xpath.t52245.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"domina.xpath/t52245");
});
domina.xpath.t52245.prototype.domina$DomContent$ = true;
domina.xpath.t52245.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t52245.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t52245.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52247){var self__ = this;
var _52247__$1 = this;return self__.meta52246;
});
domina.xpath.t52245.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52247,meta52246__$1){var self__ = this;
var _52247__$1 = this;return (new domina.xpath.t52245(self__.expr,self__.base,self__.xpath,meta52246__$1));
});
domina.xpath.__GT_t52245 = (function __GT_t52245(expr__$1,base__$1,xpath__$1,meta52246){return (new domina.xpath.t52245(expr__$1,base__$1,xpath__$1,meta52246));
});
}
return (new domina.xpath.t52245(expr,base,xpath,null));
});
