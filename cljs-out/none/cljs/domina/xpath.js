...
{{
var G__57668 = (i + (1));
var G__57669 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__57668;
acc = G__57669;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t57673 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t57673 = (function (expr,base,xpath,meta57674){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t57673.cljs$lang$type = true;
domina.xpath.t57673.cljs$lang$ctorStr = "domina.xpath/t57673";
domina.xpath.t57673.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"domina.xpath/t57673");
});
domina.xpath.t57673.prototype.domina$DomContent$ = true;
domina.xpath.t57673.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t57673.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t57673.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_57675){var self__ = this;
var _57675__$1 = this;return self__.meta57674;
});
domina.xpath.t57673.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_57675,meta57674__$1){var self__ = this;
var _57675__$1 = this;return (new domina.xpath.t57673(self__.expr,self__.base,self__.xpath,meta57674__$1));
});
domina.xpath.__GT_t57673 = (function __GT_t57673(expr__$1,base__$1,xpath__$1,meta57674){return (new domina.xpath.t57673(expr__$1,base__$1,xpath__$1,meta57674));
});
}
return (new domina.xpath.t57673(expr,base,xpath,null));
});
