...
{{
var G__17004 = (i + 1);
var G__17005 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__17004;
acc = G__17005;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t17009 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t17009 = (function (expr,base,xpath,meta17010){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t17009.cljs$lang$type = true;
domina.xpath.t17009.cljs$lang$ctorStr = "domina.xpath/t17009";
domina.xpath.t17009.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t17009");
});
domina.xpath.t17009.prototype.domina$DomContent$ = true;
domina.xpath.t17009.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17009.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17009.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17011){var self__ = this;
var _17011__$1 = this;return self__.meta17010;
});
domina.xpath.t17009.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17011,meta17010__$1){var self__ = this;
var _17011__$1 = this;return (new domina.xpath.t17009(self__.expr,self__.base,self__.xpath,meta17010__$1));
});
domina.xpath.__GT_t17009 = (function __GT_t17009(expr__$1,base__$1,xpath__$1,meta17010){return (new domina.xpath.t17009(expr__$1,base__$1,xpath__$1,meta17010));
});
}
return (new domina.xpath.t17009(expr,base,xpath,null));
});
