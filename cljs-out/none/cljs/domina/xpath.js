...
{{
var G__17120 = (i + 1);
var G__17121 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__17120;
acc = G__17121;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t17125 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t17125 = (function (expr,base,xpath,meta17126){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t17125.cljs$lang$type = true;
domina.xpath.t17125.cljs$lang$ctorStr = "domina.xpath/t17125";
domina.xpath.t17125.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t17125");
});
domina.xpath.t17125.prototype.domina$DomContent$ = true;
domina.xpath.t17125.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17125.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17125.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17127){var self__ = this;
var _17127__$1 = this;return self__.meta17126;
});
domina.xpath.t17125.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17127,meta17126__$1){var self__ = this;
var _17127__$1 = this;return (new domina.xpath.t17125(self__.expr,self__.base,self__.xpath,meta17126__$1));
});
domina.xpath.__GT_t17125 = (function __GT_t17125(expr__$1,base__$1,xpath__$1,meta17126){return (new domina.xpath.t17125(expr__$1,base__$1,xpath__$1,meta17126));
});
}
return (new domina.xpath.t17125(expr,base,xpath,null));
});
