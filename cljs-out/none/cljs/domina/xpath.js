...
{{
var G__16423 = (i + 1);
var G__16424 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__16423;
acc = G__16424;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t16428 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t16428 = (function (expr,base,xpath,meta16429){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t16428.cljs$lang$type = true;
domina.xpath.t16428.cljs$lang$ctorStr = "domina.xpath/t16428";
domina.xpath.t16428.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t16428");
});
domina.xpath.t16428.prototype.domina$DomContent$ = true;
domina.xpath.t16428.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16428.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16428.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16430){var self__ = this;
var _16430__$1 = this;return self__.meta16429;
});
domina.xpath.t16428.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16430,meta16429__$1){var self__ = this;
var _16430__$1 = this;return (new domina.xpath.t16428(self__.expr,self__.base,self__.xpath,meta16429__$1));
});
domina.xpath.__GT_t16428 = (function __GT_t16428(expr__$1,base__$1,xpath__$1,meta16429){return (new domina.xpath.t16428(expr__$1,base__$1,xpath__$1,meta16429));
});
}
return (new domina.xpath.t16428(expr,base,xpath,null));
});
