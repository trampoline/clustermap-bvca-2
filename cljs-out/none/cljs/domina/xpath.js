...
{{
var G__16980 = (i + 1);
var G__16981 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__16980;
acc = G__16981;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t16985 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t16985 = (function (expr,base,xpath,meta16986){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t16985.cljs$lang$type = true;
domina.xpath.t16985.cljs$lang$ctorStr = "domina.xpath/t16985";
domina.xpath.t16985.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t16985");
});
domina.xpath.t16985.prototype.domina$DomContent$ = true;
domina.xpath.t16985.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16985.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16985.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16987){var self__ = this;
var _16987__$1 = this;return self__.meta16986;
});
domina.xpath.t16985.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16987,meta16986__$1){var self__ = this;
var _16987__$1 = this;return (new domina.xpath.t16985(self__.expr,self__.base,self__.xpath,meta16986__$1));
});
domina.xpath.__GT_t16985 = (function __GT_t16985(expr__$1,base__$1,xpath__$1,meta16986){return (new domina.xpath.t16985(expr__$1,base__$1,xpath__$1,meta16986));
});
}
return (new domina.xpath.t16985(expr,base,xpath,null));
});
