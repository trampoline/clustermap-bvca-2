...
{{
var G__16938 = (i + 1);
var G__16939 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__16938;
acc = G__16939;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t16943 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t16943 = (function (expr,base,xpath,meta16944){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t16943.cljs$lang$type = true;
domina.xpath.t16943.cljs$lang$ctorStr = "domina.xpath/t16943";
domina.xpath.t16943.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t16943");
});
domina.xpath.t16943.prototype.domina$DomContent$ = true;
domina.xpath.t16943.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16943.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16943.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16945){var self__ = this;
var _16945__$1 = this;return self__.meta16944;
});
domina.xpath.t16943.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16945,meta16944__$1){var self__ = this;
var _16945__$1 = this;return (new domina.xpath.t16943(self__.expr,self__.base,self__.xpath,meta16944__$1));
});
domina.xpath.__GT_t16943 = (function __GT_t16943(expr__$1,base__$1,xpath__$1,meta16944){return (new domina.xpath.t16943(expr__$1,base__$1,xpath__$1,meta16944));
});
}
return (new domina.xpath.t16943(expr,base,xpath,null));
});
