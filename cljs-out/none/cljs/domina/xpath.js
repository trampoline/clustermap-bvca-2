...
{{
var G__56096 = (i + (1));
var G__56097 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__56096;
acc = G__56097;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t56101 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t56101 = (function (expr,base,xpath,meta56102){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t56101.cljs$lang$type = true;
domina.xpath.t56101.cljs$lang$ctorStr = "domina.xpath/t56101";
domina.xpath.t56101.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"domina.xpath/t56101");
});
domina.xpath.t56101.prototype.domina$DomContent$ = true;
domina.xpath.t56101.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t56101.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t56101.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_56103){var self__ = this;
var _56103__$1 = this;return self__.meta56102;
});
domina.xpath.t56101.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_56103,meta56102__$1){var self__ = this;
var _56103__$1 = this;return (new domina.xpath.t56101(self__.expr,self__.base,self__.xpath,meta56102__$1));
});
domina.xpath.__GT_t56101 = (function __GT_t56101(expr__$1,base__$1,xpath__$1,meta56102){return (new domina.xpath.t56101(expr__$1,base__$1,xpath__$1,meta56102));
});
}
return (new domina.xpath.t56101(expr,base,xpath,null));
});
