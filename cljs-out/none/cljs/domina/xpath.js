...
{{
var G__15384 = (i + 1);
var G__15385 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__15384;
acc = G__15385;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t15389 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t15389 = (function (expr,base,xpath,meta15390){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t15389.cljs$lang$type = true;
domina.xpath.t15389.cljs$lang$ctorStr = "domina.xpath/t15389";
domina.xpath.t15389.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t15389");
});
domina.xpath.t15389.prototype.domina$DomContent$ = true;
domina.xpath.t15389.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t15389.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t15389.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15391){var self__ = this;
var _15391__$1 = this;return self__.meta15390;
});
domina.xpath.t15389.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15391,meta15390__$1){var self__ = this;
var _15391__$1 = this;return (new domina.xpath.t15389(self__.expr,self__.base,self__.xpath,meta15390__$1));
});
domina.xpath.__GT_t15389 = (function __GT_t15389(expr__$1,base__$1,xpath__$1,meta15390){return (new domina.xpath.t15389(expr__$1,base__$1,xpath__$1,meta15390));
});
}
return (new domina.xpath.t15389(expr,base,xpath,null));
});
