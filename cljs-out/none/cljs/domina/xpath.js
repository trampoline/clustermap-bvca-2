...
{{
var G__14408 = (i + 1);
var G__14409 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__14408;
acc = G__14409;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t14413 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t14413 = (function (expr,base,xpath,meta14414){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t14413.cljs$lang$type = true;
domina.xpath.t14413.cljs$lang$ctorStr = "domina.xpath/t14413";
domina.xpath.t14413.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t14413");
});
domina.xpath.t14413.prototype.domina$DomContent$ = true;
domina.xpath.t14413.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t14413.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t14413.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14415){var self__ = this;
var _14415__$1 = this;return self__.meta14414;
});
domina.xpath.t14413.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14415,meta14414__$1){var self__ = this;
var _14415__$1 = this;return (new domina.xpath.t14413(self__.expr,self__.base,self__.xpath,meta14414__$1));
});
domina.xpath.__GT_t14413 = (function __GT_t14413(expr__$1,base__$1,xpath__$1,meta14414){return (new domina.xpath.t14413(expr__$1,base__$1,xpath__$1,meta14414));
});
}
return (new domina.xpath.t14413(expr,base,xpath,null));
});
