...
{{
var G__28482 = (i + 1);
var G__28483 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__28482;
acc = G__28483;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t28487 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t28487 = (function (expr,base,xpath,meta28488){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t28487.cljs$lang$type = true;
domina.xpath.t28487.cljs$lang$ctorStr = "domina.xpath/t28487";
domina.xpath.t28487.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t28487");
});
domina.xpath.t28487.prototype.domina$DomContent$ = true;
domina.xpath.t28487.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28487.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28487.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28489){var self__ = this;
var _28489__$1 = this;return self__.meta28488;
});
domina.xpath.t28487.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28489,meta28488__$1){var self__ = this;
var _28489__$1 = this;return (new domina.xpath.t28487(self__.expr,self__.base,self__.xpath,meta28488__$1));
});
domina.xpath.__GT_t28487 = (function __GT_t28487(expr__$1,base__$1,xpath__$1,meta28488){return (new domina.xpath.t28487(expr__$1,base__$1,xpath__$1,meta28488));
});
}
return (new domina.xpath.t28487(expr,base,xpath,null));
});
