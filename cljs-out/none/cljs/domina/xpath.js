...
{{
var G__17112 = (i + 1);
var G__17113 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__17112;
acc = G__17113;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t17117 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t17117 = (function (expr,base,xpath,meta17118){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t17117.cljs$lang$type = true;
domina.xpath.t17117.cljs$lang$ctorStr = "domina.xpath/t17117";
domina.xpath.t17117.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t17117");
});
domina.xpath.t17117.prototype.domina$DomContent$ = true;
domina.xpath.t17117.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17117.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17117.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17119){var self__ = this;
var _17119__$1 = this;return self__.meta17118;
});
domina.xpath.t17117.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17119,meta17118__$1){var self__ = this;
var _17119__$1 = this;return (new domina.xpath.t17117(self__.expr,self__.base,self__.xpath,meta17118__$1));
});
domina.xpath.__GT_t17117 = (function __GT_t17117(expr__$1,base__$1,xpath__$1,meta17118){return (new domina.xpath.t17117(expr__$1,base__$1,xpath__$1,meta17118));
});
}
return (new domina.xpath.t17117(expr,base,xpath,null));
});
