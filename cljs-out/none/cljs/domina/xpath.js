...
{{
var G__15012 = (i + 1);
var G__15013 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__15012;
acc = G__15013;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t15017 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t15017 = (function (expr,base,xpath,meta15018){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t15017.cljs$lang$type = true;
domina.xpath.t15017.cljs$lang$ctorStr = "domina.xpath/t15017";
domina.xpath.t15017.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t15017");
});
domina.xpath.t15017.prototype.domina$DomContent$ = true;
domina.xpath.t15017.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t15017.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t15017.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15019){var self__ = this;
var _15019__$1 = this;return self__.meta15018;
});
domina.xpath.t15017.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15019,meta15018__$1){var self__ = this;
var _15019__$1 = this;return (new domina.xpath.t15017(self__.expr,self__.base,self__.xpath,meta15018__$1));
});
domina.xpath.__GT_t15017 = (function __GT_t15017(expr__$1,base__$1,xpath__$1,meta15018){return (new domina.xpath.t15017(expr__$1,base__$1,xpath__$1,meta15018));
});
}
return (new domina.xpath.t15017(expr,base,xpath,null));
});
