...
{{
var G__15132 = (i + 1);
var G__15133 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__15132;
acc = G__15133;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t15137 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t15137 = (function (expr,base,xpath,meta15138){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t15137.cljs$lang$type = true;
domina.xpath.t15137.cljs$lang$ctorStr = "domina.xpath/t15137";
domina.xpath.t15137.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t15137");
});
domina.xpath.t15137.prototype.domina$DomContent$ = true;
domina.xpath.t15137.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t15137.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t15137.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15139){var self__ = this;
var _15139__$1 = this;return self__.meta15138;
});
domina.xpath.t15137.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15139,meta15138__$1){var self__ = this;
var _15139__$1 = this;return (new domina.xpath.t15137(self__.expr,self__.base,self__.xpath,meta15138__$1));
});
domina.xpath.__GT_t15137 = (function __GT_t15137(expr__$1,base__$1,xpath__$1,meta15138){return (new domina.xpath.t15137(expr__$1,base__$1,xpath__$1,meta15138));
});
}
return (new domina.xpath.t15137(expr,base,xpath,null));
});
