...
{{
var G__19081 = (i + 1);
var G__19082 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__19081;
acc = G__19082;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t19086 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t19086 = (function (expr,base,xpath,meta19087){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t19086.cljs$lang$type = true;
domina.xpath.t19086.cljs$lang$ctorStr = "domina.xpath/t19086";
domina.xpath.t19086.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"domina.xpath/t19086");
});
domina.xpath.t19086.prototype.domina$DomContent$ = true;
domina.xpath.t19086.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t19086.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t19086.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19088){var self__ = this;
var _19088__$1 = this;return self__.meta19087;
});
domina.xpath.t19086.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19088,meta19087__$1){var self__ = this;
var _19088__$1 = this;return (new domina.xpath.t19086(self__.expr,self__.base,self__.xpath,meta19087__$1));
});
domina.xpath.__GT_t19086 = (function __GT_t19086(expr__$1,base__$1,xpath__$1,meta19087){return (new domina.xpath.t19086(expr__$1,base__$1,xpath__$1,meta19087));
});
}
return (new domina.xpath.t19086(expr,base,xpath,null));
});
