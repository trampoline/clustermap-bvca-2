...
{{
var G__16942 = (i + 1);
var G__16943 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__16942;
acc = G__16943;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t16947 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t16947 = (function (expr,base,xpath,meta16948){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t16947.cljs$lang$type = true;
domina.xpath.t16947.cljs$lang$ctorStr = "domina.xpath/t16947";
domina.xpath.t16947.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t16947");
});
domina.xpath.t16947.prototype.domina$DomContent$ = true;
domina.xpath.t16947.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16947.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16947.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16949){var self__ = this;
var _16949__$1 = this;return self__.meta16948;
});
domina.xpath.t16947.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16949,meta16948__$1){var self__ = this;
var _16949__$1 = this;return (new domina.xpath.t16947(self__.expr,self__.base,self__.xpath,meta16948__$1));
});
domina.xpath.__GT_t16947 = (function __GT_t16947(expr__$1,base__$1,xpath__$1,meta16948){return (new domina.xpath.t16947(expr__$1,base__$1,xpath__$1,meta16948));
});
}
return (new domina.xpath.t16947(expr,base,xpath,null));
});
