...
{{
var G__14917 = (i + 1);
var G__14918 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__14917;
acc = G__14918;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t14922 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t14922 = (function (expr,base,xpath,meta14923){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t14922.cljs$lang$type = true;
domina.xpath.t14922.cljs$lang$ctorStr = "domina.xpath/t14922";
domina.xpath.t14922.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t14922");
});
domina.xpath.t14922.prototype.domina$DomContent$ = true;
domina.xpath.t14922.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t14922.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t14922.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14924){var self__ = this;
var _14924__$1 = this;return self__.meta14923;
});
domina.xpath.t14922.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14924,meta14923__$1){var self__ = this;
var _14924__$1 = this;return (new domina.xpath.t14922(self__.expr,self__.base,self__.xpath,meta14923__$1));
});
domina.xpath.__GT_t14922 = (function __GT_t14922(expr__$1,base__$1,xpath__$1,meta14923){return (new domina.xpath.t14922(expr__$1,base__$1,xpath__$1,meta14923));
});
}
return (new domina.xpath.t14922(expr,base,xpath,null));
});
