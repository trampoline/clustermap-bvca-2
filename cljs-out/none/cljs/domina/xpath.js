...
{{
var G__28530 = (i + 1);
var G__28531 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__28530;
acc = G__28531;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t28535 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t28535 = (function (expr,base,xpath,meta28536){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t28535.cljs$lang$type = true;
domina.xpath.t28535.cljs$lang$ctorStr = "domina.xpath/t28535";
domina.xpath.t28535.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t28535");
});
domina.xpath.t28535.prototype.domina$DomContent$ = true;
domina.xpath.t28535.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28535.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28535.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28537){var self__ = this;
var _28537__$1 = this;return self__.meta28536;
});
domina.xpath.t28535.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28537,meta28536__$1){var self__ = this;
var _28537__$1 = this;return (new domina.xpath.t28535(self__.expr,self__.base,self__.xpath,meta28536__$1));
});
domina.xpath.__GT_t28535 = (function __GT_t28535(expr__$1,base__$1,xpath__$1,meta28536){return (new domina.xpath.t28535(expr__$1,base__$1,xpath__$1,meta28536));
});
}
return (new domina.xpath.t28535(expr,base,xpath,null));
});
