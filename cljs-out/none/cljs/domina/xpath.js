...
{{
var G__16680 = (i + 1);
var G__16681 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__16680;
acc = G__16681;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t16685 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t16685 = (function (expr,base,xpath,meta16686){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t16685.cljs$lang$type = true;
domina.xpath.t16685.cljs$lang$ctorStr = "domina.xpath/t16685";
domina.xpath.t16685.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t16685");
});
domina.xpath.t16685.prototype.domina$DomContent$ = true;
domina.xpath.t16685.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16685.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t16685.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16687){var self__ = this;
var _16687__$1 = this;return self__.meta16686;
});
domina.xpath.t16685.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16687,meta16686__$1){var self__ = this;
var _16687__$1 = this;return (new domina.xpath.t16685(self__.expr,self__.base,self__.xpath,meta16686__$1));
});
domina.xpath.__GT_t16685 = (function __GT_t16685(expr__$1,base__$1,xpath__$1,meta16686){return (new domina.xpath.t16685(expr__$1,base__$1,xpath__$1,meta16686));
});
}
return (new domina.xpath.t16685(expr,base,xpath,null));
});
