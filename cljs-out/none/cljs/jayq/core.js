...
var G__16229 = null;
var G__16229__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__16229__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
G__16229 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__16229__2.call(this,self__,k);
case 3:
return G__16229__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
return G__16229;
...
;
jQuery.prototype.apply = (function (self__,args16228){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args16228)));
});
...
var hide__delegate = function ($elem,p__16230){var vec__16232 = p__16230;var speed = cljs.core.nth.call(null,vec__16232,0,null);var on_finish = cljs.core.nth.call(null,vec__16232,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__16230 = null;if (arguments.length > 1) {
  p__16230 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__16230);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__16233){
var $elem = cljs.core.first(arglist__16233);
var p__16230 = cljs.core.rest(arglist__16233);
return hide__delegate($elem,p__16230);
});
...
var show__delegate = function ($elem,p__16234){var vec__16236 = p__16234;var speed = cljs.core.nth.call(null,vec__16236,0,null);var on_finish = cljs.core.nth.call(null,vec__16236,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__16234 = null;if (arguments.length > 1) {
  p__16234 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__16234);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__16237){
var $elem = cljs.core.first(arglist__16237);
var p__16234 = cljs.core.rest(arglist__16237);
return show__delegate($elem,p__16234);
});
...
var toggle__delegate = function ($elem,p__16238){var vec__16240 = p__16238;var speed = cljs.core.nth.call(null,vec__16240,0,null);var on_finish = cljs.core.nth.call(null,vec__16240,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__16238 = null;if (arguments.length > 1) {
  p__16238 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__16238);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__16241){
var $elem = cljs.core.first(arglist__16241);
var p__16238 = cljs.core.rest(arglist__16241);
return toggle__delegate($elem,p__16238);
});
...
var fade_out__delegate = function ($elem,p__16242){var vec__16244 = p__16242;var speed = cljs.core.nth.call(null,vec__16244,0,null);var on_finish = cljs.core.nth.call(null,vec__16244,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__16242 = null;if (arguments.length > 1) {
  p__16242 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__16242);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__16245){
var $elem = cljs.core.first(arglist__16245);
var p__16242 = cljs.core.rest(arglist__16245);
return fade_out__delegate($elem,p__16242);
});
...
var fade_in__delegate = function ($elem,p__16246){var vec__16248 = p__16246;var speed = cljs.core.nth.call(null,vec__16248,0,null);var on_finish = cljs.core.nth.call(null,vec__16248,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__16246 = null;if (arguments.length > 1) {
  p__16246 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__16246);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__16249){
var $elem = cljs.core.first(arglist__16249);
var p__16246 = cljs.core.rest(arglist__16249);
return fade_in__delegate($elem,p__16246);
});
...
var slide_up__delegate = function ($elem,p__16250){var vec__16252 = p__16250;var speed = cljs.core.nth.call(null,vec__16252,0,null);var on_finish = cljs.core.nth.call(null,vec__16252,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__16250 = null;if (arguments.length > 1) {
  p__16250 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__16250);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__16253){
var $elem = cljs.core.first(arglist__16253);
var p__16250 = cljs.core.rest(arglist__16253);
return slide_up__delegate($elem,p__16250);
});
...
var slide_down__delegate = function ($elem,p__16254){var vec__16256 = p__16254;var speed = cljs.core.nth.call(null,vec__16256,0,null);var on_finish = cljs.core.nth.call(null,vec__16256,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__16254 = null;if (arguments.length > 1) {
  p__16254 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__16254);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__16257){
var $elem = cljs.core.first(arglist__16257);
var p__16254 = cljs.core.rest(arglist__16257);
return slide_down__delegate($elem,p__16254);
});
...
var closest__delegate = function ($elem,selector,p__16258){var vec__16260 = p__16258;var context = cljs.core.nth.call(null,vec__16260,0,null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__16258 = null;if (arguments.length > 2) {
  p__16258 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__16258);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__16261){
var $elem = cljs.core.first(arglist__16261);
arglist__16261 = cljs.core.next(arglist__16261);
var selector = cljs.core.first(arglist__16261);
var p__16258 = cljs.core.rest(arglist__16261);
return closest__delegate($elem,selector,p__16258);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__16264){var map__16266 = p__16264;var map__16266__$1 = ((cljs.core.seq_QMARK_.call(null,map__16266))?cljs.core.apply.call(null,cljs.core.hash_map,map__16266):map__16266);var request = map__16266__$1;var contentType = cljs.core.get.call(null,map__16266__$1,new cljs.core.Keyword(null,"contentType","contentType",624772805));var data = cljs.core.get.call(null,map__16266__$1,new cljs.core.Keyword(null,"data","data",1016980252));var ct = jayq.core.__GT_content_type.call(null,contentType);return (function (p1__16263_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__16263_SHARP_,new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.pr_str.call(null,data));
} else
{return p1__16263_SHARP_;
}
}).call(null,(function (p1__16262_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__16262_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",624772805),ct);
} else
...
var unbind__delegate = function ($elem,ev,p__16270){var vec__16272 = p__16270;var func = cljs.core.nth.call(null,vec__16272,0,null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__16270 = null;if (arguments.length > 2) {
  p__16270 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__16270);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__16273){
var $elem = cljs.core.first(arglist__16273);
arglist__16273 = cljs.core.next(arglist__16273);
var ev = cljs.core.first(arglist__16273);
var p__16270 = cljs.core.rest(arglist__16273);
return unbind__delegate($elem,ev,p__16270);
});
...
var on__delegate = function ($elem,events,p__16274){var vec__16276 = p__16274;var sel = cljs.core.nth.call(null,vec__16276,0,null);var data = cljs.core.nth.call(null,vec__16276,1,null);var handler = cljs.core.nth.call(null,vec__16276,2,null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__16274 = null;if (arguments.length > 2) {
  p__16274 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__16274);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__16277){
var $elem = cljs.core.first(arglist__16277);
arglist__16277 = cljs.core.next(arglist__16277);
var events = cljs.core.first(arglist__16277);
var p__16274 = cljs.core.rest(arglist__16277);
return on__delegate($elem,events,p__16274);
});
...
var one__delegate = function ($elem,events,p__16278){var vec__16280 = p__16278;var sel = cljs.core.nth.call(null,vec__16280,0,null);var data = cljs.core.nth.call(null,vec__16280,1,null);var handler = cljs.core.nth.call(null,vec__16280,2,null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__16278 = null;if (arguments.length > 2) {
  p__16278 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__16278);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__16281){
var $elem = cljs.core.first(arglist__16281);
arglist__16281 = cljs.core.next(arglist__16281);
var events = cljs.core.first(arglist__16281);
var p__16278 = cljs.core.rest(arglist__16281);
return one__delegate($elem,events,p__16278);
});
...
var off__delegate = function ($elem,events,p__16282){var vec__16284 = p__16282;var sel = cljs.core.nth.call(null,vec__16284,0,null);var handler = cljs.core.nth.call(null,vec__16284,1,null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__16282 = null;if (arguments.length > 2) {
  p__16282 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__16282);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__16285){
var $elem = cljs.core.first(arglist__16285);
arglist__16285 = cljs.core.next(arglist__16285);
var events = cljs.core.first(arglist__16285);
var p__16282 = cljs.core.rest(arglist__16285);
return off__delegate($elem,events,p__16282);
});
...
done.cljs$lang$applyTo = (function (arglist__16286){
...
fail.cljs$lang$applyTo = (function (arglist__16287){
...
always.cljs$lang$applyTo = (function (arglist__16288){
var deferred = cljs.core.first(arglist__16288);
var fns_args = cljs.core.rest(arglist__16288);
