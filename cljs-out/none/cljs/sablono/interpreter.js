...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj16161 = {};return obj16161;
})();
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__16163 = sablono.util.normalize_element.call(null,element__$1);var tag = cljs.core.nth.call(null,vec__16163,0,null);var attrs = cljs.core.nth.call(null,vec__16163,1,null);var content = cljs.core.nth.call(null,vec__16163,2,null);var dom_fn = (React.DOM[cljs.core.name.call(null,tag)]);if(cljs.core.truth_(content))
