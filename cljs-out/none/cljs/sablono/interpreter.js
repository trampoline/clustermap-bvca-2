...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj15746 = {};return obj15746;
})();
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__15748 = sablono.util.normalize_element.call(null,element__$1);var tag = cljs.core.nth.call(null,vec__15748,0,null);var attrs = cljs.core.nth.call(null,vec__15748,1,null);var content = cljs.core.nth.call(null,vec__15748,2,null);var dom_fn = (React.DOM[cljs.core.name.call(null,tag)]);if(cljs.core.truth_(content))
