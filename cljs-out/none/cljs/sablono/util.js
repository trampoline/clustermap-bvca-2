...
sablono.util.ToString = (function (){var obj15865 = {};return obj15865;
})();
...
sablono.util.ToURI = (function (){var obj15867 = {};return obj15867;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__15868){
var xs = cljs.core.seq(arglist__15868);
...
*/
sablono.util.camelcase_key = (function camelcase_key(k){var vec__15870 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__15870,0,null);var words = cljs.core.nthnext.call(null,vec__15870,1);if(cljs.core.empty_QMARK_.call(null,words))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15871_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__15871_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15871_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__15871_SHARP_))
{return p1__15871_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__15872){
var maps = cljs.core.seq(arglist__15872);
...
*/
sablono.util.normalize_element = (function normalize_element(p__15873){var vec__15876 = p__15873;var tag = cljs.core.nth.call(null,vec__15876,0,null);var content = cljs.core.nthnext.call(null,vec__15876,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__15877 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__15877,0,null);var tag__$1 = cljs.core.nth.call(null,vec__15877,1,null);var id = cljs.core.nth.call(null,vec__15877,2,null);var class$ = cljs.core.nth.call(null,vec__15877,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
