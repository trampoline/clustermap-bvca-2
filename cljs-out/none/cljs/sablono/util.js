...
sablono.util.ToString = (function (){var obj15442 = {};return obj15442;
})();
...
sablono.util.ToURI = (function (){var obj15444 = {};return obj15444;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__15445){
var xs = cljs.core.seq(arglist__15445);
...
*/
sablono.util.camelcase_key = (function camelcase_key(k){var vec__15447 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__15447,0,null);var words = cljs.core.nthnext.call(null,vec__15447,1);if(cljs.core.empty_QMARK_.call(null,words))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15448_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__15448_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15448_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__15448_SHARP_))
{return p1__15448_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__15449){
var maps = cljs.core.seq(arglist__15449);
...
*/
sablono.util.normalize_element = (function normalize_element(p__15450){var vec__15453 = p__15450;var tag = cljs.core.nth.call(null,vec__15453,0,null);var content = cljs.core.nthnext.call(null,vec__15453,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
