...
sablono.util.ToString = (function (){var obj16566 = {};return obj16566;
})();
...
sablono.util.ToURI = (function (){var obj16568 = {};return obj16568;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__16569){
var xs = cljs.core.seq(arglist__16569);
...
{var vec__16571 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__16571,0,null);var words = cljs.core.nthnext.call(null,vec__16571,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__16572_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__16572_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16572_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__16572_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__16573){
var maps = cljs.core.seq(arglist__16573);
...
*/
sablono.util.normalize_element = (function normalize_element(p__16574){var vec__16577 = p__16574;var tag = cljs.core.nth.call(null,vec__16577,0,null);var content = cljs.core.nthnext.call(null,vec__16577,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
