...
sablono.util.ToString = (function (){var obj15882 = {};return obj15882;
})();
...
sablono.util.ToURI = (function (){var obj15884 = {};return obj15884;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__15885){
var xs = cljs.core.seq(arglist__15885);
...
{var vec__15887 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__15887,0,null);var words = cljs.core.nthnext.call(null,vec__15887,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15888_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__15888_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15888_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__15888_SHARP_))
{return p1__15888_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__15889){
var maps = cljs.core.seq(arglist__15889);
...
*/
sablono.util.normalize_element = (function normalize_element(p__15890){var vec__15893 = p__15890;var tag = cljs.core.nth.call(null,vec__15893,0,null);var content = cljs.core.nthnext.call(null,vec__15893,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
