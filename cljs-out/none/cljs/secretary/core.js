...
{return cljs.core.every_QMARK_.call(null,cljs.core.true_QMARK_,cljs.core.map.call(null,(function (p1__16350_SHARP_,p2__16351_SHARP_){return secretary.core.component_matches_QMARK_.call(null,p1__16350_SHARP_,p2__16351_SHARP_);
}),r,u));
} else
{return null;
}
});
secretary.core.filter_routes = (function filter_routes(pred,uri_path){return cljs.core.filter.call(null,(function (p1__16352_SHARP_){return pred.call(null,cljs.core.first.call(null,p1__16352_SHARP_),uri_path);
}),cljs.core.deref.call(null,secretary.core._STAR_routes_STAR_));
});
/**
* Turns a map of query parameters into url encoded string.
*/
secretary.core.encode_query_params = (function encode_query_params(query_params){return clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p__16355){var vec__16356 = p__16355;var k = cljs.core.nth.call(null,vec__16356,0,null);var v = cljs.core.nth.call(null,vec__16356,1,null);return [cljs.core.str(cljs.core.name.call(null,k)),cljs.core.str("="),cljs.core.str(encodeURIComponent([cljs.core.str(v)].join('')))].join('');
}),query_params));
});
/**
* Extract a map of query parameters from a query string.
*/
secretary.core.decode_query_params = (function decode_query_params(query_string){return cljs.core.reduce.call(null,(function (m,param){var vec__16358 = clojure.string.split.call(null,param,/=/,2);var k = cljs.core.nth.call(null,vec__16358,0,null);var v = cljs.core.nth.call(null,vec__16358,1,null);var v__$1 = decodeURIComponent(v);return cljs.core.assoc.call(null,m,k,v__$1);
...
{return cljs.core.apply.call(null,cljs.core.merge,(function (){var iter__4117__auto__ = (function iter__16363(s__16364){return (new cljs.core.LazySeq(null,(function (){var s__16364__$1 = s__16364;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__16364__$1);if(temp__4092__auto__)
{var s__16364__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__16364__$2))
{var c__4115__auto__ = cljs.core.chunk_first.call(null,s__16364__$2);var size__4116__auto__ = cljs.core.count.call(null,c__4115__auto__);var b__16366 = cljs.core.chunk_buffer.call(null,size__4116__auto__);if((function (){var i__16365 = 0;while(true){
if((i__16365 < size__4116__auto__))
{var z = cljs.core._nth.call(null,c__4115__auto__,i__16365);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{cljs.core.chunk_append.call(null,b__16366,c);
{
var G__16367 = (i__16365 + 1);
i__16365 = G__16367;
continue;
}
} else
{{
var G__16368 = (i__16365 + 1);
i__16365 = G__16368;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__16366),iter__16363.call(null,cljs.core.chunk_rest.call(null,s__16364__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__16366),null);
}
} else
{var z = cljs.core.first.call(null,s__16364__$2);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{return cljs.core.cons.call(null,c,iter__16363.call(null,cljs.core.rest.call(null,s__16364__$2)));
} else
{{
var G__16369 = cljs.core.rest.call(null,s__16364__$2);
s__16364__$1 = G__16369;
continue;
}
}
}
...
{var vec__16372 = temp__4090__auto__;var route = cljs.core.nth.call(null,vec__16372,0,null);var action = cljs.core.nth.call(null,vec__16372,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [action,cljs.core.PersistentArrayMap.EMPTY], null);
} else
...
{var xs__4579__auto__ = temp__4092__auto__;var vec__16373 = cljs.core.first.call(null,xs__4579__auto__);var route = cljs.core.nth.call(null,vec__16373,0,null);var action = cljs.core.nth.call(null,vec__16373,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [action,secretary.core.extract_components.call(null,route,uri_path)], null);
} else
{return null;
}
}
...
*/
secretary.core.dispatch_BANG_ = (function dispatch_BANG_(uri){var vec__16376 = clojure.string.split.call(null,uri,/\?/);var uri_path = cljs.core.nth.call(null,vec__16376,0,null);var query_string = cljs.core.nth.call(null,vec__16376,1,null);var query_params = (cljs.core.truth_(query_string)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"query-params","query-params",1080249757),secretary.core.decode_query_params.call(null,query_string)], null):null);var vec__16377 = secretary.core.parse_action.call(null,uri_path);var action = cljs.core.nth.call(null,vec__16377,0,null);var params = cljs.core.nth.call(null,vec__16377,1,null);var action__$1 = (function (){var or__3406__auto__ = action;if(cljs.core.truth_(or__3406__auto__))
...
var render_route__2 = (function (route,p__16378){var map__16380 = p__16378;var map__16380__$1 = ((cljs.core.seq_QMARK_.call(null,map__16380))?cljs.core.apply.call(null,cljs.core.hash_map,map__16380):map__16380);var m = map__16380__$1;var query_params = cljs.core.get.call(null,map__16380__$1,new cljs.core.Keyword(null,"query-params","query-params",1080249757));var path = route.replace((new RegExp(":[^/]+","g")),(function ($1){var lookup = cljs.core.keyword.call(null,cljs.core.subs.call(null,$1,1));return m.call(null,lookup,$1);
