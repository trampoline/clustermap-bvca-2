...
{return cljs.core.every_QMARK_.call(null,cljs.core.true_QMARK_,cljs.core.map.call(null,(function (p1__15753_SHARP_,p2__15754_SHARP_){return secretary.core.component_matches_QMARK_.call(null,p1__15753_SHARP_,p2__15754_SHARP_);
}),r,u));
} else
{return null;
}
...
*/
secretary.core.any_matches_QMARK_ = (function any_matches_QMARK_(uri_path){return cljs.core.some.call(null,(function (p1__15755_SHARP_){return secretary.core.route_matches_QMARK_.call(null,cljs.core.first.call(null,p1__15755_SHARP_),uri_path);
...
{return cljs.core.apply.call(null,cljs.core.merge,(function (){var iter__4117__auto__ = (function iter__15760(s__15761){return (new cljs.core.LazySeq(null,(function (){var s__15761__$1 = s__15761;while(true){
...
{var z = cljs.core._nth.call(null,c__4115__auto__,i__15762);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{cljs.core.chunk_append.call(null,b__15763,c);
{
...
{var z = cljs.core.first.call(null,s__15761__$2);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{return cljs.core.cons.call(null,c,iter__15760.call(null,cljs.core.rest.call(null,s__15761__$2)));
} else
{{
var G__15766 = cljs.core.rest.call(null,s__15761__$2);
s__15761__$1 = G__15766;
continue;
}
}
}
...
secretary.core.filter_routes = (function filter_routes(f,uri_path){return cljs.core.filter.call(null,(function (p1__15767_SHARP_){return f.call(null,cljs.core.first.call(null,p1__15767_SHARP_),uri_path);
}),cljs.core.deref.call(null,secretary.core._STAR_routes_STAR_));
});
/**
...
{var vec__15770 = temp__4090__auto__;var route = cljs.core.nth.call(null,vec__15770,0,null);var action = cljs.core.nth.call(null,vec__15770,1,null);return action.call(null,cljs.core.PersistentArrayMap.EMPTY);
} else
...
{var xs__4579__auto__ = temp__4092__auto__;var vec__15771 = cljs.core.first.call(null,xs__4579__auto__);var route = cljs.core.nth.call(null,vec__15771,0,null);var action = cljs.core.nth.call(null,vec__15771,1,null);return action.call(null,secretary.core.extract_components.call(null,route,uri_path));
} else
{return null;
}
}
