...
{return cljs.core.every_QMARK_.call(null,cljs.core.true_QMARK_,cljs.core.map.call(null,(function (p1__15764_SHARP_,p2__15765_SHARP_){return secretary.core.component_matches_QMARK_.call(null,p1__15764_SHARP_,p2__15765_SHARP_);
}),r,u));
} else
{return null;
}
...
*/
secretary.core.any_matches_QMARK_ = (function any_matches_QMARK_(uri_path){return cljs.core.some.call(null,(function (p1__15766_SHARP_){return secretary.core.route_matches_QMARK_.call(null,cljs.core.first.call(null,p1__15766_SHARP_),uri_path);
...
{return cljs.core.apply.call(null,cljs.core.merge,(function (){var iter__4117__auto__ = (function iter__15771(s__15772){return (new cljs.core.LazySeq(null,(function (){var s__15772__$1 = s__15772;while(true){
...
{var z = cljs.core._nth.call(null,c__4115__auto__,i__15773);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{cljs.core.chunk_append.call(null,b__15774,c);
{
...
{var z = cljs.core.first.call(null,s__15772__$2);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{return cljs.core.cons.call(null,c,iter__15771.call(null,cljs.core.rest.call(null,s__15772__$2)));
} else
{{
var G__15777 = cljs.core.rest.call(null,s__15772__$2);
s__15772__$1 = G__15777;
continue;
}
}
}
...
secretary.core.filter_routes = (function filter_routes(f,uri_path){return cljs.core.filter.call(null,(function (p1__15778_SHARP_){return f.call(null,cljs.core.first.call(null,p1__15778_SHARP_),uri_path);
}),cljs.core.deref.call(null,secretary.core._STAR_routes_STAR_));
});
/**
...
{var vec__15781 = temp__4090__auto__;var route = cljs.core.nth.call(null,vec__15781,0,null);var action = cljs.core.nth.call(null,vec__15781,1,null);return action.call(null,cljs.core.PersistentArrayMap.EMPTY);
} else
...
{var xs__4579__auto__ = temp__4092__auto__;var vec__15782 = cljs.core.first.call(null,xs__4579__auto__);var route = cljs.core.nth.call(null,vec__15782,0,null);var action = cljs.core.nth.call(null,vec__15782,1,null);return action.call(null,secretary.core.extract_components.call(null,route,uri_path));
} else
{return null;
}
}
