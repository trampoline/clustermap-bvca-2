...
{return cljs.core.every_QMARK_.call(null,cljs.core.true_QMARK_,cljs.core.map.call(null,(function (p1__15920_SHARP_,p2__15921_SHARP_){return secretary.core.component_matches_QMARK_.call(null,p1__15920_SHARP_,p2__15921_SHARP_);
}),r,u));
} else
{return null;
}
});
secretary.core.filter_routes = (function filter_routes(pred,uri_path){return cljs.core.filter.call(null,(function (p1__15922_SHARP_){return pred.call(null,cljs.core.first.call(null,p1__15922_SHARP_),uri_path);
}),cljs.core.deref.call(null,secretary.core._STAR_routes_STAR_));
});
/**
* Turns a map of query parameters into url encoded string.
*/
secretary.core.encode_query_params = (function encode_query_params(query_params){return clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p__15925){var vec__15926 = p__15925;var k = cljs.core.nth.call(null,vec__15926,0,null);var v = cljs.core.nth.call(null,vec__15926,1,null);return [cljs.core.str(cljs.core.name.call(null,k)),cljs.core.str("="),cljs.core.str(encodeURIComponent([cljs.core.str(v)].join('')))].join('');
}),query_params));
});
/**
* Extract a map of query parameters from a query string.
*/
secretary.core.decode_query_params = (function decode_query_params(query_string){return cljs.core.reduce.call(null,(function (m,param){var vec__15928 = clojure.string.split.call(null,param,/=/,2);var k = cljs.core.nth.call(null,vec__15928,0,null);var v = cljs.core.nth.call(null,vec__15928,1,null);var v__$1 = decodeURIComponent(v);return cljs.core.assoc.call(null,m,k,v__$1);
...
{return cljs.core.apply.call(null,cljs.core.merge,(function (){var iter__4117__auto__ = (function iter__15933(s__15934){return (new cljs.core.LazySeq(null,(function (){var s__15934__$1 = s__15934;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__15934__$1);if(temp__4092__auto__)
{var s__15934__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__15934__$2))
{var c__4115__auto__ = cljs.core.chunk_first.call(null,s__15934__$2);var size__4116__auto__ = cljs.core.count.call(null,c__4115__auto__);var b__15936 = cljs.core.chunk_buffer.call(null,size__4116__auto__);if((function (){var i__15935 = 0;while(true){
if((i__15935 < size__4116__auto__))
{var z = cljs.core._nth.call(null,c__4115__auto__,i__15935);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{cljs.core.chunk_append.call(null,b__15936,c);
{
var G__15937 = (i__15935 + 1);
i__15935 = G__15937;
continue;
}
} else
{{
var G__15938 = (i__15935 + 1);
i__15935 = G__15938;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15936),iter__15933.call(null,cljs.core.chunk_rest.call(null,s__15934__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15936),null);
}
} else
{var z = cljs.core.first.call(null,s__15934__$2);var c = cljs.core.apply.call(null,secretary.core.extract_component,z);if(!((c == null)))
{return cljs.core.cons.call(null,c,iter__15933.call(null,cljs.core.rest.call(null,s__15934__$2)));
} else
{{
var G__15939 = cljs.core.rest.call(null,s__15934__$2);
s__15934__$1 = G__15939;
continue;
}
}
}
...
{var vec__15942 = temp__4090__auto__;var route = cljs.core.nth.call(null,vec__15942,0,null);var action = cljs.core.nth.call(null,vec__15942,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [action,cljs.core.PersistentArrayMap.EMPTY], null);
} else
...
{var xs__4579__auto__ = temp__4092__auto__;var vec__15943 = cljs.core.first.call(null,xs__4579__auto__);var route = cljs.core.nth.call(null,vec__15943,0,null);var action = cljs.core.nth.call(null,vec__15943,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [action,secretary.core.extract_components.call(null,route,uri_path)], null);
} else
{return null;
}
}
...
*/
secretary.core.dispatch_BANG_ = (function dispatch_BANG_(uri){var vec__15946 = clojure.string.split.call(null,uri,/\?/);var uri_path = cljs.core.nth.call(null,vec__15946,0,null);var query_string = cljs.core.nth.call(null,vec__15946,1,null);var query_params = (cljs.core.truth_(query_string)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"query-params","query-params",1080249757),secretary.core.decode_query_params.call(null,query_string)], null):null);var vec__15947 = secretary.core.parse_action.call(null,uri_path);var action = cljs.core.nth.call(null,vec__15947,0,null);var params = cljs.core.nth.call(null,vec__15947,1,null);var action__$1 = (function (){var or__3406__auto__ = action;if(cljs.core.truth_(or__3406__auto__))
...
var render_route__2 = (function (route,p__15948){var map__15950 = p__15948;var map__15950__$1 = ((cljs.core.seq_QMARK_.call(null,map__15950))?cljs.core.apply.call(null,cljs.core.hash_map,map__15950):map__15950);var m = map__15950__$1;var query_params = cljs.core.get.call(null,map__15950__$1,new cljs.core.Keyword(null,"query-params","query-params",1080249757));var path = route.replace((new RegExp(":[^/]+","g")),(function ($1){var lookup = cljs.core.keyword.call(null,cljs.core.subs.call(null,$1,1));return m.call(null,lookup,$1);
