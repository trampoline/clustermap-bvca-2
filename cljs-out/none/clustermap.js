...
goog.addDependency("../clustermap/app.js", ['clustermap.app'], ['clustermap.boundarylines', 'clustermap.api', 'clustermap.components.page_title', 'clustermap.components.full_report', 'cljs.core', 'secretary.core', 'om.core', 'clustermap.components.search', 'om.dom', 'clustermap.nav', 'cljs.core.async', 'clustermap.components.map_report', 'clustermap.components.map']);
