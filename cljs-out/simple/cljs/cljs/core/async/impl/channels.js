...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t28294 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t28294 = (function (val,box,meta28295){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t28294.cljs$lang$type = true;
cljs.core.async.impl.channels.t28294.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t28294";
cljs.core.async.impl.channels.t28294.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"cljs.core.async.impl.channels/t28294");
});
cljs.core.async.impl.channels.t28294.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t28294.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28296){var self__ = this;
var _28296__$1 = this;return self__.meta28295;
});
cljs.core.async.impl.channels.t28294.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28296,meta28295__$1){var self__ = this;
var _28296__$1 = this;return (new cljs.core.async.impl.channels.t28294(self__.val,self__.box,meta28295__$1));
});
cljs.core.async.impl.channels.__GT_t28294 = (function __GT_t28294(val__$1,box__$1,meta28295){return (new cljs.core.async.impl.channels.t28294(val__$1,box__$1,meta28295));
});
}
return (new cljs.core.async.impl.channels.t28294(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_28297 = self__.takes.pop();if((taker_28297 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_28297))
{var take_cb_28298 = cljs.core.async.impl.protocols.commit.call(null,taker_28297);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_28298,taker_28297,this$__$1){
return (function (){return take_cb_28298.call(null,null);
});})(take_cb_28298,taker_28297,this$__$1))
);
} else
{}
{
