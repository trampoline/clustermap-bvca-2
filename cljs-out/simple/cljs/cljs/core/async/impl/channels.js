...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t31008 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t31008 = (function (val,box,meta31009){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t31008.cljs$lang$type = true;
cljs.core.async.impl.channels.t31008.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t31008";
cljs.core.async.impl.channels.t31008.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"cljs.core.async.impl.channels/t31008");
});
cljs.core.async.impl.channels.t31008.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t31008.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31010){var self__ = this;
var _31010__$1 = this;return self__.meta31009;
});
cljs.core.async.impl.channels.t31008.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31010,meta31009__$1){var self__ = this;
var _31010__$1 = this;return (new cljs.core.async.impl.channels.t31008(self__.val,self__.box,meta31009__$1));
});
cljs.core.async.impl.channels.__GT_t31008 = (function __GT_t31008(val__$1,box__$1,meta31009){return (new cljs.core.async.impl.channels.t31008(val__$1,box__$1,meta31009));
});
}
return (new cljs.core.async.impl.channels.t31008(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_31011 = self__.takes.pop();if((taker_31011 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_31011))
{var take_cb_31012 = cljs.core.async.impl.protocols.commit.call(null,taker_31011);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_31012,taker_31011,this$__$1){
return (function (){return take_cb_31012.call(null,null);
});})(take_cb_31012,taker_31011,this$__$1))
);
} else
{}
{
