...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16676 = 0;while(true){
var m_16677 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16677 == null))
{} else
{m_16677.call(null);
if((count_16676 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16678 = (count_16676 + 1);
count_16676 = G__16678;
continue;
}
} else
{}
