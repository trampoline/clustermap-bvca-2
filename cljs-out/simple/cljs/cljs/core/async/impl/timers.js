...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_27948 = 0;while(true){
if((i_27948 < arr.length))
{(arr[i_27948] = null);
{
...
{var i_27955 = (self__.level + 1);while(true){
if((i_27955 <= (new_level + 1)))
{(update[i_27955] = self__.header);
{
var G__27956 = (i_27955 + 1);
i_27955 = G__27956;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_27957 = 0;while(true){
if((i_27957 <= self__.level))
{var links_27958 = (update[i_27957]).forward;if(((links_27958[i_27957]) === x__$1))
{(links_27958[i_27957] = (x__$1.forward[i_27957]));
{
var G__27959 = (i_27957 + 1);
i_27957 = G__27959;
continue;
}
} else
{{
var G__27960 = (i_27957 + 1);
i_27957 = G__27960;
continue;
}
}
