...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_38228 = (0);while(true){
if((i_38228 < arr.length))
{(arr[i_38228] = null);
{
var G__38229 = (i_38228 + (1));
i_38228 = G__38229;
continue;
}
} else
...
{var i_38235 = (self__.level + (1));while(true){
if((i_38235 <= (new_level + (1))))
{(update[i_38235] = self__.header);
{
var G__38236 = (i_38235 + (1));
i_38235 = G__38236;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_38237 = (0);while(true){
if((i_38237 <= self__.level))
{var links_38238 = (update[i_38237]).forward;if(((links_38238[i_38237]) === x__$1))
{(links_38238[i_38237] = (x__$1.forward[i_38237]));
{
