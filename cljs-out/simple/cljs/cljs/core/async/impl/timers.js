...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_28195 = (0);while(true){
if((i_28195 < arr.length))
{(arr[i_28195] = null);
{
var G__28196 = (i_28195 + (1));
i_28195 = G__28196;
continue;
}
} else
...
{var i_28202 = (self__.level + (1));while(true){
if((i_28202 <= (new_level + (1))))
{(update[i_28202] = self__.header);
{
var G__28203 = (i_28202 + (1));
i_28202 = G__28203;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_28204 = (0);while(true){
if((i_28204 <= self__.level))
{var links_28205 = (update[i_28204]).forward;if(((links_28205[i_28204]) === x__$1))
{(links_28205[i_28204] = (x__$1.forward[i_28204]));
{
