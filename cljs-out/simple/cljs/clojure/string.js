...
{{
var G__30714 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30714;
continue;
}
} else
...
{var pred__30718 = cljs.core._EQ_;var expr__30719 = limit;if(cljs.core.truth_(pred__30718.call(null,(1),expr__30719)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__30718.call(null,(2),expr__30719)))
...
var G__30721 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30722 = (limit__$1 - (1));
var G__30723 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__30721;
limit__$1 = G__30722;
parts = G__30723;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___30725 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___30725))
{var replacement_30726 = temp__4124__auto___30725;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_30726)));
} else
{buffer.append(ch);
}
{
var G__30727 = (index + (1));
index = G__30727;
continue;
}
}
