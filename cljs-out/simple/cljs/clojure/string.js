...
{{
var G__14048 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14048;
continue;
}
} else
...
{var pred__14052 = cljs.core._EQ_;var expr__14053 = limit;if(cljs.core.truth_(pred__14052.call(null,1,expr__14053)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14052.call(null,2,expr__14053)))
...
var G__14055 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14056 = (limit__$1 - 1);
var G__14057 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14055;
limit__$1 = G__14056;
parts = G__14057;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14059 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14059))
{var replacement_14060 = temp__4090__auto___14059;buffer.append([cljs.core.str(replacement_14060)].join(''));
} else
{buffer.append(ch);
}
{
var G__14061 = (index + 1);
index = G__14061;
continue;
}
}
