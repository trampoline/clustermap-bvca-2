...
{{
var G__14068 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14068;
continue;
}
} else
...
{var pred__14072 = cljs.core._EQ_;var expr__14073 = limit;if(cljs.core.truth_(pred__14072.call(null,1,expr__14073)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14072.call(null,2,expr__14073)))
...
var G__14075 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14076 = (limit__$1 - 1);
var G__14077 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14075;
limit__$1 = G__14076;
parts = G__14077;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14079 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14079))
{var replacement_14080 = temp__4090__auto___14079;buffer.append([cljs.core.str(replacement_14080)].join(''));
} else
{buffer.append(ch);
}
{
var G__14081 = (index + 1);
index = G__14081;
continue;
}
}
