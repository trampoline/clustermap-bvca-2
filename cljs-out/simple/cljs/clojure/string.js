...
{{
var G__14032 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14032;
continue;
}
} else
...
{var pred__14036 = cljs.core._EQ_;var expr__14037 = limit;if(cljs.core.truth_(pred__14036.call(null,1,expr__14037)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14036.call(null,2,expr__14037)))
...
var G__14039 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14040 = (limit__$1 - 1);
var G__14041 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14039;
limit__$1 = G__14040;
parts = G__14041;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14043 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14043))
{var replacement_14044 = temp__4090__auto___14043;buffer.append([cljs.core.str(replacement_14044)].join(''));
} else
{buffer.append(ch);
}
{
var G__14045 = (index + 1);
index = G__14045;
continue;
}
}
