...
{{
var G__14044 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14044;
continue;
}
} else
...
{var pred__14048 = cljs.core._EQ_;var expr__14049 = limit;if(cljs.core.truth_(pred__14048.call(null,1,expr__14049)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14048.call(null,2,expr__14049)))
...
var G__14051 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14052 = (limit__$1 - 1);
var G__14053 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14051;
limit__$1 = G__14052;
parts = G__14053;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14055 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14055))
{var replacement_14056 = temp__4090__auto___14055;buffer.append([cljs.core.str(replacement_14056)].join(''));
} else
{buffer.append(ch);
}
{
var G__14057 = (index + 1);
index = G__14057;
continue;
}
}
