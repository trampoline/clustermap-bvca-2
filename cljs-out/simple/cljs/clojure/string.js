...
{{
var G__36914 = cljs.core.pop.call(null,v__$1);
v__$1 = G__36914;
continue;
}
} else
...
{var pred__36918 = cljs.core._EQ_;var expr__36919 = limit;if(cljs.core.truth_(pred__36918.call(null,(1),expr__36919)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__36918.call(null,(2),expr__36919)))
...
var G__36921 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__36922 = (limit__$1 - (1));
var G__36923 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__36921;
limit__$1 = G__36922;
parts = G__36923;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___36925 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___36925))
{var replacement_36926 = temp__4124__auto___36925;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_36926)));
} else
{buffer.append(ch);
}
{
var G__36927 = (index + (1));
index = G__36927;
continue;
}
}
