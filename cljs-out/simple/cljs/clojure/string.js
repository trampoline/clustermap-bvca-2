...
{{
var G__13980 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13980;
continue;
}
} else
...
{var pred__13984 = cljs.core._EQ_;var expr__13985 = limit;if(cljs.core.truth_(pred__13984.call(null,1,expr__13985)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13984.call(null,2,expr__13985)))
...
var G__13987 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13988 = (limit__$1 - 1);
var G__13989 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13987;
limit__$1 = G__13988;
parts = G__13989;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13991 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13991))
{var replacement_13992 = temp__4090__auto___13991;buffer.append([cljs.core.str(replacement_13992)].join(''));
} else
{buffer.append(ch);
}
{
var G__13993 = (index + 1);
index = G__13993;
continue;
}
}
