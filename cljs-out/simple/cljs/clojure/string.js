...
{{
var G__14072 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14072;
continue;
}
} else
...
{var pred__14076 = cljs.core._EQ_;var expr__14077 = limit;if(cljs.core.truth_(pred__14076.call(null,1,expr__14077)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14076.call(null,2,expr__14077)))
...
var G__14079 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14080 = (limit__$1 - 1);
var G__14081 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14079;
limit__$1 = G__14080;
parts = G__14081;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14083 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14083))
{var replacement_14084 = temp__4090__auto___14083;buffer.append([cljs.core.str(replacement_14084)].join(''));
} else
{buffer.append(ch);
}
{
var G__14085 = (index + 1);
index = G__14085;
continue;
}
}
