...
{{
var G__36920 = cljs.core.pop.call(null,v__$1);
v__$1 = G__36920;
continue;
}
} else
...
{var pred__36924 = cljs.core._EQ_;var expr__36925 = limit;if(cljs.core.truth_(pred__36924.call(null,(1),expr__36925)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__36924.call(null,(2),expr__36925)))
...
var G__36927 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__36928 = (limit__$1 - (1));
var G__36929 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__36927;
limit__$1 = G__36928;
parts = G__36929;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___36931 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___36931))
{var replacement_36932 = temp__4124__auto___36931;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_36932)));
} else
{buffer.append(ch);
}
{
var G__36933 = (index + (1));
index = G__36933;
continue;
}
}
