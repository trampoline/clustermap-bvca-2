...
goog.require('clustermap.api');
goog.require('clustermap.ordered_resource');
clustermap.components.filter.render = (function render(p__26374,owner,state){var map__26462 = p__26374;var map__26462__$1 = ((cljs.core.seq_QMARK_.call(null,map__26462))?cljs.core.apply.call(null,cljs.core.hash_map,map__26462):map__26462);var bounds = cljs.core.get.call(null,map__26462__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var filter_spec = cljs.core.get.call(null,map__26462__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"filter by view"),React.DOM.div({"className": "tbl-cell"},sablono.interpreter.input.call(null,{"type": "checkbox", "name": "filter-by-view", "value": "true", "onChange": ((function (map__26462,map__26462__$1,bounds,filter_spec){
...
});})(map__26462,map__26462__$1,bounds,filter_spec))
}))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__26462,map__26462__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__26537 = cljs.core._EQ_;var expr__26538 = val;if(cljs.core.truth_(pred__26537.call(null,"new",expr__26538)))
...
{if(cljs.core.truth_(pred__26537.call(null,"old",expr__26538)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "new"},"< 5 years old"),sablono.interpreter.option.call(null,{"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__26462,map__26462__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__26540 = cljs.core._EQ_;var expr__26541 = val;if(cljs.core.truth_(pred__26540.call(null,"group",expr__26541)))
...
{if(cljs.core.truth_(pred__26540.call(null,"notgroup",expr__26541)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "group"},"group"),sablono.interpreter.option.call(null,{"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__26462,map__26462__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__26543 = cljs.core._EQ_;var expr__26544 = val;if(cljs.core.truth_(pred__26543.call(null,"low",expr__26544)))
...
{if(cljs.core.truth_(pred__26543.call(null,"high",expr__26544)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "low"},"< \u00A31 million"),sablono.interpreter.option.call(null,{"value": "high"},">= \u00A31 million")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"SIC section"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"style": {"width": "100%"}, "onChange": ((function (map__26462,map__26462__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(e.target.value);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__26546 = cljs.core._EQ_;var expr__26547 = val;if(cljs.core.truth_(pred__26546.call(null,"A",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"B",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"C",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"D",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"E",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"F",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"G",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"H",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"I",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"J",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"K",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"L",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"M",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"N",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"O",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"P",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"Q",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"R",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"S",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"T",expr__26547)))
...
{if(cljs.core.truth_(pred__26546.call(null,"U",expr__26547)))
...
clustermap.components.filter.filter_component = (function filter_component(p__26549,owner){var map__26558 = p__26549;var map__26558__$1 = ((cljs.core.seq_QMARK_.call(null,map__26558))?cljs.core.apply.call(null,cljs.core.hash_map,map__26558):map__26558);var props = map__26558__$1;var map__26559 = cljs.core.get.call(null,map__26558__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__26559__$1 = ((cljs.core.seq_QMARK_.call(null,map__26559))?cljs.core.apply.call(null,cljs.core.hash_map,map__26559):map__26559);var filter_spec = map__26559__$1;var components = cljs.core.get.call(null,map__26559__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var filter_by_view = cljs.core.get.call(null,map__26559__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var compiled = cljs.core.get.call(null,map__26559__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var bounds = cljs.core.get.call(null,map__26558__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));if(typeof clustermap.components.filter.t26560 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t26560 = (function (filter_component,owner,filter_by_view,props,map__26558,p__26549,map__26559,filter_spec,compiled,bounds,components,meta26561){
this.filter_component = filter_component;
this.owner = owner;
this.filter_by_view = filter_by_view;
this.props = props;
this.map__26558 = map__26558;
this.p__26549 = p__26549;
this.map__26559 = map__26559;
...
clustermap.components.filter.t26560.cljs$lang$type = true;
clustermap.components.filter.t26560.cljs$lang$ctorStr = "clustermap.components.filter/t26560";
clustermap.components.filter.t26560.cljs$lang$ctorPrWriter = ((function (map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t26560");
});})(map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t26560.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t26560.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,p__26563,next_state){var self__ = this;
var map__26564 = p__26563;var map__26564__$1 = ((cljs.core.seq_QMARK_.call(null,map__26564))?cljs.core.apply.call(null,cljs.core.hash_map,map__26564):map__26564);var map__26565 = cljs.core.get.call(null,map__26564__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__26565__$1 = ((cljs.core.seq_QMARK_.call(null,map__26565))?cljs.core.apply.call(null,cljs.core.hash_map,map__26565):map__26565);var next_components = cljs.core.get.call(null,map__26565__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_filter_by_view = cljs.core.get.call(null,map__26565__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var next_compiled = cljs.core.get.call(null,map__26565__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var next_bounds = cljs.core.get.call(null,map__26564__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var ___$1 = this;if(cljs.core.truth_((function (){var or__3558__auto__ = cljs.core.not_EQ_.call(null,next_components,self__.components);if(or__3558__auto__)
...
;
clustermap.components.filter.t26560.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t26560.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.props,self__.owner,state);
});})(map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t26560.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_26562){var self__ = this;
var _26562__$1 = this;return self__.meta26561;
});})(map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t26560.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_26562,meta26561__$1){var self__ = this;
var _26562__$1 = this;return (new clustermap.components.filter.t26560(self__.filter_component,self__.owner,self__.filter_by_view,self__.props,self__.map__26558,self__.p__26549,self__.map__26559,self__.filter_spec,self__.compiled,self__.bounds,self__.components,meta26561__$1));
});})(map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.__GT_t26560 = ((function (map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function __GT_t26560(filter_component__$1,owner__$1,filter_by_view__$1,props__$1,map__26558__$2,p__26549__$1,map__26559__$2,filter_spec__$1,compiled__$1,bounds__$1,components__$1,meta26561){return (new clustermap.components.filter.t26560(filter_component__$1,owner__$1,filter_by_view__$1,props__$1,map__26558__$2,p__26549__$1,map__26559__$2,filter_spec__$1,compiled__$1,bounds__$1,components__$1,meta26561));
});})(map__26558,map__26558__$1,props,map__26559,map__26559__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
}
return (new clustermap.components.filter.t26560(filter_component,owner,filter_by_view,props,map__26558__$1,p__26549,map__26559__$1,filter_spec,compiled,bounds,components,null));
});
