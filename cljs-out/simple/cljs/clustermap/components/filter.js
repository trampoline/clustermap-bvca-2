...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__25547 = cljs.core._EQ_;var expr__25548 = val;if(cljs.core.truth_(pred__25547.call(null,"new",expr__25548)))
...
{if(cljs.core.truth_(pred__25547.call(null,"old",expr__25548)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__25550 = cljs.core._EQ_;var expr__25551 = val;if(cljs.core.truth_(pred__25550.call(null,"group",expr__25551)))
...
{if(cljs.core.truth_(pred__25550.call(null,"notgroup",expr__25551)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__25553 = cljs.core._EQ_;var expr__25554 = val;if(cljs.core.truth_(pred__25553.call(null,"low",expr__25554)))
...
{if(cljs.core.truth_(pred__25553.call(null,"high",expr__25554)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__25556 = cljs.core._EQ_;var expr__25557 = val;if(cljs.core.truth_(pred__25556.call(null,"A",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"B",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"C",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"D",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"E",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"F",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"G",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"H",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"I",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"J",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"K",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"L",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"M",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"N",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"O",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"P",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"Q",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"R",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"S",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"T",expr__25557)))
...
{if(cljs.core.truth_(pred__25556.call(null,"U",expr__25557)))
...
clustermap.components.filter.filter_component = (function filter_component(p__25559,owner){var map__25566 = p__25559;var map__25566__$1 = ((cljs.core.seq_QMARK_.call(null,map__25566))?cljs.core.apply.call(null,cljs.core.hash_map,map__25566):map__25566);var cursor = map__25566__$1;var components = cljs.core.get.call(null,map__25566__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__25566__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(typeof clustermap.components.filter.t25567 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t25567 = (function (compiled,components,cursor,map__25566,owner,p__25559,filter_component,meta25568){
this.compiled = compiled;
this.components = components;
this.cursor = cursor;
this.map__25566 = map__25566;
this.owner = owner;
this.p__25559 = p__25559;
this.filter_component = filter_component;
this.meta25568 = meta25568;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t25567.cljs$lang$type = true;
clustermap.components.filter.t25567.cljs$lang$ctorStr = "clustermap.components.filter/t25567";
clustermap.components.filter.t25567.cljs$lang$ctorPrWriter = ((function (map__25566,map__25566__$1,cursor,components,compiled){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t25567");
});})(map__25566,map__25566__$1,cursor,components,compiled))
;
clustermap.components.filter.t25567.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t25567.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__25566,map__25566__$1,cursor,components,compiled){
return (function (_,p__25570,next_state){var self__ = this;
var map__25571 = p__25570;var map__25571__$1 = ((cljs.core.seq_QMARK_.call(null,map__25571))?cljs.core.apply.call(null,cljs.core.hash_map,map__25571):map__25571);var next_components = cljs.core.get.call(null,map__25571__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__25571__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var ___$1 = this;if(cljs.core.not_EQ_.call(null,next_components,self__.components))
...
;
clustermap.components.filter.t25567.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t25567.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__25566,map__25566__$1,cursor,components,compiled){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.cursor,self__.owner,state);
});})(map__25566,map__25566__$1,cursor,components,compiled))
;
clustermap.components.filter.t25567.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__25566,map__25566__$1,cursor,components,compiled){
return (function (_25569){var self__ = this;
var _25569__$1 = this;return self__.meta25568;
});})(map__25566,map__25566__$1,cursor,components,compiled))
;
clustermap.components.filter.t25567.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__25566,map__25566__$1,cursor,components,compiled){
return (function (_25569,meta25568__$1){var self__ = this;
var _25569__$1 = this;return (new clustermap.components.filter.t25567(self__.compiled,self__.components,self__.cursor,self__.map__25566,self__.owner,self__.p__25559,self__.filter_component,meta25568__$1));
});})(map__25566,map__25566__$1,cursor,components,compiled))
;
clustermap.components.filter.__GT_t25567 = ((function (map__25566,map__25566__$1,cursor,components,compiled){
return (function __GT_t25567(compiled__$1,components__$1,cursor__$1,map__25566__$2,owner__$1,p__25559__$1,filter_component__$1,meta25568){return (new clustermap.components.filter.t25567(compiled__$1,components__$1,cursor__$1,map__25566__$2,owner__$1,p__25559__$1,filter_component__$1,meta25568));
});})(map__25566,map__25566__$1,cursor,components,compiled))
;
}
return (new clustermap.components.filter.t25567(compiled,components,cursor,map__25566__$1,owner,p__25559,filter_component,null));
});
