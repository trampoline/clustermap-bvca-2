...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__25254,owner){var map__25346 = p__25254;var map__25346__$1 = ((cljs.core.seq_QMARK_.call(null,map__25346))?cljs.core.apply.call(null,cljs.core.hash_map,map__25346):map__25346);var cursor = map__25346__$1;if(typeof clustermap.components.filter.t25347 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t25347 = (function (cursor,map__25346,owner,p__25254,filter_component,meta25348){
this.cursor = cursor;
this.map__25346 = map__25346;
this.owner = owner;
this.p__25254 = p__25254;
this.filter_component = filter_component;
this.meta25348 = meta25348;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t25347.cljs$lang$type = true;
clustermap.components.filter.t25347.cljs$lang$ctorStr = "clustermap.components.filter/t25347";
clustermap.components.filter.t25347.cljs$lang$ctorPrWriter = ((function (map__25346,map__25346__$1,cursor){
return (function (this__4108__auto__,writer__4109__auto__,opt__4110__auto__){return cljs.core._write.call(null,writer__4109__auto__,"clustermap.components.filter/t25347");
});})(map__25346,map__25346__$1,cursor))
;
clustermap.components.filter.t25347.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t25347.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__25346,map__25346__$1,cursor){
return (function (this$,p__25350,next_state){var self__ = this;
var map__25351 = p__25350;var map__25351__$1 = ((cljs.core.seq_QMARK_.call(null,map__25351))?cljs.core.apply.call(null,cljs.core.hash_map,map__25351):map__25351);var next_components = cljs.core.get.call(null,map__25351__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__25351__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__25352 = om.core.get_props.call(null,self__.owner);var map__25352__$1 = ((cljs.core.seq_QMARK_.call(null,map__25352))?cljs.core.apply.call(null,cljs.core.hash_map,map__25352):map__25352);var components = cljs.core.get.call(null,map__25352__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__25352__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t25347.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t25347.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__25346,map__25346__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25346,map__25346__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__25425 = cljs.core._EQ_;var expr__25426 = val;if(cljs.core.truth_(pred__25425.call(null,"new",expr__25426)))
...
{if(cljs.core.truth_(pred__25425.call(null,"old",expr__25426)))
...
});})(this$__$1,map__25346,map__25346__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25346,map__25346__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__25428 = cljs.core._EQ_;var expr__25429 = val;if(cljs.core.truth_(pred__25428.call(null,"group",expr__25429)))
...
{if(cljs.core.truth_(pred__25428.call(null,"notgroup",expr__25429)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25346,map__25346__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__25431 = cljs.core._EQ_;var expr__25432 = val;if(cljs.core.truth_(pred__25431.call(null,"low",expr__25432)))
...
{if(cljs.core.truth_(pred__25431.call(null,"high",expr__25432)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__25434 = cljs.core._EQ_;var expr__25435 = val;if(cljs.core.truth_(pred__25434.call(null,"A",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"B",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"C",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"D",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"E",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"F",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"G",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"H",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"I",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"J",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"K",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"L",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"M",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"N",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"O",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"P",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"Q",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"R",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"S",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"T",expr__25435)))
...
{if(cljs.core.truth_(pred__25434.call(null,"U",expr__25435)))
...
;
clustermap.components.filter.t25347.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__25346,map__25346__$1,cursor){
return (function (_25349){var self__ = this;
var _25349__$1 = this;return self__.meta25348;
});})(map__25346,map__25346__$1,cursor))
;
clustermap.components.filter.t25347.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__25346,map__25346__$1,cursor){
return (function (_25349,meta25348__$1){var self__ = this;
var _25349__$1 = this;return (new clustermap.components.filter.t25347(self__.cursor,self__.map__25346,self__.owner,self__.p__25254,self__.filter_component,meta25348__$1));
});})(map__25346,map__25346__$1,cursor))
;
clustermap.components.filter.__GT_t25347 = ((function (map__25346,map__25346__$1,cursor){
return (function __GT_t25347(cursor__$1,map__25346__$2,owner__$1,p__25254__$1,filter_component__$1,meta25348){return (new clustermap.components.filter.t25347(cursor__$1,map__25346__$2,owner__$1,p__25254__$1,filter_component__$1,meta25348));
});})(map__25346,map__25346__$1,cursor))
;
}
return (new clustermap.components.filter.t25347(cursor,map__25346__$1,owner,p__25254,filter_component,null));
});
