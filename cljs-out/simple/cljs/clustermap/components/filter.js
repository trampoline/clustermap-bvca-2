...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__26209 = cljs.core._EQ_;var expr__26210 = val;if(cljs.core.truth_(pred__26209.call(null,"new",expr__26210)))
...
{if(cljs.core.truth_(pred__26209.call(null,"old",expr__26210)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__26212 = cljs.core._EQ_;var expr__26213 = val;if(cljs.core.truth_(pred__26212.call(null,"group",expr__26213)))
...
{if(cljs.core.truth_(pred__26212.call(null,"notgroup",expr__26213)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__26215 = cljs.core._EQ_;var expr__26216 = val;if(cljs.core.truth_(pred__26215.call(null,"low",expr__26216)))
...
{if(cljs.core.truth_(pred__26215.call(null,"high",expr__26216)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__26218 = cljs.core._EQ_;var expr__26219 = val;if(cljs.core.truth_(pred__26218.call(null,"A",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"B",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"C",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"D",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"E",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"F",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"G",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"H",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"I",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"J",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"K",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"L",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"M",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"N",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"O",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"P",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"Q",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"R",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"S",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"T",expr__26219)))
...
{if(cljs.core.truth_(pred__26218.call(null,"U",expr__26219)))
...
clustermap.components.filter.filter_component = (function filter_component(p__26221,owner){var map__26228 = p__26221;var map__26228__$1 = ((cljs.core.seq_QMARK_.call(null,map__26228))?cljs.core.apply.call(null,cljs.core.hash_map,map__26228):map__26228);var cursor = map__26228__$1;var components = cljs.core.get.call(null,map__26228__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__26228__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(typeof clustermap.components.filter.t26229 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t26229 = (function (compiled,components,cursor,map__26228,owner,p__26221,filter_component,meta26230){
this.compiled = compiled;
this.components = components;
this.cursor = cursor;
this.map__26228 = map__26228;
this.owner = owner;
this.p__26221 = p__26221;
this.filter_component = filter_component;
this.meta26230 = meta26230;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t26229.cljs$lang$type = true;
clustermap.components.filter.t26229.cljs$lang$ctorStr = "clustermap.components.filter/t26229";
clustermap.components.filter.t26229.cljs$lang$ctorPrWriter = ((function (map__26228,map__26228__$1,cursor,components,compiled){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t26229");
});})(map__26228,map__26228__$1,cursor,components,compiled))
;
clustermap.components.filter.t26229.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t26229.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__26228,map__26228__$1,cursor,components,compiled){
return (function (_,p__26232,next_state){var self__ = this;
var map__26233 = p__26232;var map__26233__$1 = ((cljs.core.seq_QMARK_.call(null,map__26233))?cljs.core.apply.call(null,cljs.core.hash_map,map__26233):map__26233);var next_components = cljs.core.get.call(null,map__26233__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__26233__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var ___$1 = this;if(cljs.core.not_EQ_.call(null,next_components,self__.components))
...
;
clustermap.components.filter.t26229.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t26229.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__26228,map__26228__$1,cursor,components,compiled){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.cursor,self__.owner,state);
});})(map__26228,map__26228__$1,cursor,components,compiled))
;
clustermap.components.filter.t26229.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__26228,map__26228__$1,cursor,components,compiled){
return (function (_26231){var self__ = this;
var _26231__$1 = this;return self__.meta26230;
});})(map__26228,map__26228__$1,cursor,components,compiled))
;
clustermap.components.filter.t26229.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__26228,map__26228__$1,cursor,components,compiled){
return (function (_26231,meta26230__$1){var self__ = this;
var _26231__$1 = this;return (new clustermap.components.filter.t26229(self__.compiled,self__.components,self__.cursor,self__.map__26228,self__.owner,self__.p__26221,self__.filter_component,meta26230__$1));
});})(map__26228,map__26228__$1,cursor,components,compiled))
;
clustermap.components.filter.__GT_t26229 = ((function (map__26228,map__26228__$1,cursor,components,compiled){
return (function __GT_t26229(compiled__$1,components__$1,cursor__$1,map__26228__$2,owner__$1,p__26221__$1,filter_component__$1,meta26230){return (new clustermap.components.filter.t26229(compiled__$1,components__$1,cursor__$1,map__26228__$2,owner__$1,p__26221__$1,filter_component__$1,meta26230));
});})(map__26228,map__26228__$1,cursor,components,compiled))
;
}
return (new clustermap.components.filter.t26229(compiled,components,cursor,map__26228__$1,owner,p__26221,filter_component,null));
});
