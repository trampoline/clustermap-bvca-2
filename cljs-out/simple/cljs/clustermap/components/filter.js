...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__25117,owner){var map__25209 = p__25117;var map__25209__$1 = ((cljs.core.seq_QMARK_.call(null,map__25209))?cljs.core.apply.call(null,cljs.core.hash_map,map__25209):map__25209);var cursor = map__25209__$1;if(typeof clustermap.components.filter.t25210 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t25210 = (function (cursor,map__25209,owner,p__25117,filter_component,meta25211){
this.cursor = cursor;
this.map__25209 = map__25209;
this.owner = owner;
this.p__25117 = p__25117;
this.filter_component = filter_component;
this.meta25211 = meta25211;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t25210.cljs$lang$type = true;
clustermap.components.filter.t25210.cljs$lang$ctorStr = "clustermap.components.filter/t25210";
clustermap.components.filter.t25210.cljs$lang$ctorPrWriter = ((function (map__25209,map__25209__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t25210");
});})(map__25209,map__25209__$1,cursor))
;
clustermap.components.filter.t25210.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t25210.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__25209,map__25209__$1,cursor){
return (function (this$,p__25213,next_state){var self__ = this;
var map__25214 = p__25213;var map__25214__$1 = ((cljs.core.seq_QMARK_.call(null,map__25214))?cljs.core.apply.call(null,cljs.core.hash_map,map__25214):map__25214);var next_components = cljs.core.get.call(null,map__25214__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__25214__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__25215 = om.core.get_props.call(null,self__.owner);var map__25215__$1 = ((cljs.core.seq_QMARK_.call(null,map__25215))?cljs.core.apply.call(null,cljs.core.hash_map,map__25215):map__25215);var components = cljs.core.get.call(null,map__25215__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__25215__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t25210.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t25210.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__25209,map__25209__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25209,map__25209__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__25288 = cljs.core._EQ_;var expr__25289 = val;if(cljs.core.truth_(pred__25288.call(null,"new",expr__25289)))
...
{if(cljs.core.truth_(pred__25288.call(null,"old",expr__25289)))
...
});})(this$__$1,map__25209,map__25209__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25209,map__25209__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__25291 = cljs.core._EQ_;var expr__25292 = val;if(cljs.core.truth_(pred__25291.call(null,"group",expr__25292)))
...
{if(cljs.core.truth_(pred__25291.call(null,"notgroup",expr__25292)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25209,map__25209__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__25294 = cljs.core._EQ_;var expr__25295 = val;if(cljs.core.truth_(pred__25294.call(null,"low",expr__25295)))
...
{if(cljs.core.truth_(pred__25294.call(null,"high",expr__25295)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__25297 = cljs.core._EQ_;var expr__25298 = val;if(cljs.core.truth_(pred__25297.call(null,"A",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"B",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"C",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"D",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"E",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"F",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"G",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"H",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"I",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"J",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"K",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"L",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"M",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"N",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"O",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"P",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"Q",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"R",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"S",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"T",expr__25298)))
...
{if(cljs.core.truth_(pred__25297.call(null,"U",expr__25298)))
...
;
clustermap.components.filter.t25210.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__25209,map__25209__$1,cursor){
return (function (_25212){var self__ = this;
var _25212__$1 = this;return self__.meta25211;
});})(map__25209,map__25209__$1,cursor))
;
clustermap.components.filter.t25210.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__25209,map__25209__$1,cursor){
return (function (_25212,meta25211__$1){var self__ = this;
var _25212__$1 = this;return (new clustermap.components.filter.t25210(self__.cursor,self__.map__25209,self__.owner,self__.p__25117,self__.filter_component,meta25211__$1));
});})(map__25209,map__25209__$1,cursor))
;
clustermap.components.filter.__GT_t25210 = ((function (map__25209,map__25209__$1,cursor){
return (function __GT_t25210(cursor__$1,map__25209__$2,owner__$1,p__25117__$1,filter_component__$1,meta25211){return (new clustermap.components.filter.t25210(cursor__$1,map__25209__$2,owner__$1,p__25117__$1,filter_component__$1,meta25211));
});})(map__25209,map__25209__$1,cursor))
;
}
return (new clustermap.components.filter.t25210(cursor,map__25209__$1,owner,p__25117,filter_component,null));
});
