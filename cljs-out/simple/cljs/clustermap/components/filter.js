...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__25049,owner){var map__25141 = p__25049;var map__25141__$1 = ((cljs.core.seq_QMARK_.call(null,map__25141))?cljs.core.apply.call(null,cljs.core.hash_map,map__25141):map__25141);var cursor = map__25141__$1;if(typeof clustermap.components.filter.t25142 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t25142 = (function (cursor,map__25141,owner,p__25049,filter_component,meta25143){
this.cursor = cursor;
this.map__25141 = map__25141;
this.owner = owner;
this.p__25049 = p__25049;
this.filter_component = filter_component;
this.meta25143 = meta25143;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t25142.cljs$lang$type = true;
clustermap.components.filter.t25142.cljs$lang$ctorStr = "clustermap.components.filter/t25142";
clustermap.components.filter.t25142.cljs$lang$ctorPrWriter = ((function (map__25141,map__25141__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t25142");
});})(map__25141,map__25141__$1,cursor))
;
clustermap.components.filter.t25142.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t25142.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__25141,map__25141__$1,cursor){
return (function (this$,p__25145,next_state){var self__ = this;
var map__25146 = p__25145;var map__25146__$1 = ((cljs.core.seq_QMARK_.call(null,map__25146))?cljs.core.apply.call(null,cljs.core.hash_map,map__25146):map__25146);var next_components = cljs.core.get.call(null,map__25146__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__25146__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__25147 = om.core.get_props.call(null,self__.owner);var map__25147__$1 = ((cljs.core.seq_QMARK_.call(null,map__25147))?cljs.core.apply.call(null,cljs.core.hash_map,map__25147):map__25147);var components = cljs.core.get.call(null,map__25147__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__25147__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t25142.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t25142.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__25141,map__25141__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25141,map__25141__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__25220 = cljs.core._EQ_;var expr__25221 = val;if(cljs.core.truth_(pred__25220.call(null,"new",expr__25221)))
...
{if(cljs.core.truth_(pred__25220.call(null,"old",expr__25221)))
...
});})(this$__$1,map__25141,map__25141__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25141,map__25141__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__25223 = cljs.core._EQ_;var expr__25224 = val;if(cljs.core.truth_(pred__25223.call(null,"group",expr__25224)))
...
{if(cljs.core.truth_(pred__25223.call(null,"notgroup",expr__25224)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__25141,map__25141__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__25226 = cljs.core._EQ_;var expr__25227 = val;if(cljs.core.truth_(pred__25226.call(null,"low",expr__25227)))
...
{if(cljs.core.truth_(pred__25226.call(null,"high",expr__25227)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__25229 = cljs.core._EQ_;var expr__25230 = val;if(cljs.core.truth_(pred__25229.call(null,"A",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"B",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"C",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"D",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"E",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"F",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"G",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"H",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"I",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"J",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"K",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"L",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"M",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"N",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"O",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"P",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"Q",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"R",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"S",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"T",expr__25230)))
...
{if(cljs.core.truth_(pred__25229.call(null,"U",expr__25230)))
...
;
clustermap.components.filter.t25142.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__25141,map__25141__$1,cursor){
return (function (_25144){var self__ = this;
var _25144__$1 = this;return self__.meta25143;
});})(map__25141,map__25141__$1,cursor))
;
clustermap.components.filter.t25142.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__25141,map__25141__$1,cursor){
return (function (_25144,meta25143__$1){var self__ = this;
var _25144__$1 = this;return (new clustermap.components.filter.t25142(self__.cursor,self__.map__25141,self__.owner,self__.p__25049,self__.filter_component,meta25143__$1));
});})(map__25141,map__25141__$1,cursor))
;
clustermap.components.filter.__GT_t25142 = ((function (map__25141,map__25141__$1,cursor){
return (function __GT_t25142(cursor__$1,map__25141__$2,owner__$1,p__25049__$1,filter_component__$1,meta25143){return (new clustermap.components.filter.t25142(cursor__$1,map__25141__$2,owner__$1,p__25049__$1,filter_component__$1,meta25143));
});})(map__25141,map__25141__$1,cursor))
;
}
return (new clustermap.components.filter.t25142(cursor,map__25141__$1,owner,p__25049,filter_component,null));
});
