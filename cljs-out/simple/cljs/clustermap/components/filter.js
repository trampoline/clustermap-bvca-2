...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__25942,owner){var map__26034 = p__25942;var map__26034__$1 = ((cljs.core.seq_QMARK_.call(null,map__26034))?cljs.core.apply.call(null,cljs.core.hash_map,map__26034):map__26034);var cursor = map__26034__$1;if(typeof clustermap.components.filter.t26035 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t26035 = (function (cursor,map__26034,owner,p__25942,filter_component,meta26036){
this.cursor = cursor;
this.map__26034 = map__26034;
this.owner = owner;
this.p__25942 = p__25942;
this.filter_component = filter_component;
this.meta26036 = meta26036;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t26035.cljs$lang$type = true;
clustermap.components.filter.t26035.cljs$lang$ctorStr = "clustermap.components.filter/t26035";
clustermap.components.filter.t26035.cljs$lang$ctorPrWriter = ((function (map__26034,map__26034__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t26035");
});})(map__26034,map__26034__$1,cursor))
;
clustermap.components.filter.t26035.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t26035.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__26034,map__26034__$1,cursor){
return (function (this$,p__26038,next_state){var self__ = this;
var map__26039 = p__26038;var map__26039__$1 = ((cljs.core.seq_QMARK_.call(null,map__26039))?cljs.core.apply.call(null,cljs.core.hash_map,map__26039):map__26039);var next_components = cljs.core.get.call(null,map__26039__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__26039__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__26040 = om.core.get_props.call(null,self__.owner);var map__26040__$1 = ((cljs.core.seq_QMARK_.call(null,map__26040))?cljs.core.apply.call(null,cljs.core.hash_map,map__26040):map__26040);var components = cljs.core.get.call(null,map__26040__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__26040__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t26035.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t26035.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__26034,map__26034__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__26034,map__26034__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__26113 = cljs.core._EQ_;var expr__26114 = val;if(cljs.core.truth_(pred__26113.call(null,"new",expr__26114)))
...
{if(cljs.core.truth_(pred__26113.call(null,"old",expr__26114)))
...
});})(this$__$1,map__26034,map__26034__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__26034,map__26034__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__26116 = cljs.core._EQ_;var expr__26117 = val;if(cljs.core.truth_(pred__26116.call(null,"group",expr__26117)))
...
{if(cljs.core.truth_(pred__26116.call(null,"notgroup",expr__26117)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__26034,map__26034__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__26119 = cljs.core._EQ_;var expr__26120 = val;if(cljs.core.truth_(pred__26119.call(null,"low",expr__26120)))
...
{if(cljs.core.truth_(pred__26119.call(null,"high",expr__26120)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__26122 = cljs.core._EQ_;var expr__26123 = val;if(cljs.core.truth_(pred__26122.call(null,"A",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"B",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"C",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"D",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"E",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"F",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"G",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"H",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"I",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"J",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"K",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"L",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"M",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"N",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"O",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"P",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"Q",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"R",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"S",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"T",expr__26123)))
...
{if(cljs.core.truth_(pred__26122.call(null,"U",expr__26123)))
...
;
clustermap.components.filter.t26035.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__26034,map__26034__$1,cursor){
return (function (_26037){var self__ = this;
var _26037__$1 = this;return self__.meta26036;
});})(map__26034,map__26034__$1,cursor))
;
clustermap.components.filter.t26035.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__26034,map__26034__$1,cursor){
return (function (_26037,meta26036__$1){var self__ = this;
var _26037__$1 = this;return (new clustermap.components.filter.t26035(self__.cursor,self__.map__26034,self__.owner,self__.p__25942,self__.filter_component,meta26036__$1));
});})(map__26034,map__26034__$1,cursor))
;
clustermap.components.filter.__GT_t26035 = ((function (map__26034,map__26034__$1,cursor){
return (function __GT_t26035(cursor__$1,map__26034__$2,owner__$1,p__25942__$1,filter_component__$1,meta26036){return (new clustermap.components.filter.t26035(cursor__$1,map__26034__$2,owner__$1,p__25942__$1,filter_component__$1,meta26036));
});})(map__26034,map__26034__$1,cursor))
;
}
return (new clustermap.components.filter.t26035(cursor,map__26034__$1,owner,p__25942,filter_component,null));
});
