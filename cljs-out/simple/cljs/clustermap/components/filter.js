...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__24625,owner){var map__24717 = p__24625;var map__24717__$1 = ((cljs.core.seq_QMARK_.call(null,map__24717))?cljs.core.apply.call(null,cljs.core.hash_map,map__24717):map__24717);var cursor = map__24717__$1;if(typeof clustermap.components.filter.t24718 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t24718 = (function (cursor,map__24717,owner,p__24625,filter_component,meta24719){
this.cursor = cursor;
this.map__24717 = map__24717;
this.owner = owner;
this.p__24625 = p__24625;
this.filter_component = filter_component;
this.meta24719 = meta24719;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t24718.cljs$lang$type = true;
clustermap.components.filter.t24718.cljs$lang$ctorStr = "clustermap.components.filter/t24718";
clustermap.components.filter.t24718.cljs$lang$ctorPrWriter = ((function (map__24717,map__24717__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t24718");
});})(map__24717,map__24717__$1,cursor))
;
clustermap.components.filter.t24718.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t24718.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__24717,map__24717__$1,cursor){
return (function (this$,p__24721,next_state){var self__ = this;
var map__24722 = p__24721;var map__24722__$1 = ((cljs.core.seq_QMARK_.call(null,map__24722))?cljs.core.apply.call(null,cljs.core.hash_map,map__24722):map__24722);var next_components = cljs.core.get.call(null,map__24722__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__24722__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__24723 = om.core.get_props.call(null,self__.owner);var map__24723__$1 = ((cljs.core.seq_QMARK_.call(null,map__24723))?cljs.core.apply.call(null,cljs.core.hash_map,map__24723):map__24723);var components = cljs.core.get.call(null,map__24723__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__24723__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t24718.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t24718.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__24717,map__24717__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__24717,map__24717__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__24796 = cljs.core._EQ_;var expr__24797 = val;if(cljs.core.truth_(pred__24796.call(null,"new",expr__24797)))
...
{if(cljs.core.truth_(pred__24796.call(null,"old",expr__24797)))
...
});})(this$__$1,map__24717,map__24717__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__24717,map__24717__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__24799 = cljs.core._EQ_;var expr__24800 = val;if(cljs.core.truth_(pred__24799.call(null,"group",expr__24800)))
...
{if(cljs.core.truth_(pred__24799.call(null,"notgroup",expr__24800)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__24717,map__24717__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__24802 = cljs.core._EQ_;var expr__24803 = val;if(cljs.core.truth_(pred__24802.call(null,"low",expr__24803)))
...
{if(cljs.core.truth_(pred__24802.call(null,"high",expr__24803)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__24805 = cljs.core._EQ_;var expr__24806 = val;if(cljs.core.truth_(pred__24805.call(null,"A",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"B",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"C",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"D",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"E",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"F",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"G",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"H",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"I",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"J",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"K",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"L",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"M",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"N",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"O",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"P",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"Q",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"R",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"S",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"T",expr__24806)))
...
{if(cljs.core.truth_(pred__24805.call(null,"U",expr__24806)))
...
;
clustermap.components.filter.t24718.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__24717,map__24717__$1,cursor){
return (function (_24720){var self__ = this;
var _24720__$1 = this;return self__.meta24719;
});})(map__24717,map__24717__$1,cursor))
;
clustermap.components.filter.t24718.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__24717,map__24717__$1,cursor){
return (function (_24720,meta24719__$1){var self__ = this;
var _24720__$1 = this;return (new clustermap.components.filter.t24718(self__.cursor,self__.map__24717,self__.owner,self__.p__24625,self__.filter_component,meta24719__$1));
});})(map__24717,map__24717__$1,cursor))
;
clustermap.components.filter.__GT_t24718 = ((function (map__24717,map__24717__$1,cursor){
return (function __GT_t24718(cursor__$1,map__24717__$2,owner__$1,p__24625__$1,filter_component__$1,meta24719){return (new clustermap.components.filter.t24718(cursor__$1,map__24717__$2,owner__$1,p__24625__$1,filter_component__$1,meta24719));
});})(map__24717,map__24717__$1,cursor))
;
}
return (new clustermap.components.filter.t24718(cursor,map__24717__$1,owner,p__24625,filter_component,null));
});
