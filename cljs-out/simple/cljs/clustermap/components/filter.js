...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__25934,owner){var map__26026 = p__25934;var map__26026__$1 = ((cljs.core.seq_QMARK_.call(null,map__26026))?cljs.core.apply.call(null,cljs.core.hash_map,map__26026):map__26026);var cursor = map__26026__$1;if(typeof clustermap.components.filter.t26027 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t26027 = (function (cursor,map__26026,owner,p__25934,filter_component,meta26028){
this.cursor = cursor;
this.map__26026 = map__26026;
this.owner = owner;
this.p__25934 = p__25934;
this.filter_component = filter_component;
this.meta26028 = meta26028;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t26027.cljs$lang$type = true;
clustermap.components.filter.t26027.cljs$lang$ctorStr = "clustermap.components.filter/t26027";
clustermap.components.filter.t26027.cljs$lang$ctorPrWriter = ((function (map__26026,map__26026__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t26027");
});})(map__26026,map__26026__$1,cursor))
;
clustermap.components.filter.t26027.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t26027.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__26026,map__26026__$1,cursor){
return (function (this$,p__26030,next_state){var self__ = this;
var map__26031 = p__26030;var map__26031__$1 = ((cljs.core.seq_QMARK_.call(null,map__26031))?cljs.core.apply.call(null,cljs.core.hash_map,map__26031):map__26031);var next_components = cljs.core.get.call(null,map__26031__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__26031__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__26032 = om.core.get_props.call(null,self__.owner);var map__26032__$1 = ((cljs.core.seq_QMARK_.call(null,map__26032))?cljs.core.apply.call(null,cljs.core.hash_map,map__26032):map__26032);var components = cljs.core.get.call(null,map__26032__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__26032__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t26027.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t26027.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__26026,map__26026__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__26026,map__26026__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__26105 = cljs.core._EQ_;var expr__26106 = val;if(cljs.core.truth_(pred__26105.call(null,"new",expr__26106)))
...
{if(cljs.core.truth_(pred__26105.call(null,"old",expr__26106)))
...
});})(this$__$1,map__26026,map__26026__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__26026,map__26026__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__26108 = cljs.core._EQ_;var expr__26109 = val;if(cljs.core.truth_(pred__26108.call(null,"group",expr__26109)))
...
{if(cljs.core.truth_(pred__26108.call(null,"notgroup",expr__26109)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__26026,map__26026__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__26111 = cljs.core._EQ_;var expr__26112 = val;if(cljs.core.truth_(pred__26111.call(null,"low",expr__26112)))
...
{if(cljs.core.truth_(pred__26111.call(null,"high",expr__26112)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__26114 = cljs.core._EQ_;var expr__26115 = val;if(cljs.core.truth_(pred__26114.call(null,"A",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"B",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"C",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"D",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"E",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"F",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"G",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"H",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"I",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"J",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"K",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"L",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"M",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"N",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"O",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"P",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"Q",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"R",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"S",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"T",expr__26115)))
...
{if(cljs.core.truth_(pred__26114.call(null,"U",expr__26115)))
...
;
clustermap.components.filter.t26027.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__26026,map__26026__$1,cursor){
return (function (_26029){var self__ = this;
var _26029__$1 = this;return self__.meta26028;
});})(map__26026,map__26026__$1,cursor))
;
clustermap.components.filter.t26027.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__26026,map__26026__$1,cursor){
return (function (_26029,meta26028__$1){var self__ = this;
var _26029__$1 = this;return (new clustermap.components.filter.t26027(self__.cursor,self__.map__26026,self__.owner,self__.p__25934,self__.filter_component,meta26028__$1));
});})(map__26026,map__26026__$1,cursor))
;
clustermap.components.filter.__GT_t26027 = ((function (map__26026,map__26026__$1,cursor){
return (function __GT_t26027(cursor__$1,map__26026__$2,owner__$1,p__25934__$1,filter_component__$1,meta26028){return (new clustermap.components.filter.t26027(cursor__$1,map__26026__$2,owner__$1,p__25934__$1,filter_component__$1,meta26028));
});})(map__26026,map__26026__$1,cursor))
;
}
return (new clustermap.components.filter.t26027(cursor,map__26026__$1,owner,p__25934,filter_component,null));
});
