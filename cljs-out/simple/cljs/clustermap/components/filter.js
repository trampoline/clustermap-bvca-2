...
goog.require('clustermap.api');
goog.require('clustermap.ordered_resource');
clustermap.components.filter.render = (function render(p__30672,owner,state){var map__30774 = p__30672;var map__30774__$1 = ((cljs.core.seq_QMARK_.call(null,map__30774))?cljs.core.apply.call(null,cljs.core.hash_map,map__30774):map__30774);var bounds = cljs.core.get.call(null,map__30774__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var filter_spec = cljs.core.get.call(null,map__30774__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"filter by view"),React.DOM.div({"className": "tbl-cell"},sablono.interpreter.input.call(null,{"type": "checkbox", "name": "filter-by-view", "value": "true", "onChange": ((function (map__30774,map__30774__$1,bounds,filter_spec){
...
});})(map__30774,map__30774__$1,bounds,filter_spec))
}))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__30774,map__30774__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__30863 = cljs.core._EQ_;var expr__30864 = val;if(cljs.core.truth_(pred__30863.call(null,"new",expr__30864)))
...
{if(cljs.core.truth_(pred__30863.call(null,"old",expr__30864)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "new"},"< 5 years old"),sablono.interpreter.option.call(null,{"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__30774,map__30774__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__30866 = cljs.core._EQ_;var expr__30867 = val;if(cljs.core.truth_(pred__30866.call(null,"group",expr__30867)))
...
{if(cljs.core.truth_(pred__30866.call(null,"notgroup",expr__30867)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "group"},"group"),sablono.interpreter.option.call(null,{"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__30774,map__30774__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__30869 = cljs.core._EQ_;var expr__30870 = val;if(cljs.core.truth_(pred__30869.call(null,"low",expr__30870)))
...
{if(cljs.core.truth_(pred__30869.call(null,"high",expr__30870)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "low"},"< \u00A31 million"),sablono.interpreter.option.call(null,{"value": "high"},">= \u00A31 million")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"SIC section"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"style": {"width": "100%"}, "onChange": ((function (map__30774,map__30774__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(e.target.value);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__30872 = cljs.core._EQ_;var expr__30873 = val;if(cljs.core.truth_(pred__30872.call(null,"A",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"B",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"C",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"D",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"E",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"F",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"G",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"H",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"I",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"J",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"K",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"L",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"M",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"N",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"O",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"P",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"Q",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"R",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"S",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"T",expr__30873)))
...
{if(cljs.core.truth_(pred__30872.call(null,"U",expr__30873)))
...
clustermap.components.filter.filter_component = (function filter_component(p__30875,owner){var map__30884 = p__30875;var map__30884__$1 = ((cljs.core.seq_QMARK_.call(null,map__30884))?cljs.core.apply.call(null,cljs.core.hash_map,map__30884):map__30884);var props = map__30884__$1;var map__30885 = cljs.core.get.call(null,map__30884__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__30885__$1 = ((cljs.core.seq_QMARK_.call(null,map__30885))?cljs.core.apply.call(null,cljs.core.hash_map,map__30885):map__30885);var filter_spec = map__30885__$1;var components = cljs.core.get.call(null,map__30885__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var filter_by_view = cljs.core.get.call(null,map__30885__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var compiled = cljs.core.get.call(null,map__30885__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var bounds = cljs.core.get.call(null,map__30884__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));if(typeof clustermap.components.filter.t30886 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t30886 = (function (filter_component,p__30875,owner,filter_by_view,props,filter_spec,map__30885,compiled,bounds,components,map__30884,meta30887){
this.filter_component = filter_component;
this.p__30875 = p__30875;
this.owner = owner;
this.filter_by_view = filter_by_view;
this.props = props;
this.filter_spec = filter_spec;
this.map__30885 = map__30885;
this.compiled = compiled;
this.bounds = bounds;
this.components = components;
this.map__30884 = map__30884;
this.meta30887 = meta30887;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t30886.cljs$lang$type = true;
clustermap.components.filter.t30886.cljs$lang$ctorStr = "clustermap.components.filter/t30886";
clustermap.components.filter.t30886.cljs$lang$ctorPrWriter = ((function (map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (this__4213__auto__,writer__4214__auto__,opt__4215__auto__){return cljs.core._write.call(null,writer__4214__auto__,"clustermap.components.filter/t30886");
});})(map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t30886.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t30886.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,p__30889,next_state){var self__ = this;
var map__30890 = p__30889;var map__30890__$1 = ((cljs.core.seq_QMARK_.call(null,map__30890))?cljs.core.apply.call(null,cljs.core.hash_map,map__30890):map__30890);var map__30891 = cljs.core.get.call(null,map__30890__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__30891__$1 = ((cljs.core.seq_QMARK_.call(null,map__30891))?cljs.core.apply.call(null,cljs.core.hash_map,map__30891):map__30891);var next_components = cljs.core.get.call(null,map__30891__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_filter_by_view = cljs.core.get.call(null,map__30891__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var next_compiled = cljs.core.get.call(null,map__30891__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var next_bounds = cljs.core.get.call(null,map__30890__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var ___$1 = this;if(cljs.core.truth_((function (){var or__3637__auto__ = cljs.core.not_EQ_.call(null,next_components,self__.components);if(or__3637__auto__)
...
;
clustermap.components.filter.t30886.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t30886.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.props,self__.owner,state);
});})(map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t30886.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_30888){var self__ = this;
var _30888__$1 = this;return self__.meta30887;
});})(map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t30886.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_30888,meta30887__$1){var self__ = this;
var _30888__$1 = this;return (new clustermap.components.filter.t30886(self__.filter_component,self__.p__30875,self__.owner,self__.filter_by_view,self__.props,self__.filter_spec,self__.map__30885,self__.compiled,self__.bounds,self__.components,self__.map__30884,meta30887__$1));
});})(map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.__GT_t30886 = ((function (map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function __GT_t30886(filter_component__$1,p__30875__$1,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,map__30885__$2,compiled__$1,bounds__$1,components__$1,map__30884__$2,meta30887){return (new clustermap.components.filter.t30886(filter_component__$1,p__30875__$1,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,map__30885__$2,compiled__$1,bounds__$1,components__$1,map__30884__$2,meta30887));
});})(map__30884,map__30884__$1,props,map__30885,map__30885__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
}
return (new clustermap.components.filter.t30886(filter_component,p__30875,owner,filter_by_view,props,filter_spec,map__30885__$1,compiled,bounds,components,map__30884__$1,null));
});
