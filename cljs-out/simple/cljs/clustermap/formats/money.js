...
var readable__delegate = function (n,p__13845){var map__13848 = p__13845;var map__13848__$1 = ((cljs.core.seq_QMARK_.call(null,map__13848))?cljs.core.apply.call(null,cljs.core.hash_map,map__13848):map__13848);var default$ = cljs.core.get.call(null,map__13848__$1,new cljs.core.Keyword(null,"default","default",-1987822328));var plus_QMARK_ = cljs.core.get.call(null,map__13848__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327));var curr = cljs.core.get.call(null,map__13848__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"\u00A3");var sf = cljs.core.get.call(null,map__13848__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738));if(cljs.core.truth_(n))
{var vec__13849 = clustermap.formats.number.eng_notation.call(null,n,new cljs.core.Keyword(null,"sf","sf",-1949491738),sf);var sig = cljs.core.nth.call(null,vec__13849,(0),null);var exp = cljs.core.nth.call(null,vec__13849,(1),null);var abs_sig = Math.abs(sig);var suffix = clustermap.formats.money.money_suffix.call(null,exp);return cljs.core.apply.call(null,cljs.core.str,cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3627__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3627__auto__))
{return (sig > (0));
} else
...
var p__13845 = null;if (arguments.length > 1) {
  p__13845 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return readable__delegate.call(this,n,p__13845);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__13850){
var n = cljs.core.first(arglist__13850);
var p__13845 = cljs.core.rest(arglist__13850);
return readable__delegate(n,p__13845);
});
