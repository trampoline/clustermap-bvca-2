...
{{
var G__20086 = (i + (1));
var G__20087 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__20086;
acc = G__20087;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t20091 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t20091 = (function (expr,base,xpath,meta20092){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t20091.cljs$lang$type = true;
domina.xpath.t20091.cljs$lang$ctorStr = "domina.xpath/t20091";
domina.xpath.t20091.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t20091");
});
domina.xpath.t20091.prototype.domina$DomContent$ = true;
domina.xpath.t20091.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t20091.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t20091.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20093){var self__ = this;
var _20093__$1 = this;return self__.meta20092;
});
domina.xpath.t20091.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20093,meta20092__$1){var self__ = this;
var _20093__$1 = this;return (new domina.xpath.t20091(self__.expr,self__.base,self__.xpath,meta20092__$1));
});
domina.xpath.__GT_t20091 = (function __GT_t20091(expr__$1,base__$1,xpath__$1,meta20092){return (new domina.xpath.t20091(expr__$1,base__$1,xpath__$1,meta20092));
});
}
return (new domina.xpath.t20091(expr,base,xpath,null));
});
