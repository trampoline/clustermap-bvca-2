...
{{
var G__31866 = (i + (1));
var G__31867 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__31866;
acc = G__31867;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t31871 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t31871 = (function (expr,base,xpath,meta31872){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t31871.cljs$lang$type = true;
domina.xpath.t31871.cljs$lang$ctorStr = "domina.xpath/t31871";
domina.xpath.t31871.cljs$lang$ctorPrWriter = (function (this__4108__auto__,writer__4109__auto__,opt__4110__auto__){return cljs.core._write.call(null,writer__4109__auto__,"domina.xpath/t31871");
});
domina.xpath.t31871.prototype.domina$DomContent$ = true;
domina.xpath.t31871.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t31871.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t31871.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31873){var self__ = this;
var _31873__$1 = this;return self__.meta31872;
});
domina.xpath.t31871.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31873,meta31872__$1){var self__ = this;
var _31873__$1 = this;return (new domina.xpath.t31871(self__.expr,self__.base,self__.xpath,meta31872__$1));
});
domina.xpath.__GT_t31871 = (function __GT_t31871(expr__$1,base__$1,xpath__$1,meta31872){return (new domina.xpath.t31871(expr__$1,base__$1,xpath__$1,meta31872));
});
}
return (new domina.xpath.t31871(expr,base,xpath,null));
});
