...
{{
var G__32440 = (i + (1));
var G__32441 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__32440;
acc = G__32441;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t32445 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t32445 = (function (expr,base,xpath,meta32446){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t32445.cljs$lang$type = true;
domina.xpath.t32445.cljs$lang$ctorStr = "domina.xpath/t32445";
domina.xpath.t32445.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"domina.xpath/t32445");
});
domina.xpath.t32445.prototype.domina$DomContent$ = true;
domina.xpath.t32445.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32445.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32445.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32447){var self__ = this;
var _32447__$1 = this;return self__.meta32446;
});
domina.xpath.t32445.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32447,meta32446__$1){var self__ = this;
var _32447__$1 = this;return (new domina.xpath.t32445(self__.expr,self__.base,self__.xpath,meta32446__$1));
});
domina.xpath.__GT_t32445 = (function __GT_t32445(expr__$1,base__$1,xpath__$1,meta32446){return (new domina.xpath.t32445(expr__$1,base__$1,xpath__$1,meta32446));
});
}
return (new domina.xpath.t32445(expr,base,xpath,null));
});
