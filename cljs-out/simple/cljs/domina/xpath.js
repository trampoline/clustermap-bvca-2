...
{{
var G__20089 = (i + (1));
var G__20090 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__20089;
acc = G__20090;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t20094 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t20094 = (function (expr,base,xpath,meta20095){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t20094.cljs$lang$type = true;
domina.xpath.t20094.cljs$lang$ctorStr = "domina.xpath/t20094";
domina.xpath.t20094.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t20094");
});
domina.xpath.t20094.prototype.domina$DomContent$ = true;
domina.xpath.t20094.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t20094.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t20094.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20096){var self__ = this;
var _20096__$1 = this;return self__.meta20095;
});
domina.xpath.t20094.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20096,meta20095__$1){var self__ = this;
var _20096__$1 = this;return (new domina.xpath.t20094(self__.expr,self__.base,self__.xpath,meta20095__$1));
});
domina.xpath.__GT_t20094 = (function __GT_t20094(expr__$1,base__$1,xpath__$1,meta20095){return (new domina.xpath.t20094(expr__$1,base__$1,xpath__$1,meta20095));
});
}
return (new domina.xpath.t20094(expr,base,xpath,null));
});
