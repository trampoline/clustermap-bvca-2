...
{{
var G__31586 = (i + (1));
var G__31587 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__31586;
acc = G__31587;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t31591 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t31591 = (function (expr,base,xpath,meta31592){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t31591.cljs$lang$type = true;
domina.xpath.t31591.cljs$lang$ctorStr = "domina.xpath/t31591";
domina.xpath.t31591.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"domina.xpath/t31591");
});
domina.xpath.t31591.prototype.domina$DomContent$ = true;
domina.xpath.t31591.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t31591.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t31591.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31593){var self__ = this;
var _31593__$1 = this;return self__.meta31592;
});
domina.xpath.t31591.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31593,meta31592__$1){var self__ = this;
var _31593__$1 = this;return (new domina.xpath.t31591(self__.expr,self__.base,self__.xpath,meta31592__$1));
});
domina.xpath.__GT_t31591 = (function __GT_t31591(expr__$1,base__$1,xpath__$1,meta31592){return (new domina.xpath.t31591(expr__$1,base__$1,xpath__$1,meta31592));
});
}
return (new domina.xpath.t31591(expr,base,xpath,null));
});
