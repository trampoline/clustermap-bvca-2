...
{{
var G__29970 = (i + (1));
var G__29971 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29970;
acc = G__29971;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29975 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29975 = (function (expr,base,xpath,meta29976){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29975.cljs$lang$type = true;
domina.xpath.t29975.cljs$lang$ctorStr = "domina.xpath/t29975";
domina.xpath.t29975.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"domina.xpath/t29975");
});
domina.xpath.t29975.prototype.domina$DomContent$ = true;
domina.xpath.t29975.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29975.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29975.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29977){var self__ = this;
var _29977__$1 = this;return self__.meta29976;
});
domina.xpath.t29975.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29977,meta29976__$1){var self__ = this;
var _29977__$1 = this;return (new domina.xpath.t29975(self__.expr,self__.base,self__.xpath,meta29976__$1));
});
domina.xpath.__GT_t29975 = (function __GT_t29975(expr__$1,base__$1,xpath__$1,meta29976){return (new domina.xpath.t29975(expr__$1,base__$1,xpath__$1,meta29976));
});
}
return (new domina.xpath.t29975(expr,base,xpath,null));
});
