...
{{
var G__32425 = (i + (1));
var G__32426 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__32425;
acc = G__32426;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t32430 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t32430 = (function (expr,base,xpath,meta32431){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t32430.cljs$lang$type = true;
domina.xpath.t32430.cljs$lang$ctorStr = "domina.xpath/t32430";
domina.xpath.t32430.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"domina.xpath/t32430");
});
domina.xpath.t32430.prototype.domina$DomContent$ = true;
domina.xpath.t32430.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32430.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32430.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32432){var self__ = this;
var _32432__$1 = this;return self__.meta32431;
});
domina.xpath.t32430.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32432,meta32431__$1){var self__ = this;
var _32432__$1 = this;return (new domina.xpath.t32430(self__.expr,self__.base,self__.xpath,meta32431__$1));
});
domina.xpath.__GT_t32430 = (function __GT_t32430(expr__$1,base__$1,xpath__$1,meta32431){return (new domina.xpath.t32430(expr__$1,base__$1,xpath__$1,meta32431));
});
}
return (new domina.xpath.t32430(expr,base,xpath,null));
});
