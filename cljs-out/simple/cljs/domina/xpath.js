...
{{
var G__17505 = (i + 1);
var G__17506 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__17505;
acc = G__17506;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t17510 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t17510 = (function (expr,base,xpath,meta17511){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t17510.cljs$lang$type = true;
domina.xpath.t17510.cljs$lang$ctorStr = "domina.xpath/t17510";
domina.xpath.t17510.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t17510");
});
domina.xpath.t17510.prototype.domina$DomContent$ = true;
domina.xpath.t17510.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17510.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17510.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17512){var self__ = this;
var _17512__$1 = this;return self__.meta17511;
});
domina.xpath.t17510.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17512,meta17511__$1){var self__ = this;
var _17512__$1 = this;return (new domina.xpath.t17510(self__.expr,self__.base,self__.xpath,meta17511__$1));
});
domina.xpath.__GT_t17510 = (function __GT_t17510(expr__$1,base__$1,xpath__$1,meta17511){return (new domina.xpath.t17510(expr__$1,base__$1,xpath__$1,meta17511));
});
}
return (new domina.xpath.t17510(expr,base,xpath,null));
});
