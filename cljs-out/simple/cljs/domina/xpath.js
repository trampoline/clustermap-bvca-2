...
{{
var G__17521 = (i + 1);
var G__17522 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__17521;
acc = G__17522;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t17526 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t17526 = (function (expr,base,xpath,meta17527){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t17526.cljs$lang$type = true;
domina.xpath.t17526.cljs$lang$ctorStr = "domina.xpath/t17526";
domina.xpath.t17526.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t17526");
});
domina.xpath.t17526.prototype.domina$DomContent$ = true;
domina.xpath.t17526.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17526.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17526.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17528){var self__ = this;
var _17528__$1 = this;return self__.meta17527;
});
domina.xpath.t17526.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17528,meta17527__$1){var self__ = this;
var _17528__$1 = this;return (new domina.xpath.t17526(self__.expr,self__.base,self__.xpath,meta17527__$1));
});
domina.xpath.__GT_t17526 = (function __GT_t17526(expr__$1,base__$1,xpath__$1,meta17527){return (new domina.xpath.t17526(expr__$1,base__$1,xpath__$1,meta17527));
});
}
return (new domina.xpath.t17526(expr,base,xpath,null));
});
