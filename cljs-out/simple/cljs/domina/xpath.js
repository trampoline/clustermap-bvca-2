...
{{
var G__32377 = (i + (1));
var G__32378 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__32377;
acc = G__32378;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t32382 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t32382 = (function (expr,base,xpath,meta32383){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t32382.cljs$lang$type = true;
domina.xpath.t32382.cljs$lang$ctorStr = "domina.xpath/t32382";
domina.xpath.t32382.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"domina.xpath/t32382");
});
domina.xpath.t32382.prototype.domina$DomContent$ = true;
domina.xpath.t32382.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32382.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32382.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32384){var self__ = this;
var _32384__$1 = this;return self__.meta32383;
});
domina.xpath.t32382.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32384,meta32383__$1){var self__ = this;
var _32384__$1 = this;return (new domina.xpath.t32382(self__.expr,self__.base,self__.xpath,meta32383__$1));
});
domina.xpath.__GT_t32382 = (function __GT_t32382(expr__$1,base__$1,xpath__$1,meta32383){return (new domina.xpath.t32382(expr__$1,base__$1,xpath__$1,meta32383));
});
}
return (new domina.xpath.t32382(expr,base,xpath,null));
});
