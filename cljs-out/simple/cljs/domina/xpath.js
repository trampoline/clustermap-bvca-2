...
{{
var G__17517 = (i + 1);
var G__17518 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__17517;
acc = G__17518;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t17522 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t17522 = (function (expr,base,xpath,meta17523){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t17522.cljs$lang$type = true;
domina.xpath.t17522.cljs$lang$ctorStr = "domina.xpath/t17522";
domina.xpath.t17522.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t17522");
});
domina.xpath.t17522.prototype.domina$DomContent$ = true;
domina.xpath.t17522.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17522.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t17522.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17524){var self__ = this;
var _17524__$1 = this;return self__.meta17523;
});
domina.xpath.t17522.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17524,meta17523__$1){var self__ = this;
var _17524__$1 = this;return (new domina.xpath.t17522(self__.expr,self__.base,self__.xpath,meta17523__$1));
});
domina.xpath.__GT_t17522 = (function __GT_t17522(expr__$1,base__$1,xpath__$1,meta17523){return (new domina.xpath.t17522(expr__$1,base__$1,xpath__$1,meta17523));
});
}
return (new domina.xpath.t17522(expr,base,xpath,null));
});
