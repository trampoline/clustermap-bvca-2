...
var G__42475 = null;
var G__42475__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__42475__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
G__42475 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__42475__2.call(this,self__,k);
case 3:
return G__42475__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__42475.cljs$core$IFn$_invoke$arity$2 = G__42475__2;
G__42475.cljs$core$IFn$_invoke$arity$3 = G__42475__3;
return G__42475;
})()
;
jQuery.prototype.apply = (function (self__,args42474){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args42474)));
});
...
var hide__delegate = function ($elem,p__42476){var vec__42478 = p__42476;var speed = cljs.core.nth.call(null,vec__42478,(0),null);var on_finish = cljs.core.nth.call(null,vec__42478,(1),null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__42476 = null;if (arguments.length > 1) {
  p__42476 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__42476);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__42479){
var $elem = cljs.core.first(arglist__42479);
var p__42476 = cljs.core.rest(arglist__42479);
return hide__delegate($elem,p__42476);
});
...
var show__delegate = function ($elem,p__42480){var vec__42482 = p__42480;var speed = cljs.core.nth.call(null,vec__42482,(0),null);var on_finish = cljs.core.nth.call(null,vec__42482,(1),null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__42480 = null;if (arguments.length > 1) {
  p__42480 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__42480);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__42483){
var $elem = cljs.core.first(arglist__42483);
var p__42480 = cljs.core.rest(arglist__42483);
return show__delegate($elem,p__42480);
});
...
var toggle__delegate = function ($elem,p__42484){var vec__42486 = p__42484;var speed = cljs.core.nth.call(null,vec__42486,(0),null);var on_finish = cljs.core.nth.call(null,vec__42486,(1),null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__42484 = null;if (arguments.length > 1) {
  p__42484 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__42484);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__42487){
var $elem = cljs.core.first(arglist__42487);
var p__42484 = cljs.core.rest(arglist__42487);
return toggle__delegate($elem,p__42484);
});
...
var fade_out__delegate = function ($elem,p__42488){var vec__42490 = p__42488;var speed = cljs.core.nth.call(null,vec__42490,(0),null);var on_finish = cljs.core.nth.call(null,vec__42490,(1),null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__42488 = null;if (arguments.length > 1) {
  p__42488 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__42488);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__42491){
var $elem = cljs.core.first(arglist__42491);
var p__42488 = cljs.core.rest(arglist__42491);
return fade_out__delegate($elem,p__42488);
});
...
var fade_in__delegate = function ($elem,p__42492){var vec__42494 = p__42492;var speed = cljs.core.nth.call(null,vec__42494,(0),null);var on_finish = cljs.core.nth.call(null,vec__42494,(1),null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__42492 = null;if (arguments.length > 1) {
  p__42492 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__42492);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__42495){
var $elem = cljs.core.first(arglist__42495);
var p__42492 = cljs.core.rest(arglist__42495);
return fade_in__delegate($elem,p__42492);
});
...
var slide_up__delegate = function ($elem,p__42496){var vec__42498 = p__42496;var speed = cljs.core.nth.call(null,vec__42498,(0),null);var on_finish = cljs.core.nth.call(null,vec__42498,(1),null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__42496 = null;if (arguments.length > 1) {
  p__42496 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__42496);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__42499){
var $elem = cljs.core.first(arglist__42499);
var p__42496 = cljs.core.rest(arglist__42499);
return slide_up__delegate($elem,p__42496);
});
...
var slide_down__delegate = function ($elem,p__42500){var vec__42502 = p__42500;var speed = cljs.core.nth.call(null,vec__42502,(0),null);var on_finish = cljs.core.nth.call(null,vec__42502,(1),null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__42500 = null;if (arguments.length > 1) {
  p__42500 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__42500);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__42503){
var $elem = cljs.core.first(arglist__42503);
var p__42500 = cljs.core.rest(arglist__42503);
return slide_down__delegate($elem,p__42500);
});
...
var closest__delegate = function ($elem,selector,p__42504){var vec__42506 = p__42504;var context = cljs.core.nth.call(null,vec__42506,(0),null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__42504 = null;if (arguments.length > 2) {
  p__42504 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__42504);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__42507){
var $elem = cljs.core.first(arglist__42507);
arglist__42507 = cljs.core.next(arglist__42507);
var selector = cljs.core.first(arglist__42507);
var p__42504 = cljs.core.rest(arglist__42507);
return closest__delegate($elem,selector,p__42504);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__42510){var map__42512 = p__42510;var map__42512__$1 = ((cljs.core.seq_QMARK_.call(null,map__42512))?cljs.core.apply.call(null,cljs.core.hash_map,map__42512):map__42512);var request = map__42512__$1;var contentType = cljs.core.get.call(null,map__42512__$1,new cljs.core.Keyword(null,"contentType","contentType",-1462509576));var data = cljs.core.get.call(null,map__42512__$1,new cljs.core.Keyword(null,"data","data",-232669377));var ct = jayq.core.__GT_content_type.call(null,contentType);return ((function (ct,map__42512,map__42512__$1,request,contentType,data){
return (function (p1__42509_SHARP_){if(cljs.core.truth_((function (){var and__3625__auto__ = ct;if(cljs.core.truth_(and__3625__auto__))
{return jayq.core.clj_content_type_QMARK_.call(null,ct);
} else
{return and__3625__auto__;
}
})()))
{return cljs.core.assoc.call(null,p1__42509_SHARP_,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.pr_str.call(null,data));
} else
{return p1__42509_SHARP_;
}
});})(ct,map__42512,map__42512__$1,request,contentType,data))
.call(null,((function (ct,map__42512,map__42512__$1,request,contentType,data){
return (function (p1__42508_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__42508_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",-1462509576),ct);
} else
{return p1__42508_SHARP_;
}
});})(ct,map__42512,map__42512__$1,request,contentType,data))
.call(null,request));
});
...
var unbind__delegate = function ($elem,ev,p__42516){var vec__42518 = p__42516;var func = cljs.core.nth.call(null,vec__42518,(0),null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__42516 = null;if (arguments.length > 2) {
  p__42516 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__42516);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__42519){
var $elem = cljs.core.first(arglist__42519);
arglist__42519 = cljs.core.next(arglist__42519);
var ev = cljs.core.first(arglist__42519);
var p__42516 = cljs.core.rest(arglist__42519);
return unbind__delegate($elem,ev,p__42516);
});
...
var on__delegate = function ($elem,events,p__42520){var vec__42522 = p__42520;var sel = cljs.core.nth.call(null,vec__42522,(0),null);var data = cljs.core.nth.call(null,vec__42522,(1),null);var handler = cljs.core.nth.call(null,vec__42522,(2),null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__42520 = null;if (arguments.length > 2) {
  p__42520 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__42520);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__42523){
var $elem = cljs.core.first(arglist__42523);
arglist__42523 = cljs.core.next(arglist__42523);
var events = cljs.core.first(arglist__42523);
var p__42520 = cljs.core.rest(arglist__42523);
return on__delegate($elem,events,p__42520);
});
...
var one__delegate = function ($elem,events,p__42524){var vec__42526 = p__42524;var sel = cljs.core.nth.call(null,vec__42526,(0),null);var data = cljs.core.nth.call(null,vec__42526,(1),null);var handler = cljs.core.nth.call(null,vec__42526,(2),null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__42524 = null;if (arguments.length > 2) {
  p__42524 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__42524);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__42527){
var $elem = cljs.core.first(arglist__42527);
arglist__42527 = cljs.core.next(arglist__42527);
var events = cljs.core.first(arglist__42527);
var p__42524 = cljs.core.rest(arglist__42527);
return one__delegate($elem,events,p__42524);
});
...
var off__delegate = function ($elem,events,p__42528){var vec__42530 = p__42528;var sel = cljs.core.nth.call(null,vec__42530,(0),null);var handler = cljs.core.nth.call(null,vec__42530,(1),null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__42528 = null;if (arguments.length > 2) {
  p__42528 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__42528);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__42531){
var $elem = cljs.core.first(arglist__42531);
arglist__42531 = cljs.core.next(arglist__42531);
var events = cljs.core.first(arglist__42531);
var p__42528 = cljs.core.rest(arglist__42531);
return off__delegate($elem,events,p__42528);
});
...
done.cljs$lang$applyTo = (function (arglist__42532){
var deferred = cljs.core.first(arglist__42532);
var fns_args = cljs.core.rest(arglist__42532);
...
fail.cljs$lang$applyTo = (function (arglist__42533){
var deferred = cljs.core.first(arglist__42533);
var fns_args = cljs.core.rest(arglist__42533);
...
always.cljs$lang$applyTo = (function (arglist__42534){
var deferred = cljs.core.first(arglist__42534);
var fns_args = cljs.core.rest(arglist__42534);
