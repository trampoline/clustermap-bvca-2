...
var G__35786 = null;
var G__35786__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__35786__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
G__35786 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__35786__2.call(this,self__,k);
case 3:
return G__35786__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__35786.cljs$core$IFn$_invoke$arity$2 = G__35786__2;
G__35786.cljs$core$IFn$_invoke$arity$3 = G__35786__3;
return G__35786;
})()
;
jQuery.prototype.apply = (function (self__,args35785){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args35785)));
});
...
var hide__delegate = function ($elem,p__35787){var vec__35789 = p__35787;var speed = cljs.core.nth.call(null,vec__35789,(0),null);var on_finish = cljs.core.nth.call(null,vec__35789,(1),null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__35787 = null;if (arguments.length > 1) {
  p__35787 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__35787);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__35790){
var $elem = cljs.core.first(arglist__35790);
var p__35787 = cljs.core.rest(arglist__35790);
return hide__delegate($elem,p__35787);
});
...
var show__delegate = function ($elem,p__35791){var vec__35793 = p__35791;var speed = cljs.core.nth.call(null,vec__35793,(0),null);var on_finish = cljs.core.nth.call(null,vec__35793,(1),null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__35791 = null;if (arguments.length > 1) {
  p__35791 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__35791);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__35794){
var $elem = cljs.core.first(arglist__35794);
var p__35791 = cljs.core.rest(arglist__35794);
return show__delegate($elem,p__35791);
});
...
var toggle__delegate = function ($elem,p__35795){var vec__35797 = p__35795;var speed = cljs.core.nth.call(null,vec__35797,(0),null);var on_finish = cljs.core.nth.call(null,vec__35797,(1),null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__35795 = null;if (arguments.length > 1) {
  p__35795 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__35795);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__35798){
var $elem = cljs.core.first(arglist__35798);
var p__35795 = cljs.core.rest(arglist__35798);
return toggle__delegate($elem,p__35795);
});
...
var fade_out__delegate = function ($elem,p__35799){var vec__35801 = p__35799;var speed = cljs.core.nth.call(null,vec__35801,(0),null);var on_finish = cljs.core.nth.call(null,vec__35801,(1),null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__35799 = null;if (arguments.length > 1) {
  p__35799 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__35799);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__35802){
var $elem = cljs.core.first(arglist__35802);
var p__35799 = cljs.core.rest(arglist__35802);
return fade_out__delegate($elem,p__35799);
});
...
var fade_in__delegate = function ($elem,p__35803){var vec__35805 = p__35803;var speed = cljs.core.nth.call(null,vec__35805,(0),null);var on_finish = cljs.core.nth.call(null,vec__35805,(1),null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__35803 = null;if (arguments.length > 1) {
  p__35803 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__35803);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__35806){
var $elem = cljs.core.first(arglist__35806);
var p__35803 = cljs.core.rest(arglist__35806);
return fade_in__delegate($elem,p__35803);
});
...
var slide_up__delegate = function ($elem,p__35807){var vec__35809 = p__35807;var speed = cljs.core.nth.call(null,vec__35809,(0),null);var on_finish = cljs.core.nth.call(null,vec__35809,(1),null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__35807 = null;if (arguments.length > 1) {
  p__35807 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__35807);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__35810){
var $elem = cljs.core.first(arglist__35810);
var p__35807 = cljs.core.rest(arglist__35810);
return slide_up__delegate($elem,p__35807);
});
...
var slide_down__delegate = function ($elem,p__35811){var vec__35813 = p__35811;var speed = cljs.core.nth.call(null,vec__35813,(0),null);var on_finish = cljs.core.nth.call(null,vec__35813,(1),null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__35811 = null;if (arguments.length > 1) {
  p__35811 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__35811);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__35814){
var $elem = cljs.core.first(arglist__35814);
var p__35811 = cljs.core.rest(arglist__35814);
return slide_down__delegate($elem,p__35811);
});
...
var closest__delegate = function ($elem,selector,p__35815){var vec__35817 = p__35815;var context = cljs.core.nth.call(null,vec__35817,(0),null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__35815 = null;if (arguments.length > 2) {
  p__35815 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__35815);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__35818){
var $elem = cljs.core.first(arglist__35818);
arglist__35818 = cljs.core.next(arglist__35818);
var selector = cljs.core.first(arglist__35818);
var p__35815 = cljs.core.rest(arglist__35818);
return closest__delegate($elem,selector,p__35815);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__35821){var map__35823 = p__35821;var map__35823__$1 = ((cljs.core.seq_QMARK_.call(null,map__35823))?cljs.core.apply.call(null,cljs.core.hash_map,map__35823):map__35823);var request = map__35823__$1;var contentType = cljs.core.get.call(null,map__35823__$1,new cljs.core.Keyword(null,"contentType","contentType",-1462509576));var data = cljs.core.get.call(null,map__35823__$1,new cljs.core.Keyword(null,"data","data",-232669377));var ct = jayq.core.__GT_content_type.call(null,contentType);return ((function (ct,map__35823,map__35823__$1,request,contentType,data){
return (function (p1__35820_SHARP_){if(cljs.core.truth_((function (){var and__3546__auto__ = ct;if(cljs.core.truth_(and__3546__auto__))
{return jayq.core.clj_content_type_QMARK_.call(null,ct);
} else
{return and__3546__auto__;
}
})()))
{return cljs.core.assoc.call(null,p1__35820_SHARP_,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.pr_str.call(null,data));
} else
{return p1__35820_SHARP_;
}
});})(ct,map__35823,map__35823__$1,request,contentType,data))
.call(null,((function (ct,map__35823,map__35823__$1,request,contentType,data){
return (function (p1__35819_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__35819_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",-1462509576),ct);
} else
...
var unbind__delegate = function ($elem,ev,p__35827){var vec__35829 = p__35827;var func = cljs.core.nth.call(null,vec__35829,(0),null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__35827 = null;if (arguments.length > 2) {
  p__35827 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__35827);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__35830){
var $elem = cljs.core.first(arglist__35830);
arglist__35830 = cljs.core.next(arglist__35830);
var ev = cljs.core.first(arglist__35830);
var p__35827 = cljs.core.rest(arglist__35830);
return unbind__delegate($elem,ev,p__35827);
});
...
var on__delegate = function ($elem,events,p__35831){var vec__35833 = p__35831;var sel = cljs.core.nth.call(null,vec__35833,(0),null);var data = cljs.core.nth.call(null,vec__35833,(1),null);var handler = cljs.core.nth.call(null,vec__35833,(2),null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__35831 = null;if (arguments.length > 2) {
  p__35831 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__35831);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__35834){
var $elem = cljs.core.first(arglist__35834);
arglist__35834 = cljs.core.next(arglist__35834);
var events = cljs.core.first(arglist__35834);
var p__35831 = cljs.core.rest(arglist__35834);
return on__delegate($elem,events,p__35831);
});
...
var one__delegate = function ($elem,events,p__35835){var vec__35837 = p__35835;var sel = cljs.core.nth.call(null,vec__35837,(0),null);var data = cljs.core.nth.call(null,vec__35837,(1),null);var handler = cljs.core.nth.call(null,vec__35837,(2),null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__35835 = null;if (arguments.length > 2) {
  p__35835 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__35835);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__35838){
var $elem = cljs.core.first(arglist__35838);
arglist__35838 = cljs.core.next(arglist__35838);
var events = cljs.core.first(arglist__35838);
var p__35835 = cljs.core.rest(arglist__35838);
return one__delegate($elem,events,p__35835);
});
...
var off__delegate = function ($elem,events,p__35839){var vec__35841 = p__35839;var sel = cljs.core.nth.call(null,vec__35841,(0),null);var handler = cljs.core.nth.call(null,vec__35841,(1),null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__35839 = null;if (arguments.length > 2) {
  p__35839 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__35839);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__35842){
var $elem = cljs.core.first(arglist__35842);
arglist__35842 = cljs.core.next(arglist__35842);
var events = cljs.core.first(arglist__35842);
var p__35839 = cljs.core.rest(arglist__35842);
return off__delegate($elem,events,p__35839);
});
...
done.cljs$lang$applyTo = (function (arglist__35843){
var deferred = cljs.core.first(arglist__35843);
var fns_args = cljs.core.rest(arglist__35843);
...
fail.cljs$lang$applyTo = (function (arglist__35844){
var deferred = cljs.core.first(arglist__35844);
var fns_args = cljs.core.rest(arglist__35844);
...
always.cljs$lang$applyTo = (function (arglist__35845){
var deferred = cljs.core.first(arglist__35845);
var fns_args = cljs.core.rest(arglist__35845);
