...
sablono.util.ToString = (function (){var obj30983 = {};return obj30983;
})();
...
sablono.util.ToURI = (function (){var obj30985 = {};return obj30985;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__30986){
var xs = cljs.core.seq(arglist__30986);
...
{var vec__30988 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__30988,(0),null);var words = cljs.core.nthnext.call(null,vec__30988,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__30989_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__30989_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__30989_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__30989_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__30990){
var maps = cljs.core.seq(arglist__30990);
...
*/
sablono.util.normalize_element = (function normalize_element(p__30995){var vec__30998 = p__30995;var tag = cljs.core.nth.call(null,vec__30998,(0),null);var content = cljs.core.nthnext.call(null,vec__30998,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__30999 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__30999,(0),null);var id = cljs.core.nth.call(null,vec__30999,(1),null);var class$ = cljs.core.nth.call(null,vec__30999,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
