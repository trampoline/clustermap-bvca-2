...
sablono.util.ToString = (function (){var obj29991 = {};return obj29991;
})();
...
sablono.util.ToURI = (function (){var obj29993 = {};return obj29993;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__29994){
var xs = cljs.core.seq(arglist__29994);
...
{var vec__29996 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__29996,(0),null);var words = cljs.core.nthnext.call(null,vec__29996,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__29997_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__29997_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__29997_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__29997_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__29998){
var maps = cljs.core.seq(arglist__29998);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__30002 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):((new cljs.core.Keyword(null,"default","default",-1987822328))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null):null)));var tag_name = cljs.core.nth.call(null,vec__30002,(0),null);var names = cljs.core.nth.call(null,vec__30002,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__30002,tag_name,names){
return (function (p1__29999_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__29999_SHARP_));
});})(matches,vec__30002,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__30002,tag_name,names){
return (function (p1__30000_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__30000_SHARP_));
});})(matches,vec__30002,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__30003){var vec__30006 = p__30003;var tag = cljs.core.nth.call(null,vec__30006,(0),null);var content = cljs.core.nthnext.call(null,vec__30006,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
