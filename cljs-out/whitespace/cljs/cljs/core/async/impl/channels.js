...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t34174 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t34174 = (function (val,box,meta34175){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t34174.cljs$lang$type = true;
cljs.core.async.impl.channels.t34174.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t34174";
cljs.core.async.impl.channels.t34174.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t34174");
});
cljs.core.async.impl.channels.t34174.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t34174.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34176){var self__ = this;
var _34176__$1 = this;return self__.meta34175;
});
cljs.core.async.impl.channels.t34174.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34176,meta34175__$1){var self__ = this;
var _34176__$1 = this;return (new cljs.core.async.impl.channels.t34174(self__.val,self__.box,meta34175__$1));
});
cljs.core.async.impl.channels.__GT_t34174 = (function __GT_t34174(val__$1,box__$1,meta34175){return (new cljs.core.async.impl.channels.t34174(val__$1,box__$1,meta34175));
});
}
return (new cljs.core.async.impl.channels.t34174(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_34177 = self__.takes.pop();if((taker_34177 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_34177))
{var take_cb_34178 = cljs.core.async.impl.protocols.commit.call(null,taker_34177);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_34178,taker_34177){
return (function (){return take_cb_34178.call(null,null);
});})(take_cb_34178,taker_34177))
);
} else
{}
{
