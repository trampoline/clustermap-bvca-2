...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t46212 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t46212 = (function (val,box,meta46213){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t46212.cljs$lang$type = true;
cljs.core.async.impl.channels.t46212.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t46212";
cljs.core.async.impl.channels.t46212.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"cljs.core.async.impl.channels/t46212");
});
cljs.core.async.impl.channels.t46212.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t46212.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_46214){var self__ = this;
var _46214__$1 = this;return self__.meta46213;
});
cljs.core.async.impl.channels.t46212.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_46214,meta46213__$1){var self__ = this;
var _46214__$1 = this;return (new cljs.core.async.impl.channels.t46212(self__.val,self__.box,meta46213__$1));
});
cljs.core.async.impl.channels.__GT_t46212 = (function __GT_t46212(val__$1,box__$1,meta46213){return (new cljs.core.async.impl.channels.t46212(val__$1,box__$1,meta46213));
});
}
return (new cljs.core.async.impl.channels.t46212(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3838__auto__,writer__3839__auto__,opts__3840__auto__){return cljs.core._write.call(null,writer__3839__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_46215 = self__.takes.pop();if((taker_46215 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_46215))
{var take_cb_46216 = cljs.core.async.impl.protocols.commit.call(null,taker_46215);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_46216,taker_46215){
return (function (){return take_cb_46216.call(null,null);
});})(take_cb_46216,taker_46215))
);
} else
{}
{
