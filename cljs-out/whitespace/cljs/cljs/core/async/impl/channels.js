...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t33679 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t33679 = (function (val,box,meta33680){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t33679.cljs$lang$type = true;
cljs.core.async.impl.channels.t33679.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t33679";
cljs.core.async.impl.channels.t33679.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t33679");
});
cljs.core.async.impl.channels.t33679.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t33679.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33681){var self__ = this;
var _33681__$1 = this;return self__.meta33680;
});
cljs.core.async.impl.channels.t33679.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33681,meta33680__$1){var self__ = this;
var _33681__$1 = this;return (new cljs.core.async.impl.channels.t33679(self__.val,self__.box,meta33680__$1));
});
cljs.core.async.impl.channels.__GT_t33679 = (function __GT_t33679(val__$1,box__$1,meta33680){return (new cljs.core.async.impl.channels.t33679(val__$1,box__$1,meta33680));
});
}
return (new cljs.core.async.impl.channels.t33679(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_33682 = self__.takes.pop();if((taker_33682 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_33682))
{var take_cb_33683 = cljs.core.async.impl.protocols.commit.call(null,taker_33682);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_33683,taker_33682){
return (function (){return take_cb_33683.call(null,null);
});})(take_cb_33683,taker_33682))
);
} else
{}
{
