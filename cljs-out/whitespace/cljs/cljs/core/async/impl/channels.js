...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17967 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17967 = (function (val,box,meta17968){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17967.cljs$lang$type = true;
cljs.core.async.impl.channels.t17967.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17967";
cljs.core.async.impl.channels.t17967.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"cljs.core.async.impl.channels/t17967");
});
cljs.core.async.impl.channels.t17967.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17967.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17969){var self__ = this;
var _17969__$1 = this;return self__.meta17968;
});
cljs.core.async.impl.channels.t17967.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17969,meta17968__$1){var self__ = this;
var _17969__$1 = this;return (new cljs.core.async.impl.channels.t17967(self__.val,self__.box,meta17968__$1));
});
cljs.core.async.impl.channels.__GT_t17967 = (function __GT_t17967(val__$1,box__$1,meta17968){return (new cljs.core.async.impl.channels.t17967(val__$1,box__$1,meta17968));
});
}
return (new cljs.core.async.impl.channels.t17967(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_17970 = self__.takes.pop();if((taker_17970 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17970))
{var take_cb_17971 = cljs.core.async.impl.protocols.commit.call(null,taker_17970);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17971,taker_17970,this$__$1){
return (function (){return take_cb_17971.call(null,null);
});})(take_cb_17971,taker_17970,this$__$1))
);
} else
{}
{
