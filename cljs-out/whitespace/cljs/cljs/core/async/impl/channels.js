...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t21132 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t21132 = (function (val,box,meta21133){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t21132.cljs$lang$type = true;
cljs.core.async.impl.channels.t21132.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t21132";
cljs.core.async.impl.channels.t21132.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"cljs.core.async.impl.channels/t21132");
});
cljs.core.async.impl.channels.t21132.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t21132.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21134){var self__ = this;
var _21134__$1 = this;return self__.meta21133;
});
cljs.core.async.impl.channels.t21132.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21134,meta21133__$1){var self__ = this;
var _21134__$1 = this;return (new cljs.core.async.impl.channels.t21132(self__.val,self__.box,meta21133__$1));
});
cljs.core.async.impl.channels.__GT_t21132 = (function __GT_t21132(val__$1,box__$1,meta21133){return (new cljs.core.async.impl.channels.t21132(val__$1,box__$1,meta21133));
});
}
return (new cljs.core.async.impl.channels.t21132(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_21135 = self__.takes.pop();if((taker_21135 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_21135))
{var take_cb_21136 = cljs.core.async.impl.protocols.commit.call(null,taker_21135);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_21136,taker_21135,this$__$1){
return (function (){return take_cb_21136.call(null,null);
});})(take_cb_21136,taker_21135,this$__$1))
);
} else
{}
{
