...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t36939 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t36939 = (function (val,box,meta36940){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t36939.cljs$lang$type = true;
cljs.core.async.impl.channels.t36939.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t36939";
cljs.core.async.impl.channels.t36939.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t36939");
});
cljs.core.async.impl.channels.t36939.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t36939.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36941){var self__ = this;
var _36941__$1 = this;return self__.meta36940;
});
cljs.core.async.impl.channels.t36939.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36941,meta36940__$1){var self__ = this;
var _36941__$1 = this;return (new cljs.core.async.impl.channels.t36939(self__.val,self__.box,meta36940__$1));
});
cljs.core.async.impl.channels.__GT_t36939 = (function __GT_t36939(val__$1,box__$1,meta36940){return (new cljs.core.async.impl.channels.t36939(val__$1,box__$1,meta36940));
});
}
return (new cljs.core.async.impl.channels.t36939(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_36942 = self__.takes.pop();if((taker_36942 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_36942))
{var take_cb_36943 = cljs.core.async.impl.protocols.commit.call(null,taker_36942);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_36943,taker_36942){
return (function (){return take_cb_36943.call(null,null);
});})(take_cb_36943,taker_36942))
);
} else
{}
{
