...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t49549 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t49549 = (function (val,box,meta49550){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t49549.cljs$lang$type = true;
cljs.core.async.impl.channels.t49549.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t49549";
cljs.core.async.impl.channels.t49549.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"cljs.core.async.impl.channels/t49549");
});
cljs.core.async.impl.channels.t49549.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t49549.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49551){var self__ = this;
var _49551__$1 = this;return self__.meta49550;
});
cljs.core.async.impl.channels.t49549.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49551,meta49550__$1){var self__ = this;
var _49551__$1 = this;return (new cljs.core.async.impl.channels.t49549(self__.val,self__.box,meta49550__$1));
});
cljs.core.async.impl.channels.__GT_t49549 = (function __GT_t49549(val__$1,box__$1,meta49550){return (new cljs.core.async.impl.channels.t49549(val__$1,box__$1,meta49550));
});
}
return (new cljs.core.async.impl.channels.t49549(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_49552 = self__.takes.pop();if((taker_49552 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_49552))
{var take_cb_49553 = cljs.core.async.impl.protocols.commit.call(null,taker_49552);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_49553,taker_49552){
return (function (){return take_cb_49553.call(null,null);
});})(take_cb_49553,taker_49552))
);
} else
{}
{
