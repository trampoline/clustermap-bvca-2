...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t48993 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t48993 = (function (val,box,meta48994){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t48993.cljs$lang$type = true;
cljs.core.async.impl.channels.t48993.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t48993";
cljs.core.async.impl.channels.t48993.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"cljs.core.async.impl.channels/t48993");
});
cljs.core.async.impl.channels.t48993.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t48993.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_48995){var self__ = this;
var _48995__$1 = this;return self__.meta48994;
});
cljs.core.async.impl.channels.t48993.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_48995,meta48994__$1){var self__ = this;
var _48995__$1 = this;return (new cljs.core.async.impl.channels.t48993(self__.val,self__.box,meta48994__$1));
});
cljs.core.async.impl.channels.__GT_t48993 = (function __GT_t48993(val__$1,box__$1,meta48994){return (new cljs.core.async.impl.channels.t48993(val__$1,box__$1,meta48994));
});
}
return (new cljs.core.async.impl.channels.t48993(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_48996 = self__.takes.pop();if((taker_48996 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_48996))
{var take_cb_48997 = cljs.core.async.impl.protocols.commit.call(null,taker_48996);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_48997,taker_48996){
return (function (){return take_cb_48997.call(null,null);
});})(take_cb_48997,taker_48996))
);
} else
{}
{
