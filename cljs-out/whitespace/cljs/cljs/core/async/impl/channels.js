...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t34727 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t34727 = (function (val,box,meta34728){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t34727.cljs$lang$type = true;
cljs.core.async.impl.channels.t34727.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t34727";
cljs.core.async.impl.channels.t34727.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t34727");
});
cljs.core.async.impl.channels.t34727.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t34727.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34729){var self__ = this;
var _34729__$1 = this;return self__.meta34728;
});
cljs.core.async.impl.channels.t34727.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34729,meta34728__$1){var self__ = this;
var _34729__$1 = this;return (new cljs.core.async.impl.channels.t34727(self__.val,self__.box,meta34728__$1));
});
cljs.core.async.impl.channels.__GT_t34727 = (function __GT_t34727(val__$1,box__$1,meta34728){return (new cljs.core.async.impl.channels.t34727(val__$1,box__$1,meta34728));
});
}
return (new cljs.core.async.impl.channels.t34727(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_34730 = self__.takes.pop();if((taker_34730 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_34730))
{var take_cb_34731 = cljs.core.async.impl.protocols.commit.call(null,taker_34730);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_34731,taker_34730){
return (function (){return take_cb_34731.call(null,null);
});})(take_cb_34731,taker_34730))
);
} else
{}
{
