...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t49293 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t49293 = (function (val,box,meta49294){
this.val = val;
this.box = box;
this.meta49294 = meta49294;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t49293.cljs$lang$type = true;
cljs.core.async.impl.channels.t49293.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t49293";
cljs.core.async.impl.channels.t49293.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"cljs.core.async.impl.channels/t49293");
});
cljs.core.async.impl.channels.t49293.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t49293.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49295){var self__ = this;
var _49295__$1 = this;return self__.meta49294;
});
cljs.core.async.impl.channels.t49293.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49295,meta49294__$1){var self__ = this;
var _49295__$1 = this;return (new cljs.core.async.impl.channels.t49293(self__.val,self__.box,meta49294__$1));
});
cljs.core.async.impl.channels.__GT_t49293 = (function __GT_t49293(val__$1,box__$1,meta49294){return (new cljs.core.async.impl.channels.t49293(val__$1,box__$1,meta49294));
});
}
return (new cljs.core.async.impl.channels.t49293(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_49296 = self__.takes.pop();if((taker_49296 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_49296))
{var take_cb_49297 = cljs.core.async.impl.protocols.commit.call(null,taker_49296);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_49297,taker_49296){
return (function (){return take_cb_49297.call(null,null);
});})(take_cb_49297,taker_49296))
);
} else
{}
{
