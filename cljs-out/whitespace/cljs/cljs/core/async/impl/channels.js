...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18106 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18106 = (function (val,box,meta18107){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18106.cljs$lang$type = true;
cljs.core.async.impl.channels.t18106.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18106";
cljs.core.async.impl.channels.t18106.cljs$lang$ctorPrWriter = (function (this__4108__auto__,writer__4109__auto__,opt__4110__auto__){return cljs.core._write.call(null,writer__4109__auto__,"cljs.core.async.impl.channels/t18106");
});
cljs.core.async.impl.channels.t18106.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18106.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18108){var self__ = this;
var _18108__$1 = this;return self__.meta18107;
});
cljs.core.async.impl.channels.t18106.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18108,meta18107__$1){var self__ = this;
var _18108__$1 = this;return (new cljs.core.async.impl.channels.t18106(self__.val,self__.box,meta18107__$1));
});
cljs.core.async.impl.channels.__GT_t18106 = (function __GT_t18106(val__$1,box__$1,meta18107){return (new cljs.core.async.impl.channels.t18106(val__$1,box__$1,meta18107));
});
}
return (new cljs.core.async.impl.channels.t18106(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_18109 = self__.takes.pop();if((taker_18109 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18109))
{var take_cb_18110 = cljs.core.async.impl.protocols.commit.call(null,taker_18109);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18110,taker_18109,this$__$1){
return (function (){return take_cb_18110.call(null,null);
});})(take_cb_18110,taker_18109,this$__$1))
);
} else
{}
{
