...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t36153 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t36153 = (function (val,box,meta36154){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t36153.cljs$lang$type = true;
cljs.core.async.impl.channels.t36153.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t36153";
cljs.core.async.impl.channels.t36153.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t36153");
});
cljs.core.async.impl.channels.t36153.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t36153.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36155){var self__ = this;
var _36155__$1 = this;return self__.meta36154;
});
cljs.core.async.impl.channels.t36153.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36155,meta36154__$1){var self__ = this;
var _36155__$1 = this;return (new cljs.core.async.impl.channels.t36153(self__.val,self__.box,meta36154__$1));
});
cljs.core.async.impl.channels.__GT_t36153 = (function __GT_t36153(val__$1,box__$1,meta36154){return (new cljs.core.async.impl.channels.t36153(val__$1,box__$1,meta36154));
});
}
return (new cljs.core.async.impl.channels.t36153(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_36156 = self__.takes.pop();if((taker_36156 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_36156))
{var take_cb_36157 = cljs.core.async.impl.protocols.commit.call(null,taker_36156);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_36157,taker_36156){
return (function (){return take_cb_36157.call(null,null);
});})(take_cb_36157,taker_36156))
);
} else
{}
{
