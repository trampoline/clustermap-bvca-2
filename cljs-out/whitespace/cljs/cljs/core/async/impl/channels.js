...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t37053 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t37053 = (function (val,box,meta37054){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t37053.cljs$lang$type = true;
cljs.core.async.impl.channels.t37053.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t37053";
cljs.core.async.impl.channels.t37053.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"cljs.core.async.impl.channels/t37053");
});
cljs.core.async.impl.channels.t37053.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t37053.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37055){var self__ = this;
var _37055__$1 = this;return self__.meta37054;
});
cljs.core.async.impl.channels.t37053.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37055,meta37054__$1){var self__ = this;
var _37055__$1 = this;return (new cljs.core.async.impl.channels.t37053(self__.val,self__.box,meta37054__$1));
});
cljs.core.async.impl.channels.__GT_t37053 = (function __GT_t37053(val__$1,box__$1,meta37054){return (new cljs.core.async.impl.channels.t37053(val__$1,box__$1,meta37054));
});
}
return (new cljs.core.async.impl.channels.t37053(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_37056 = self__.takes.pop();if((taker_37056 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_37056))
{var take_cb_37057 = cljs.core.async.impl.protocols.commit.call(null,taker_37056);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_37057,taker_37056){
return (function (){return take_cb_37057.call(null,null);
});})(take_cb_37057,taker_37056))
);
} else
{}
{
