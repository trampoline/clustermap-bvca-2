...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_32482 = 0;while(true){
var m_32483 = cljs.core.async.impl.dispatch.tasks.pop();if((m_32483 == null))
{} else
{m_32483.call(null);
if((count_32482 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__32484 = (count_32482 + 1);
count_32482 = G__32484;
continue;
}
} else
{}
