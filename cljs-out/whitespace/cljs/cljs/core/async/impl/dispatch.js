...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_36075 = 0;while(true){
var m_36076 = cljs.core.async.impl.dispatch.tasks.pop();if((m_36076 == null))
{} else
{m_36076.call(null);
if((count_36075 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__36077 = (count_36075 + 1);
count_36075 = G__36077;
continue;
}
} else
{}
