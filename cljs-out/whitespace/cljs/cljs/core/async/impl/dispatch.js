...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_37047 = 0;while(true){
var m_37048 = cljs.core.async.impl.dispatch.tasks.pop();if((m_37048 == null))
{} else
{m_37048.call(null);
if((count_37047 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__37049 = (count_37047 + 1);
count_37047 = G__37049;
continue;
}
} else
{}
