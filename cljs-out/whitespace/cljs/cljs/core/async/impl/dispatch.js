...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_46206 = 0;while(true){
var m_46207 = cljs.core.async.impl.dispatch.tasks.pop();if((m_46207 == null))
{} else
{m_46207.call(null);
if((count_46206 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__46208 = (count_46206 + 1);
count_46206 = G__46208;
continue;
}
} else
{}
