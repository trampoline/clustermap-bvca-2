...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_32247 = 0;while(true){
var m_32248 = cljs.core.async.impl.dispatch.tasks.pop();if((m_32248 == null))
{} else
{m_32248.call(null);
if((count_32247 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__32249 = (count_32247 + 1);
count_32247 = G__32249;
continue;
}
} else
{}
