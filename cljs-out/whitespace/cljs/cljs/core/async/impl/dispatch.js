...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_37125 = 0;while(true){
var m_37126 = cljs.core.async.impl.dispatch.tasks.pop();if((m_37126 == null))
{} else
{m_37126.call(null);
if((count_37125 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__37127 = (count_37125 + 1);
count_37125 = G__37127;
continue;
}
} else
{}
