...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_36957 = 0;while(true){
var m_36958 = cljs.core.async.impl.dispatch.tasks.pop();if((m_36958 == null))
{} else
{m_36958.call(null);
if((count_36957 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__36959 = (count_36957 + 1);
count_36957 = G__36959;
continue;
}
} else
{}
