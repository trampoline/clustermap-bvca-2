...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_34721 = 0;while(true){
var m_34722 = cljs.core.async.impl.dispatch.tasks.pop();if((m_34722 == null))
{} else
{m_34722.call(null);
if((count_34721 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__34723 = (count_34721 + 1);
count_34721 = G__34723;
continue;
}
} else
{}
