...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_32390 = 0;while(true){
var m_32391 = cljs.core.async.impl.dispatch.tasks.pop();if((m_32391 == null))
{} else
{m_32391.call(null);
if((count_32390 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__32392 = (count_32390 + 1);
count_32390 = G__32392;
continue;
}
} else
{}
