...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_37380 = 0;while(true){
var m_37381 = cljs.core.async.impl.dispatch.tasks.pop();if((m_37381 == null))
{} else
{m_37381.call(null);
if((count_37380 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__37382 = (count_37380 + 1);
count_37380 = G__37382;
continue;
}
} else
{}
