...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_50291 = 0;while(true){
var m_50292 = cljs.core.async.impl.dispatch.tasks.pop();if((m_50292 == null))
{} else
{m_50292.call(null);
if((count_50291 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__50293 = (count_50291 + 1);
count_50291 = G__50293;
continue;
}
} else
{}
