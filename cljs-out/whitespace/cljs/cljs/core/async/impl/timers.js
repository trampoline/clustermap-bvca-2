...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_46171 = 0;while(true){
if((i_46171 < arr.length))
{(arr[i_46171] = null);
{
var G__46172 = (i_46171 + 1);
i_46171 = G__46172;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_46178 = (self__.level + 1);while(true){
if((i_46178 <= (new_level + 1)))
{(update[i_46178] = self__.header);
{
var G__46179 = (i_46178 + 1);
i_46178 = G__46179;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_46180 = 0;while(true){
if((i_46180 <= self__.level))
{var links_46181 = (update[i_46180]).forward;if(((links_46181[i_46180]) === x__$1))
{(links_46181[i_46180] = (x__$1.forward[i_46180]));
{
var G__46182 = (i_46180 + 1);
i_46180 = G__46182;
continue;
}
} else
{{
var G__46183 = (i_46180 + 1);
i_46180 = G__46183;
continue;
}
}
