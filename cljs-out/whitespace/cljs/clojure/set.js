...
return (function (p1__17909_SHARP_){return (max === p1__17909_SHARP_);
});})(max))
,coll));
});
/**
...
var G__17910__delegate = function (s1,s2,sets){var bubbled_sets = clojure.set.bubble_max_key.call(null,cljs.core.count,cljs.core.conj.call(null,sets,s2,s1));return cljs.core.reduce.call(null,cljs.core.into,cljs.core.first.call(null,bubbled_sets),cljs.core.rest.call(null,bubbled_sets));
};
...
var G__17915__delegate = function (s1,s2,sets){var bubbled_sets = clojure.set.bubble_max_key.call(null,(function (p1__17912_SHARP_){return (- cljs.core.count.call(null,p1__17912_SHARP_));
...
var G__17917__delegate = function (s1,s2,sets){return cljs.core.reduce.call(null,difference,s1,cljs.core.conj.call(null,sets,s2));
};
...
*/
clojure.set.project = (function project(xrel,ks){return cljs.core.set.call(null,cljs.core.map.call(null,(function (p1__17919_SHARP_){return cljs.core.select_keys.call(null,p1__17919_SHARP_,ks);
}),xrel));
});
/**
* Returns the map with the keys in kmap renamed to the vals in kmap
*/
clojure.set.rename_keys = (function rename_keys(map,kmap){return cljs.core.reduce.call(null,(function (m,p__17922){var vec__17923 = p__17922;var old = cljs.core.nth.call(null,vec__17923,(0),null);var new$ = cljs.core.nth.call(null,vec__17923,(1),null);if(cljs.core.contains_QMARK_.call(null,map,old))
...
*/
clojure.set.rename = (function rename(xrel,kmap){return cljs.core.set.call(null,cljs.core.map.call(null,(function (p1__17924_SHARP_){return clojure.set.rename_keys.call(null,p1__17924_SHARP_,kmap);
}),xrel));
});
/**
...
*/
clojure.set.map_invert = (function map_invert(m){return cljs.core.reduce.call(null,(function (m__$1,p__17927){var vec__17928 = p__17927;var k = cljs.core.nth.call(null,vec__17928,(0),null);var v = cljs.core.nth.call(null,vec__17928,(1),null);return cljs.core.assoc.call(null,m__$1,v,k);
...
{var ks = clojure.set.intersection.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,cljs.core.first.call(null,xrel))),cljs.core.set.call(null,cljs.core.keys.call(null,cljs.core.first.call(null,yrel))));var vec__17935 = (((cljs.core.count.call(null,xrel) <= cljs.core.count.call(null,yrel)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [xrel,yrel], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [yrel,xrel], null));var r = cljs.core.nth.call(null,vec__17935,(0),null);var s = cljs.core.nth.call(null,vec__17935,(1),null);var idx = clojure.set.index.call(null,r,ks);return cljs.core.reduce.call(null,((function (ks,vec__17935,r,s,idx){
...
return (function (p1__17929_SHARP_,p2__17930_SHARP_){return cljs.core.conj.call(null,p1__17929_SHARP_,cljs.core.merge.call(null,p2__17930_SHARP_,x));
});})(found,ks,vec__17935,r,s,idx))
,ret,found);
} else
{return ret;
}
});})(ks,vec__17935,r,s,idx))
,cljs.core.PersistentHashSet.EMPTY,s);
} else
{return cljs.core.PersistentHashSet.EMPTY;
}
});
var join__3 = (function (xrel,yrel,km){var vec__17936 = (((cljs.core.count.call(null,xrel) <= cljs.core.count.call(null,yrel)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [xrel,yrel,clojure.set.map_invert.call(null,km)], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [yrel,xrel,km], null));var r = cljs.core.nth.call(null,vec__17936,(0),null);var s = cljs.core.nth.call(null,vec__17936,(1),null);var k = cljs.core.nth.call(null,vec__17936,(2),null);var idx = clojure.set.index.call(null,r,cljs.core.vals.call(null,k));return cljs.core.reduce.call(null,((function (vec__17936,r,s,k,idx){
...
return (function (p1__17931_SHARP_,p2__17932_SHARP_){return cljs.core.conj.call(null,p1__17931_SHARP_,cljs.core.merge.call(null,p2__17932_SHARP_,x));
});})(found,vec__17936,r,s,k,idx))
,ret,found);
} else
{return ret;
}
});})(vec__17936,r,s,k,idx))
,cljs.core.PersistentHashSet.EMPTY,s);
});
...
*/
clojure.set.subset_QMARK_ = (function subset_QMARK_(set1,set2){return ((cljs.core.count.call(null,set1) <= cljs.core.count.call(null,set2))) && (cljs.core.every_QMARK_.call(null,(function (p1__17937_SHARP_){return cljs.core.contains_QMARK_.call(null,set2,p1__17937_SHARP_);
}),set1));
});
/**
* Is set1 a superset of set2?
*/
clojure.set.superset_QMARK_ = (function superset_QMARK_(set1,set2){return ((cljs.core.count.call(null,set1) >= cljs.core.count.call(null,set2))) && (cljs.core.every_QMARK_.call(null,(function (p1__17938_SHARP_){return cljs.core.contains_QMARK_.call(null,set1,p1__17938_SHARP_);
}),set2));
});
