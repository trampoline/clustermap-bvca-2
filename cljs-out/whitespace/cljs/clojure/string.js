...
{{
var G__30313 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30313;
continue;
}
} else
...
{var pred__30317 = cljs.core._EQ_;var expr__30318 = limit;if(cljs.core.truth_(pred__30317.call(null,1,expr__30318)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__30317.call(null,2,expr__30318)))
...
var G__30320 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30321 = (limit__$1 - 1);
var G__30322 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__30320;
limit__$1 = G__30321;
parts = G__30322;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___30324 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___30324))
{var replacement_30325 = temp__4090__auto___30324;buffer.append([cljs.core.str(replacement_30325)].join(''));
} else
{buffer.append(ch);
}
{
var G__30326 = (index + 1);
index = G__30326;
continue;
}
}
