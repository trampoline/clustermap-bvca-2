...
{var pred__12533 = cljs.core._EQ_;var expr__12534 = limit;if(cljs.core.truth_(pred__12533.call(null,1,expr__12534)))
...
{var ch = s.charAt(index);var temp__4090__auto___12540 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12540))
{var replacement_12541 = temp__4090__auto___12540;buffer.append([cljs.core.str(replacement_12541)].join(''));
} else
{buffer.append(ch);
}
{
