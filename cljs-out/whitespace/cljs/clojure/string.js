...
{{
var G__34329 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34329;
continue;
}
} else
...
{var pred__34333 = cljs.core._EQ_;var expr__34334 = limit;if(cljs.core.truth_(pred__34333.call(null,1,expr__34334)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34333.call(null,2,expr__34334)))
...
var G__34336 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34337 = (limit__$1 - 1);
var G__34338 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34336;
limit__$1 = G__34337;
parts = G__34338;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34340 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34340))
{var replacement_34341 = temp__4090__auto___34340;buffer.append([cljs.core.str(replacement_34341)].join(''));
} else
{buffer.append(ch);
}
{
