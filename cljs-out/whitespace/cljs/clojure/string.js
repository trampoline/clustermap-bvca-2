...
{{
var G__34839 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34839;
continue;
}
} else
...
{var pred__34843 = cljs.core._EQ_;var expr__34844 = limit;if(cljs.core.truth_(pred__34843.call(null,1,expr__34844)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34843.call(null,2,expr__34844)))
...
var G__34846 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34847 = (limit__$1 - 1);
var G__34848 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34846;
limit__$1 = G__34847;
parts = G__34848;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34850 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34850))
{var replacement_34851 = temp__4090__auto___34850;buffer.append([cljs.core.str(replacement_34851)].join(''));
} else
{buffer.append(ch);
}
{
var G__34852 = (index + 1);
index = G__34852;
continue;
}
}
