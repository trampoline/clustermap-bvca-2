...
{var pred__18749 = cljs.core._EQ_;var expr__18750 = limit;if(cljs.core.truth_(pred__18749.call(null,(1),expr__18750)))
...
{var ch = s.charAt(index);var temp__4124__auto___18756 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___18756))
{var replacement_18757 = temp__4124__auto___18756;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_18757)));
} else
{buffer.append(ch);
}
{
