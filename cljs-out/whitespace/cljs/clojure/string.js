...
{{
var G__32462 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32462;
continue;
}
} else
...
{var pred__32466 = cljs.core._EQ_;var expr__32467 = limit;if(cljs.core.truth_(pred__32466.call(null,1,expr__32467)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32466.call(null,2,expr__32467)))
...
var G__32469 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32470 = (limit__$1 - 1);
var G__32471 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32469;
limit__$1 = G__32470;
parts = G__32471;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___32473 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___32473))
{var replacement_32474 = temp__4090__auto___32473;buffer.append([cljs.core.str(replacement_32474)].join(''));
} else
{buffer.append(ch);
}
{
var G__32475 = (index + 1);
index = G__32475;
continue;
}
}
