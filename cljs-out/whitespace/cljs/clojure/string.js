...
{{
var G__31069 = cljs.core.pop.call(null,v__$1);
v__$1 = G__31069;
continue;
}
} else
...
{var pred__31073 = cljs.core._EQ_;var expr__31074 = limit;if(cljs.core.truth_(pred__31073.call(null,1,expr__31074)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__31073.call(null,2,expr__31074)))
...
var G__31076 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__31077 = (limit__$1 - 1);
var G__31078 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__31076;
limit__$1 = G__31077;
parts = G__31078;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___31080 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___31080))
{var replacement_31081 = temp__4090__auto___31080;buffer.append([cljs.core.str(replacement_31081)].join(''));
} else
{buffer.append(ch);
}
{
var G__31082 = (index + 1);
index = G__31082;
continue;
}
}
