...
{var pred__17724 = cljs.core._EQ_;var expr__17725 = limit;if(cljs.core.truth_(pred__17724.call(null,(1),expr__17725)))
...
{var ch = s.charAt(index);var temp__4124__auto___17731 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___17731))
{var replacement_17732 = temp__4124__auto___17731;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_17732)));
} else
{buffer.append(ch);
}
{
