...
{var pred__21999 = cljs.core._EQ_;var expr__22000 = limit;if(cljs.core.truth_(pred__21999.call(null,(1),expr__22000)))
...
{var ch = s.charAt(index);var temp__4124__auto___22006 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___22006))
{var replacement_22007 = temp__4124__auto___22006;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_22007)));
} else
{buffer.append(ch);
}
{
