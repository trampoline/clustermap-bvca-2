...
{{
var G__17042 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17042;
continue;
}
} else
...
{var pred__17046 = cljs.core._EQ_;var expr__17047 = limit;if(cljs.core.truth_(pred__17046.call(null,(1),expr__17047)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__17046.call(null,(2),expr__17047)))
...
var G__17049 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17050 = (limit__$1 - (1));
var G__17051 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__17049;
limit__$1 = G__17050;
parts = G__17051;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___17053 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___17053))
{var replacement_17054 = temp__4124__auto___17053;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_17054)));
} else
{buffer.append(ch);
}
{
var G__17055 = (index + (1));
index = G__17055;
continue;
}
}
