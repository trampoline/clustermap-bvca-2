...
{{
var G__46939 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46939;
continue;
}
} else
...
{var pred__46943 = cljs.core._EQ_;var expr__46944 = limit;if(cljs.core.truth_(pred__46943.call(null,1,expr__46944)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__46943.call(null,2,expr__46944)))
...
var G__46946 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46947 = (limit__$1 - 1);
var G__46948 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46946;
limit__$1 = G__46947;
parts = G__46948;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___46950 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___46950))
{var replacement_46951 = temp__4090__auto___46950;buffer.append([cljs.core.str(replacement_46951)].join(''));
} else
{buffer.append(ch);
}
{
var G__46952 = (index + 1);
index = G__46952;
continue;
}
}
