...
{{
var G__32483 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32483;
continue;
}
} else
...
{var pred__32487 = cljs.core._EQ_;var expr__32488 = limit;if(cljs.core.truth_(pred__32487.call(null,1,expr__32488)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32487.call(null,2,expr__32488)))
...
var G__32490 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32491 = (limit__$1 - 1);
var G__32492 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32490;
limit__$1 = G__32491;
parts = G__32492;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___32494 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___32494))
{var replacement_32495 = temp__4090__auto___32494;buffer.append([cljs.core.str(replacement_32495)].join(''));
} else
{buffer.append(ch);
}
{
var G__32496 = (index + 1);
index = G__32496;
continue;
}
}
