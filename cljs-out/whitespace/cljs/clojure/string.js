...
{{
var G__29878 = cljs.core.pop.call(null,v__$1);
v__$1 = G__29878;
continue;
}
} else
...
{var pred__29882 = cljs.core._EQ_;var expr__29883 = limit;if(cljs.core.truth_(pred__29882.call(null,1,expr__29883)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__29882.call(null,2,expr__29883)))
...
var G__29885 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__29886 = (limit__$1 - 1);
var G__29887 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__29885;
limit__$1 = G__29886;
parts = G__29887;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___29889 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___29889))
{var replacement_29890 = temp__4090__auto___29889;buffer.append([cljs.core.str(replacement_29890)].join(''));
} else
{buffer.append(ch);
}
{
var G__29891 = (index + 1);
index = G__29891;
continue;
}
}
