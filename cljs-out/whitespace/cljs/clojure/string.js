...
{{
var G__34353 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34353;
continue;
}
} else
...
{var pred__34357 = cljs.core._EQ_;var expr__34358 = limit;if(cljs.core.truth_(pred__34357.call(null,1,expr__34358)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34357.call(null,2,expr__34358)))
...
var G__34360 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34361 = (limit__$1 - 1);
var G__34362 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34360;
limit__$1 = G__34361;
parts = G__34362;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34364 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34364))
{var replacement_34365 = temp__4090__auto___34364;buffer.append([cljs.core.str(replacement_34365)].join(''));
} else
{buffer.append(ch);
}
{
var G__34366 = (index + 1);
index = G__34366;
continue;
}
}
