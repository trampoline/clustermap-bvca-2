...
{var pred__18403 = cljs.core._EQ_;var expr__18404 = limit;if(cljs.core.truth_(pred__18403.call(null,(1),expr__18404)))
...
{var ch = s.charAt(index);var temp__4124__auto___18410 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___18410))
{var replacement_18411 = temp__4124__auto___18410;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_18411)));
} else
{buffer.append(ch);
}
{
