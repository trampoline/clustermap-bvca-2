...
{{
var G__46683 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46683;
continue;
}
} else
...
{var pred__46687 = cljs.core._EQ_;var expr__46688 = limit;if(cljs.core.truth_(pred__46687.call(null,1,expr__46688)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__46687.call(null,2,expr__46688)))
...
var G__46690 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46691 = (limit__$1 - 1);
var G__46692 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46690;
limit__$1 = G__46691;
parts = G__46692;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___46694 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___46694))
{var replacement_46695 = temp__4090__auto___46694;buffer.append([cljs.core.str(replacement_46695)].join(''));
} else
{buffer.append(ch);
}
{
var G__46696 = (index + 1);
index = G__46696;
continue;
}
}
