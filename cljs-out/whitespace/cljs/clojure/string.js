...
{{
var G__32117 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32117;
continue;
}
} else
...
{var pred__32121 = cljs.core._EQ_;var expr__32122 = limit;if(cljs.core.truth_(pred__32121.call(null,1,expr__32122)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32121.call(null,2,expr__32122)))
...
var G__32124 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32125 = (limit__$1 - 1);
var G__32126 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32124;
limit__$1 = G__32125;
parts = G__32126;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___32128 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___32128))
{var replacement_32129 = temp__4090__auto___32128;buffer.append([cljs.core.str(replacement_32129)].join(''));
} else
{buffer.append(ch);
}
{
