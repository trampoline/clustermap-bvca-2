...
{{
var G__46891 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46891;
continue;
}
} else
...
{var pred__46895 = cljs.core._EQ_;var expr__46896 = limit;if(cljs.core.truth_(pred__46895.call(null,1,expr__46896)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__46895.call(null,2,expr__46896)))
...
var G__46898 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46899 = (limit__$1 - 1);
var G__46900 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46898;
limit__$1 = G__46899;
parts = G__46900;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___46902 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___46902))
{var replacement_46903 = temp__4090__auto___46902;buffer.append([cljs.core.str(replacement_46903)].join(''));
} else
{buffer.append(ch);
}
{
var G__46904 = (index + 1);
index = G__46904;
continue;
}
}
