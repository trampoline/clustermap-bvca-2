...
{var pred__34831 = cljs.core._EQ_;var expr__34832 = limit;if(cljs.core.truth_(pred__34831.call(null,1,expr__34832)))
...
{var ch = s.charAt(index);var temp__4090__auto___34838 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34838))
{var replacement_34839 = temp__4090__auto___34838;buffer.append([cljs.core.str(replacement_34839)].join(''));
} else
{buffer.append(ch);
}
{
