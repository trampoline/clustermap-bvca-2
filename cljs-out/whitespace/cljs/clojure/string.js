...
{{
var G__34443 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34443;
continue;
}
} else
...
{var pred__34447 = cljs.core._EQ_;var expr__34448 = limit;if(cljs.core.truth_(pred__34447.call(null,1,expr__34448)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34447.call(null,2,expr__34448)))
...
var G__34450 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34451 = (limit__$1 - 1);
var G__34452 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34450;
limit__$1 = G__34451;
parts = G__34452;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34454 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34454))
{var replacement_34455 = temp__4090__auto___34454;buffer.append([cljs.core.str(replacement_34455)].join(''));
} else
{buffer.append(ch);
}
{
var G__34456 = (index + 1);
index = G__34456;
continue;
}
}
