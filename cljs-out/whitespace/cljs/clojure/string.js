...
{{
var G__33543 = cljs.core.pop.call(null,v__$1);
v__$1 = G__33543;
continue;
}
} else
...
{var pred__33547 = cljs.core._EQ_;var expr__33548 = limit;if(cljs.core.truth_(pred__33547.call(null,1,expr__33548)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__33547.call(null,2,expr__33548)))
...
var G__33550 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__33551 = (limit__$1 - 1);
var G__33552 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__33550;
limit__$1 = G__33551;
parts = G__33552;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___33554 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___33554))
{var replacement_33555 = temp__4090__auto___33554;buffer.append([cljs.core.str(replacement_33555)].join(''));
} else
{buffer.append(ch);
}
{
var G__33556 = (index + 1);
index = G__33556;
continue;
}
}
