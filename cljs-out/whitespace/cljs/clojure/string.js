...
{var pred__47055 = cljs.core._EQ_;var expr__47056 = limit;if(cljs.core.truth_(pred__47055.call(null,1,expr__47056)))
...
{var ch = s.charAt(index);var temp__4090__auto___47062 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___47062))
{var replacement_47063 = temp__4090__auto___47062;buffer.append([cljs.core.str(replacement_47063)].join(''));
} else
{buffer.append(ch);
}
{
