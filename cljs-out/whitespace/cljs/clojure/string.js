...
{{
var G__46955 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46955;
continue;
}
} else
...
{var pred__46959 = cljs.core._EQ_;var expr__46960 = limit;if(cljs.core.truth_(pred__46959.call(null,1,expr__46960)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__46959.call(null,2,expr__46960)))
...
var G__46962 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46963 = (limit__$1 - 1);
var G__46964 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46962;
limit__$1 = G__46963;
parts = G__46964;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___46966 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___46966))
{var replacement_46967 = temp__4090__auto___46966;buffer.append([cljs.core.str(replacement_46967)].join(''));
} else
{buffer.append(ch);
}
{
var G__46968 = (index + 1);
index = G__46968;
continue;
}
}
