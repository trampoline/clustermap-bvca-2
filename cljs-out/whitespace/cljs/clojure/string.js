...
{var pred__34519 = cljs.core._EQ_;var expr__34520 = limit;if(cljs.core.truth_(pred__34519.call(null,1,expr__34520)))
...
{var ch = s.charAt(index);var temp__4090__auto___34526 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34526))
{var replacement_34527 = temp__4090__auto___34526;buffer.append([cljs.core.str(replacement_34527)].join(''));
} else
{buffer.append(ch);
}
{
