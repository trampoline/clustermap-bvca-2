...
{{
var G__34899 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34899;
continue;
}
} else
...
{var pred__34903 = cljs.core._EQ_;var expr__34904 = limit;if(cljs.core.truth_(pred__34903.call(null,1,expr__34904)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34903.call(null,2,expr__34904)))
...
var G__34906 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34907 = (limit__$1 - 1);
var G__34908 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34906;
limit__$1 = G__34907;
parts = G__34908;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34910 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34910))
{var replacement_34911 = temp__4090__auto___34910;buffer.append([cljs.core.str(replacement_34911)].join(''));
} else
{buffer.append(ch);
}
{
var G__34912 = (index + 1);
index = G__34912;
continue;
}
}
