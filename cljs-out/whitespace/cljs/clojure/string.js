...
{{
var G__49216 = cljs.core.pop.call(null,v__$1);
v__$1 = G__49216;
continue;
}
} else
...
{var pred__49220 = cljs.core._EQ_;var expr__49221 = limit;if(cljs.core.truth_(pred__49220.call(null,1,expr__49221)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__49220.call(null,2,expr__49221)))
...
var G__49223 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__49224 = (limit__$1 - 1);
var G__49225 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__49223;
limit__$1 = G__49224;
parts = G__49225;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___49227 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___49227))
{var replacement_49228 = temp__4090__auto___49227;buffer.append([cljs.core.str(replacement_49228)].join(''));
} else
{buffer.append(ch);
}
{
var G__49229 = (index + 1);
index = G__49229;
continue;
}
}
