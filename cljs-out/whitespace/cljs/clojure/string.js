...
{{
var G__29786 = cljs.core.pop.call(null,v__$1);
v__$1 = G__29786;
continue;
}
} else
...
{var pred__29790 = cljs.core._EQ_;var expr__29791 = limit;if(cljs.core.truth_(pred__29790.call(null,1,expr__29791)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__29790.call(null,2,expr__29791)))
...
var G__29793 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__29794 = (limit__$1 - 1);
var G__29795 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__29793;
limit__$1 = G__29794;
parts = G__29795;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___29797 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___29797))
{var replacement_29798 = temp__4090__auto___29797;buffer.append([cljs.core.str(replacement_29798)].join(''));
} else
{buffer.append(ch);
}
{
var G__29799 = (index + 1);
index = G__29799;
continue;
}
}
