...
{{
var G__32579 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32579;
continue;
}
} else
...
{var pred__32583 = cljs.core._EQ_;var expr__32584 = limit;if(cljs.core.truth_(pred__32583.call(null,1,expr__32584)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32583.call(null,2,expr__32584)))
...
var G__32586 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32587 = (limit__$1 - 1);
var G__32588 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32586;
limit__$1 = G__32587;
parts = G__32588;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___32590 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___32590))
{var replacement_32591 = temp__4090__auto___32590;buffer.append([cljs.core.str(replacement_32591)].join(''));
} else
{buffer.append(ch);
}
{
var G__32592 = (index + 1);
index = G__32592;
continue;
}
}
