...
{{
var G__46888 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46888;
continue;
}
} else
...
{var pred__46892 = cljs.core._EQ_;var expr__46893 = limit;if(cljs.core.truth_(pred__46892.call(null,1,expr__46893)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__46892.call(null,2,expr__46893)))
...
var G__46895 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46896 = (limit__$1 - 1);
var G__46897 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46895;
limit__$1 = G__46896;
parts = G__46897;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___46899 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___46899))
{var replacement_46900 = temp__4090__auto___46899;buffer.append([cljs.core.str(replacement_46900)].join(''));
} else
{buffer.append(ch);
}
{
