...
{{
var G__34776 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34776;
continue;
}
} else
...
{var pred__34780 = cljs.core._EQ_;var expr__34781 = limit;if(cljs.core.truth_(pred__34780.call(null,1,expr__34781)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34780.call(null,2,expr__34781)))
...
var G__34783 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34784 = (limit__$1 - 1);
var G__34785 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34783;
limit__$1 = G__34784;
parts = G__34785;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34787 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34787))
{var replacement_34788 = temp__4090__auto___34787;buffer.append([cljs.core.str(replacement_34788)].join(''));
} else
{buffer.append(ch);
}
{
var G__34789 = (index + 1);
index = G__34789;
continue;
}
}
