...
{var pred__16930 = cljs.core._EQ_;var expr__16931 = limit;if(cljs.core.truth_(pred__16930.call(null,1,expr__16931)))
...
{var ch = s.charAt(index);var temp__4124__auto___16937 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___16937))
{var replacement_16938 = temp__4124__auto___16937;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_16938)));
} else
{buffer.append(ch);
}
{
