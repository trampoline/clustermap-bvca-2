...
{{
var G__50302 = cljs.core.pop.call(null,v__$1);
v__$1 = G__50302;
continue;
}
} else
...
{var pred__50306 = cljs.core._EQ_;var expr__50307 = limit;if(cljs.core.truth_(pred__50306.call(null,1,expr__50307)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__50306.call(null,2,expr__50307)))
...
var G__50309 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__50310 = (limit__$1 - 1);
var G__50311 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__50309;
limit__$1 = G__50310;
parts = G__50311;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___50313 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___50313))
{var replacement_50314 = temp__4124__auto___50313;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_50314)));
} else
{buffer.append(ch);
}
{
var G__50315 = (index + 1);
index = G__50315;
continue;
}
}
