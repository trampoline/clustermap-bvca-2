...
{{
var G__31405 = cljs.core.pop.call(null,v__$1);
v__$1 = G__31405;
continue;
}
} else
...
{var pred__31409 = cljs.core._EQ_;var expr__31410 = limit;if(cljs.core.truth_(pred__31409.call(null,1,expr__31410)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__31409.call(null,2,expr__31410)))
...
var G__31412 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__31413 = (limit__$1 - 1);
var G__31414 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__31412;
limit__$1 = G__31413;
parts = G__31414;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___31416 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___31416))
{var replacement_31417 = temp__4090__auto___31416;buffer.append([cljs.core.str(replacement_31417)].join(''));
} else
{buffer.append(ch);
}
{
var G__31418 = (index + 1);
index = G__31418;
continue;
}
}
