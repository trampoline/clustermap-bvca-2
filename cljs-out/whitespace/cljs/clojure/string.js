...
{{
var G__47035 = cljs.core.pop.call(null,v__$1);
v__$1 = G__47035;
continue;
}
} else
...
{var pred__47039 = cljs.core._EQ_;var expr__47040 = limit;if(cljs.core.truth_(pred__47039.call(null,1,expr__47040)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__47039.call(null,2,expr__47040)))
...
var G__47042 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__47043 = (limit__$1 - 1);
var G__47044 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__47042;
limit__$1 = G__47043;
parts = G__47044;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___47046 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___47046))
{var replacement_47047 = temp__4090__auto___47046;buffer.append([cljs.core.str(replacement_47047)].join(''));
} else
{buffer.append(ch);
}
{
var G__47048 = (index + 1);
index = G__47048;
continue;
}
}
