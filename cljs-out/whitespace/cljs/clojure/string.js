...
{{
var G__34521 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34521;
continue;
}
} else
...
{var pred__34525 = cljs.core._EQ_;var expr__34526 = limit;if(cljs.core.truth_(pred__34525.call(null,1,expr__34526)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34525.call(null,2,expr__34526)))
...
var G__34528 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34529 = (limit__$1 - 1);
var G__34530 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34528;
limit__$1 = G__34529;
parts = G__34530;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34532 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34532))
{var replacement_34533 = temp__4090__auto___34532;buffer.append([cljs.core.str(replacement_34533)].join(''));
} else
{buffer.append(ch);
}
{
var G__34534 = (index + 1);
index = G__34534;
continue;
}
}
