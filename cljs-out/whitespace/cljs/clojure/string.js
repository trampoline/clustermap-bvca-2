...
{{
var G__34911 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34911;
continue;
}
} else
...
{var pred__34915 = cljs.core._EQ_;var expr__34916 = limit;if(cljs.core.truth_(pred__34915.call(null,1,expr__34916)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34915.call(null,2,expr__34916)))
...
var G__34918 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34919 = (limit__$1 - 1);
var G__34920 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34918;
limit__$1 = G__34919;
parts = G__34920;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34922 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34922))
{var replacement_34923 = temp__4090__auto___34922;buffer.append([cljs.core.str(replacement_34923)].join(''));
} else
{buffer.append(ch);
}
{
var G__34924 = (index + 1);
index = G__34924;
continue;
}
}
