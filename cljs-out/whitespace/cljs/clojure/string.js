...
{{
var G__34317 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34317;
continue;
}
} else
...
{var pred__34321 = cljs.core._EQ_;var expr__34322 = limit;if(cljs.core.truth_(pred__34321.call(null,1,expr__34322)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34321.call(null,2,expr__34322)))
...
var G__34324 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34325 = (limit__$1 - 1);
var G__34326 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34324;
limit__$1 = G__34325;
parts = G__34326;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___34328 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___34328))
{var replacement_34329 = temp__4090__auto___34328;buffer.append([cljs.core.str(replacement_34329)].join(''));
} else
{buffer.append(ch);
}
{
var G__34330 = (index + 1);
index = G__34330;
continue;
}
}
