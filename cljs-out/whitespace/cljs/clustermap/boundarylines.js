...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__32561){var vec__32562 = p__32561;var z = cljs.core.nth.call(null,vec__32562,0,null);var t = cljs.core.nth.call(null,vec__32562,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_32582){var state_val_32583 = (state_32582[1]);if((state_val_32583 === 2))
{var inst_32578 = (state_32582[2]);var inst_32579 = (function (){var bl = inst_32578;return ((function (bl,inst_32578,state_val_32583){
return (function (old){return bl;
});
;})(bl,inst_32578,state_val_32583))
})();var inst_32580 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_32579);var state_32582__$1 = state_32582;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_32582__$1,inst_32580);
} else
{if((state_val_32583 === 1))
{var state_32582__$1 = state_32582;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_32582__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_32587 = [null,null,null,null,null,null,null];(statearr_32587[0] = state_machine__5507__auto__);
(statearr_32587[1] = 1);
return statearr_32587;
});
var state_machine__5507__auto____1 = (function (state_32582){while(true){
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__.call(null,state_32582);if(cljs.core.keyword_identical_QMARK_.call(null,result__5509__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__5510__auto__ = e32588;var statearr_32589_32591 = state_32582;(statearr_32589_32591[5] = ex__5510__auto__);
...
{{
var G__32592 = state_32582;
state_32582 = G__32592;
continue;
}
} else
...
state_machine__5507__auto__ = function(state_32582){
switch(arguments.length){
case 0:
return state_machine__5507__auto____0.call(this);
case 1:
return state_machine__5507__auto____1.call(this,state_32582);
}
...
})();var state__5523__auto__ = (function (){var statearr_32590 = f__5522__auto__.call(null);(statearr_32590[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__32593){var map__32595 = p__32593;var map__32595__$1 = ((cljs.core.seq_QMARK_.call(null,map__32595))?cljs.core.apply.call(null,cljs.core.hash_map,map__32595):map__32595);var min_zoom = cljs.core.get.call(null,map__32595__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
...
var p__32593 = null;if (arguments.length > 4) {
  p__32593 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return get_or_fetch_best_boundaryline__delegate.call(this,app_state,korks,boundaryline_id,zoom,p__32593);};
get_or_fetch_best_boundaryline.cljs$lang$maxFixedArity = 4;
get_or_fetch_best_boundaryline.cljs$lang$applyTo = (function (arglist__32596){
var app_state = cljs.core.first(arglist__32596);
arglist__32596 = cljs.core.next(arglist__32596);
var korks = cljs.core.first(arglist__32596);
arglist__32596 = cljs.core.next(arglist__32596);
var boundaryline_id = cljs.core.first(arglist__32596);
arglist__32596 = cljs.core.next(arglist__32596);
var zoom = cljs.core.first(arglist__32596);
var p__32593 = cljs.core.rest(arglist__32596);
return get_or_fetch_best_boundaryline__delegate(app_state,korks,boundaryline_id,zoom,p__32593);
});
