...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__32859){var vec__32860 = p__32859;var z = cljs.core.nth.call(null,vec__32860,0,null);var t = cljs.core.nth.call(null,vec__32860,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_32880){var state_val_32881 = (state_32880[1]);if((state_val_32881 === 2))
{var inst_32876 = (state_32880[2]);var inst_32877 = (function (){var bl = inst_32876;return ((function (bl,inst_32876,state_val_32881){
return (function (old){return bl;
});
;})(bl,inst_32876,state_val_32881))
})();var inst_32878 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_32877);var state_32880__$1 = state_32880;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_32880__$1,inst_32878);
} else
{if((state_val_32881 === 1))
{var state_32880__$1 = state_32880;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_32880__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_32885 = [null,null,null,null,null,null,null];(statearr_32885[0] = state_machine__5507__auto__);
(statearr_32885[1] = 1);
return statearr_32885;
});
var state_machine__5507__auto____1 = (function (state_32880){while(true){
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__.call(null,state_32880);if(cljs.core.keyword_identical_QMARK_.call(null,result__5509__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__5510__auto__ = e32886;var statearr_32887_32889 = state_32880;(statearr_32887_32889[5] = ex__5510__auto__);
...
})();var state__5523__auto__ = (function (){var statearr_32888 = f__5522__auto__.call(null);(statearr_32888[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__32891){var map__32893 = p__32891;var map__32893__$1 = ((cljs.core.seq_QMARK_.call(null,map__32893))?cljs.core.apply.call(null,cljs.core.hash_map,map__32893):map__32893);var min_zoom = cljs.core.get.call(null,map__32893__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
...
var p__32891 = null;if (arguments.length > 4) {
