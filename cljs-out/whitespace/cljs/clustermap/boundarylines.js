...
clustermap.boundarylines.ideal_tolerance = (function ideal_tolerance(zoom){var or__3406__auto__ = cljs.core.some.call(null,(function (p__32621){var vec__32622 = p__32621;var z = cljs.core.nth.call(null,vec__32622,0,null);var t = cljs.core.nth.call(null,vec__32622,1,null);if(cljs.core.truth_((function (){var and__3394__auto__ = z;if(cljs.core.truth_(and__3394__auto__))
{return (zoom <= z);
} else
...
*/
clustermap.boundarylines.fetch_boundaryline = (function fetch_boundaryline(app_state,korks,boundaryline_id,tolerance){var comm = clustermap.api.boundarylines.call(null,boundaryline_id,tolerance,new cljs.core.Keyword(null,"raw","raw",1014016922),true);var use_korks = ((cljs.core.sequential_QMARK_.call(null,korks))?korks:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [korks], null));var path = cljs.core.concat.call(null,use_korks,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [boundaryline_id,tolerance], null));var c__5521__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__5522__auto__ = (function (){var switch__5506__auto__ = (function (state_32642){var state_val_32643 = (state_32642[1]);if((state_val_32643 === 2))
{var inst_32638 = (state_32642[2]);var inst_32639 = (function (){var bl = inst_32638;return ((function (bl,inst_32638,state_val_32643){
return (function (old){return bl;
});
;})(bl,inst_32638,state_val_32643))
})();var inst_32640 = cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,path,inst_32639);var state_32642__$1 = state_32642;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_32642__$1,inst_32640);
} else
{if((state_val_32643 === 1))
{var state_32642__$1 = state_32642;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_32642__$1,2,comm);
} else
{return null;
}
}
...
var state_machine__5507__auto____0 = (function (){var statearr_32647 = [null,null,null,null,null,null,null];(statearr_32647[0] = state_machine__5507__auto__);
(statearr_32647[1] = 1);
return statearr_32647;
});
var state_machine__5507__auto____1 = (function (state_32642){while(true){
var ret_value__5508__auto__ = (function (){try{while(true){
var result__5509__auto__ = switch__5506__auto__.call(null,state_32642);if(cljs.core.keyword_identical_QMARK_.call(null,result__5509__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__5510__auto__ = e32648;var statearr_32649_32651 = state_32642;(statearr_32649_32651[5] = ex__5510__auto__);
...
})();var state__5523__auto__ = (function (){var statearr_32650 = f__5522__auto__.call(null);(statearr_32650[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__5521__auto__);
...
var get_or_fetch_best_boundaryline__delegate = function (app_state,korks,boundaryline_id,zoom,p__32653){var map__32655 = p__32653;var map__32655__$1 = ((cljs.core.seq_QMARK_.call(null,map__32655))?cljs.core.apply.call(null,cljs.core.hash_map,map__32655):map__32655);var min_zoom = cljs.core.get.call(null,map__32655__$1,new cljs.core.Keyword(null,"min-zoom","min-zoom",3894785504));if(cljs.core.truth_((function (){var and__3394__auto__ = min_zoom;if(cljs.core.truth_(and__3394__auto__))
...
var p__32653 = null;if (arguments.length > 4) {
