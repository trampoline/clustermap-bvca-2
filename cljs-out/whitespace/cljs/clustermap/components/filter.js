...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__12780,owner){var map__12872 = p__12780;var map__12872__$1 = ((cljs.core.seq_QMARK_.call(null,map__12872))?cljs.core.apply.call(null,cljs.core.hash_map,map__12872):map__12872);var cursor = map__12872__$1;if(typeof clustermap.components.filter.t12873 !== 'undefined')
{} else
{
/**
* @constructor
...
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t12873");
...
return (function (this$,p__12876,next_state){var self__ = this;
var map__12877 = p__12876;var map__12877__$1 = ((cljs.core.seq_QMARK_.call(null,map__12877))?cljs.core.apply.call(null,cljs.core.hash_map,map__12877):map__12877);var next_components = cljs.core.get.call(null,map__12877__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__12877__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__12878 = om.core.get_props.call(null,self__.owner);var map__12878__$1 = ((cljs.core.seq_QMARK_.call(null,map__12878))?cljs.core.apply.call(null,cljs.core.hash_map,map__12878):map__12878);var components = cljs.core.get.call(null,map__12878__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__12878__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__12951 = cljs.core._EQ_;var expr__12952 = val;if(cljs.core.truth_(pred__12951.call(null,"new",expr__12952)))
...
});})(this$__$1,map__12872,map__12872__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__12872,map__12872__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__12954 = cljs.core._EQ_;var expr__12955 = val;if(cljs.core.truth_(pred__12954.call(null,"group",expr__12955)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__12872,map__12872__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__12957 = cljs.core._EQ_;var expr__12958 = val;if(cljs.core.truth_(pred__12957.call(null,"low",expr__12958)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__12960 = cljs.core._EQ_;var expr__12961 = val;if(cljs.core.truth_(pred__12960.call(null,"A",expr__12961)))
...
return (function (_12875){var self__ = this;
var _12875__$1 = this;return self__.meta12874;
});})(map__12872,map__12872__$1,cursor))
;
...
return (function (_12875,meta12874__$1){var self__ = this;
var _12875__$1 = this;return (new clustermap.components.filter.t12873(self__.cursor,self__.map__12872,self__.owner,self__.p__12780,self__.filter_component,meta12874__$1));
});})(map__12872,map__12872__$1,cursor))
;
clustermap.components.filter.__GT_t12873 = ((function (map__12872,map__12872__$1,cursor){
return (function __GT_t12873(cursor__$1,map__12872__$2,owner__$1,p__12780__$1,filter_component__$1,meta12874){return (new clustermap.components.filter.t12873(cursor__$1,map__12872__$2,owner__$1,p__12780__$1,filter_component__$1,meta12874));
});})(map__12872,map__12872__$1,cursor))
;
}
