...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__13196 = cljs.core._EQ_;var expr__13197 = val;if(cljs.core.truth_(pred__13196.call(null,"new",expr__13197)))
...
{if(cljs.core.truth_(pred__13196.call(null,"old",expr__13197)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__13199 = cljs.core._EQ_;var expr__13200 = val;if(cljs.core.truth_(pred__13199.call(null,"group",expr__13200)))
...
{if(cljs.core.truth_(pred__13199.call(null,"notgroup",expr__13200)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__13202 = cljs.core._EQ_;var expr__13203 = val;if(cljs.core.truth_(pred__13202.call(null,"low",expr__13203)))
...
{if(cljs.core.truth_(pred__13202.call(null,"high",expr__13203)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__13205 = cljs.core._EQ_;var expr__13206 = val;if(cljs.core.truth_(pred__13205.call(null,"A",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"B",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"C",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"D",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"E",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"F",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"G",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"H",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"I",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"J",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"K",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"L",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"M",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"N",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"O",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"P",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"Q",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"R",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"S",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"T",expr__13206)))
...
{if(cljs.core.truth_(pred__13205.call(null,"U",expr__13206)))
...
clustermap.components.filter.filter_component = (function filter_component(p__13208,owner){var map__13215 = p__13208;var map__13215__$1 = ((cljs.core.seq_QMARK_.call(null,map__13215))?cljs.core.apply.call(null,cljs.core.hash_map,map__13215):map__13215);var cursor = map__13215__$1;var components = cljs.core.get.call(null,map__13215__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__13215__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(typeof clustermap.components.filter.t13216 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t13216 = (function (compiled,components,cursor,map__13215,owner,p__13208,filter_component,meta13217){
this.compiled = compiled;
this.components = components;
this.cursor = cursor;
this.map__13215 = map__13215;
this.owner = owner;
this.p__13208 = p__13208;
this.filter_component = filter_component;
this.meta13217 = meta13217;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t13216.cljs$lang$type = true;
clustermap.components.filter.t13216.cljs$lang$ctorStr = "clustermap.components.filter/t13216";
clustermap.components.filter.t13216.cljs$lang$ctorPrWriter = ((function (map__13215,map__13215__$1,cursor,components,compiled){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t13216");
});})(map__13215,map__13215__$1,cursor,components,compiled))
;
clustermap.components.filter.t13216.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t13216.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__13215,map__13215__$1,cursor,components,compiled){
return (function (_,p__13219,next_state){var self__ = this;
var map__13220 = p__13219;var map__13220__$1 = ((cljs.core.seq_QMARK_.call(null,map__13220))?cljs.core.apply.call(null,cljs.core.hash_map,map__13220):map__13220);var next_components = cljs.core.get.call(null,map__13220__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__13220__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var ___$1 = this;if(cljs.core.not_EQ_.call(null,next_components,self__.components))
...
;
clustermap.components.filter.t13216.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t13216.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__13215,map__13215__$1,cursor,components,compiled){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.cursor,self__.owner,state);
});})(map__13215,map__13215__$1,cursor,components,compiled))
;
clustermap.components.filter.t13216.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__13215,map__13215__$1,cursor,components,compiled){
return (function (_13218){var self__ = this;
var _13218__$1 = this;return self__.meta13217;
});})(map__13215,map__13215__$1,cursor,components,compiled))
;
clustermap.components.filter.t13216.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__13215,map__13215__$1,cursor,components,compiled){
return (function (_13218,meta13217__$1){var self__ = this;
var _13218__$1 = this;return (new clustermap.components.filter.t13216(self__.compiled,self__.components,self__.cursor,self__.map__13215,self__.owner,self__.p__13208,self__.filter_component,meta13217__$1));
});})(map__13215,map__13215__$1,cursor,components,compiled))
;
clustermap.components.filter.__GT_t13216 = ((function (map__13215,map__13215__$1,cursor,components,compiled){
return (function __GT_t13216(compiled__$1,components__$1,cursor__$1,map__13215__$2,owner__$1,p__13208__$1,filter_component__$1,meta13217){return (new clustermap.components.filter.t13216(compiled__$1,components__$1,cursor__$1,map__13215__$2,owner__$1,p__13208__$1,filter_component__$1,meta13217));
});})(map__13215,map__13215__$1,cursor,components,compiled))
;
}
return (new clustermap.components.filter.t13216(compiled,components,cursor,map__13215__$1,owner,p__13208,filter_component,null));
});
