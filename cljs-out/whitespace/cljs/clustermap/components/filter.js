...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__12965 = cljs.core._EQ_;var expr__12966 = val;if(cljs.core.truth_(pred__12965.call(null,"new",expr__12966)))
...
{if(cljs.core.truth_(pred__12965.call(null,"old",expr__12966)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__12968 = cljs.core._EQ_;var expr__12969 = val;if(cljs.core.truth_(pred__12968.call(null,"group",expr__12969)))
...
{if(cljs.core.truth_(pred__12968.call(null,"notgroup",expr__12969)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__12971 = cljs.core._EQ_;var expr__12972 = val;if(cljs.core.truth_(pred__12971.call(null,"low",expr__12972)))
...
{if(cljs.core.truth_(pred__12971.call(null,"high",expr__12972)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__12974 = cljs.core._EQ_;var expr__12975 = val;if(cljs.core.truth_(pred__12974.call(null,"A",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"B",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"C",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"D",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"E",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"F",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"G",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"H",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"I",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"J",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"K",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"L",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"M",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"N",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"O",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"P",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"Q",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"R",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"S",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"T",expr__12975)))
...
{if(cljs.core.truth_(pred__12974.call(null,"U",expr__12975)))
...
clustermap.components.filter.filter_component = (function filter_component(p__12977,owner){var map__12984 = p__12977;var map__12984__$1 = ((cljs.core.seq_QMARK_.call(null,map__12984))?cljs.core.apply.call(null,cljs.core.hash_map,map__12984):map__12984);var cursor = map__12984__$1;var components = cljs.core.get.call(null,map__12984__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__12984__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(typeof clustermap.components.filter.t12985 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t12985 = (function (compiled,components,cursor,map__12984,owner,p__12977,filter_component,meta12986){
this.compiled = compiled;
this.components = components;
this.cursor = cursor;
this.map__12984 = map__12984;
this.owner = owner;
this.p__12977 = p__12977;
this.filter_component = filter_component;
this.meta12986 = meta12986;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t12985.cljs$lang$type = true;
clustermap.components.filter.t12985.cljs$lang$ctorStr = "clustermap.components.filter/t12985";
clustermap.components.filter.t12985.cljs$lang$ctorPrWriter = ((function (map__12984,map__12984__$1,cursor,components,compiled){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t12985");
});})(map__12984,map__12984__$1,cursor,components,compiled))
;
clustermap.components.filter.t12985.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t12985.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__12984,map__12984__$1,cursor,components,compiled){
return (function (_,p__12988,next_state){var self__ = this;
var map__12989 = p__12988;var map__12989__$1 = ((cljs.core.seq_QMARK_.call(null,map__12989))?cljs.core.apply.call(null,cljs.core.hash_map,map__12989):map__12989);var next_components = cljs.core.get.call(null,map__12989__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__12989__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var ___$1 = this;if(cljs.core.not_EQ_.call(null,next_components,self__.components))
...
;
clustermap.components.filter.t12985.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t12985.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__12984,map__12984__$1,cursor,components,compiled){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.cursor,self__.owner,state);
});})(map__12984,map__12984__$1,cursor,components,compiled))
;
clustermap.components.filter.t12985.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__12984,map__12984__$1,cursor,components,compiled){
return (function (_12987){var self__ = this;
var _12987__$1 = this;return self__.meta12986;
});})(map__12984,map__12984__$1,cursor,components,compiled))
;
clustermap.components.filter.t12985.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__12984,map__12984__$1,cursor,components,compiled){
return (function (_12987,meta12986__$1){var self__ = this;
var _12987__$1 = this;return (new clustermap.components.filter.t12985(self__.compiled,self__.components,self__.cursor,self__.map__12984,self__.owner,self__.p__12977,self__.filter_component,meta12986__$1));
});})(map__12984,map__12984__$1,cursor,components,compiled))
;
clustermap.components.filter.__GT_t12985 = ((function (map__12984,map__12984__$1,cursor,components,compiled){
return (function __GT_t12985(compiled__$1,components__$1,cursor__$1,map__12984__$2,owner__$1,p__12977__$1,filter_component__$1,meta12986){return (new clustermap.components.filter.t12985(compiled__$1,components__$1,cursor__$1,map__12984__$2,owner__$1,p__12977__$1,filter_component__$1,meta12986));
});})(map__12984,map__12984__$1,cursor,components,compiled))
;
}
return (new clustermap.components.filter.t12985(compiled,components,cursor,map__12984__$1,owner,p__12977,filter_component,null));
});
