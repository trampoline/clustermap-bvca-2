...
goog.require('clustermap.api');
goog.require('clustermap.ordered_resource');
clustermap.components.filter.render = (function render(p__16451,owner,state){var map__16553 = p__16451;var map__16553__$1 = ((cljs.core.seq_QMARK_.call(null,map__16553))?cljs.core.apply.call(null,cljs.core.hash_map,map__16553):map__16553);var bounds = cljs.core.get.call(null,map__16553__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var filter_spec = cljs.core.get.call(null,map__16553__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"filter by view"),React.DOM.div({"className": "tbl-cell"},sablono.interpreter.input.call(null,{"type": "checkbox", "name": "filter-by-view", "value": "true", "onChange": ((function (map__16553,map__16553__$1,bounds,filter_spec){
...
});})(map__16553,map__16553__$1,bounds,filter_spec))
}))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__16553,map__16553__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__16642 = cljs.core._EQ_;var expr__16643 = val;if(cljs.core.truth_(pred__16642.call(null,"new",expr__16643)))
...
{if(cljs.core.truth_(pred__16642.call(null,"old",expr__16643)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "new"},"< 5 years old"),sablono.interpreter.option.call(null,{"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__16553,map__16553__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__16645 = cljs.core._EQ_;var expr__16646 = val;if(cljs.core.truth_(pred__16645.call(null,"group",expr__16646)))
...
{if(cljs.core.truth_(pred__16645.call(null,"notgroup",expr__16646)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "group"},"group"),sablono.interpreter.option.call(null,{"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__16553,map__16553__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__16648 = cljs.core._EQ_;var expr__16649 = val;if(cljs.core.truth_(pred__16648.call(null,"low",expr__16649)))
...
{if(cljs.core.truth_(pred__16648.call(null,"high",expr__16649)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "low"},"< \u00A31 million"),sablono.interpreter.option.call(null,{"value": "high"},">= \u00A31 million")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"SIC section"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"style": {"width": "100%"}, "onChange": ((function (map__16553,map__16553__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(e.target.value);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__16651 = cljs.core._EQ_;var expr__16652 = val;if(cljs.core.truth_(pred__16651.call(null,"A",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"B",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"C",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"D",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"E",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"F",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"G",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"H",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"I",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"J",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"K",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"L",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"M",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"N",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"O",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"P",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"Q",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"R",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"S",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"T",expr__16652)))
...
{if(cljs.core.truth_(pred__16651.call(null,"U",expr__16652)))
...
clustermap.components.filter.filter_component = (function filter_component(p__16654,owner){var map__16663 = p__16654;var map__16663__$1 = ((cljs.core.seq_QMARK_.call(null,map__16663))?cljs.core.apply.call(null,cljs.core.hash_map,map__16663):map__16663);var props = map__16663__$1;var map__16664 = cljs.core.get.call(null,map__16663__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__16664__$1 = ((cljs.core.seq_QMARK_.call(null,map__16664))?cljs.core.apply.call(null,cljs.core.hash_map,map__16664):map__16664);var filter_spec = map__16664__$1;var components = cljs.core.get.call(null,map__16664__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var filter_by_view = cljs.core.get.call(null,map__16664__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var compiled = cljs.core.get.call(null,map__16664__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var bounds = cljs.core.get.call(null,map__16663__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));if(typeof clustermap.components.filter.t16665 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t16665 = (function (filter_component,p__16654,owner,filter_by_view,props,filter_spec,compiled,bounds,components,map__16663,map__16664,meta16666){
this.filter_component = filter_component;
this.p__16654 = p__16654;
this.owner = owner;
...
this.map__16663 = map__16663;
this.map__16664 = map__16664;
this.meta16666 = meta16666;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t16665.cljs$lang$type = true;
clustermap.components.filter.t16665.cljs$lang$ctorStr = "clustermap.components.filter/t16665";
clustermap.components.filter.t16665.cljs$lang$ctorPrWriter = ((function (map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t16665");
});})(map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t16665.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t16665.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,p__16668,next_state){var self__ = this;
var map__16669 = p__16668;var map__16669__$1 = ((cljs.core.seq_QMARK_.call(null,map__16669))?cljs.core.apply.call(null,cljs.core.hash_map,map__16669):map__16669);var map__16670 = cljs.core.get.call(null,map__16669__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__16670__$1 = ((cljs.core.seq_QMARK_.call(null,map__16670))?cljs.core.apply.call(null,cljs.core.hash_map,map__16670):map__16670);var next_components = cljs.core.get.call(null,map__16670__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_filter_by_view = cljs.core.get.call(null,map__16670__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var next_compiled = cljs.core.get.call(null,map__16670__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var next_bounds = cljs.core.get.call(null,map__16669__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var ___$1 = this;if(cljs.core.truth_((function (){var or__3558__auto__ = cljs.core.not_EQ_.call(null,next_components,self__.components);if(or__3558__auto__)
...
;
clustermap.components.filter.t16665.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t16665.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.props,self__.owner,state);
});})(map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t16665.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_16667){var self__ = this;
var _16667__$1 = this;return self__.meta16666;
});})(map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t16665.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_16667,meta16666__$1){var self__ = this;
var _16667__$1 = this;return (new clustermap.components.filter.t16665(self__.filter_component,self__.p__16654,self__.owner,self__.filter_by_view,self__.props,self__.filter_spec,self__.compiled,self__.bounds,self__.components,self__.map__16663,self__.map__16664,meta16666__$1));
});})(map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.__GT_t16665 = ((function (map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function __GT_t16665(filter_component__$1,p__16654__$1,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,compiled__$1,bounds__$1,components__$1,map__16663__$2,map__16664__$2,meta16666){return (new clustermap.components.filter.t16665(filter_component__$1,p__16654__$1,owner__$1,filter_by_view__$1,props__$1,filter_spec__$1,compiled__$1,bounds__$1,components__$1,map__16663__$2,map__16664__$2,meta16666));
});})(map__16663,map__16663__$1,props,map__16664,map__16664__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
}
return (new clustermap.components.filter.t16665(filter_component,p__16654,owner,filter_by_view,props,filter_spec,compiled,bounds,components,map__16663__$1,map__16664__$1,null));
});
