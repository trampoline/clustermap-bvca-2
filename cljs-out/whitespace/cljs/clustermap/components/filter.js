...
goog.require('clustermap.api');
goog.require('clustermap.ordered_resource');
clustermap.components.filter.render = (function render(p__11658,owner,state){var map__11760 = p__11658;var map__11760__$1 = ((cljs.core.seq_QMARK_.call(null,map__11760))?cljs.core.apply.call(null,cljs.core.hash_map,map__11760):map__11760);var bounds = cljs.core.get.call(null,map__11760__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var filter_spec = cljs.core.get.call(null,map__11760__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"filter by view"),React.DOM.div({"className": "tbl-cell"},sablono.interpreter.input.call(null,{"type": "checkbox", "name": "filter-by-view", "value": "true", "onChange": ((function (map__11760,map__11760__$1,bounds,filter_spec){
...
});})(map__11760,map__11760__$1,bounds,filter_spec))
}))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__11760,map__11760__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__11849 = cljs.core._EQ_;var expr__11850 = val;if(cljs.core.truth_(pred__11849.call(null,"new",expr__11850)))
...
{if(cljs.core.truth_(pred__11849.call(null,"old",expr__11850)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "new"},"< 5 years old"),sablono.interpreter.option.call(null,{"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__11760,map__11760__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__11852 = cljs.core._EQ_;var expr__11853 = val;if(cljs.core.truth_(pred__11852.call(null,"group",expr__11853)))
...
{if(cljs.core.truth_(pred__11852.call(null,"notgroup",expr__11853)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "group"},"group"),sablono.interpreter.option.call(null,{"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (map__11760,map__11760__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__11855 = cljs.core._EQ_;var expr__11856 = val;if(cljs.core.truth_(pred__11855.call(null,"low",expr__11856)))
...
{if(cljs.core.truth_(pred__11855.call(null,"high",expr__11856)))
...
},sablono.interpreter.option.call(null,{"value": ""},"any"),sablono.interpreter.option.call(null,{"value": "low"},"< \u00A31 million"),sablono.interpreter.option.call(null,{"value": "high"},">= \u00A31 million")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"SIC section"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"style": {"width": "100%"}, "onChange": ((function (map__11760,map__11760__$1,bounds,filter_spec){
return (function (e){var val = e.target.value;console.log(e.target.value);
return om.core.update_BANG_.call(null,filter_spec,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__11858 = cljs.core._EQ_;var expr__11859 = val;if(cljs.core.truth_(pred__11858.call(null,"A",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"B",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"C",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"D",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"E",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"F",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"G",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"H",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"I",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"J",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"K",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"L",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"M",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"N",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"O",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"P",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"Q",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"R",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"S",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"T",expr__11859)))
...
{if(cljs.core.truth_(pred__11858.call(null,"U",expr__11859)))
...
clustermap.components.filter.filter_component = (function filter_component(p__11861,owner){var map__11870 = p__11861;var map__11870__$1 = ((cljs.core.seq_QMARK_.call(null,map__11870))?cljs.core.apply.call(null,cljs.core.hash_map,map__11870):map__11870);var props = map__11870__$1;var map__11871 = cljs.core.get.call(null,map__11870__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__11871__$1 = ((cljs.core.seq_QMARK_.call(null,map__11871))?cljs.core.apply.call(null,cljs.core.hash_map,map__11871):map__11871);var filter_spec = map__11871__$1;var components = cljs.core.get.call(null,map__11871__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var filter_by_view = cljs.core.get.call(null,map__11871__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var compiled = cljs.core.get.call(null,map__11871__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var bounds = cljs.core.get.call(null,map__11870__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));if(typeof clustermap.components.filter.t11872 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t11872 = (function (filter_component,p__11861,owner,filter_by_view,props,map__11871,filter_spec,compiled,map__11870,bounds,components,meta11873){
this.filter_component = filter_component;
this.p__11861 = p__11861;
this.owner = owner;
...
clustermap.components.filter.t11872.cljs$lang$type = true;
clustermap.components.filter.t11872.cljs$lang$ctorStr = "clustermap.components.filter/t11872";
clustermap.components.filter.t11872.cljs$lang$ctorPrWriter = ((function (map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t11872");
});})(map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t11872.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t11872.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,p__11875,next_state){var self__ = this;
var map__11876 = p__11875;var map__11876__$1 = ((cljs.core.seq_QMARK_.call(null,map__11876))?cljs.core.apply.call(null,cljs.core.hash_map,map__11876):map__11876);var map__11877 = cljs.core.get.call(null,map__11876__$1,new cljs.core.Keyword(null,"filter-spec","filter-spec",-1101318648));var map__11877__$1 = ((cljs.core.seq_QMARK_.call(null,map__11877))?cljs.core.apply.call(null,cljs.core.hash_map,map__11877):map__11877);var next_components = cljs.core.get.call(null,map__11877__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_filter_by_view = cljs.core.get.call(null,map__11877__$1,new cljs.core.Keyword(null,"filter-by-view","filter-by-view",902292255));var next_compiled = cljs.core.get.call(null,map__11877__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var next_bounds = cljs.core.get.call(null,map__11876__$1,new cljs.core.Keyword(null,"bounds","bounds",1691609455));var ___$1 = this;if(cljs.core.truth_((function (){var or__3558__auto__ = cljs.core.not_EQ_.call(null,next_components,self__.components);if(or__3558__auto__)
...
;
clustermap.components.filter.t11872.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t11872.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.props,self__.owner,state);
});})(map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t11872.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_11874){var self__ = this;
var _11874__$1 = this;return self__.meta11873;
});})(map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.t11872.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function (_11874,meta11873__$1){var self__ = this;
var _11874__$1 = this;return (new clustermap.components.filter.t11872(self__.filter_component,self__.p__11861,self__.owner,self__.filter_by_view,self__.props,self__.map__11871,self__.filter_spec,self__.compiled,self__.map__11870,self__.bounds,self__.components,meta11873__$1));
});})(map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
clustermap.components.filter.__GT_t11872 = ((function (map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds){
return (function __GT_t11872(filter_component__$1,p__11861__$1,owner__$1,filter_by_view__$1,props__$1,map__11871__$2,filter_spec__$1,compiled__$1,map__11870__$2,bounds__$1,components__$1,meta11873){return (new clustermap.components.filter.t11872(filter_component__$1,p__11861__$1,owner__$1,filter_by_view__$1,props__$1,map__11871__$2,filter_spec__$1,compiled__$1,map__11870__$2,bounds__$1,components__$1,meta11873));
});})(map__11870,map__11870__$1,props,map__11871,map__11871__$1,filter_spec,components,filter_by_view,compiled,bounds))
;
}
return (new clustermap.components.filter.t11872(filter_component,p__11861,owner,filter_by_view,props,map__11871__$1,filter_spec,compiled,map__11870__$1,bounds,components,null));
});
