...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__13320,owner){var map__13412 = p__13320;var map__13412__$1 = ((cljs.core.seq_QMARK_.call(null,map__13412))?cljs.core.apply.call(null,cljs.core.hash_map,map__13412):map__13412);var cursor = map__13412__$1;if(typeof clustermap.components.filter.t13413 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t13413 = (function (cursor,map__13412,owner,p__13320,filter_component,meta13414){
this.cursor = cursor;
this.map__13412 = map__13412;
this.owner = owner;
this.p__13320 = p__13320;
this.filter_component = filter_component;
this.meta13414 = meta13414;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t13413.cljs$lang$type = true;
clustermap.components.filter.t13413.cljs$lang$ctorStr = "clustermap.components.filter/t13413";
clustermap.components.filter.t13413.cljs$lang$ctorPrWriter = ((function (map__13412,map__13412__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t13413");
});})(map__13412,map__13412__$1,cursor))
;
clustermap.components.filter.t13413.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t13413.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__13412,map__13412__$1,cursor){
return (function (this$,p__13416,next_state){var self__ = this;
var map__13417 = p__13416;var map__13417__$1 = ((cljs.core.seq_QMARK_.call(null,map__13417))?cljs.core.apply.call(null,cljs.core.hash_map,map__13417):map__13417);var next_components = cljs.core.get.call(null,map__13417__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__13417__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__13418 = om.core.get_props.call(null,self__.owner);var map__13418__$1 = ((cljs.core.seq_QMARK_.call(null,map__13418))?cljs.core.apply.call(null,cljs.core.hash_map,map__13418):map__13418);var components = cljs.core.get.call(null,map__13418__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__13418__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t13413.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t13413.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__13412,map__13412__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__13412,map__13412__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__13491 = cljs.core._EQ_;var expr__13492 = val;if(cljs.core.truth_(pred__13491.call(null,"new",expr__13492)))
...
{if(cljs.core.truth_(pred__13491.call(null,"old",expr__13492)))
...
});})(this$__$1,map__13412,map__13412__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__13412,map__13412__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__13494 = cljs.core._EQ_;var expr__13495 = val;if(cljs.core.truth_(pred__13494.call(null,"group",expr__13495)))
...
{if(cljs.core.truth_(pred__13494.call(null,"notgroup",expr__13495)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__13412,map__13412__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__13497 = cljs.core._EQ_;var expr__13498 = val;if(cljs.core.truth_(pred__13497.call(null,"low",expr__13498)))
...
{if(cljs.core.truth_(pred__13497.call(null,"high",expr__13498)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__13500 = cljs.core._EQ_;var expr__13501 = val;if(cljs.core.truth_(pred__13500.call(null,"A",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"B",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"C",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"D",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"E",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"F",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"G",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"H",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"I",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"J",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"K",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"L",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"M",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"N",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"O",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"P",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"Q",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"R",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"S",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"T",expr__13501)))
...
{if(cljs.core.truth_(pred__13500.call(null,"U",expr__13501)))
...
;
clustermap.components.filter.t13413.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__13412,map__13412__$1,cursor){
return (function (_13415){var self__ = this;
var _13415__$1 = this;return self__.meta13414;
});})(map__13412,map__13412__$1,cursor))
;
clustermap.components.filter.t13413.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__13412,map__13412__$1,cursor){
return (function (_13415,meta13414__$1){var self__ = this;
var _13415__$1 = this;return (new clustermap.components.filter.t13413(self__.cursor,self__.map__13412,self__.owner,self__.p__13320,self__.filter_component,meta13414__$1));
});})(map__13412,map__13412__$1,cursor))
;
clustermap.components.filter.__GT_t13413 = ((function (map__13412,map__13412__$1,cursor){
return (function __GT_t13413(cursor__$1,map__13412__$2,owner__$1,p__13320__$1,filter_component__$1,meta13414){return (new clustermap.components.filter.t13413(cursor__$1,map__13412__$2,owner__$1,p__13320__$1,filter_component__$1,meta13414));
});})(map__13412,map__13412__$1,cursor))
;
}
return (new clustermap.components.filter.t13413(cursor,map__13412__$1,owner,p__13320,filter_component,null));
});
