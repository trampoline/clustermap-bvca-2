...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__12896,owner){var map__12988 = p__12896;var map__12988__$1 = ((cljs.core.seq_QMARK_.call(null,map__12988))?cljs.core.apply.call(null,cljs.core.hash_map,map__12988):map__12988);var cursor = map__12988__$1;if(typeof clustermap.components.filter.t12989 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t12989 = (function (cursor,map__12988,owner,p__12896,filter_component,meta12990){
this.cursor = cursor;
this.map__12988 = map__12988;
this.owner = owner;
this.p__12896 = p__12896;
this.filter_component = filter_component;
this.meta12990 = meta12990;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t12989.cljs$lang$type = true;
clustermap.components.filter.t12989.cljs$lang$ctorStr = "clustermap.components.filter/t12989";
clustermap.components.filter.t12989.cljs$lang$ctorPrWriter = ((function (map__12988,map__12988__$1,cursor){
return (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"clustermap.components.filter/t12989");
});})(map__12988,map__12988__$1,cursor))
;
clustermap.components.filter.t12989.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t12989.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__12988,map__12988__$1,cursor){
return (function (this$,p__12992,next_state){var self__ = this;
var map__12993 = p__12992;var map__12993__$1 = ((cljs.core.seq_QMARK_.call(null,map__12993))?cljs.core.apply.call(null,cljs.core.hash_map,map__12993):map__12993);var next_components = cljs.core.get.call(null,map__12993__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__12993__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__12994 = om.core.get_props.call(null,self__.owner);var map__12994__$1 = ((cljs.core.seq_QMARK_.call(null,map__12994))?cljs.core.apply.call(null,cljs.core.hash_map,map__12994):map__12994);var components = cljs.core.get.call(null,map__12994__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__12994__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t12989.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t12989.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__12988,map__12988__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__12988,map__12988__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__13067 = cljs.core._EQ_;var expr__13068 = val;if(cljs.core.truth_(pred__13067.call(null,"new",expr__13068)))
...
{if(cljs.core.truth_(pred__13067.call(null,"old",expr__13068)))
...
});})(this$__$1,map__12988,map__12988__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__12988,map__12988__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__13070 = cljs.core._EQ_;var expr__13071 = val;if(cljs.core.truth_(pred__13070.call(null,"group",expr__13071)))
...
{if(cljs.core.truth_(pred__13070.call(null,"notgroup",expr__13071)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__12988,map__12988__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__13073 = cljs.core._EQ_;var expr__13074 = val;if(cljs.core.truth_(pred__13073.call(null,"low",expr__13074)))
...
{if(cljs.core.truth_(pred__13073.call(null,"high",expr__13074)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__13076 = cljs.core._EQ_;var expr__13077 = val;if(cljs.core.truth_(pred__13076.call(null,"A",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"B",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"C",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"D",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"E",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"F",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"G",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"H",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"I",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"J",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"K",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"L",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"M",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"N",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"O",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"P",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"Q",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"R",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"S",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"T",expr__13077)))
...
{if(cljs.core.truth_(pred__13076.call(null,"U",expr__13077)))
...
;
clustermap.components.filter.t12989.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__12988,map__12988__$1,cursor){
return (function (_12991){var self__ = this;
var _12991__$1 = this;return self__.meta12990;
});})(map__12988,map__12988__$1,cursor))
;
clustermap.components.filter.t12989.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__12988,map__12988__$1,cursor){
return (function (_12991,meta12990__$1){var self__ = this;
var _12991__$1 = this;return (new clustermap.components.filter.t12989(self__.cursor,self__.map__12988,self__.owner,self__.p__12896,self__.filter_component,meta12990__$1));
});})(map__12988,map__12988__$1,cursor))
;
clustermap.components.filter.__GT_t12989 = ((function (map__12988,map__12988__$1,cursor){
return (function __GT_t12989(cursor__$1,map__12988__$2,owner__$1,p__12896__$1,filter_component__$1,meta12990){return (new clustermap.components.filter.t12989(cursor__$1,map__12988__$2,owner__$1,p__12896__$1,filter_component__$1,meta12990));
});})(map__12988,map__12988__$1,cursor))
;
}
return (new clustermap.components.filter.t12989(cursor,map__12988__$1,owner,p__12896,filter_component,null));
});
