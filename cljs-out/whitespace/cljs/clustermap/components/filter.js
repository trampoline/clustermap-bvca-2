...
goog.require('om.core');
clustermap.components.filter.filter_component = (function filter_component(p__12926,owner){var map__13018 = p__12926;var map__13018__$1 = ((cljs.core.seq_QMARK_.call(null,map__13018))?cljs.core.apply.call(null,cljs.core.hash_map,map__13018):map__13018);var cursor = map__13018__$1;if(typeof clustermap.components.filter.t13019 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t13019 = (function (cursor,map__13018,owner,p__12926,filter_component,meta13020){
this.cursor = cursor;
...
clustermap.components.filter.t13019.cljs$lang$type = true;
clustermap.components.filter.t13019.cljs$lang$ctorStr = "clustermap.components.filter/t13019";
clustermap.components.filter.t13019.cljs$lang$ctorPrWriter = ((function (map__13018,map__13018__$1,cursor){
return (function (this__4108__auto__,writer__4109__auto__,opt__4110__auto__){return cljs.core._write.call(null,writer__4109__auto__,"clustermap.components.filter/t13019");
});})(map__13018,map__13018__$1,cursor))
;
clustermap.components.filter.t13019.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t13019.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__13018,map__13018__$1,cursor){
return (function (this$,p__13022,next_state){var self__ = this;
var map__13023 = p__13022;var map__13023__$1 = ((cljs.core.seq_QMARK_.call(null,map__13023))?cljs.core.apply.call(null,cljs.core.hash_map,map__13023):map__13023);var next_components = cljs.core.get.call(null,map__13023__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__13023__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var this$__$1 = this;var map__13024 = om.core.get_props.call(null,self__.owner);var map__13024__$1 = ((cljs.core.seq_QMARK_.call(null,map__13024))?cljs.core.apply.call(null,cljs.core.hash_map,map__13024):map__13024);var components = cljs.core.get.call(null,map__13024__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__13024__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(cljs.core.not_EQ_.call(null,next_components,components))
...
;
clustermap.components.filter.t13019.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t13019.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__13018,map__13018__$1,cursor){
return (function (this$,state){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "filter-component"},React.DOM.div({"className": "tbl"},React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},React.DOM.h3(null,"Filter"))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"age"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__13018,map__13018__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__13097 = cljs.core._EQ_;var expr__13098 = val;if(cljs.core.truth_(pred__13097.call(null,"new",expr__13098)))
...
{if(cljs.core.truth_(pred__13097.call(null,"old",expr__13098)))
...
});})(this$__$1,map__13018,map__13018__$1,cursor))
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "new"},"< 5 years old"),React.DOM.option({"value": "old"},">= 5 years old")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"group ?"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__13018,map__13018__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__13100 = cljs.core._EQ_;var expr__13101 = val;if(cljs.core.truth_(pred__13100.call(null,"group",expr__13101)))
...
{if(cljs.core.truth_(pred__13100.call(null,"notgroup",expr__13101)))
...
},React.DOM.option({"value": ""},"any"),React.DOM.option({"value": "group"},"group"),React.DOM.option({"value": "notgroup"},"not group")))),React.DOM.div({"className": "tbl-row"},React.DOM.div({"className": "tbl-cell"},"turnover"),React.DOM.div({"className": "tbl-cell"},React.DOM.select({"onChange": ((function (this$__$1,map__13018,map__13018__$1,cursor){
return (function (e){var val = e.target.value;console.log(val);
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__13103 = cljs.core._EQ_;var expr__13104 = val;if(cljs.core.truth_(pred__13103.call(null,"low",expr__13104)))
...
{if(cljs.core.truth_(pred__13103.call(null,"high",expr__13104)))
...
return om.core.update_BANG_.call(null,self__.cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__13106 = cljs.core._EQ_;var expr__13107 = val;if(cljs.core.truth_(pred__13106.call(null,"A",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"B",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"C",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"D",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"E",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"F",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"G",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"H",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"I",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"J",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"K",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"L",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"M",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"N",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"O",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"P",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"Q",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"R",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"S",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"T",expr__13107)))
...
{if(cljs.core.truth_(pred__13106.call(null,"U",expr__13107)))
...
;
clustermap.components.filter.t13019.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__13018,map__13018__$1,cursor){
return (function (_13021){var self__ = this;
var _13021__$1 = this;return self__.meta13020;
});})(map__13018,map__13018__$1,cursor))
;
clustermap.components.filter.t13019.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__13018,map__13018__$1,cursor){
return (function (_13021,meta13020__$1){var self__ = this;
var _13021__$1 = this;return (new clustermap.components.filter.t13019(self__.cursor,self__.map__13018,self__.owner,self__.p__12926,self__.filter_component,meta13020__$1));
});})(map__13018,map__13018__$1,cursor))
;
clustermap.components.filter.__GT_t13019 = ((function (map__13018,map__13018__$1,cursor){
return (function __GT_t13019(cursor__$1,map__13018__$2,owner__$1,p__12926__$1,filter_component__$1,meta13020){return (new clustermap.components.filter.t13019(cursor__$1,map__13018__$2,owner__$1,p__12926__$1,filter_component__$1,meta13020));
});})(map__13018,map__13018__$1,cursor))
;
}
return (new clustermap.components.filter.t13019(cursor,map__13018__$1,owner,p__12926,filter_component,null));
});
