...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"age","age",-604307804)], null),(function (){var pred__12977 = cljs.core._EQ_;var expr__12978 = val;if(cljs.core.truth_(pred__12977.call(null,"new",expr__12978)))
...
{if(cljs.core.truth_(pred__12977.call(null,"old",expr__12978)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"group","group",582596132)], null),(function (){var pred__12980 = cljs.core._EQ_;var expr__12981 = val;if(cljs.core.truth_(pred__12980.call(null,"group",expr__12981)))
...
{if(cljs.core.truth_(pred__12980.call(null,"notgroup",expr__12981)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"turnover","turnover",-1778310555)], null),(function (){var pred__12983 = cljs.core._EQ_;var expr__12984 = val;if(cljs.core.truth_(pred__12983.call(null,"low",expr__12984)))
...
{if(cljs.core.truth_(pred__12983.call(null,"high",expr__12984)))
...
return om.core.update_BANG_.call(null,cursor,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"components","components",-1073188942),new cljs.core.Keyword(null,"sic","sic",589884826)], null),(function (){var pred__12986 = cljs.core._EQ_;var expr__12987 = val;if(cljs.core.truth_(pred__12986.call(null,"A",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"B",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"C",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"D",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"E",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"F",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"G",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"H",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"I",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"J",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"K",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"L",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"M",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"N",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"O",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"P",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"Q",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"R",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"S",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"T",expr__12987)))
...
{if(cljs.core.truth_(pred__12986.call(null,"U",expr__12987)))
...
clustermap.components.filter.filter_component = (function filter_component(p__12989,owner){var map__12996 = p__12989;var map__12996__$1 = ((cljs.core.seq_QMARK_.call(null,map__12996))?cljs.core.apply.call(null,cljs.core.hash_map,map__12996):map__12996);var cursor = map__12996__$1;var components = cljs.core.get.call(null,map__12996__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var compiled = cljs.core.get.call(null,map__12996__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));if(typeof clustermap.components.filter.t12997 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.filter.t12997 = (function (compiled,components,cursor,map__12996,owner,p__12989,filter_component,meta12998){
this.compiled = compiled;
this.components = components;
this.cursor = cursor;
this.map__12996 = map__12996;
this.owner = owner;
this.p__12989 = p__12989;
this.filter_component = filter_component;
this.meta12998 = meta12998;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
clustermap.components.filter.t12997.cljs$lang$type = true;
clustermap.components.filter.t12997.cljs$lang$ctorStr = "clustermap.components.filter/t12997";
clustermap.components.filter.t12997.cljs$lang$ctorPrWriter = ((function (map__12996,map__12996__$1,cursor,components,compiled){
return (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"clustermap.components.filter/t12997");
});})(map__12996,map__12996__$1,cursor,components,compiled))
;
clustermap.components.filter.t12997.prototype.om$core$IWillUpdate$ = true;
clustermap.components.filter.t12997.prototype.om$core$IWillUpdate$will_update$arity$3 = ((function (map__12996,map__12996__$1,cursor,components,compiled){
return (function (_,p__13000,next_state){var self__ = this;
var map__13001 = p__13000;var map__13001__$1 = ((cljs.core.seq_QMARK_.call(null,map__13001))?cljs.core.apply.call(null,cljs.core.hash_map,map__13001):map__13001);var next_components = cljs.core.get.call(null,map__13001__$1,new cljs.core.Keyword(null,"components","components",-1073188942));var next_compiled = cljs.core.get.call(null,map__13001__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));var ___$1 = this;if(cljs.core.not_EQ_.call(null,next_components,self__.components))
...
;
clustermap.components.filter.t12997.prototype.om$core$IRenderState$ = true;
clustermap.components.filter.t12997.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__12996,map__12996__$1,cursor,components,compiled){
return (function (_,state){var self__ = this;
var ___$1 = this;return clustermap.components.filter.render.call(null,self__.cursor,self__.owner,state);
});})(map__12996,map__12996__$1,cursor,components,compiled))
;
clustermap.components.filter.t12997.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__12996,map__12996__$1,cursor,components,compiled){
return (function (_12999){var self__ = this;
var _12999__$1 = this;return self__.meta12998;
});})(map__12996,map__12996__$1,cursor,components,compiled))
;
clustermap.components.filter.t12997.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__12996,map__12996__$1,cursor,components,compiled){
return (function (_12999,meta12998__$1){var self__ = this;
var _12999__$1 = this;return (new clustermap.components.filter.t12997(self__.compiled,self__.components,self__.cursor,self__.map__12996,self__.owner,self__.p__12989,self__.filter_component,meta12998__$1));
});})(map__12996,map__12996__$1,cursor,components,compiled))
;
clustermap.components.filter.__GT_t12997 = ((function (map__12996,map__12996__$1,cursor,components,compiled){
return (function __GT_t12997(compiled__$1,components__$1,cursor__$1,map__12996__$2,owner__$1,p__12989__$1,filter_component__$1,meta12998){return (new clustermap.components.filter.t12997(compiled__$1,components__$1,cursor__$1,map__12996__$2,owner__$1,p__12989__$1,filter_component__$1,meta12998));
});})(map__12996,map__12996__$1,cursor,components,compiled))
;
}
return (new clustermap.components.filter.t12997(compiled,components,cursor,map__12996__$1,owner,p__12989,filter_component,null));
});
