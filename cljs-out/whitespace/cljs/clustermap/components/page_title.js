...
goog.require('cljs.core.async');
goog.require('clustermap.formats.number');
clustermap.components.page_title.describe_type = (function describe_type(type){var pred__22664 = cljs.core._EQ_;var expr__22665 = type;if(cljs.core.truth_(pred__22664.call(null,new cljs.core.Keyword(null,"portfolio-company","portfolio-company",3606204522),expr__22665)))
{return "Portfolio Company";
} else
{if(cljs.core.truth_(pred__22664.call(null,new cljs.core.Keyword(null,"investor-company","investor-company",3983736762),expr__22665)))
{return "Investor";
} else
{if(cljs.core.truth_(pred__22664.call(null,new cljs.core.Keyword(null,"constituency","constituency",3902864696),expr__22665)))
{return "Constituency";
} else
...
clustermap.components.page_title.page_title_component = (function page_title_component(selection,owner){var comm = om.core.get_shared.call(null,owner,new cljs.core.Keyword(null,"comm","comm",1016963710));var type = (function (){var G__22674 = selection;var G__22674__$1 = (((G__22674 == null))?null:new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(G__22674));var G__22674__$2 = (((G__22674__$1 == null))?null:clustermap.components.page_title.describe_type.call(null,G__22674__$1));return G__22674__$2;
})();var name = (function (){var G__22675 = selection;var G__22675__$1 = (((G__22675 == null))?null:new cljs.core.Keyword(null,"value","value",1125876963).cljs$core$IFn$_invoke$arity$1(G__22675));var G__22675__$2 = (((G__22675__$1 == null))?null:new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(G__22675__$1));return G__22675__$2;
...
clustermap.components.page_title.t22676.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.page-title/t22676");
});
...
})();if(cljs.core.map_QMARK_.call(null,attrs22679))
{return React.DOM.h2(sablono.interpreter.attributes.call(null,attrs22679),null);
} else
{return React.DOM.h2(null,sablono.interpreter.interpret.call(null,attrs22679));
}
...
})();if(cljs.core.map_QMARK_.call(null,attrs22680))
{return React.DOM.h3(sablono.interpreter.attributes.call(null,attrs22680),null);
} else
{return React.DOM.h3(null,sablono.interpreter.interpret.call(null,attrs22680));
}
})());
});
