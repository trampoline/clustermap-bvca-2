...
goog.require('clustermap.formats.number');
goog.require('jayq.core');
clustermap.components.timeline_chart.create_chart = (function create_chart(data,node,p__45493){var map__45495 = p__45493;var map__45495__$1 = ((cljs.core.seq_QMARK_.call(null,map__45495))?cljs.core.apply.call(null,cljs.core.hash_map,map__45495):map__45495);var opts = map__45495__$1;var y1_title = cljs.core.get.call(null,map__45495__$1,new cljs.core.Keyword(null,"y1-title","y1-title",3377247893));var y0_title = cljs.core.get.call(null,map__45495__$1,new cljs.core.Keyword(null,"y0-title","y0-title",2489744212));var x_labels = cljs.core.map.call(null,new cljs.core.Keyword(null,"date","date",1016980256),data);var stats = cljs.core.map.call(null,new cljs.core.Keyword(null,"stats","stats",1123661841),data);var y_median = cljs.core.map.call(null,cljs.core.comp.call(null,((function (x_labels,stats){
return (function (p1__45487_SHARP_){return clustermap.formats.number.round_decimal.call(null,p1__45487_SHARP_,0);
});})(x_labels,stats))
,((function (x_labels,stats){
return (function (p1__45488_SHARP_){return cljs.core.get_in.call(null,p1__45488_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stats","stats",1123661841),new cljs.core.Keyword(null,"median","median",4230840444)], null));
});})(x_labels,stats))
),data);var y_mean = cljs.core.map.call(null,cljs.core.comp.call(null,((function (x_labels,stats,y_median){
return (function (p1__45489_SHARP_){return clustermap.formats.number.round_decimal.call(null,p1__45489_SHARP_,0);
});})(x_labels,stats,y_median))
,((function (x_labels,stats,y_median){
return (function (p1__45490_SHARP_){return cljs.core.get_in.call(null,p1__45490_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stats","stats",1123661841),new cljs.core.Keyword(null,"mean","mean",1017251639)], null));
});})(x_labels,stats,y_median))
),data);var y_total = cljs.core.map.call(null,cljs.core.comp.call(null,((function (x_labels,stats,y_median,y_mean){
return (function (p1__45491_SHARP_){return clustermap.formats.number.round_decimal.call(null,p1__45491_SHARP_,0);
});})(x_labels,stats,y_median,y_mean))
,((function (x_labels,stats,y_median,y_mean){
return (function (p1__45492_SHARP_){return cljs.core.get_in.call(null,p1__45492_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stats","stats",1123661841),new cljs.core.Keyword(null,"total","total",1124454070)], null));
});})(x_labels,stats,y_median,y_mean))
...
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,p__45496){var map__45501 = p__45496;var map__45501__$1 = ((cljs.core.seq_QMARK_.call(null,map__45501))?cljs.core.apply.call(null,cljs.core.hash_map,map__45501):map__45501);var opts = map__45501__$1;var id = cljs.core.get.call(null,map__45501__$1,new cljs.core.Keyword(null,"id","id",1013907597));if(typeof clustermap.components.timeline_chart.t45502 !== 'undefined')
{} else
{
/**
* @constructor
...
clustermap.components.timeline_chart.t45502.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"clustermap.components.timeline-chart/t45502");
});
clustermap.components.timeline_chart.t45502.prototype.om$core$IDidUpdate$ = true;
clustermap.components.timeline_chart.t45502.prototype.om$core$IDidUpdate$did_update$arity$3 = (function (this$,prev_props,prev_state){var self__ = this;
...
clustermap.components.timeline_chart.t45502.prototype.om$core$IDidMount$did_mount$arity$1 = (function (this$){var self__ = this;
...
clustermap.components.timeline_chart.t45502.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "timeline-chart", "id": self__.id, "ref": "chart"});
});
clustermap.components.timeline_chart.t45502.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_45504){var self__ = this;
var _45504__$1 = this;return self__.meta45503;
});
clustermap.components.timeline_chart.t45502.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_45504,meta45503__$1){var self__ = this;
var _45504__$1 = this;return (new clustermap.components.timeline_chart.t45502(self__.id,self__.opts,self__.map__45501,self__.p__45496,self__.owner,self__.data,self__.timeline_chart,meta45503__$1));
});
clustermap.components.timeline_chart.__GT_t45502 = (function __GT_t45502(id__$1,opts__$1,map__45501__$2,p__45496__$1,owner__$1,data__$1,timeline_chart__$1,meta45503){return (new clustermap.components.timeline_chart.t45502(id__$1,opts__$1,map__45501__$2,p__45496__$1,owner__$1,data__$1,timeline_chart__$1,meta45503));
});
}
