...
clustermap.components.timeline_chart.timeline_chart = (function timeline_chart(data,owner,opts){if(typeof clustermap.components.timeline_chart.t33168 !== 'undefined')
{} else
{
/**
* @constructor
*/
clustermap.components.timeline_chart.t33168 = (function (opts,owner,data,timeline_chart,meta33169){
this.opts = opts;
this.owner = owner;
this.data = data;
...
clustermap.components.timeline_chart.t33168.cljs$lang$type = true;
clustermap.components.timeline_chart.t33168.cljs$lang$ctorStr = "clustermap.components.timeline-chart/t33168";
clustermap.components.timeline_chart.t33168.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"clustermap.components.timeline-chart/t33168");
});
clustermap.components.timeline_chart.t33168.prototype.om$core$IDidUpdate$ = true;
clustermap.components.timeline_chart.t33168.prototype.om$core$IDidUpdate$did_update$arity$4 = (function (this$,prev_props,prev_state,root_node){var self__ = this;
...
clustermap.components.timeline_chart.t33168.prototype.om$core$IDidMount$ = true;
clustermap.components.timeline_chart.t33168.prototype.om$core$IDidMount$did_mount$arity$2 = (function (this$,node){var self__ = this;
var this$__$1 = this;return clustermap.components.timeline_chart.create_chart.call(null,self__.data,om.core.get_node.call(null,self__.owner,"chart"),self__.opts);
});
clustermap.components.timeline_chart.t33168.prototype.om$core$IRender$ = true;
clustermap.components.timeline_chart.t33168.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;return React.DOM.div({"className": "timeline-chart", "ref": "chart"});
});
clustermap.components.timeline_chart.t33168.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33170){var self__ = this;
var _33170__$1 = this;return self__.meta33169;
});
clustermap.components.timeline_chart.t33168.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33170,meta33169__$1){var self__ = this;
var _33170__$1 = this;return (new clustermap.components.timeline_chart.t33168(self__.opts,self__.owner,self__.data,self__.timeline_chart,meta33169__$1));
});
clustermap.components.timeline_chart.__GT_t33168 = (function __GT_t33168(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta33169){return (new clustermap.components.timeline_chart.t33168(opts__$1,owner__$1,data__$1,timeline_chart__$1,meta33169));
});
}
return (new clustermap.components.timeline_chart.t33168(opts,owner,data,timeline_chart,null));
});
