...
var readable__delegate = function (n,p__28645){var map__28648 = p__28645;var map__28648__$1 = ((cljs.core.seq_QMARK_.call(null,map__28648))?cljs.core.apply.call(null,cljs.core.hash_map,map__28648):map__28648);var default$ = cljs.core.get.call(null,map__28648__$1,new cljs.core.Keyword(null,"default","default",2558708147));var plus_QMARK_ = cljs.core.get.call(null,map__28648__$1,new cljs.core.Keyword(null,"plus?","plus?",1120672087));var curr = cljs.core.get.call(null,map__28648__$1,new cljs.core.Keyword(null,"curr","curr",1016969636),"\u00A3");var sf = cljs.core.get.call(null,map__28648__$1,new cljs.core.Keyword(null,"sf","sf",1013907909));if(cljs.core.truth_(n))
{var vec__28649 = clustermap.formats.number.eng_notation.call(null,n,new cljs.core.Keyword(null,"sf","sf",1013907909),sf);var sig = cljs.core.nth.call(null,vec__28649,0,null);var exp = cljs.core.nth.call(null,vec__28649,1,null);var abs_sig = Math.abs(sig);var suffix = clustermap.formats.money.money_suffix.call(null,exp);return cljs.core.apply.call(null,cljs.core.str,cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3394__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3394__auto__))
{return (sig > 0);
} else
...
return readable__delegate.call(this,n,p__28645);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__28650){
var n = cljs.core.first(arglist__28650);
var p__28645 = cljs.core.rest(arglist__28650);
return readable__delegate(n,p__28645);
});
