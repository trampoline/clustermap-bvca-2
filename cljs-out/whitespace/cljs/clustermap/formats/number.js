...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__31417_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__31417_SHARP_);
...
var p__31418 = null;if (arguments.length > 1) {
  p__31418 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return eng_notation__delegate.call(this,n,p__31418);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__31427){
var n = cljs.core.first(arglist__31427);
var p__31418 = cljs.core.rest(arglist__31427);
return eng_notation__delegate(n,p__31418);
});
...
var readable__delegate = function (n,p__31428){var map__31431 = p__31428;var map__31431__$1 = ((cljs.core.seq_QMARK_.call(null,map__31431))?cljs.core.apply.call(null,cljs.core.hash_map,map__31431):map__31431);var default$ = cljs.core.get.call(null,map__31431__$1,new cljs.core.Keyword(null,"default","default",2558708147));var plus_QMARK_ = cljs.core.get.call(null,map__31431__$1,new cljs.core.Keyword(null,"plus?","plus?",1120672087));var dec = cljs.core.get.call(null,map__31431__$1,new cljs.core.Keyword(null,"dec","dec",1014003572));if(cljs.core.truth_(n))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = [cljs.core.str(round_n)].join('');var vec__31432 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__31432,0,null);var d_str = cljs.core.nth.call(null,vec__31432,1,null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return clustermap.formats.number.prefix_sign.call(null,t_dec_str,n,plus_QMARK_);
} else
{return default$;
}
};
var readable = function (n,var_args){
var p__31428 = null;if (arguments.length > 1) {
  p__31428 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return readable__delegate.call(this,n,p__31428);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__31433){
var n = cljs.core.first(arglist__31433);
var p__31428 = cljs.core.rest(arglist__31433);
return readable__delegate(n,p__31428);
});
