...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__14018_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__14018_SHARP_);
...
return eng_notation__delegate.call(this,n,p__14019);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__14028){
var n = cljs.core.first(arglist__14028);
var p__14019 = cljs.core.rest(arglist__14028);
return eng_notation__delegate(n,p__14019);
});
...
var readable__delegate = function (n,p__14029){var map__14032 = p__14029;var map__14032__$1 = ((cljs.core.seq_QMARK_.call(null,map__14032))?cljs.core.apply.call(null,cljs.core.hash_map,map__14032):map__14032);var default$ = cljs.core.get.call(null,map__14032__$1,new cljs.core.Keyword(null,"default","default",-1987822328));var plus_QMARK_ = cljs.core.get.call(null,map__14032__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327));var dec = cljs.core.get.call(null,map__14032__$1,new cljs.core.Keyword(null,"dec","dec",1888433436));if(cljs.core.truth_(n))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(round_n));var vec__14033 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__14033,(0),null);var d_str = cljs.core.nth.call(null,vec__14033,(1),null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return clustermap.formats.number.prefix_sign.call(null,t_dec_str,n,plus_QMARK_);
} else
{return default$;
}
};
...
return readable__delegate.call(this,n,p__14029);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__14034){
var n = cljs.core.first(arglist__14034);
var p__14029 = cljs.core.rest(arglist__14034);
return readable__delegate(n,p__14029);
});
