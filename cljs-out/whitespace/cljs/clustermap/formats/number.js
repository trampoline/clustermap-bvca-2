...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__13360_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__13360_SHARP_);
...
var p__13361 = null;if (arguments.length > 1) {
...
var readable__delegate = function (n,p__13371){var map__13374 = p__13371;var map__13374__$1 = ((cljs.core.seq_QMARK_.call(null,map__13374))?cljs.core.apply.call(null,cljs.core.hash_map,map__13374):map__13374);var default$ = cljs.core.get.call(null,map__13374__$1,new cljs.core.Keyword(null,"default","default",-1987822328));var plus_QMARK_ = cljs.core.get.call(null,map__13374__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327));var dec = cljs.core.get.call(null,map__13374__$1,new cljs.core.Keyword(null,"dec","dec",1888433436));if(cljs.core.truth_(n))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(round_n));var vec__13375 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__13375,(0),null);var d_str = cljs.core.nth.call(null,vec__13375,(1),null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return clustermap.formats.number.prefix_sign.call(null,t_dec_str,n,plus_QMARK_);
} else
{return default$;
}
};
