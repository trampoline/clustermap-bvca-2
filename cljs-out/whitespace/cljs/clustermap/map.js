...
pan_to_show.cljs$lang$applyTo = (function (arglist__44998){
var m = cljs.core.first(arglist__44998);
var all_bounds = cljs.core.rest(arglist__44998);
...
console.log(m);
console.log(sites);
return clustermap.async.dorun_async.call(null,clustermap.async.map_async.call(null,cljs.core.partial.call(null,clustermap.map.display_site,m),sites));
});
