...
{{
var G__38270 = (i + 1);
var G__38271 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__38270;
acc = G__38271;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t38275 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t38275 = (function (expr,base,xpath,meta38276){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t38275.cljs$lang$type = true;
domina.xpath.t38275.cljs$lang$ctorStr = "domina.xpath/t38275";
domina.xpath.t38275.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t38275");
});
domina.xpath.t38275.prototype.domina$DomContent$ = true;
domina.xpath.t38275.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t38275.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t38275.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38277){var self__ = this;
var _38277__$1 = this;return self__.meta38276;
});
domina.xpath.t38275.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38277,meta38276__$1){var self__ = this;
var _38277__$1 = this;return (new domina.xpath.t38275(self__.expr,self__.base,self__.xpath,meta38276__$1));
});
domina.xpath.__GT_t38275 = (function __GT_t38275(expr__$1,base__$1,xpath__$1,meta38276){return (new domina.xpath.t38275(expr__$1,base__$1,xpath__$1,meta38276));
});
}
return (new domina.xpath.t38275(expr,base,xpath,null));
});
