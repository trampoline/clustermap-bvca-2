...
{{
var G__23956 = (i + (1));
var G__23957 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__23956;
acc = G__23957;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t23961 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t23961 = (function (expr,base,xpath,meta23962){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t23961.cljs$lang$type = true;
domina.xpath.t23961.cljs$lang$ctorStr = "domina.xpath/t23961";
domina.xpath.t23961.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"domina.xpath/t23961");
});
domina.xpath.t23961.prototype.domina$DomContent$ = true;
domina.xpath.t23961.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t23961.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t23961.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23963){var self__ = this;
var _23963__$1 = this;return self__.meta23962;
});
domina.xpath.t23961.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23963,meta23962__$1){var self__ = this;
var _23963__$1 = this;return (new domina.xpath.t23961(self__.expr,self__.base,self__.xpath,meta23962__$1));
});
domina.xpath.__GT_t23961 = (function __GT_t23961(expr__$1,base__$1,xpath__$1,meta23962){return (new domina.xpath.t23961(expr__$1,base__$1,xpath__$1,meta23962));
});
}
return (new domina.xpath.t23961(expr,base,xpath,null));
});
