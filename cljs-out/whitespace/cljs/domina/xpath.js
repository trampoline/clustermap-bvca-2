...
{{
var G__49415 = (i + 1);
var G__49416 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__49415;
acc = G__49416;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t49420 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t49420 = (function (expr,base,xpath,meta49421){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t49420.cljs$lang$type = true;
domina.xpath.t49420.cljs$lang$ctorStr = "domina.xpath/t49420";
domina.xpath.t49420.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"domina.xpath/t49420");
});
domina.xpath.t49420.prototype.domina$DomContent$ = true;
domina.xpath.t49420.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t49420.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t49420.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49422){var self__ = this;
var _49422__$1 = this;return self__.meta49421;
});
domina.xpath.t49420.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49422,meta49421__$1){var self__ = this;
var _49422__$1 = this;return (new domina.xpath.t49420(self__.expr,self__.base,self__.xpath,meta49421__$1));
});
domina.xpath.__GT_t49420 = (function __GT_t49420(expr__$1,base__$1,xpath__$1,meta49421){return (new domina.xpath.t49420(expr__$1,base__$1,xpath__$1,meta49421));
});
}
return (new domina.xpath.t49420(expr,base,xpath,null));
});
