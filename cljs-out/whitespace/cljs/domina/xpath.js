...
{{
var G__34822 = (i + 1);
var G__34823 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__34822;
acc = G__34823;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t34827 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t34827 = (function (expr,base,xpath,meta34828){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t34827.cljs$lang$type = true;
domina.xpath.t34827.cljs$lang$ctorStr = "domina.xpath/t34827";
domina.xpath.t34827.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t34827");
});
domina.xpath.t34827.prototype.domina$DomContent$ = true;
domina.xpath.t34827.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t34827.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t34827.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34829){var self__ = this;
var _34829__$1 = this;return self__.meta34828;
});
domina.xpath.t34827.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34829,meta34828__$1){var self__ = this;
var _34829__$1 = this;return (new domina.xpath.t34827(self__.expr,self__.base,self__.xpath,meta34828__$1));
});
domina.xpath.__GT_t34827 = (function __GT_t34827(expr__$1,base__$1,xpath__$1,meta34828){return (new domina.xpath.t34827(expr__$1,base__$1,xpath__$1,meta34828));
});
}
return (new domina.xpath.t34827(expr,base,xpath,null));
});
