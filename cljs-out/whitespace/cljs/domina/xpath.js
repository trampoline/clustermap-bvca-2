...
{{
var G__25472 = (i + (1));
var G__25473 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__25472;
acc = G__25473;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t25477 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t25477 = (function (expr,base,xpath,meta25478){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t25477.cljs$lang$type = true;
domina.xpath.t25477.cljs$lang$ctorStr = "domina.xpath/t25477";
domina.xpath.t25477.cljs$lang$ctorPrWriter = (function (this__4213__auto__,writer__4214__auto__,opt__4215__auto__){return cljs.core._write.call(null,writer__4214__auto__,"domina.xpath/t25477");
});
domina.xpath.t25477.prototype.domina$DomContent$ = true;
domina.xpath.t25477.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t25477.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t25477.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25479){var self__ = this;
var _25479__$1 = this;return self__.meta25478;
});
domina.xpath.t25477.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25479,meta25478__$1){var self__ = this;
var _25479__$1 = this;return (new domina.xpath.t25477(self__.expr,self__.base,self__.xpath,meta25478__$1));
});
domina.xpath.__GT_t25477 = (function __GT_t25477(expr__$1,base__$1,xpath__$1,meta25478){return (new domina.xpath.t25477(expr__$1,base__$1,xpath__$1,meta25478));
});
}
return (new domina.xpath.t25477(expr,base,xpath,null));
});
