...
{{
var G__50364 = (i + 1);
var G__50365 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__50364;
acc = G__50365;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t50369 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t50369 = (function (expr,base,xpath,meta50370){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t50369.cljs$lang$type = true;
domina.xpath.t50369.cljs$lang$ctorStr = "domina.xpath/t50369";
domina.xpath.t50369.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t50369");
});
domina.xpath.t50369.prototype.domina$DomContent$ = true;
domina.xpath.t50369.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t50369.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t50369.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50371){var self__ = this;
var _50371__$1 = this;return self__.meta50370;
});
domina.xpath.t50369.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50371,meta50370__$1){var self__ = this;
var _50371__$1 = this;return (new domina.xpath.t50369(self__.expr,self__.base,self__.xpath,meta50370__$1));
});
domina.xpath.__GT_t50369 = (function __GT_t50369(expr__$1,base__$1,xpath__$1,meta50370){return (new domina.xpath.t50369(expr__$1,base__$1,xpath__$1,meta50370));
});
}
return (new domina.xpath.t50369(expr,base,xpath,null));
});
