...
{{
var G__18469 = (i + (1));
var G__18470 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__18469;
acc = G__18470;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t18474 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t18474 = (function (expr,base,xpath,meta18475){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t18474.cljs$lang$type = true;
domina.xpath.t18474.cljs$lang$ctorStr = "domina.xpath/t18474";
domina.xpath.t18474.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"domina.xpath/t18474");
});
domina.xpath.t18474.prototype.domina$DomContent$ = true;
domina.xpath.t18474.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t18474.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t18474.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18476){var self__ = this;
var _18476__$1 = this;return self__.meta18475;
});
domina.xpath.t18474.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18476,meta18475__$1){var self__ = this;
var _18476__$1 = this;return (new domina.xpath.t18474(self__.expr,self__.base,self__.xpath,meta18475__$1));
});
domina.xpath.__GT_t18474 = (function __GT_t18474(expr__$1,base__$1,xpath__$1,meta18475){return (new domina.xpath.t18474(expr__$1,base__$1,xpath__$1,meta18475));
});
}
return (new domina.xpath.t18474(expr,base,xpath,null));
});
