...
{{
var G__37952 = (i + 1);
var G__37953 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__37952;
acc = G__37953;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t37957 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t37957 = (function (expr,base,xpath,meta37958){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t37957.cljs$lang$type = true;
domina.xpath.t37957.cljs$lang$ctorStr = "domina.xpath/t37957";
domina.xpath.t37957.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t37957");
});
domina.xpath.t37957.prototype.domina$DomContent$ = true;
domina.xpath.t37957.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t37957.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t37957.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37959){var self__ = this;
var _37959__$1 = this;return self__.meta37958;
});
domina.xpath.t37957.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37959,meta37958__$1){var self__ = this;
var _37959__$1 = this;return (new domina.xpath.t37957(self__.expr,self__.base,self__.xpath,meta37958__$1));
});
domina.xpath.__GT_t37957 = (function __GT_t37957(expr__$1,base__$1,xpath__$1,meta37958){return (new domina.xpath.t37957(expr__$1,base__$1,xpath__$1,meta37958));
});
}
return (new domina.xpath.t37957(expr,base,xpath,null));
});
