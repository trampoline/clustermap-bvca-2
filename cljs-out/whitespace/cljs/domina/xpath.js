...
{{
var G__36791 = (i + 1);
var G__36792 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__36791;
acc = G__36792;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t36796 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t36796 = (function (expr,base,xpath,meta36797){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t36796.cljs$lang$type = true;
domina.xpath.t36796.cljs$lang$ctorStr = "domina.xpath/t36796";
domina.xpath.t36796.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t36796");
});
domina.xpath.t36796.prototype.domina$DomContent$ = true;
domina.xpath.t36796.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t36796.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t36796.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36798){var self__ = this;
var _36798__$1 = this;return self__.meta36797;
});
domina.xpath.t36796.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36798,meta36797__$1){var self__ = this;
var _36798__$1 = this;return (new domina.xpath.t36796(self__.expr,self__.base,self__.xpath,meta36797__$1));
});
domina.xpath.__GT_t36796 = (function __GT_t36796(expr__$1,base__$1,xpath__$1,meta36797){return (new domina.xpath.t36796(expr__$1,base__$1,xpath__$1,meta36797));
});
}
return (new domina.xpath.t36796(expr,base,xpath,null));
});
