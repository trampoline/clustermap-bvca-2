...
{{
var G__37760 = (i + 1);
var G__37761 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__37760;
acc = G__37761;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t37765 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t37765 = (function (expr,base,xpath,meta37766){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t37765.cljs$lang$type = true;
domina.xpath.t37765.cljs$lang$ctorStr = "domina.xpath/t37765";
domina.xpath.t37765.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t37765");
});
domina.xpath.t37765.prototype.domina$DomContent$ = true;
domina.xpath.t37765.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t37765.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t37765.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37767){var self__ = this;
var _37767__$1 = this;return self__.meta37766;
});
domina.xpath.t37765.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37767,meta37766__$1){var self__ = this;
var _37767__$1 = this;return (new domina.xpath.t37765(self__.expr,self__.base,self__.xpath,meta37766__$1));
});
domina.xpath.__GT_t37765 = (function __GT_t37765(expr__$1,base__$1,xpath__$1,meta37766){return (new domina.xpath.t37765(expr__$1,base__$1,xpath__$1,meta37766));
});
}
return (new domina.xpath.t37765(expr,base,xpath,null));
});
