...
{{
var G__36496 = (i + 1);
var G__36497 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__36496;
acc = G__36497;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t36501 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t36501 = (function (expr,base,xpath,meta36502){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t36501.cljs$lang$type = true;
domina.xpath.t36501.cljs$lang$ctorStr = "domina.xpath/t36501";
domina.xpath.t36501.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t36501");
});
domina.xpath.t36501.prototype.domina$DomContent$ = true;
domina.xpath.t36501.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t36501.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t36501.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36503){var self__ = this;
var _36503__$1 = this;return self__.meta36502;
});
domina.xpath.t36501.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36503,meta36502__$1){var self__ = this;
var _36503__$1 = this;return (new domina.xpath.t36501(self__.expr,self__.base,self__.xpath,meta36502__$1));
});
domina.xpath.__GT_t36501 = (function __GT_t36501(expr__$1,base__$1,xpath__$1,meta36502){return (new domina.xpath.t36501(expr__$1,base__$1,xpath__$1,meta36502));
});
}
return (new domina.xpath.t36501(expr,base,xpath,null));
});
