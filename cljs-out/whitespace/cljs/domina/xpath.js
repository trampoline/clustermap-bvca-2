...
{{
var G__19834 = (i + (1));
var G__19835 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__19834;
acc = G__19835;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t19839 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t19839 = (function (expr,base,xpath,meta19840){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t19839.cljs$lang$type = true;
domina.xpath.t19839.cljs$lang$ctorStr = "domina.xpath/t19839";
domina.xpath.t19839.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"domina.xpath/t19839");
});
domina.xpath.t19839.prototype.domina$DomContent$ = true;
domina.xpath.t19839.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t19839.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t19839.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19841){var self__ = this;
var _19841__$1 = this;return self__.meta19840;
});
domina.xpath.t19839.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19841,meta19840__$1){var self__ = this;
var _19841__$1 = this;return (new domina.xpath.t19839(self__.expr,self__.base,self__.xpath,meta19840__$1));
});
domina.xpath.__GT_t19839 = (function __GT_t19839(expr__$1,base__$1,xpath__$1,meta19840){return (new domina.xpath.t19839(expr__$1,base__$1,xpath__$1,meta19840));
});
}
return (new domina.xpath.t19839(expr,base,xpath,null));
});
