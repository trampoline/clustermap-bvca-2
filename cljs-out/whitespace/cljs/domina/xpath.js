...
{{
var G__34640 = (i + 1);
var G__34641 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__34640;
acc = G__34641;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t34645 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t34645 = (function (expr,base,xpath,meta34646){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t34645.cljs$lang$type = true;
domina.xpath.t34645.cljs$lang$ctorStr = "domina.xpath/t34645";
domina.xpath.t34645.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"domina.xpath/t34645");
});
domina.xpath.t34645.prototype.domina$DomContent$ = true;
domina.xpath.t34645.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t34645.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t34645.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34647){var self__ = this;
var _34647__$1 = this;return self__.meta34646;
});
domina.xpath.t34645.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34647,meta34646__$1){var self__ = this;
var _34647__$1 = this;return (new domina.xpath.t34645(self__.expr,self__.base,self__.xpath,meta34646__$1));
});
domina.xpath.__GT_t34645 = (function __GT_t34645(expr__$1,base__$1,xpath__$1,meta34646){return (new domina.xpath.t34645(expr__$1,base__$1,xpath__$1,meta34646));
});
}
return (new domina.xpath.t34645(expr,base,xpath,null));
});
