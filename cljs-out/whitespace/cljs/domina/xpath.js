...
{{
var G__50156 = (i + 1);
var G__50157 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__50156;
acc = G__50157;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t50161 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t50161 = (function (expr,base,xpath,meta50162){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t50161.cljs$lang$type = true;
domina.xpath.t50161.cljs$lang$ctorStr = "domina.xpath/t50161";
domina.xpath.t50161.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t50161");
});
domina.xpath.t50161.prototype.domina$DomContent$ = true;
domina.xpath.t50161.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t50161.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t50161.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50163){var self__ = this;
var _50163__$1 = this;return self__.meta50162;
});
domina.xpath.t50161.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50163,meta50162__$1){var self__ = this;
var _50163__$1 = this;return (new domina.xpath.t50161(self__.expr,self__.base,self__.xpath,meta50162__$1));
});
domina.xpath.__GT_t50161 = (function __GT_t50161(expr__$1,base__$1,xpath__$1,meta50162){return (new domina.xpath.t50161(expr__$1,base__$1,xpath__$1,meta50162));
});
}
return (new domina.xpath.t50161(expr,base,xpath,null));
});
