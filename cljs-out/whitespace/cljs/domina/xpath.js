...
{{
var G__32723 = (i + 1);
var G__32724 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__32723;
acc = G__32724;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t32728 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t32728 = (function (expr,base,xpath,meta32729){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t32728.cljs$lang$type = true;
domina.xpath.t32728.cljs$lang$ctorStr = "domina.xpath/t32728";
domina.xpath.t32728.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t32728");
});
domina.xpath.t32728.prototype.domina$DomContent$ = true;
domina.xpath.t32728.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32728.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32728.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32730){var self__ = this;
var _32730__$1 = this;return self__.meta32729;
});
domina.xpath.t32728.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32730,meta32729__$1){var self__ = this;
var _32730__$1 = this;return (new domina.xpath.t32728(self__.expr,self__.base,self__.xpath,meta32729__$1));
});
domina.xpath.__GT_t32728 = (function __GT_t32728(expr__$1,base__$1,xpath__$1,meta32729){return (new domina.xpath.t32728(expr__$1,base__$1,xpath__$1,meta32729));
});
}
return (new domina.xpath.t32728(expr,base,xpath,null));
});
