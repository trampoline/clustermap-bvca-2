...
{{
var G__50428 = (i + 1);
var G__50429 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__50428;
acc = G__50429;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t50433 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t50433 = (function (expr,base,xpath,meta50434){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t50433.cljs$lang$type = true;
domina.xpath.t50433.cljs$lang$ctorStr = "domina.xpath/t50433";
domina.xpath.t50433.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"domina.xpath/t50433");
});
domina.xpath.t50433.prototype.domina$DomContent$ = true;
domina.xpath.t50433.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t50433.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t50433.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50435){var self__ = this;
var _50435__$1 = this;return self__.meta50434;
});
domina.xpath.t50433.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50435,meta50434__$1){var self__ = this;
var _50435__$1 = this;return (new domina.xpath.t50433(self__.expr,self__.base,self__.xpath,meta50434__$1));
});
domina.xpath.__GT_t50433 = (function __GT_t50433(expr__$1,base__$1,xpath__$1,meta50434){return (new domina.xpath.t50433(expr__$1,base__$1,xpath__$1,meta50434));
});
}
return (new domina.xpath.t50433(expr,base,xpath,null));
});
