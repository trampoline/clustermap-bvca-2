...
{{
var G__36902 = (i + 1);
var G__36903 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__36902;
acc = G__36903;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t36907 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t36907 = (function (expr,base,xpath,meta36908){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t36907.cljs$lang$type = true;
domina.xpath.t36907.cljs$lang$ctorStr = "domina.xpath/t36907";
domina.xpath.t36907.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t36907");
});
domina.xpath.t36907.prototype.domina$DomContent$ = true;
domina.xpath.t36907.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t36907.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t36907.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36909){var self__ = this;
var _36909__$1 = this;return self__.meta36908;
});
domina.xpath.t36907.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36909,meta36908__$1){var self__ = this;
var _36909__$1 = this;return (new domina.xpath.t36907(self__.expr,self__.base,self__.xpath,meta36908__$1));
});
domina.xpath.__GT_t36907 = (function __GT_t36907(expr__$1,base__$1,xpath__$1,meta36908){return (new domina.xpath.t36907(expr__$1,base__$1,xpath__$1,meta36908));
});
}
return (new domina.xpath.t36907(expr,base,xpath,null));
});
