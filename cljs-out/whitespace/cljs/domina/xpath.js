...
{{
var G__32852 = (i + 1);
var G__32853 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__32852;
acc = G__32853;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t32857 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t32857 = (function (expr,base,xpath,meta32858){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t32857.cljs$lang$type = true;
domina.xpath.t32857.cljs$lang$ctorStr = "domina.xpath/t32857";
domina.xpath.t32857.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t32857");
});
domina.xpath.t32857.prototype.domina$DomContent$ = true;
domina.xpath.t32857.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32857.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t32857.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32859){var self__ = this;
var _32859__$1 = this;return self__.meta32858;
});
domina.xpath.t32857.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32859,meta32858__$1){var self__ = this;
var _32859__$1 = this;return (new domina.xpath.t32857(self__.expr,self__.base,self__.xpath,meta32858__$1));
});
domina.xpath.__GT_t32857 = (function __GT_t32857(expr__$1,base__$1,xpath__$1,meta32858){return (new domina.xpath.t32857(expr__$1,base__$1,xpath__$1,meta32858));
});
}
return (new domina.xpath.t32857(expr,base,xpath,null));
});
