...
{{
var G__35979 = (i + 1);
var G__35980 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__35979;
acc = G__35980;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t35984 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t35984 = (function (expr,base,xpath,meta35985){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t35984.cljs$lang$type = true;
domina.xpath.t35984.cljs$lang$ctorStr = "domina.xpath/t35984";
domina.xpath.t35984.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t35984");
});
domina.xpath.t35984.prototype.domina$DomContent$ = true;
domina.xpath.t35984.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t35984.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t35984.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35986){var self__ = this;
var _35986__$1 = this;return self__.meta35985;
});
domina.xpath.t35984.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35986,meta35985__$1){var self__ = this;
var _35986__$1 = this;return (new domina.xpath.t35984(self__.expr,self__.base,self__.xpath,meta35985__$1));
});
domina.xpath.__GT_t35984 = (function __GT_t35984(expr__$1,base__$1,xpath__$1,meta35985){return (new domina.xpath.t35984(expr__$1,base__$1,xpath__$1,meta35985));
});
}
return (new domina.xpath.t35984(expr,base,xpath,null));
});
