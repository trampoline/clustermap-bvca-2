...
{{
var G__38207 = (i + 1);
var G__38208 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__38207;
acc = G__38208;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t38212 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t38212 = (function (expr,base,xpath,meta38213){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t38212.cljs$lang$type = true;
domina.xpath.t38212.cljs$lang$ctorStr = "domina.xpath/t38212";
domina.xpath.t38212.cljs$lang$ctorPrWriter = (function (this__3968__auto__,writer__3969__auto__,opt__3970__auto__){return cljs.core._write.call(null,writer__3969__auto__,"domina.xpath/t38212");
});
domina.xpath.t38212.prototype.domina$DomContent$ = true;
domina.xpath.t38212.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t38212.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t38212.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38214){var self__ = this;
var _38214__$1 = this;return self__.meta38213;
});
domina.xpath.t38212.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38214,meta38213__$1){var self__ = this;
var _38214__$1 = this;return (new domina.xpath.t38212(self__.expr,self__.base,self__.xpath,meta38213__$1));
});
domina.xpath.__GT_t38212 = (function __GT_t38212(expr__$1,base__$1,xpath__$1,meta38213){return (new domina.xpath.t38212(expr__$1,base__$1,xpath__$1,meta38213));
});
}
return (new domina.xpath.t38212(expr,base,xpath,null));
});
