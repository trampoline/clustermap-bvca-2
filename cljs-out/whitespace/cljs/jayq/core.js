...
var G__36586 = null;
var G__36586__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__36586__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
G__36586 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__36586__2.call(this,self__,k);
case 3:
return G__36586__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
return G__36586;
...
;
jQuery.prototype.apply = (function (self__,args36585){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args36585)));
});
...
var hide__delegate = function ($elem,p__36587){var vec__36589 = p__36587;var speed = cljs.core.nth.call(null,vec__36589,0,null);var on_finish = cljs.core.nth.call(null,vec__36589,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__36587 = null;if (arguments.length > 1) {
  p__36587 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__36587);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__36590){
var $elem = cljs.core.first(arglist__36590);
var p__36587 = cljs.core.rest(arglist__36590);
return hide__delegate($elem,p__36587);
});
...
var show__delegate = function ($elem,p__36591){var vec__36593 = p__36591;var speed = cljs.core.nth.call(null,vec__36593,0,null);var on_finish = cljs.core.nth.call(null,vec__36593,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__36591 = null;if (arguments.length > 1) {
  p__36591 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__36591);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__36594){
var $elem = cljs.core.first(arglist__36594);
var p__36591 = cljs.core.rest(arglist__36594);
return show__delegate($elem,p__36591);
});
...
var toggle__delegate = function ($elem,p__36595){var vec__36597 = p__36595;var speed = cljs.core.nth.call(null,vec__36597,0,null);var on_finish = cljs.core.nth.call(null,vec__36597,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__36595 = null;if (arguments.length > 1) {
  p__36595 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__36595);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__36598){
var $elem = cljs.core.first(arglist__36598);
var p__36595 = cljs.core.rest(arglist__36598);
return toggle__delegate($elem,p__36595);
});
...
var fade_out__delegate = function ($elem,p__36599){var vec__36601 = p__36599;var speed = cljs.core.nth.call(null,vec__36601,0,null);var on_finish = cljs.core.nth.call(null,vec__36601,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__36599 = null;if (arguments.length > 1) {
  p__36599 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__36599);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__36602){
var $elem = cljs.core.first(arglist__36602);
var p__36599 = cljs.core.rest(arglist__36602);
return fade_out__delegate($elem,p__36599);
});
...
var fade_in__delegate = function ($elem,p__36603){var vec__36605 = p__36603;var speed = cljs.core.nth.call(null,vec__36605,0,null);var on_finish = cljs.core.nth.call(null,vec__36605,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__36603 = null;if (arguments.length > 1) {
  p__36603 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__36603);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__36606){
var $elem = cljs.core.first(arglist__36606);
var p__36603 = cljs.core.rest(arglist__36606);
return fade_in__delegate($elem,p__36603);
});
...
var slide_up__delegate = function ($elem,p__36607){var vec__36609 = p__36607;var speed = cljs.core.nth.call(null,vec__36609,0,null);var on_finish = cljs.core.nth.call(null,vec__36609,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__36607 = null;if (arguments.length > 1) {
  p__36607 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__36607);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__36610){
var $elem = cljs.core.first(arglist__36610);
var p__36607 = cljs.core.rest(arglist__36610);
return slide_up__delegate($elem,p__36607);
});
...
var slide_down__delegate = function ($elem,p__36611){var vec__36613 = p__36611;var speed = cljs.core.nth.call(null,vec__36613,0,null);var on_finish = cljs.core.nth.call(null,vec__36613,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__36611 = null;if (arguments.length > 1) {
  p__36611 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__36611);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__36614){
var $elem = cljs.core.first(arglist__36614);
var p__36611 = cljs.core.rest(arglist__36614);
return slide_down__delegate($elem,p__36611);
});
...
var closest__delegate = function ($elem,selector,p__36615){var vec__36617 = p__36615;var context = cljs.core.nth.call(null,vec__36617,0,null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__36615 = null;if (arguments.length > 2) {
  p__36615 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__36615);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__36618){
var $elem = cljs.core.first(arglist__36618);
arglist__36618 = cljs.core.next(arglist__36618);
var selector = cljs.core.first(arglist__36618);
var p__36615 = cljs.core.rest(arglist__36618);
return closest__delegate($elem,selector,p__36615);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__36621){var map__36623 = p__36621;var map__36623__$1 = ((cljs.core.seq_QMARK_.call(null,map__36623))?cljs.core.apply.call(null,cljs.core.hash_map,map__36623):map__36623);var request = map__36623__$1;var contentType = cljs.core.get.call(null,map__36623__$1,new cljs.core.Keyword(null,"contentType","contentType",624772805));var data = cljs.core.get.call(null,map__36623__$1,new cljs.core.Keyword(null,"data","data",1016980252));var ct = jayq.core.__GT_content_type.call(null,contentType);return (function (p1__36620_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__36620_SHARP_,new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.pr_str.call(null,data));
} else
{return p1__36620_SHARP_;
}
}).call(null,(function (p1__36619_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__36619_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",624772805),ct);
} else
...
var unbind__delegate = function ($elem,ev,p__36627){var vec__36629 = p__36627;var func = cljs.core.nth.call(null,vec__36629,0,null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__36627 = null;if (arguments.length > 2) {
  p__36627 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__36627);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__36630){
var $elem = cljs.core.first(arglist__36630);
arglist__36630 = cljs.core.next(arglist__36630);
var ev = cljs.core.first(arglist__36630);
var p__36627 = cljs.core.rest(arglist__36630);
return unbind__delegate($elem,ev,p__36627);
});
...
var on__delegate = function ($elem,events,p__36631){var vec__36633 = p__36631;var sel = cljs.core.nth.call(null,vec__36633,0,null);var data = cljs.core.nth.call(null,vec__36633,1,null);var handler = cljs.core.nth.call(null,vec__36633,2,null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__36631 = null;if (arguments.length > 2) {
  p__36631 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__36631);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__36634){
var $elem = cljs.core.first(arglist__36634);
arglist__36634 = cljs.core.next(arglist__36634);
var events = cljs.core.first(arglist__36634);
var p__36631 = cljs.core.rest(arglist__36634);
return on__delegate($elem,events,p__36631);
});
...
var one__delegate = function ($elem,events,p__36635){var vec__36637 = p__36635;var sel = cljs.core.nth.call(null,vec__36637,0,null);var data = cljs.core.nth.call(null,vec__36637,1,null);var handler = cljs.core.nth.call(null,vec__36637,2,null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__36635 = null;if (arguments.length > 2) {
  p__36635 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__36635);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__36638){
var $elem = cljs.core.first(arglist__36638);
arglist__36638 = cljs.core.next(arglist__36638);
var events = cljs.core.first(arglist__36638);
var p__36635 = cljs.core.rest(arglist__36638);
return one__delegate($elem,events,p__36635);
});
...
var off__delegate = function ($elem,events,p__36639){var vec__36641 = p__36639;var sel = cljs.core.nth.call(null,vec__36641,0,null);var handler = cljs.core.nth.call(null,vec__36641,1,null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__36639 = null;if (arguments.length > 2) {
  p__36639 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__36639);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__36642){
var $elem = cljs.core.first(arglist__36642);
arglist__36642 = cljs.core.next(arglist__36642);
var events = cljs.core.first(arglist__36642);
var p__36639 = cljs.core.rest(arglist__36642);
return off__delegate($elem,events,p__36639);
});
...
done.cljs$lang$applyTo = (function (arglist__36643){
var deferred = cljs.core.first(arglist__36643);
var fns_args = cljs.core.rest(arglist__36643);
...
fail.cljs$lang$applyTo = (function (arglist__36644){
var deferred = cljs.core.first(arglist__36644);
var fns_args = cljs.core.rest(arglist__36644);
...
always.cljs$lang$applyTo = (function (arglist__36645){
var deferred = cljs.core.first(arglist__36645);
var fns_args = cljs.core.rest(arglist__36645);
