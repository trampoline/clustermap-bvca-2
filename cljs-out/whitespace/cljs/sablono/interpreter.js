...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj34187 = {};return obj34187;
})();
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__34189 = sablono.util.normalize_element.call(null,element__$1);var tag = cljs.core.nth.call(null,vec__34189,0,null);var attrs = cljs.core.nth.call(null,vec__34189,1,null);var content = cljs.core.nth.call(null,vec__34189,2,null);var dom_fn = (React.DOM[cljs.core.name.call(null,tag)]);if(cljs.core.truth_(content))
