...
sablono.util.ToString = (function (){var obj36314 = {};return obj36314;
})();
...
sablono.util.ToURI = (function (){var obj36316 = {};return obj36316;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__36317){
var xs = cljs.core.seq(arglist__36317);
...
{var vec__36319 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__36319,0,null);var words = cljs.core.nthnext.call(null,vec__36319,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__36320_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__36320_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__36320_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__36320_SHARP_))
{return p1__36320_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__36321){
var maps = cljs.core.seq(arglist__36321);
...
*/
sablono.util.normalize_element = (function normalize_element(p__36322){var vec__36325 = p__36322;var tag = cljs.core.nth.call(null,vec__36325,0,null);var content = cljs.core.nthnext.call(null,vec__36325,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
