...
{var vec__26958 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__26958,0,null);var words = cljs.core.nthnext.call(null,vec__26958,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__26959_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__26959_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26959_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__26959_SHARP_))
...
*/
sablono.util.normalize_element = (function normalize_element(p__26961){var vec__26964 = p__26961;var tag = cljs.core.nth.call(null,vec__26964,0,null);var content = cljs.core.nthnext.call(null,vec__26964,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
