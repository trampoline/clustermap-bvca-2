...
sablono.util.ToString = (function (){var obj33651 = {};return obj33651;
})();
...
sablono.util.ToURI = (function (){var obj33653 = {};return obj33653;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__33654){
var xs = cljs.core.seq(arglist__33654);
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__33655_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__33655_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__33655_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__33655_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__33656){
var maps = cljs.core.seq(arglist__33656);
...
*/
sablono.util.normalize_element = (function normalize_element(p__33657){var vec__33660 = p__33657;var tag = cljs.core.nth.call(null,vec__33660,0,null);var content = cljs.core.nthnext.call(null,vec__33660,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__33661 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__33661,0,null);var tag__$1 = cljs.core.nth.call(null,vec__33661,1,null);var id = cljs.core.nth.call(null,vec__33661,2,null);var class$ = cljs.core.nth.call(null,vec__33661,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"className","className",1004015509),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
