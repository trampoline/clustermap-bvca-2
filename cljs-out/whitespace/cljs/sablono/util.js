...
sablono.util.ToString = (function (){var obj33708 = {};return obj33708;
})();
...
sablono.util.ToURI = (function (){var obj33710 = {};return obj33710;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__33711){
var xs = cljs.core.seq(arglist__33711);
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__33712_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__33712_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__33712_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__33712_SHARP_))
{return p1__33712_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__33713){
var maps = cljs.core.seq(arglist__33713);
...
*/
sablono.util.normalize_element = (function normalize_element(p__33714){var vec__33717 = p__33714;var tag = cljs.core.nth.call(null,vec__33717,0,null);var content = cljs.core.nthnext.call(null,vec__33717,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__33718 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__33718,0,null);var tag__$1 = cljs.core.nth.call(null,vec__33718,1,null);var id = cljs.core.nth.call(null,vec__33718,2,null);var class$ = cljs.core.nth.call(null,vec__33718,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"className","className",1004015509),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
