...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17715 = 0;while(true){
var m_17716 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17716 == null))
{} else
{m_17716.call(null);
if((count_17715 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17717 = (count_17715 + 1);
count_17715 = G__17717;
continue;
}
} else
{}
