...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17680 = 0;while(true){
if((i_17680 < arr.length))
{(arr[i_17680] = null);
{
...
{var i_17687 = (self__.level + 1);while(true){
if((i_17687 <= (new_level + 1)))
{(update[i_17687] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17689 = 0;while(true){
if((i_17689 <= self__.level))
{var links_17690 = (update[i_17689]).forward;if(((links_17690[i_17689]) === x__$1))
{(links_17690[i_17689] = (x__$1.forward[i_17689]));
{
var G__17691 = (i_17689 + 1);
i_17689 = G__17691;
continue;
}
} else
{{
var G__17692 = (i_17689 + 1);
i_17689 = G__17692;
continue;
}
}
