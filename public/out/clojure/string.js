...
{{
var G__14980 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14980;
continue;
}
} else
...
{var pred__14984 = cljs.core._EQ_;var expr__14985 = limit;if(cljs.core.truth_(pred__14984.call(null,1,expr__14985)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14984.call(null,2,expr__14985)))
...
var G__14987 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14988 = (limit__$1 - 1);
var G__14989 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14987;
limit__$1 = G__14988;
parts = G__14989;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14991 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14991))
{var replacement_14992 = temp__4090__auto___14991;buffer.append([cljs.core.str(replacement_14992)].join(''));
} else
{buffer.append(ch);
}
{
var G__14993 = (index + 1);
index = G__14993;
continue;
}
}
