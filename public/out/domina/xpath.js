...
{{
var G__14406 = (i + 1);
var G__14407 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__14406;
acc = G__14407;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t14411 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t14411 = (function (expr,base,xpath,meta14412){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t14411.cljs$lang$type = true;
domina.xpath.t14411.cljs$lang$ctorStr = "domina.xpath/t14411";
domina.xpath.t14411.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"domina.xpath/t14411");
});
domina.xpath.t14411.prototype.domina$DomContent$ = true;
domina.xpath.t14411.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t14411.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t14411.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14413){var self__ = this;
var _14413__$1 = this;return self__.meta14412;
});
domina.xpath.t14411.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14413,meta14412__$1){var self__ = this;
var _14413__$1 = this;return (new domina.xpath.t14411(self__.expr,self__.base,self__.xpath,meta14412__$1));
});
domina.xpath.__GT_t14411 = (function __GT_t14411(expr__$1,base__$1,xpath__$1,meta14412){return (new domina.xpath.t14411(expr__$1,base__$1,xpath__$1,meta14412));
});
}
return (new domina.xpath.t14411(expr,base,xpath,null));
});
